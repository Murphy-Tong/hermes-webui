import { p as B } from "./chunk-JWPE2WC7-C5JvTjqd.js";
import { _ as b, A as u, D as $, d as C, l as m, b as S, a as D, n as T, o as P, g as z, s as A, y as E, B as F, p as W } from "./mermaid.core-uMSYC8Sk.js";
import { p as _ } from "./cynefin-OW5HDTMX-gHq-wzJD.js";
var N = F.packet, w = class {
  constructor() {
    this.packet = [], this.setAccTitle = S, this.getAccTitle = D, this.setDiagramTitle = T, this.getDiagramTitle = P, this.getAccDescription = z, this.setAccDescription = A;
  }
  static {
    b(this, "PacketDB");
  }
  ...
  for (let { start: a, end: i, bits: d, label: c } of t.blocks) {
    ...
    for (i ??= a + (d ?? 1) - 1, d ??= i - a + 1, r = i, m.debug(`Packet block ${a} - ${r} with label ${c}`); s.length <= l + 1 && e.getPacket().length < L; ) {
      const [p, o] = Y({ start: a, end: i, bits: d, label: c }, n, l);
...
}, I = /* @__PURE__ */ b((t, e, r, s) => {
  const n = s.db, l = n.getConfig(), { rowHeight: a, paddingY: i, bitWidth: d, bitsPerRow: c } = l, p = n.getPacket(), o = n.getDiagramTitle(), h = a + i, g = h * (p.length + 1) - (o ? 0 : a), k = d * c + 2, f = $(e);
...
}, "draw"), O = /* @__PURE__ */ b((t, e, r, { rowHeight: s, paddingX: n, paddingY: l, bitWidth: a, bitsPerRow: i, showBits: d }) => {
