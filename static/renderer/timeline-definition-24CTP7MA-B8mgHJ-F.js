import { _ as o, y as pt, ab as Rt, ac as Ct, ad as Wt, c as gt, l as E, D as Pt, L as Bt, ae as ft, j as U, t as Vt, af as Ft, p as zt } from "./mermaid.core-CE4XPZv1.js";
import { d as ot } from "./arc-WjlL3bR8.js";
var tt = (function() {
  var e = /* @__PURE__ */ o(function(k, s, d, l) {
    ...
    parse: /* @__PURE__ */ o(function(s) {
      var d = this, l = [0], p = [], x = [null], u = [], S = this.table, v = "", I = 0, R = 0, W = 2, O = 1, L = u.slice.call(arguments, 1), w = Object.create(this.lexer), H = { yy: {} };
      ...
      o(b, "lex");
      for (var _, $, T, P, C = {}, G, B, X, Z; ; ) {
        if ($ = l[l.length - 1], this.defaultActions[$] ? T = this.defaultActions[$] : ((_ === null || typeof _ > "u") && (_ = b()), T = S[$] && S[$][_]), typeof T > "u" || !T.length || !T[0]) {
          var Y = "";
          Z = [];
          for (G in S[$])
            this.terminals_[G] && G > W && Z.push("'" + this.terminals_[G] + "'");
          w.showPosition ? Y = "Parse error on line " + (I + 1) + `:
` + w.showPosition() + `
Expecting ` + Z.join(", ") + ", got '" + (this.terminals_[_] || _) + "'" : Y = "Parse error on line " + (I + 1) + ": Unexpected " + (_ == O ? "end of input" : "'" + (this.terminals_[_] || _) + "'"), this.parseError(Y, {
            text: w.match,
        ...
        switch (T[0]) {
          case 1:
            l.push(_), x.push(w.yytext), u.push(w.yylloc), l.push(T[1]), _ = null, R = w.yyleng, v = w.yytext, I = w.yylineno, F = w.yylloc;
            break;
          case 2:
            if (B = this.productions_[T[1]][1], C.$ = x[x.length - B], C._$ = {
              ...
              return P;
            B && (l = l.slice(0, -1 * B * 2), x = x.slice(0, -1 * B), u = u.slice(0, -1 * B)), l.push(this.productions_[T[1]][0]), x.push(C.$), u.push(C._$), X = S[l[l.length - 2]][l[l.length - 1]], l.push(X);
            break;
          case 3:
            return !0;
        }
...
var D = "", mt = 0, nt = "LR", rt = [], q = [], j = [], xt = /* @__PURE__ */ o(() => Ft, "getCommonDb"), kt = /* @__PURE__ */ o(function() {
  rt.length = 0, q.length = 0, D = "", j.length = 0, nt = "LR", zt();
  ...
  j.find((n) => n.id === mt - 1).events.push(e);
...
}, "drawFace"), jt = /* @__PURE__ */ o(function(e, t) {
...
}, "drawSection"), et = -1, Xt = /* @__PURE__ */ o(function(e, t, n, i) {
...
}, "drawTask"), Zt = /* @__PURE__ */ o(function(e, t) {
  J(e, {
    x: t.startx,
    y: t.starty,
...
var Qt = /* @__PURE__ */ o(function(e, t, n, i, r, h = !1) {
  ...
  if (t.height = l.height + p * 1.1 * 0.5 + t.padding, t.height = Math.max(t.height, t.maxHeight), t.width = t.width + 2 * t.padding, s.attr("transform", "translate(" + t.width / 2 + ", " + t.padding / 2 + ")"), f && s.attr(
    ...
    if (S.select(`#${I}`).empty()) {
      const R = S.select("defs");
      (R.empty() ? S.append("defs") : R).append("filter").attr("id", I).attr("height", "130%").attr("width", "130%").append("feDropShadow").attr("dx", "4").attr("dy", "4").attr("stdDeviation", 0).attr("flood-opacity", x ? "0.2" : "0.06").attr("flood-color", x ? "#FFFFFF" : "#000000");
    }
  }
  return t;
  ...
  E.debug("sections", u);
  let S = 0, v = 0, I = 0, R = 0, W = 50 + y, O = 50;
  R = 50;
  let L = 0, w = !0;
  ...
  for (const [N, b] of p.entries()) {
    ...
    for (const P of b.events) {
      ...
      T += M.getVirtualNodeHeight(l, C, r);
    }
  ...
  E.debug("maxSectionHeight before draw", S), E.debug("maxTaskHeight before draw", v), u && u.length > 0 ? u.forEach((N) => {
    ...
    E.debug("sectionNode output", T), $.attr("transform", `translate(${W}, ${R})`), O += S + 50, b.length > 0 && lt(
      l,
      b,
      L,
      W,
      ...
      !1,
      t
    ), W += 200 * Math.max(b.length, 1), O = R, L++;
  }) : (w = !1, lt(
    l,
    p,
    L,
  ...
  let S = 0;
  const v = g && g.length > 0, I = v ? u : k + p, R = Math.max(50, p + x - z * 2);
  ...
  for (const [N, b] of a.entries()) {
    ...
    for (const P of b.events) {
      ...
      T += M.getVirtualNodeHeight(c, C, r);
    }
  ...
  v ? g.forEach((N) => {
    const b = a.filter((X) => X.section === N), _ = {
      number: S,
      descr: N,
      section: S,
      width: R,
  ...
  for (let n = 0; n < e.THEME_COLOR_LIMIT; n++)
    e["lineColor" + n] = e["lineColor" + n] || e["cScaleInv" + n], Rt(e["lineColor" + n]) ? e["lineColor" + n] = Ct(e["lineColor" + n], 20) : e["lineColor" + n] = Wt(e["lineColor" + n], 20);
  for (let n = 0; n < e.THEME_COLOR_LIMIT; n++) {
    const i = "" + (17 - 3 * n);
    t += `
