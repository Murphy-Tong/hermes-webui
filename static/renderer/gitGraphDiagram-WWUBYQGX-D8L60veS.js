import { I as le } from "./chunk-2Q5K7J3B-DqvyFuAT.js";
import { p as he } from "./chunk-JWPE2WC7-C5JvTjqd.js";
import { o as $e, n as fe, s as ge, g as ue, a as ye, b as xe, _ as h, y as J, l as w, j as me, c as q, x as pe, z as be, p as we, k as B, A as ke, B as ve, C as Ce } from "./mermaid.core-uMSYC8Sk.js";
import { p as Ee } from "./cynefin-OW5HDTMX-gHq-wzJD.js";
var m = {
  NORMAL: 0,
  REVERSE: 1,
  HIGHLIGHT: 2,
...
var Ge = /* @__PURE__ */ h(function() {
...
}, "getCommitsArray"), Pe = /* @__PURE__ */ h(function() {
  return d.records.currBranch;
}, "getCurrentBranch"), We = /* @__PURE__ */ h(function() {
  return d.records.direction;
}, "getDirection"), qe = /* @__PURE__ */ h(function() {
  ...
  C.clear(), E.clear(), P.clear(), I = 0, z = [], y = "LR";
  ...
  const { theme: n } = q(), a = j.has(n ?? ""), l = Z.has(n ?? ""), f = Xe.has(n ?? "");
  if (i === m.HIGHLIGHT)
  ...
  const n = j.has(q().theme ?? ""), a = y === "TB" || y === "BT" ? s : o + (n ? X / 2 + 1 : -2);
...
}, "shouldRerouteArrow"), W = /* @__PURE__ */ h((e, r, t = 0) => {
  ...
  if (l) {
    ...
    const p = n.y < a.y ? W(n.y, a.y) : W(a.y, n.y), b = n.x < a.x ? W(n.x, a.x) : W(a.x, n.x);
  ...
  const { look: o, theme: i, themeVariables: n } = q(), { dropShadow: a, THEME_COLOR_LIMIT: l } = n, f = j.has(i ?? ""), g = Z.has(i ?? ""), $ = e.append("g");
  r.forEach((c, x) => {
    const u = H(
      x,
      f ? l : G,
...
`, "id:", r, t);
  ...
  y = o.getDirection();
  const l = me(`[id="${r}"]`), { look: f, theme: g, themeVariables: $ } = q(), { useGradient: c, gradientStart: x, gradientStop: u, filterColor: p } = $;
  if (c) {
  ...
  }), re(l, P, !1, i), i.showBranches && fr(l, a, i, r), $r(l, P), re(l, P, !0, i), pe.insertTitle(
    l,
    "gitTitleText",
    i.titleTopMargin ?? 0,
    o.getDiagramTitle()
