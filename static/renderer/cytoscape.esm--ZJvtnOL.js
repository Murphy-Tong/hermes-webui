...
function ac(r) {
  if (Array.isArray(r)) return Ds(r);
}
function ct(r, e) {
...
function dt(r, e, t) {
  return e && nc(r.prototype, e), Object.defineProperty(r, "prototype", {
    writable: !1
  }), r;
}
function Cr(r, e) {
...
function Xe(r, e) {
  return tc(r) || sc(r, e) || Ks(r, e) || oc();
}
function yn(r) {
  return ac(r) || ic(r) || Ks(r) || uc();
}
function lc(r, e) {
...
function Ks(r, e) {
  if (r) {
    if (typeof r == "string") return Ds(r, e);
    var t = {}.toString.call(r).slice(8, -1);
    return t === "Object" && r.constructor && (t = r.constructor.name), t === "Map" || t === "Set" ? Array.from(r) : t === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? Ds(r, e) : void 0;
  }
}
var Qe = typeof window > "u" ? null : window, Co = Qe ? Qe.navigator : null;
Qe && Qe.document;
var vc = je(""), jl = je({}), fc = je(function() {
}), cc = typeof HTMLElement > "u" ? "undefined" : je(HTMLElement), La = function(e) {
  return e && e.instanceString && He(e.instanceString) ? e.instanceString() : null;
}, he = function(e) {
  return e != null && je(e) == vc;
}, He = function(e) {
  return e != null && je(e) === fc;
}, Fe = function(e) {
  return !Tr(e) && (Array.isArray ? Array.isArray(e) : e != null && e instanceof Array);
}, Me = function(e) {
  return e != null && je(e) === jl && !Fe(e) && e.constructor === Object;
}, dc = function(e) {
  return e != null && je(e) === jl;
}, ae = function(e) {
  ...
  return Me(e) && ae(e.x1) && ae(e.x2) && ae(e.y1) && ae(e.y2);
}, yc = function(e) {
  return dc(e) && He(e.then);
}, mc = function() {
  return Co && Co.userAgent.match(/msie|trident|edge/i);
}, Yt = function(e, t) {
  t || (t = function() {
  ...
  return st(e) ? e : e.charAt(0).toUpperCase() + e.substring(1);
}, rt = function(e, t) {
  return e.slice(-1 * t.length) === t;
}, Je = "(?:[-+]?(?:(?:\\d+|\\d*\\.\\d+)(?:[Ee][+-]?\\d+)?))", bc = "rgb[a]?\\((" + Je + "[%]?)\\s*,\\s*(" + Je + "[%]?)\\s*,\\s*(" + Je + "[%]?)(?:\\s*,\\s*(" + Je + "))?\\)", wc = "rgb[a]?\\((?:" + Je + "[%]?)\\s*,\\s*(?:" + Je + "[%]?)\\s*,\\s*(?:" + Je + "[%]?)(?:\\s*,\\s*(?:" + Je + "))?\\)", xc = "hsl[a]?\\((" + Je + ")\\s*,\\s*(" + Je + "[%])\\s*,\\s*(" + Je + "[%])(?:\\s*,\\s*(" + Je + "))?\\)", Ec = "hsl[a]?\\((?:" + Je + ")\\s*,\\s*(?:" + Je + "[%])\\s*,\\s*(?:" + Je + "[%])(?:\\s*,\\s*(?:" + Je + "))?\\)", Cc = "\\#[0-9a-fA-F]{3}", Tc = "\\#[0-9a-fA-F]{6}", nv = function(e, t) {
  return e < t ? -1 : e > t ? 1 : 0;
}, Sc = function(e, t) {
  return -1 * nv(e, t);
}, me = Object.assign != null ? Object.assign.bind(Object) : function(r) {
  ...
  if (f) {
    ...
    if (n === 0)
      ...
      o = Math.round(255 * v(h, c, a + 1 / 3)), u = Math.round(255 * v(h, c, a)), l = Math.round(255 * v(h, c, a - 1 / 3));
    }
    t = [o, u, l, s];
  }
  return t;
}, Bc = function(e) {
  var t, a = new RegExp("^" + bc + "$").exec(e);
  if (a) {
    t = [];
    for (var n = [], i = 1; i <= 3; i++) {
      var s = a[i];
  ...
  return (Fe(e) ? e : null) || Pc(e) || kc(e) || Bc(e) || Dc(e);
}, Ac = {
...
function Mn() {
  if (Do) return jn;
  Do = 1;
  var r = Rc(), e = typeof self == "object" && self && self.Object === Object && self, t = r || e || Function("return this")();
  return jn = t, jn;
}
var ei, Bo;
function Mc() {
...
function Oc() {
  if (Mo) return ni;
  Mo = 1;
  var r = Zs(), e = Object.prototype, t = e.hasOwnProperty, a = e.toString, n = r ? r.toStringTag : void 0;
  function i(s) {
...
function uv() {
  if (Io) return si;
  Io = 1;
  var r = Zs(), e = Oc(), t = Nc(), a = "[object Null]", n = "[object Undefined]", i = r ? r.toStringTag : void 0;
  function s(o) {
...
function Fc() {
  if (zo) return li;
  zo = 1;
  var r = Ic(), e = Na(), t = za(), a = NaN, n = /^[-+]0x[0-9a-f]+$/i, i = /^0b[01]+$/i, s = /^0o[0-7]+$/i, o = parseInt;
  function u(l) {
    if (typeof l == "number")
      return l;
    if (t(l))
      return a;
    if (e(l)) {
      var v = typeof l.valueOf == "function" ? l.valueOf() : l;
      l = e(v) ? v + "" : v;
    }
    if (typeof l != "string")
      return l === 0 ? l : +l;
...
function Vc() {
  if (Fo) return vi;
  Fo = 1;
  var r = Na(), e = Mc(), t = Fc(), a = "Expected a function", n = Math.max, i = Math.min;
  function s(o, u, l) {
    var v, f, c, h, d, y, g = 0, p = !1, m = !1, b = !0;
    if (typeof o != "function")
      throw new TypeError(a);
    u = t(u) || 0, r(l) && (p = !!l.leading, m = "maxWait" in l, c = m ? n(t(l.maxWait) || 0, u) : c, b = "trailing" in l ? !!l.trailing : b);
    function w(A) {
      var R = v, L = f;
      return v = f = void 0, g = A, h = o.apply(L, R), h;
    }
    function E(A) {
      return g = A, d = setTimeout(T, u), p ? w(A) : h;
    }
    function C(A) {
      var R = A - y, L = A - g, I = u - R;
      return m ? i(I, c - L) : I;
    }
    function x(A) {
      var R = A - y, L = A - g;
      return y === void 0 || R >= u || R < 0 || m && L >= c;
    }
    function T() {
      var A = e();
      if (x(A))
    ...
    return P.cancel = B, P.flush = D, P;
  }
  return vi = s, vi;
}
var qc = Vc(), Fa = /* @__PURE__ */ Oa(qc), fi = Qe ? Qe.performance : null, lv = fi && fi.now ? function() {
  return fi.now();
} : function() {
  return Date.now();
}, _c = (function() {
  if (Qe) {
    ...
    if (Qe.mozRequestAnimationFrame)
      return function(r) {
        Qe.mozRequestAnimationFrame(r);
      };
    if (Qe.webkitRequestAnimationFrame)
      return function(r) {
        Qe.webkitRequestAnimationFrame(r);
      };
    if (Qe.msRequestAnimationFrame)
      return function(r) {
        Qe.msRequestAnimationFrame(r);
      };
  }
  return function(r) {
  ...
  return _c(e);
}, Kr = lv, Et = 9261, vv = 65599, _t = 5381, fv = function(e) {
  for (var t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : Et, a = t, n; n = e.next(), !n.done; )
    a = a * vv + n.value | 0;
  return a;
}, Ca = function(e) {
  var t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : Et;
  return t * vv + e | 0;
}, Ta = function(e) {
  var t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : _t;
  return (t << 5) + t + e | 0;
}, Gc = function(e, t) {
  return e * 2097152 + t;
}, Jr = function(e) {
...
function Uc(r, e, t) {
  if (t === 0) return r;
  var a = (e.x1 + e.x2) / 2, n = (e.y1 + e.y2) / 2, i = e.w / e.h, s = 1 / i, o = Wc(r.x, r.y, a, n, t), u = $c(o.x, o.y, a, n, i, s);
  return {
    x: u.x,
    y: u.y
  };
}
var qo = !0, Kc = console.warn != null, Xc = console.trace != null, Qs = Number.MAX_SAFE_INTEGER || 9007199254740991, dv = function() {
  return !0;
}, wn = function() {
  return !1;
}, _o = function() {
  ...
  hv() && (Kc ? console.warn(e) : (console.log(e), Xc && console.trace()));
}, Yc = function(e) {
  return me({}, e);
}, _r = function(e) {
  return e == null ? e : Fe(e) ? e.slice() : Me(e) ? Yc(e) : e;
}, Zc = function(e) {
  return e.slice();
}, gv = function(e, t) {
  for (
...
})(), Ur = typeof Map < "u" ? Map : jc, ed = "undefined", rd = /* @__PURE__ */ (function() {
  function r(e) {
    if (ct(this, r), this._obj = /* @__PURE__ */ Object.create(null), this.size = 0, e != null) {
      var t;
...
})(), ra = (typeof Set > "u" ? "undefined" : je(Set)) !== ed ? Set : rd, Ln = function(e, t) {
  var a = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : !0;
  if (e === void 0 || t === void 0 || !Xs(e)) {
  ...
  var l = [];
  Fe(t.classes) ? l = t.classes : he(t.classes) && (l = t.classes.split(/\s+/));
  for (var v = 0, f = l.length; v < f; v++) {
    var c = l[v];
    !c || c === "" || i.classes.add(c);
  }
  this.createEmitter(), (a === void 0 || a) && this.restore();
  var h = t.style || t.css;
  h && (Ne("Setting a `style` bypass at element creation should be done only when absolutely necessary.  Try to use the stylesheet instead."), this.style(h));
}, Go = function(e) {
  return e = {
    bfs: e.bfs || !e.dfs,
    dfs: e.dfs || !e.bfs
    ...
    var s;
    Me(a) && !Tr(a) && (s = a, a = s.roots || s.root, n = s.visit, i = s.directed), i = arguments.length === 2 && !He(n) ? n : i, n = He(n) ? n : function() {
    };
    for (var o = this._private.cy, u = a = he(a) ? this.filter(a) : a, l = [], v = [], f = {}, c = {}, h = {}, d = 0, y, g = this.byGroup(), p = g.nodes, m = g.edges, b = 0; b < u.length; b++) {
      var w = u[b], E = w.id();
      w.isNode() && (l.unshift(w), e.bfs && (h[E] = !0, v.push(w)), c[E] = 0);
    }
    for (var C = function() {
      var A = e.bfs ? l.shift() : l.pop(), R = A.id();
      if (e.dfs) {
        if (h[R])
          return 0;
        h[R] = !0, v.push(A);
      }
      var L = c[R], I = f[R], M = I != null ? I.source() : null, N = I != null ? I.target() : null, F = I == null ? void 0 : A.same(M) ? N[0] : M[0], _;
      if (_ = n(A, I, F, d++, L), _ === !0)
        return y = A, 1;
      if (_ === !1)
        return 1;
      for (var z = A.connectedEdges().filter(function(J) {
        return (!i || J.source().same(A)) && m.has(J);
      }), q = 0; q < z.length; q++) {
        var Z = z[q], Q = Z.connectedNodes().filter(function(J) {
          return !J.same(A) && p.has(J);
        }), X = Q.id();
        Q.length !== 0 && !h[X] && (Q = Q[0], l.push(Q), e.bfs && (h[X] = !0, v.push(Q)), f[X] = Z, c[X] = c[R] + 1);
      }
    }, x; l.length !== 0 && (x = C(), !(x !== 0 && x === 1)); )
      ;
    for (var T = o.collection(), k = 0; k < v.length; k++) {
      var B = v[k], D = f[B.id()];
      D != null && T.push(D), T.push(B);
    }
    return {
      path: o.collection(T),
...
var sn = { exports: {} }, td = sn.exports, Ho;
function ad() {
  return Ho || (Ho = 1, (function(r, e) {
    (function() {
      var t, a, n, i, s, o, u, l, v, f, c, h, d, y, g;
      n = Math.floor, f = Math.min, a = function(p, m) {
        ...
        for (m == null && (m = a), C = (function() {
          T = [];
          for (var k = 0, B = n(p.length / 2); 0 <= B ? k < B : k > B; 0 <= B ? k++ : k--)
            T.push(k);
          return T;
        ...
        var w, E, C, x, T, k, B, D, P;
        if (b == null && (b = a), m * 10 <= p.length) {
          if (C = p.slice(0, m).sort(b), !C.length)
            return C;
          for (E = C[C.length - 1], B = p.slice(m), x = 0, k = B.length; x < k; x++)
            w = B[x], b(w, E) < 0 && (v(C, w, 0, null, b), C.pop(), E = C[C.length - 1]);
          return C;
        }
        for (i(p, b), P = [], T = 0, D = f(m, p.length); 0 <= D ? T < D : T > D; 0 <= D ? ++T : --T)
          P.push(s(p, b));
        return P;
      }, y = function(p, m, b, w) {
        var E, C, x;
        ...
        p.push = o, p.pop = s, p.replace = l, p.pushpop = u, p.heapify = i, p.updateItem = d, p.nlargest = c, p.nsmallest = h;
        function p(m) {
...
var ci, Wo;
function nd() {
  return Wo || (Wo = 1, ci = ad()), ci;
}
var id = nd(), Va = /* @__PURE__ */ Oa(id), sd = lr({
  root: null,
  weight: function(e) {
    return 1;
  },
  ...
  dijkstra: function(e) {
    ...
    var a = sd(e), n = a.root, i = a.weight, s = a.directed, o = this, u = i, l = he(n) ? this.filter(n)[0] : n[0], v = {}, f = {}, c = {}, h = this.byGroup(), d = h.nodes, y = h.edges;
    ...
    for (var g = function(I) {
      ...
      var w = d[b];
      v[w.id()] = w.same(l) ? 0 : 1 / 0, m.push(w);
    }
    for (var E = function(I, M) {
      for (var N = (s ? I.edgesTo(M) : I.edgesWith(M)).intersect(y), F = 1 / 0, _, z = 0; z < N.length; z++) {
        var q = N[z], Z = u(q);
        (Z < F || !_) && (F = Z, _ = q);
      }
      return {
      ...
      if (c[T] = x, x !== 1 / 0)
        for (var k = C.neighborhood().intersect(d), B = 0; B < k.length; B++) {
          var D = k[B], P = D.id(), A = E(C, D), R = x + A.dist;
          R < g(D) && (p(D, R), f[P] = {
            node: C,
            edge: A.edge
          });
    ...
    return {
      distanceTo: function(I) {
        var M = he(I) ? d.filter(I)[0] : I[0];
        return c[M.id()];
      },
      pathTo: function(I) {
        var M = he(I) ? d.filter(I)[0] : I[0], N = [], F = M, _ = F.id();
        if (M.length > 0)
          for (N.unshift(M); f[_]; ) {
            var z = f[_];
            N.unshift(z.edge), N.unshift(z.node), F = z.node, _ = F.id();
          }
        return o.spawn(N);
      }
    };
  ...
  kruskal: function(e) {
    ...
    for (var v = n.sort(function(b, w) {
      ...
      var c = v[f], h = c.source()[0], d = c.target()[0], y = u(h), g = u(d), p = s[y], m = s[g];
  ...
  // Implemented from pseudocode from wikipedia
  aStar: function(e) {
    var t = this.cy(), a = ld(e), n = a.root, i = a.goal, s = a.heuristic, o = a.directed, u = a.weight;
    n = t.collection(n)[0], i = t.collection(i)[0];
    var l = n.id(), v = i.id(), f = {}, c = {}, h = {}, d = new Va(function(_, z) {
      return c[_.id()] - c[z.id()];
    }), y = new ra(), g = {}, p = {}, m = function(z, q) {
      d.push(z), y.add(q);
    }, b, w, E = function() {
    ...
    for (var x = 0; d.size() > 0; ) {
      if (E(), x++, w === v) {
        for (var T = [], k = i, B = v, D = p[B]; T.unshift(k), D != null && T.unshift(D), k = g[B], k != null; )
          B = k.id(), D = p[B];
        return {
          found: !0,
          distance: f[w],
      ...
      for (var P = b._private.edges, A = 0; A < P.length; A++) {
        ...
        if (this.hasElementWithId(R.id()) && !(o && R.data("source") !== w)) {
          var L = R.source(), I = R.target(), M = L.id() !== w ? L : I, N = M.id();
          if (this.hasElementWithId(N) && !h[N]) {
            var F = f[w] + u(R);
            if (!C(N)) {
              f[N] = F, c[N] = F + s(M), m(M, N), g[N] = b, p[N] = R;
              continue;
            }
            F < f[N] && (f[N] = F, c[N] = F + s(M), d.updateItem(M), g[N] = b, p[N] = R);
          }
        }
      }
    }
  ...
  floydWarshall: function(e) {
    for (var t = this.cy(), a = fd(e), n = a.weight, i = a.directed, s = n, o = this.byGroup(), u = o.nodes, l = o.edges, v = u.length, f = v * v, c = function(Z) {
      return u.indexOf(Z);
    }, h = function(Z) {
      return u[Z];
    ...
    for (var m = new Array(f), b = new Array(f), w = 0; w < l.length; w++) {
      ...
      if (C !== x) {
        var T = c(C), k = c(x), B = T * v + k, D = s(E);
        if (d[B] > D && (d[B] = D, m[B] = k, b[B] = E), !i) {
          var P = k * v + T;
    ...
    for (var A = 0; A < v; A++)
      for (var R = 0; R < v; R++)
        for (var L = R * v + A, I = 0; I < v; I++) {
          var M = R * v + I, N = A * v + I;
          d[L] + d[N] < d[M] && (d[M] = d[L] + d[N], m[M] = m[L]);
        }
    var F = function(Z) {
      return (he(Z) ? t.filter(Z) : Z)[0];
    }, _ = function(Z) {
      return c(F(Z));
    }, z = {
      distance: function(Z, Q) {
        var X = _(Z), J = _(Q);
        return d[X * v + J];
      },
      path: function(Z, Q) {
        var X = _(Z), J = _(Q), j = h(X);
        if (X === J)
          return j.collection();
        if (m[X * v + J] == null)
          return t.collection();
        var ne = t.collection(), Y = X, V;
        for (ne.merge(j); X !== J; )
          Y = X, X = m[X * v + J], V = b[Y * v + X], ne.merge(V), ne.merge(h(X));
        return ne;
      }
    };
    return z;
  ...
  bellmanFord: function(e) {
    var t = this, a = dd(e), n = a.weight, i = a.directed, s = a.root, o = n, u = this, l = this.cy(), v = this.byGroup(), f = v.edges, c = v.nodes, h = c.length, d = new Ur(), y = !1, g = [];
    s = l.collection(s)[0], f.unmergeBy(function(we) {
      return we.isLoop();
    });
    for (var p = f.length, m = function(ye) {
      var pe = d.get(ye.id());
      return pe || (pe = {}, d.set(ye.id(), pe)), pe;
    }, b = function(ye) {
      return (he(ye) ? l.$(ye) : ye)[0];
    }, w = function(ye) {
      return m(b(ye)).dist;
    }, E = function(ye) {
      for (var pe = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : s, se = b(ye), de = [], ge = se; ; ) {
        if (ge == null)
          return t.spawn();
        var Ee = m(ge), be = Ee.edge, Te = Ee.pred;
        if (de.unshift(ge[0]), ge.same(pe) && de.length > 0)
          break;
        be != null && de.unshift(be), ge = Te;
      }
      return u.spawn(de);
    }, C = 0; C < h; C++) {
      var x = c[C], T = m(x);
    ...
    for (var k = !1, B = function(ye, pe, se, de, ge, Ee) {
      var be = de.dist + Ee;
      be < ge.dist && !se.same(de.edge) && (ge.dist = be, ge.pred = ye, ge.edge = se, k = !0);
    }, D = 1; D < h; D++) {
      k = !1;
      for (var P = 0; P < p; P++) {
        var A = f[P], R = A.source(), L = A.target(), I = o(A), M = m(R), N = m(L);
        B(R, L, A, M, N, I), i || B(L, R, A, N, M, I);
      }
      if (!k)
        break;
    }
    if (k)
      for (var F = [], _ = 0; _ < p; _++) {
        var z = f[_], q = z.source(), Z = z.target(), Q = o(z), X = m(q).dist, J = m(Z).dist;
        if (X + Q < J || !i && J + Q < X)
          if (y || (Ne("Graph contains a negative weight cycle for Bellman-Ford"), y = !0), e.findNegativeWeightCycles !== !1) {
            var j = [];
            X + Q < J && j.push(q), !i && J + Q < X && j.push(Z);
            for (var ne = j.length, Y = 0; Y < ne; Y++) {
              var V = j[Y], H = [V];
              H.push(m(V).edge);
              for (var $ = m(V).pred; H.indexOf($) === -1; )
                H.push($), H.push(m($).edge), $ = m($).pred;
              H = H.slice(H.indexOf($));
              for (var K = H[0].id(), te = 0, ve = 2; ve < H.length; ve += 2)
                H[ve].id() < K && (K = H[ve].id(), te = ve);
              H = H.slice(te).concat(H.slice(0, te)), H.push(H[0]);
              var De = H.map(function(we) {
                return we.id();
              }).join(",");
              F.indexOf(De) === -1 && (g.push(u.spawn(H)), F.push(De));
            }
          } else
            break;
      }
  ...
  // bellmanFord
}, gd = Math.sqrt(2), pd = function(e, t, a) {
  a.length === 0 && Ge("Karger-Stein must be run on a connected (sub)graph");
  for (var n = a[e], i = n[1], s = n[2], o = t[i], u = t[s], l = a, v = l.length - 1; v >= 0; v--) {
    var f = l[v], c = f[1], h = f[2];
    (t[c] === o && t[h] === u || t[c] === u && t[h] === o) && l.splice(v, 1);
  }
  ...
  kargerStein: function() {
    ...
    var i = a.length, s = n.length, o = Math.ceil(Math.pow(Math.log(i) / Math.LN2, 2)), u = Math.floor(i / gd);
    if (i < 2) {
    ...
    for (var l = [], v = 0; v < s; v++) {
      var f = n[v];
      l.push([v, a.indexOf(f.source()), a.indexOf(f.target())]);
    }
    for (var c = 1 / 0, h = [], d = new Array(i), y = new Array(i), g = new Array(i), p = function(F, _) {
      for (var z = 0; z < i; z++)
        _[z] = F[z];
    }, m = 0; m <= o; m++) {
      for (var b = 0; b < i; b++)
        y[b] = b;
      var w = di(y, l.slice(), i, u), E = w.slice();
      p(y, g);
      var C = di(y, w, u, 2), x = di(g, E, u, 2);
      C.length <= x.length && C.length < c ? (c = C.length, h = C, p(y, d)) : x.length <= C.length && x.length < c && (c = x.length, h = x, p(g, d));
    }
    for (var T = this.spawn(h.map(function(N) {
      return n[N[0]];
    })), k = this.spawn(), B = this.spawn(), D = d[0], P = 0; P < d.length; P++) {
      var A = d[P], R = a[P];
      A === D ? k.merge(R) : B.merge(R);
    }
    var L = function(F) {
      var _ = e.spawn();
      return F.forEach(function(z) {
        _.merge(z), z.connectedEdges().forEach(function(q) {
  ...
  return t === 0 ? e : mv(t, e % t);
}, Cd = function(e) {
  for (var t = e[0], a = 0; a < e.length; a++)
    if (ev(e[a]))
      a > 0 && (t = mv(t, e[a]));
    else return 0;
  return t;
  ...
  return tt(e, t.x1, t.y1) && tt(e, t.x2, t.y2);
}, Ad = (hi = Math.hypot) !== null && hi !== void 0 ? hi : function(r, e) {
...
function Rd(r, e) {
  ...
  var t = function(T, k) {
    ...
    for (var k = 0, B = 0; B < T.length; B++) {
      var D = T[B], P = T[(B + 1) % T.length];
      k += D.x * P.y - P.x * D.y;
    }
    return k / 2;
  }, u = function(T, k, B, D) {
    var P = a(k, T), A = a(D, B), R = i(P, A);
    if (Math.abs(R) < 1e-9)
      return t(T, n(P, 0.5));
    var L = i(a(B, T), A) / R;
    return t(T, n(P, L));
  ...
  o(l) < 0 && l.reverse();
  for (var v = l.length, f = [], c = 0; c < v; c++) {
    var h = l[c], d = l[(c + 1) % v], y = a(d, h), g = s({
      x: y.y,
      y: -y.x
    });
    f.push(g);
  ...
  for (var p = f.map(function(x, T) {
    var k = t(l[T], n(x, e)), B = t(l[(T + 1) % v], n(x, e));
    return {
      p1: k,
      p2: B
    };
  }), m = [], b = 0; b < v; b++) {
    var w = p[(b - 1 + v) % v], E = p[b], C = u(w.p1, w.p2, E.p1, E.p2);
    m.push(C);
  }
  return m;
}
function Md(r, e, t, a, n, i) {
  var s = _d(r, e, t, a, n), o = Rd(s, i), u = yr();
  return o.forEach(function(l) {
    return bv(u, l.x, l.y);
  }), u;
}
var xv = function(e, t, a, n, i, s, o) {
  var u = arguments.length > 7 && arguments[7] !== void 0 ? arguments[7] : "auto", l = u === "auto" ? ut(i, s) : u, v = i / 2, f = s / 2;
  l = Math.min(l, v, f);
  var c = l !== v, h = l !== f, d;
  if (c) {
    var y = a - v + l - o, g = n - f - o, p = a + v - l + o, m = g;
    if (d = at(e, t, a, n, y, g, p, m, !1), d.length > 0)
      return d;
  }
  if (h) {
    var b = a + v + o, w = n - f + l - o, E = b, C = n + f - l + o;
    if (d = at(e, t, a, n, b, w, E, C, !1), d.length > 0)
      return d;
  }
  if (c) {
    var x = a - v + l - o, T = n + f + o, k = a + v - l + o, B = T;
    if (d = at(e, t, a, n, x, T, k, B, !1), d.length > 0)
      return d;
  }
  if (h) {
    var D = a - v - o, P = n - f + l - o, A = D, R = n + f - l + o;
    if (d = at(e, t, a, n, D, P, A, R, !1), d.length > 0)
      return d;
  }
  var L;
  {
    var I = a - v + l, M = n - f + l;
    if (L = ya(e, t, a, n, I, M, l + o), L.length > 0 && L[0] <= I && L[1] <= M)
      return [L[0], L[1]];
  }
  {
    var N = a + v - l, F = n - f + l;
    if (L = ya(e, t, a, n, N, F, l + o), L.length > 0 && L[0] >= N && L[1] <= F)
      return [L[0], L[1]];
  }
  {
    var _ = a + v - l, z = n + f - l;
    if (L = ya(e, t, a, n, _, z, l + o), L.length > 0 && L[0] >= _ && L[1] >= z)
      return [L[0], L[1]];
  }
  {
    var q = a - v + l, Z = n + f - l;
    if (L = ya(e, t, a, n, q, Z, l + o), L.length > 0 && L[0] <= q && L[1] >= Z)
      return [L[0], L[1]];
  }
  return [];
}, Ld = function(e, t, a, n, i, s, o) {
  var u = o, l = Math.min(a, i), v = Math.max(a, i), f = Math.min(n, s), c = Math.max(n, s);
  return l - u <= e && e <= v + u && f - u <= t && t <= c + u;
}, Id = function(e, t, a, n, i, s, o, u, l) {
  var v = {
    x1: Math.min(a, o, i) - l,
    x2: Math.max(a, o, i) + l,
    y1: Math.min(n, u, s) - l,
  ...
  return [u, l];
}, Nd = function(e, t, a, n, i) {
  var s = 1e-5;
  e === 0 && (e = s), t /= e, a /= e, n /= e;
  var o, u, l, v, f, c, h, d;
  if (u = (3 * a - t * t) / 9, l = -(27 * n) + t * (9 * a - 2 * (t * t)), l /= 54, o = u * u * u + l * l, i[1] = 0, h = t / 3, o > 0) {
    f = l + Math.sqrt(o), f = f < 0 ? -Math.pow(-f, 1 / 3) : Math.pow(f, 1 / 3), c = l - Math.sqrt(o), c = c < 0 ? -Math.pow(-c, 1 / 3) : Math.pow(c, 1 / 3), i[0] = -h + f + c, h += (f + c) / 2, i[4] = i[2] = -h, h = Math.sqrt(3) * (-c + f) / 2, i[3] = h, i[5] = -h;
    return;
  }
  if (i[5] = i[3] = 0, o === 0) {
  ...
  u = -u, v = u * u * u, v = Math.acos(l / Math.sqrt(v)), d = 2 * Math.sqrt(u), i[0] = -h + d * Math.cos(v / 3), i[2] = -h + d * Math.cos((v + 2 * Math.PI) / 3), i[4] = -h + d * Math.cos((v + 4 * Math.PI) / 3);
}, zd = function(e, t, a, n, i, s, o, u) {
  var l = 1 * a * a - 4 * a * i + 2 * a * o + 4 * i * i - 4 * i * o + o * o + n * n - 4 * n * s + 2 * n * u + 4 * s * s - 4 * s * u + u * u, v = 9 * a * i - 3 * a * a - 3 * a * o - 6 * i * i + 3 * i * o + 9 * n * s - 3 * n * n - 3 * n * u - 6 * s * s + 3 * s * u, f = 3 * a * a - 6 * a * i + a * o - a * e + 2 * i * i + 2 * i * e - o * e + 3 * n * n - 6 * n * s + n * u - n * t + 2 * s * s + 2 * s * t - u * t, c = 1 * a * i - a * a + a * e - i * e + n * s - n * n + n * t - s * t, h = [];
  Nd(l, v, f, c, h);
  ...
  var o = [e - a, t - n], u = [i - a, s - n], l = u[0] * u[0] + u[1] * u[1], v = o[0] * o[0] + o[1] * o[1], f = o[0] * u[0] + o[1] * u[1], c = f * f / l;
  return f < 0 ? v : c > l ? (e - i) * (e - i) + (t - s) * (t - s) : v - c;
}, Er = function(e, t, a) {
  for (var n, i, s, o, u, l = 0, v = 0; v < a.length / 2; v++)
  ...
  if (l > 0) {
    ...
    y = v;
  return Er(e, t, y);
}, Vd = function(e, t, a, n, i, s, o, u) {
  for (var l = new Array(a.length * 2), v = 0; v < u.length; v++) {
    var f = u[v];
    l[v * 4 + 0] = f.startX, l[v * 4 + 1] = f.startY, l[v * 4 + 2] = f.stopX, l[v * 4 + 3] = f.stopY;
  ...
  for (var t = new Array(e.length / 2), a, n, i, s, o, u, l, v, f = 0; f < e.length / 4; f++) {
    a = e[f * 4], n = e[f * 4 + 1], i = e[f * 4 + 2], s = e[f * 4 + 3], f < e.length / 4 - 1 ? (o = e[(f + 1) * 4], u = e[(f + 1) * 4 + 1], l = e[(f + 1) * 4 + 2], v = e[(f + 1) * 4 + 3]) : (o = e[0], u = e[1], l = e[2], v = e[3]);
    var c = at(a, n, i, s, o, u, l, v, !0);
  ...
  for (var a = new Array(e.length * 2), n, i, s, o, u = 0; u < e.length / 2; u++) {
    ...
    var l = o - i, v = -(s - n), f = Math.sqrt(l * l + v * v), c = l / f, h = v / f;
    a[u * 4] = n + c * t, a[u * 4 + 1] = i + h * t, a[u * 4 + 2] = s + c * t, a[u * 4 + 3] = o + h * t;
  }
  return a;
}, qd = function(e, t, a, n, i, s) {
  var o = a - e, u = n - t;
  o /= i, u /= s;
  var l = Math.sqrt(o * o + u * u), v = l - 1;
  if (v < 0)
    return [];
  var f = v / l;
  return [(a - e) * f + e, (n - t) * f + t];
}, Tt = function(e, t, a, n, i, s, o) {
  return e -= i, t -= s, e /= a / 2 + o, t /= n / 2 + o, e * e + t * t <= 1;
}, ya = function(e, t, a, n, i, s, o) {
  var u = [a - e, n - t], l = [e - i, t - s], v = u[0] * u[0] + u[1] * u[1], f = 2 * (l[0] * u[0] + l[1] * u[1]), c = l[0] * l[0] + l[1] * l[1] - o * o, h = f * f - 4 * v * c;
  if (h < 0)
    return [];
  var d = (-f + Math.sqrt(h)) / (2 * v), y = (-f - Math.sqrt(h)) / (2 * v), g = Math.min(d, y), p = Math.max(d, y), m = [];
...
}, at = function(e, t, a, n, i, s, o, u, l) {
  var v = e - i, f = a - e, c = o - i, h = t - s, d = n - t, y = u - s, g = c * h - y * v, p = f * h - d * v, m = y * f - c * d;
  if (m !== 0) {
    var b = g / m, w = p / m, E = 1e-3, C = 0 - E, x = 1 + E;
    return C <= b && b <= x && C <= w && w <= x ? [e + b * f, t + b * d] : l ? [e + b * f, t + b * d] : [];
  } else
    return g === 0 || p === 0 ? gi(e, a, o) === o ? [o, u] : gi(e, a, i) === i ? [i, s] : gi(i, o, a) === a ? [a, n] : [] : [];
}, _d = function(e, t, a, n, i) {
  var s = [], o = n / 2, u = i / 2, l = t, v = a;
  s.push({
    x: l + o * e[0],
    y: v + u * e[1]
  });
  ...
  return s;
}, Da = function(e, t, a, n, i, s, o, u) {
  var l = [], v, f = new Array(a.length), c = !0;
  s == null && (c = !1);
  var h;
  if (c) {
  ...
  for (var g, p, m, b, w = 0; w < h.length / 2; w++)
    g = h[w * 2], p = h[w * 2 + 1], w < h.length / 2 - 1 ? (m = h[(w + 1) * 2], b = h[(w + 1) * 2 + 1]) : (m = h[0], b = h[1]), v = at(e, t, n, i, g, p, m, b), v.length !== 0 && l.push(v[0], v[1]);
  return l;
}, Gd = function(e, t, a, n, i, s, o, u, l) {
  var v = [], f, c = new Array(a.length * 2);
  l.forEach(function(m, b) {
    b === 0 ? (c[c.length - 2] = m.startX, c[c.length - 1] = m.startY) : (c[b * 4 - 2] = m.startX, c[b * 4 - 1] = m.startY), c[b * 4] = m.stopX, c[b * 4 + 1] = m.stopY, f = ya(e, t, n, i, m.cx, m.cy, m.radius), f.length !== 0 && v.push(f[0], f[1]);
  });
  for (var h = 0; h < c.length / 4; h++)
    f = at(e, t, n, i, c[h * 4], c[h * 4 + 1], c[h * 4 + 2], c[h * 4 + 3], !1), f.length !== 0 && v.push(f[0], f[1]);
  if (v.length > 2) {
  ...
  for (var v = 2 / (o - i), f = 2 / (u - s), c = 0; c < n; c++)
    t = e[2 * c] = e[2 * c] * v, a = e[2 * c + 1] = e[2 * c + 1] * f, i = Math.min(i, t), o = Math.max(o, t), s = Math.min(s, a), u = Math.max(u, a);
  if (s < -1)
    for (var h = 0; h < n; h++)
...
function pi(r, e) {
  ...
  function a(f, c) {
    var h = 1 / 0, d = -1 / 0, y = Cr(f), g;
    try {
      for (y.s(); !(g = y.n()).done; ) {
        var p = g.value, m = p.x * c.x + p.y * c.y;
  ...
  var i = [].concat(yn(t(r)), yn(t(e))), s = Cr(i), o;
  try {
    for (s.s(); !(o = s.n()).done; ) {
      var u = o.value, l = a(r, u), v = a(e, u);
      if (!n(l, v))
        return !1;
    }
  } catch (f) {
...
var Wd = lr({
  ...
  pageRank: function(e) {
    for (var t = Wd(e), a = t.dampingFactor, n = t.precision, i = t.iterations, s = t.weight, o = this._private.cy, u = this.byGroup(), l = u.nodes, v = u.edges, f = l.length, c = f * f, h = v.length, d = new Array(c), y = new Array(f), g = (1 - a) / f, p = 0; p < f; p++) {
      for (var m = 0; m < f; m++) {
        var b = p * f + m;
        d[b] = 0;
      }
    ...
    for (var w = 0; w < h; w++) {
      ...
      if (C !== x) {
        var T = l.indexOfId(C), k = l.indexOfId(x), B = s(E), D = k * f + T;
        d[D] += B, y[T] += B;
      }
    }
    ...
    for (var N = new Array(f), F = new Array(f), _, z = 0; z < f; z++)
      N[z] = 1;
    for (var q = 0; q < i; q++) {
      for (var Z = 0; Z < f; Z++)
        F[Z] = 0;
    ...
    var V = {
      rank: function($) {
        return $ = o.collection($)[0], N[l.indexOf($)];
      }
    };
    return V;
  }
  ...
  degreeCentralityNormalized: function(e) {
    ...
    if (e.directed) {
      ...
      return {
        indegree: function(b) {
          return c == 0 ? 0 : (he(b) && (b = t.filter(b)), v[b.id()] / c);
        },
        outdegree: function(b) {
          return h === 0 ? 0 : (he(b) && (b = t.filter(b)), f[b.id()] / h);
        }
      };
    } else {
      ...
      return {
        degree: function(b) {
          return s === 0 ? 0 : (he(b) && (b = t.filter(b)), i[b.id()] / s);
        }
      };
    }
  },
  ...
  degreeCentrality: function(e) {
    ...
    if (i = t.collection(i)[0], o) {
      ...
      for (var l = i.connectedEdges().intersection(a), v = l.length, f = 0, c = 0; c < l.length; c++)
        f += s(l[c]);
      return {
        degree: Math.pow(v, 1 - u) * Math.pow(f, u)
      };
    }
  }
  // degreeCentrality
};
Ut.dc = Ut.degreeCentrality;
Ut.dcn = Ut.degreeCentralityNormalised = Ut.degreeCentralityNormalized;
var Xo = lr({
  harmonic: !0,
  weight: function() {
    return 1;
  ...
  closenessCentralityNormalized: function(e) {
    for (var t = Xo(e), a = t.harmonic, n = t.weight, i = t.directed, s = this.cy(), o = {}, u = 0, l = this.nodes(), v = this.floydWarshall({
      weight: n,
      directed: i
    }), f = 0; f < l.length; f++) {
      for (var c = 0, h = l[f], d = 0; d < l.length; d++)
        if (f !== d) {
          var y = v.distance(h, l[d]);
          a ? c += 1 / y : c += y;
        }
      a || (c = 1 / c), u < c && (u = c), o[h.id()] = c;
    }
    return {
      closeness: function(p) {
        return u == 0 ? 0 : (he(p) ? p = s.filter(p)[0].id() : p = p.id(), o[p] / u);
      }
    };
  },
  // Implemented from pseudocode from wikipedia
  closenessCentrality: function(e) {
    ...
    for (var o = this.dijkstra({
      ...
      weight: n,
      directed: i
    }), u = 0, l = this.nodes(), v = 0; v < l.length; v++) {
      var f = l[v];
      if (!f.same(a)) {
...
Kt.cc = Kt.closenessCentrality;
Kt.ccn = Kt.closenessCentralityNormalised = Kt.closenessCentralityNormalized;
var Ud = lr({
  weight: null,
  directed: !1
}), As = {
  ...
  betweennessCentrality: function(e) {
    for (var t = Ud(e), a = t.directed, n = t.weight, i = n != null, s = this.cy(), o = this.nodes(), u = {}, l = {}, v = 0, f = {
      set: function(b, w) {
        l[b] = w, w > v && (v = w);
      },
      get: function(b) {
    ...
    for (var y = function() {
      for (var b = o[g].id(), w = [], E = {}, C = {}, x = {}, T = new Va(function(Q, X) {
        return x[Q] - x[X];
      }), k = 0; k < o.length; k++) {
        var B = o[k].id();
        E[B] = [], C[B] = 0, x[B] = 1 / 0;
      ...
      for (C[b] = 1, x[b] = 0, T.push(b); !T.empty(); ) {
        ...
        if (w.push(D), i)
          for (var P = 0; P < u[D].length; P++) {
            var A = u[D][P], R = s.getElementById(D), L = void 0;
            R.edgesTo(A).length > 0 ? L = R.edgesTo(A)[0] : L = A.edgesTo(R)[0];
            var I = n(L);
            A = A.id(), x[A] > x[D] + I && (x[A] = x[D] + I, T.nodes.indexOf(A) < 0 ? T.push(A) : T.updateItem(A), C[A] = 0, E[A] = []), x[A] == x[D] + I && (C[A] = C[A] + C[D], E[A].push(D));
          }
        else
          for (var M = 0; M < u[D].length; M++) {
            var N = u[D][M].id();
            x[N] == 1 / 0 && (T.push(N), x[N] = x[D] + 1), x[N] == x[D] + 1 && (C[N] = C[N] + C[D], E[N].push(D));
          }
      }
      for (var F = {}, _ = 0; _ < o.length; _++)
        F[o[_].id()] = 0;
      for (; w.length > 0; ) {
        for (var z = w.pop(), q = 0; q < E[z].length; q++) {
          var Z = E[z][q];
          F[Z] = F[Z] + C[Z] / C[z] * (1 + F[z]);
        }
        z != o[g].id() && f.set(z, f.get(z) + F[z]);
      }
    }, g = 0; g < o.length; g++)
      y();
    var p = {
...
As.bc = As.betweennessCentrality;
var Kd = lr({
  expandFactor: 2,
  ...
  for (var t = 0; t < e.length; t++)
    for (var a = 0; a < e.length; a++)
      t != a && th(e[t], e[a]) && e.splice(a, 1);
  return e;
}, Yo = function(e) {
  for (var t = this.nodes(), a = this.edges(), n = this.cy(), i = Xd(e), s = {}, o = 0; o < t.length; o++)
    s[t[o].id()] = o;
  for (var u = t.length, l = u * u, v = new Array(l), f, c = 0; c < l; c++)
    v[c] = 0;
  for (var h = 0; h < a.length; h++) {
    var d = a[h], y = s[d.source().id()], g = s[d.target().id()], p = Yd(d, i.attributes);
    v[y * u + g] += p, v[g * u + y] += p;
  }
  Zd(v, u, i.multFactor), Tv(v, u);
  for (var m = !0, b = 0; m && b < i.maxIterations; )
    m = !1, f = Jd(v, u, i.expandFactor), v = jd(f, u, i.inflateFactor), eh(v, f, l, 4) || (m = !0), b++;
  var w = rh(v, u, t, n);
  return w = ah(w), w;
}, nh = {
  markovClustering: Yo,
  ...
  for (var s = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : ih, o = n, u, l, v = 0; v < e; v++)
    u = t(v), l = a(v), o = i(o, u, l);
  return s(o);
}, Zt = {
  euclidean: function(e, t, a) {
    return e >= 2 ? va(e, t, a, 0, Qo, sh) : va(e, t, a, 0, Zo);
  },
  ...
  max: function(e, t, a) {
    return va(e, t, a, -1 / 0, oh);
  }
};
Zt["squared-euclidean"] = Zt.squaredEuclidean;
Zt.squaredeuclidean = Zt.squaredEuclidean;
function On(r, e, t, a, n, i) {
  var s;
  return He(r) ? s = r : s = Zt[r] || Zt.euclidean, e === 0 && He(r) ? s(n, i) : s(e, t, a, n, i);
}
var uh = lr({
  k: 2,
  m: 2,
  ...
  return o;
}, kv = function(e, t, a, n, i) {
  for (var s = 1 / 0, o = 0, u = 0; u < t.length; u++) {
    var l = Cn(a, e, t[u], n, i);
    l < s && (s = l, o = u);
  }
  return o;
}, Dv = function(e, t, a) {
  ...
  if (e.length < 50)
    for (var n = 0; n < t; n++) {
      for (var i = e[Math.floor(Math.random() * e.length)]; fh(i, a, n); )
  ...
  for (var n = 0, i = 0; i < t.length; i++)
    n += Cn("manhattan", t[i], e, a, "kMedoids");
  return n;
}, ch = function(e) {
  var t = this.cy(), a = this.nodes(), n = null, i = no(e), s = new Array(i.k), o = {}, u;
  i.testMode ? typeof i.testCentroids == "number" ? (i.testCentroids, u = yi(a, i.k, i.attributes)) : je(i.testCentroids) === "object" ? u = i.testCentroids : u = yi(a, i.k, i.attributes) : u = yi(a, i.k, i.attributes);
  for (var l = !0, v = 0; l && v < i.maxIterations; ) {
    for (var f = 0; f < a.length; f++)
      n = a[f], o[n.id()] = kv(n, u, i.distance, i.attributes, "kMeans");
    l = !1;
    for (var c = 0; c < i.k; c++) {
      var h = Dv(c, a, o);
      if (h.length !== 0) {
        for (var d = i.attributes.length, y = u[c], g = new Array(d), p = new Array(d), m = 0; m < d; m++) {
          p[m] = 0;
          for (var b = 0; b < h.length; b++)
            n = h[b], p[m] += i.attributes[m](n);
          g[m] = p[m] / h.length, lh(g[m], y[m], i.sensitivityThreshold) || (l = !0);
        }
        u[c] = g, s[c] = t.collection(h);
      }
    }
    v++;
  }
  ...
  var t = this.cy(), a = this.nodes(), n = null, i = no(e), s = new Array(i.k), o, u = {}, l, v = new Array(i.k);
  i.testMode ? typeof i.testCentroids == "number" || (je(i.testCentroids) === "object" ? o = i.testCentroids : o = Jo(a, i.k)) : o = Jo(a, i.k);
  for (var f = !0, c = 0; f && c < i.maxIterations; ) {
    for (var h = 0; h < a.length; h++)
      n = a[h], u[n.id()] = kv(n, o, i.distance, i.attributes, "kMedoids");
    f = !1;
    for (var d = 0; d < o.length; d++) {
      var y = Dv(d, a, u);
      if (y.length !== 0) {
        v[d] = jo(o[d], y, i.attributes);
        for (var g = 0; g < y.length; g++)
          l = jo(y[g], y, i.attributes), l < v[d] && (v[d] = l, o[d] = y[g], f = !0);
        s[d] = t.collection(y);
      }
    }
    c++;
...
}, gh = function(e, t, a, n, i) {
  for (var s = 0; s < e.length; s++)
    t[s] = e[s].slice();
  for (var o, u, l, v = 2 / (i.m - 1), f = 0; f < a.length; f++)
    for (var c = 0; c < n.length; c++) {
      o = 0;
      for (var h = 0; h < a.length; h++)
        u = Cn(i.distance, n[c], a[f], i.attributes, "cmeans"), l = Cn(i.distance, n[c], a[h], i.attributes, "cmeans"), o += Math.pow(u / l, v);
      e[c][f] = 1 / o;
    }
}, ph = function(e, t, a, n) {
  ...
  var t = this.cy(), a = this.nodes(), n = no(e), i, s, o, u, l;
  ...
  for (var m = !0, b = 0; m && b < n.maxIterations; )
    m = !1, hh(s, a, o, l, n), gh(o, u, s, a, n), vh(o, u, n.sensitivityThreshold) || (m = !0), b++;
  return i = ph(a, o, n, t), {
    clusters: i,
  ...
  var t = mh(e), a = bh[t.linkage];
  return a != null && (t.linkage = a), t;
}, ru = function(e, t, a, n, i) {
  for (var s = 0, o = 1 / 0, u, l = i.attributes, v = function(k, B) {
    return On(i.distance, l.length, function(D) {
      return l[D](k);
    }, function(D) {
      return l[D](B);
    }, k, B);
  ...
  for (var p = 0; p < e.length; p++) {
    var m = e[p];
    d.key === m.key ? u = 1 / 0 : i.linkage === "min" ? (u = a[d.key][m.key], a[d.key][m.key] > a[y.key][m.key] && (u = a[y.key][m.key])) : i.linkage === "max" ? (u = a[d.key][m.key], a[d.key][m.key] < a[y.key][m.key] && (u = a[y.key][m.key])) : i.linkage === "mean" ? u = (a[d.key][m.key] * d.size + a[y.key][m.key] * y.size) / (d.size + y.size) : i.mode === "dendrogram" ? u = v(m.value, d.value) : u = v(m.value[0], d.value[0]), a[d.key][m.key] = a[m.key][d.key] = u;
  }
  ...
  e && (e.value ? t.push(e.value) : (e.left && Ht(e.left, t), e.right && Ht(e.right, t)));
}, Rs = function(e, t) {
  if (!e) return "";
  if (e.left && e.right) {
    var a = Rs(e.left, t), n = Rs(e.right, t), i = t.add({
      group: "nodes",
      data: {
        id: a + "," + n
      }
  ...
  if (!e) return [];
  var n = [], i = [], s = [];
  return t === 0 ? (e.left && Ht(e.left, n), e.right && Ht(e.right, i), s = n.concat(i), [a.collection(s)]) : t === 1 ? e.value ? [a.collection(e.value)] : (e.left && Ht(e.left, n), e.right && Ht(e.right, i), [a.collection(n), a.collection(i)]) : e.value ? [a.collection(e.value)] : (e.left && (n = Ms(e.left, t - 1, a)), e.right && (i = Ms(e.right, t - 1, a)), n.concat(i));
}, tu = function(e) {
  for (var t = this.cy(), a = this.nodes(), n = wh(e), i = n.attributes, s = function(b, w) {
    return On(n.distance, i.length, function(E) {
      return i[E](b);
    }, function(E) {
      return i[E](w);
    }, b, w);
  }, o = [], u = [], l = [], v = [], f = 0; f < a.length; f++) {
    var c = {
      value: n.mode === "dendrogram" ? a[f] : [a[f]],
      key: f,
      index: f
    };
    o[f] = c, v[f] = c, u[f] = [], l[f] = 0;
  }
  ...
  for (var g = ru(o, v, u, l, n); g; )
    g = ru(o, v, u, l, n);
  var p;
  return n.mode === "dendrogram" ? (p = Ms(o[0], n.dendrogramDepth, t), n.addDendrogram && Rs(o[0], t)) : (p = new Array(o.length), o.forEach(function(m, b) {
  ...
  0.5 <= t && t < 1 || Ge("Damping must range on [0.5, 1).  Got: ".concat(t));
  ...
  return -On(e, n.length, function(s) {
    return i(t, s);
  }, function(s) {
    return i(a, s);
  }, t, a);
  ...
  var a = null;
  return t === "median" ? a = Ed(e) : t === "mean" ? a = xd(e) : t === "min" ? a = bd(e) : t === "max" ? a = wd(e) : a = t, a;
}, kh = function(e, t, a) {
  for (var n = [], i = 0; i < e; i++)
  ...
  for (var n = au(e, t, a), i = 0; i < a.length; i++) {
    for (var s = [], o = 0; o < n.length; o++)
      n[o] === a[i] && s.push(o);
    for (var u = -1, l = -1 / 0, v = 0; v < s.length; v++) {
  ...
  for (var t = this.cy(), a = this.nodes(), n = Ch(e), i = {}, s = 0; s < a.length; s++)
    i[a[s].id()] = s;
  var o, u, l, v, f, c;
  ...
  for (var d = 0; d < o; d++)
    for (var y = 0; y < o; y++)
      d !== y && (l[d * o + y] = Th(n.distance, a[d], a[y], n.attributes));
  v = Sh(l, n.preference);
  for (var g = 0; g < o; g++)
    l[g * o + g] = v;
  f = new Array(u);
  ...
  for (k = 0; k < n.maxIterations; k++) {
    for (var B = 0; B < o; B++) {
      for (var D = -1 / 0, P = -1 / 0, A = -1, R = 0, L = 0; L < o; L++)
        b[L] = f[B * o + L], R = c[B * o + L] + l[B * o + L], R >= D ? (P = D, D = R, A = L) : R > P && (P = R);
      for (var I = 0; I < o; I++)
        f[B * o + I] = (1 - n.damping) * (l[B * o + I] - D) + n.damping * b[I];
      f[B * o + A] = (1 - n.damping) * (l[B * o + A] - P) + n.damping * b[A];
    }
    for (var M = 0; M < o; M++) {
      for (var N = 0, F = 0; F < o; F++)
        b[F] = c[F * o + M], w[F] = Math.max(0, f[F * o + M]), N += w[F];
      N -= w[M], w[M] = f[M * o + M], N += w[M];
      for (var _ = 0; _ < o; _++)
        c[_ * o + M] = (1 - n.damping) * Math.min(0, N - w[_]) + n.damping * b[_];
      c[M * o + M] = (1 - n.damping) * (N - w[M]) + n.damping * b[M];
    }
    for (var z = 0, q = 0; q < o; q++) {
      var Z = c[q * o + q] + f[q * o + q] > 0 ? 1 : 0;
      x[k % n.minIterations * o + q] = Z, z += Z;
    }
    if (z > 0 && (k >= n.minIterations - 1 || k == n.maxIterations - 1)) {
      for (var Q = 0, X = 0; X < o; X++) {
        E[X] = 0;
        for (var J = 0; J < n.minIterations; J++)
          E[X] += x[J * o + X];
        (E[X] === 0 || E[X] === n.minIterations) && Q++;
      }
      if (Q === o)
        break;
    }
  }
  for (var j = kh(o, f, c), ne = Dh(o, l, j), Y = {}, V = 0; V < j.length; V++)
    Y[j[V]] = [];
  for (var H = 0; H < a.length; H++) {
    var $ = i[a[H].id()], K = ne[$];
    K != null && Y[K].push(a[H]);
  }
  for (var te = new Array(j.length), ve = 0; ve < j.length; ve++)
    te[ve] = t.collection(Y[j[ve]]);
  return te;
}, Bh = {
  ...
  hierholzer: function(e) {
    ...
    var a = Ph(e), n = a.root, i = a.directed, s = this, o = !1, u, l, v;
    n && (v = he(n) ? this.filter(n)[0].id() : n[0].id());
    var f = {}, c = {};
    i ? s.forEach(function(m) {
      var b = m.id();
      if (m.isNode()) {
        var w = m.indegree(!0), E = m.outdegree(!0), C = w - E, x = E - w;
        C == 1 ? u ? o = !0 : u = b : x == 1 ? l ? o = !0 : l = b : (x > 1 || C > 1) && (o = !0), f[b] = [], m.outgoers().forEach(function(T) {
      ...
      if (m.isNode()) {
        var w = m.degree(!0);
        w % 2 && (u ? l ? o = !0 : l = b : u = b), f[b] = [], m.connectedEdges().forEach(function(E) {
    ...
    var d = function(b) {
      for (var w = b, E = [b], C, x, T; f[w].length; )
        C = f[w].shift(), x = c[C][0], T = c[C][1], w != T ? (f[T] = f[T].filter(function(k) {
          return k != C;
        }), w = T) : !i && w != x && (f[x] = f[x].filter(function(k) {
          return k != C;
  ...
  var e = this, t = {}, a = 0, n = 0, i = [], s = [], o = {}, u = function(c, h) {
    for (var d = s.length - 1, y = [], g = e.spawn(); s[d].x != c || s[d].y != h; )
      y.push(s.pop().edge), d--;
    ...
    if (y.size() === 0)
      ...
      y.forEach(function(w) {
        g = w.source().id(), p = w.target().id(), m = g === h ? p : g, m !== d && (b = w.id(), o[b] || (o[b] = !0, s.push({
          ...
          y: m,
          edge: w
        })), m in t ? t[h].low = Math.min(t[h].low, t[m].id) : (l(c, m, h), t[h].low = Math.min(t[h].low, t[m].low), t[h].id <= t[m].low && (t[h].cutVertex = !0, u(h, m))));
      });
    }
  };
  e.forEach(function(f) {
    if (f.isNode()) {
      var c = f.id();
      c in t || (n = 0, l(c, c), t[c].cutVertex = n > 1);
    }
  });
  ...
  hopcroftTarjanBiconnected: Za,
  htbc: Za,
  htb: Za,
  hopcroftTarjanBiconnectedComponents: Za
}, Qa = function() {
  var e = this, t = {}, a = 0, n = [], i = [], s = e.spawn(e), o = function(l) {
    ...
    var v = e.getElementById(l).connectedEdges().intersection(e);
    if (v.forEach(function(y) {
      var g = y.target().id();
      g !== l && (g in t || o(g), t[g].explored || (t[l].low = Math.min(t[l].low, t[g].low)));
    }), t[l].index === t[l].low) {
      for (var f = e.spawn(); ; ) {
        var c = i.pop();
        if (f.merge(e.getElementById(c)), t[c].low = t[l].index, t[c].explored = !0, c === l)
          break;
      }
  ...
  tarjanStronglyConnected: Qa,
  tsc: Qa,
  tscc: Qa,
  tarjanStronglyConnectedComponents: Qa
}, Bv = {};
[Sa, od, ud, vd, cd, hd, yd, $d, Ut, Kt, As, nh, yh, xh, Bh, Ah, Rh, Mh].forEach(function(r) {
  me(Bv, r);
});
/*!
...
*/
var Pv = 0, Av = 1, Rv = 2, Nr = function(e) {
...
Nr.prototype = {
  ...
  fulfill: function(e) {
    return iu(this, Av, "fulfillValue", e);
  },
  reject: function(e) {
    return iu(this, Rv, "rejectReason", e);
  },
  /*  "The then Method" [Promises/A+ 1.1, 1.2, 2.2]  */
  then: function(e, t) {
    var a = this, n = new Nr();
    return a.onFulfilled.push(ou(e, n, "fulfill")), a.onRejected.push(ou(t, n, "reject")), Mv(a), n.proxy;
  }
};
var iu = function(e, t, a, n) {
  return e.state === Pv && (e.state = t, e[a] = n, Mv(e)), e;
}, Mv = function(e) {
  e.state === Av ? su(e, "onFulfilled", e.fulfillValue) : e.state === Rv && su(e, "onRejected", e.rejectReason);
}, su = function(e, t, a) {
  if (e[t].length !== 0) {
    var n = e[t];
    e[t] = [];
  ...
  var a;
  if (je(t) === "object" && t !== null || typeof t == "function")
    try {
      a = t.then;
    } catch (i) {
      e.reject(i);
...
var ta = typeof Promise < "u" ? Promise : Nr, Ls = function(e, t, a) {
  var n = Xs(e), i = !n, s = this._private = me({
    duration: 1e3
  }, t, a);
...
me(Dt, {
  ...
  hook: function() {
    ...
    if (!e.hooked) {
      ...
      e.queue ? t = a.queue : t = a.current, t.push(this), Tr(e.target) && e.target.cy().addToAnimationPool(e.target), e.hooked = !0;
    }
    return this;
  },
  play: function() {
...
Dt.complete = Dt.completed;
Dt.run = Dt.play;
Dt.running = Dt.playing;
var Lh = {
  animated: function() {
    return function() {
  ...
  animation: function() {
    return function(t, a) {
      ...
      if (l && (t.style = v.getPropsList(t.style || t.css), t.css = void 0), l && t.renderedPosition != null) {
  ...
  animate: function() {
    return function(t, a) {
      ...
      for (var u = 0; u < s.length; u++) {
        var l = s[u], v = l.animated() && (t.queue === void 0 || t.queue), f = l.animation(t, v ? {
          queue: !0
        } : void 0);
        f.play();
      }
  ...
  stop: function() {
    return function(t, a) {
      ...
      if (!o.styleEnabled())
        return this;
      for (var u = 0; u < s.length; u++) {
        for (var l = s[u], v = l._private, f = v.animation.current, c = 0; c < f.length; c++) {
...
function Oh() {
  if (vu) return wi;
  vu = 1;
  var r = uv(), e = Na(), t = "[object AsyncFunction]", a = "[object Function]", n = "[object GeneratorFunction]", i = "[object Proxy]";
  function s(o) {
    if (!e(o))
      return !1;
    var u = r(o);
...
function Nh() {
  if (fu) return xi;
  fu = 1;
  var r = Mn(), e = r["__core-js_shared__"];
  return xi = e, xi;
}
var Ei, cu;
function zh() {
...
function Vh() {
  if (hu) return Ti;
  hu = 1;
  var r = Oh(), e = zh(), t = Na(), a = Fh(), n = /[\\^$.*+?()[\]{}|]/g, i = /^\[object .+?Constructor\]$/, s = Function.prototype, o = Object.prototype, u = s.toString, l = o.hasOwnProperty, v = RegExp(
...
function Hh() {
  if (wu) return Ai;
  wu = 1;
  var r = zn(), e = "__lodash_hash_undefined__", t = Object.prototype, a = t.hasOwnProperty;
  function n(i) {
    var s = this.__data__;
    if (r) {
      var o = s[i];
...
function Wh() {
  if (xu) return Ri;
  xu = 1;
  var r = zn(), e = Object.prototype, t = e.hasOwnProperty;
  function a(n) {
    var i = this.__data__;
...
function $h() {
  if (Eu) return Mi;
  Eu = 1;
  var r = zn(), e = "__lodash_hash_undefined__";
  function t(a, n) {
    var i = this.__data__;
...
function Uh() {
  ...
  return i.prototype.clear = r, i.prototype.delete = e, i.prototype.get = t, i.prototype.has = a, i.prototype.set = n, Li = i, Li;
}
var Ii, Tu;
function Kh() {
  if (Tu) return Ii;
...
function Xh() {
  if (Du) return zi;
  Du = 1;
  var r = Fn(), e = Array.prototype, t = e.splice;
  function a(n) {
...
function Jh() {
  ...
  return i.prototype.clear = r, i.prototype.delete = e, i.prototype.get = t, i.prototype.has = a, i.prototype.set = n, _i = i, _i;
}
var Gi, Mu;
function jh() {
  if (Mu) return Gi;
  Mu = 1;
  var r = io(), e = Mn(), t = r(e, "Map");
  return Gi = t, Gi;
}
var Hi, Lu;
function eg() {
...
function sg() {
  ...
  return i.prototype.clear = r, i.prototype.delete = e, i.prototype.get = t, i.prototype.has = a, i.prototype.set = n, Zi = i, Zi;
}
var Qi, _u;
function og() {
  if (_u) return Qi;
  _u = 1;
  var r = sg(), e = "Expected a function";
  function t(a, n) {
...
function Ov() {
  if (Hu) return ji;
  Hu = 1;
  var r = ug(), e = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, t = /\\(\\)?/g, a = r(function(n) {
    var i = [];
...
function lg() {
  if ($u) return rs;
  $u = 1;
  var r = Zs(), e = Nv(), t = Nn(), a = za(), n = r ? r.prototype : void 0, i = n ? n.toString : void 0;
  function s(o) {
    if (typeof o == "string")
      return o;
    if (t(o))
...
var cg = fg(), dg = /* @__PURE__ */ Oa(cg), os, Qu;
function hg() {
  if (Qu) return os;
  Qu = 1;
  var r = io(), e = (function() {
...
function pg() {
  if (ju) return ls;
  ju = 1;
  var r = gg(), e = Iv(), t = Object.prototype, a = t.hasOwnProperty;
  function n(i, s, o) {
    var u = i[s];
...
function mg() {
  ...
  function i(s, o, u, l) {
    ...
    for (var v = -1, f = o.length, c = f - 1, h = s; h != null && ++v < f; ) {
      ...
      if (v != c) {
        var g = h[d];
        y = l ? l(g, d, h) : void 0, y === void 0 && (y = a(g) ? g : t(o[v + 1]) ? [] : {});
      }
      r(h, d, y), h = h[d];
    }
    return s;
...
var wg = bg(), xg = /* @__PURE__ */ Oa(wg), ds, al;
function Eg() {
  if (al) return ds;
  al = 1;
  function r(e, t) {
...
function Cg() {
  if (nl) return hs;
  nl = 1;
  var r = Nv(), e = Eg(), t = Nn(), a = za(), n = Ov(), i = so(), s = zv();
  function o(u) {
    return t(u) ? r(u, i) : a(u) ? [u] : e(n(s(u)));
  }
  return hs = o, hs;
}
var Tg = Cg(), Sg = /* @__PURE__ */ Oa(Tg), kg = {
  // access data field
  data: function(e) {
    var t = {
      field: "data",
    ...
    return e = me({}, t, e), function(n, i) {
      var s = e, o = this, u = o.length !== void 0, l = u ? o : [o], v = u ? o[0] : o;
      if (he(n)) {
        var f = n.indexOf(".") !== -1, c = f && Sg(n);
        if (s.allowGetting && i === void 0) {
          var h;
          return v && (s.beforeGet(v), c && v._private[s.field][n] === void 0 ? h = dg(v._private[s.field], c) : h = v._private[s.field][n]), h;
          ...
          if (d) {
            ...
            for (var g = 0, p = l.length; g < p; g++) {
              var m = l[g];
              s.canSet(m) && (c && v._private[s.field][n] === void 0 ? xg(m._private[s.field], c, i) : m._private[s.field][n] = i);
            }
        ...
        for (var x = 0; x < C.length; x++) {
          ...
          if (T)
            for (var k = 0; k < l.length; k++) {
              var B = l[k];
              s.canSet(B) && (B._private[s.field][w] = E);
            }
        }
        s.updateStyle && o.updateStyle(), s.onSet(o), s.settingTriggersEvent && o[s.triggerFnName](s.settingEvent);
  ...
  removeData: function(e) {
    ...
    return e = me({}, t, e), function(n) {
      var i = e, s = this, o = s.length !== void 0, u = o ? s : [s];
      if (he(n)) {
        for (var l = n.split(/\s+/), v = l.length, f = 0; f < v; f++) {
          var c = l[f];
          if (!st(c)) {
  ...
  eventAliasesOn: function(e) {
    ...
    t.addListener = t.listen = t.bind = t.on, t.unlisten = t.unbind = t.off = t.removeListener, t.trigger = t.emit, t.pon = t.promiseOn = function(a, n) {
      ...
      return new ta(function(o, u) {
        var l = function(h) {
          i.off.apply(i, f), o(h);
        }, v = s.concat([l]), f = v.concat([]);
        i.on.apply(i, v);
      });
    };
  }
}, Oe = {};
[Lh, kg, Dg].forEach(function(r) {
  me(Oe, r);
});
var Bg = {
  animate: Oe.animate(),
  ...
  classes: function(e) {
    ...
    for (var n = [], i = new ra(e), s = 0; s < t.length; s++) {
      for (var o = t[s], u = o._private, l = u.classes, v = !1, f = 0; f < e.length; f++) {
        var c = e[f], h = l.has(c);
        if (!h) {
          v = !0;
          break;
      ...
      v || (v = l.size !== e.length), v && (u.classes = i, n.push(o));
    }
  ...
  toggleClass: function(e, t) {
    ...
    for (var a = this, n = t === void 0, i = [], s = 0, o = a.length; s < o; s++)
      for (var u = a[s], l = u._private.classes, v = !1, f = 0; f < e.length; f++) {
        var c = e[f], h = l.has(c), d = !1;
        t || n && !h ? (l.add(c), d = !0) : (!t || n && h) && (l.delete(c), d = !0), !v && d && (i.push(u), v = !0);
      }
...
var ze = function() {
  ...
  for (var r = {}, e, t = 0; t < Is.length; t++)
    e = Is[t], r[e.selector] = e.matches;
  return r;
})(), Ag = function(e, t) {
  return Pg[e](t);
}, Rg = "(" + Is.map(function(r) {
  return r.selector;
}).join("|") + ")", Lt = function(e) {
  ...
  populate: function(e, t, a) {
    var n = Xe(a, 3), i = n[0], s = n[1], o = n[2], u = new RegExp("^" + Re.string + "$").exec(o) != null;
    u ? o = o.substring(1, o.length - 1) : o = parseFloat(o), t.checks.push({
      type: le.DATA_COMPARE,
      field: Lt(i),
      operator: s,
      value: o
    });
  ...
  populate: function(e, t, a) {
    var n = Xe(a, 3), i = n[0], s = n[1], o = n[2];
    t.checks.push({
      type: le.META_COMPARE,
      field: Lt(i),
      operator: s,
      value: parseFloat(o)
    });
  ...
  populate: function(e, t) {
    if (e.currentSubject == null) {
      ...
      return a.checks.push({
        type: le.DIRECTED_EDGE,
        source: n,
        target: i
      }), jr(e, t, a), e.edgeCount++, i;
    } else {
      var s = ze(), o = t, u = ze();
  ...
  populate: function(e, t) {
    if (e.currentSubject == null) {
      var a = ze(), n = t, i = ze();
      return a.checks.push({
        type: le.UNDIRECTED_EDGE,
        nodes: [n, i]
      }), jr(e, t, a), e.edgeCount++, i;
    } else {
      var s = ze(), o = t, u = ze();
      return s.checks.push({
        type: le.NODE_NEIGHBOR,
        node: o,
        neighbor: u
      }), jr(e, t, s), u;
    }
  ...
  populate: function(e, t) {
    if (e.currentSubject == null) {
      ...
      return a.checks.push({
        ...
        parent: i,
        child: n
      }), jr(e, t, a), e.compoundCount++, n;
    } else if (e.currentSubject === t) {
      var s = ze(), o = e[e.length - 1], u = ze(), l = ze(), v = ze(), f = ze();
      return s.checks.push({
        type: le.COMPOUND_SPLIT,
        left: o,
        right: u,
        subject: l
        ...
        child: v
        // empty for now
      }), jr(e, o, s), e.currentSubject = l, e.compoundCount++, v;
    } else {
      var c = ze(), h = ze(), d = [{
        type: le.PARENT,
        parent: c,
  ...
  populate: function(e, t) {
    ...
    i === le.DIRECTED_EDGE ? n.type = le.NODE_TARGET : i === le.UNDIRECTED_EDGE && (n.type = le.NODE_NEIGHBOR, n.node = n.nodes[1], n.neighbor = n.nodes[0], n.nodes = null);
  }
}];
...
var Mg = function(e) {
  for (var t, a, n, i = 0; i < Os.length; i++) {
    var s = Os[i], o = s.name, u = e.match(s.regexObj);
    if (u != null) {
      a = u, t = s, n = o;
      var l = u[0];
  ...
  var t = this, a = t.inputText = e, n = t[0] = ze();
  for (t.length = 1, a = Lg(a); ; ) {
    var i = Mg(a);
    if (i.expr == null)
  ...
  for (var l = 0; l < t.length; l++) {
    ...
    v.edgeCount === 1 && Ne("The selector `" + e + "` is deprecated.  Edge selectors do not take effect on changes to source and target nodes after an edge is added, for performance reasons.  Use a class or data selector on edges instead, updating the class or data of an edge when your app detects a change in source or target nodes.");
  }
  return !0;
}, Og = function() {
  ...
  for (var e = function(v) {
    ...
    switch (c) {
      ...
      case le.DATA_COMPARE: {
        var y = v.field, g = v.operator;
        return "[" + y + a(e(g)) + t(h) + "]";
      }
      case le.DATA_BOOL: {
        var p = v.operator, m = v.field;
        return "[" + e(p) + m + "]";
      }
      case le.DATA_EXIST: {
        var b = v.field;
  ...
  var n, i = he(e), s = ae(e), o = he(a), u, l, v = !1, f = !1, c = !1;
  switch (t.indexOf("!") >= 0 && (t = t.replace("!", ""), f = !0), t.indexOf("@") >= 0 && (t = t.replace("@", ""), v = !0), (i || o || v) && (u = !i && !s ? "" : "" + e, l = "" + a), v && (e = u = u.toLowerCase(), a = l = l.toLowerCase()), t) {
    case "*=":
      n = u.indexOf(l) >= 0;
      break;
    case "$=":
  ...
  return e.checks.every(function(a) {
    return Ue[a.type](a, t);
  });
};
Ue[le.GROUP] = function(r, e) {
  var t = r.value;
  return t === "*" || t === e.group();
};
Ue[le.STATE] = function(r, e) {
  var t = r.value;
  return Ag(t, e);
};
Ue[le.ID] = function(r, e) {
  var t = r.value;
  return e.id() === t;
};
Ue[le.CLASS] = function(r, e) {
  var t = r.value;
  return e.hasClass(t);
};
Ue[le.META_COMPARE] = function(r, e) {
  var t = r.field, a = r.operator, n = r.value;
  return Vv(Vg(e, t), a, n);
};
Ue[le.DATA_COMPARE] = function(r, e) {
  var t = r.field, a = r.operator, n = r.value;
  return Vv(oo(e, t), a, n);
};
Ue[le.DATA_BOOL] = function(r, e) {
  var t = r.field, a = r.operator;
  return zg(oo(e, t), a);
};
Ue[le.DATA_EXIST] = function(r, e) {
  var t = r.field;
  return r.operator, Fg(oo(e, t));
};
Ue[le.UNDIRECTED_EDGE] = function(r, e) {
  var t = r.nodes[0], a = r.nodes[1], n = e.source(), i = e.target();
  return _e(t, n) && _e(a, i) || _e(a, n) && _e(t, i);
};
Ue[le.NODE_NEIGHBOR] = function(r, e) {
  return _e(r.node, e) && e.neighborhood().some(function(t) {
    return t.isNode() && _e(r.neighbor, t);
  });
};
Ue[le.DIRECTED_EDGE] = function(r, e) {
  return _e(r.source, e.source()) && _e(r.target, e.target());
};
Ue[le.NODE_SOURCE] = function(r, e) {
  return _e(r.source, e) && e.outgoers().some(function(t) {
    return t.isNode() && _e(r.target, t);
  });
};
Ue[le.NODE_TARGET] = function(r, e) {
  return _e(r.target, e) && e.incomers().some(function(t) {
    return t.isNode() && _e(r.source, t);
  });
};
Ue[le.CHILD] = function(r, e) {
  return _e(r.child, e) && _e(r.parent, e.parent());
};
Ue[le.PARENT] = function(r, e) {
  return _e(r.parent, e) && e.children().some(function(t) {
    return _e(r.child, t);
  });
};
Ue[le.DESCENDANT] = function(r, e) {
  return _e(r.descendant, e) && e.ancestors().some(function(t) {
    return _e(r.ancestor, t);
  });
};
Ue[le.ANCESTOR] = function(r, e) {
  return _e(r.ancestor, e) && e.descendants().some(function(t) {
    return _e(r.descendant, t);
  });
};
Ue[le.COMPOUND_SPLIT] = function(r, e) {
  return _e(r.subject, e) && _e(r.left, e) && _e(r.right, e);
};
Ue[le.TRUE] = function() {
  return !0;
};
Ue[le.COLLECTION] = function(r, e) {
  var t = r.value;
  return t.has(e);
};
Ue[le.FILTER] = function(r, e) {
  var t = r.value;
  return t(e);
};
var qg = function(e) {
  var t = this;
  if (t.length === 1 && t[0].checks.length === 1 && t[0].checks[0].type === le.ID)
  ...
  this.inputText = e, this.currentSubject = null, this.compoundCount = 0, this.edgeCount = 0, this.length = 0, e == null || he(e) && e.match(/^\s*$/) || (Tr(e) ? this.addQuery({
    checks: [{
      type: le.COLLECTION,
      value: e.collection()
    }]
  ...
  }) : he(e) ? this.parse(e) || (this.invalid = !0) : Ge("A selector must be created from a string; found "));
}, vt = lt.prototype;
[Ng, Gg].forEach(function(r) {
  return me(vt, r);
});
vt.text = function() {
...
vt.sameText = function(r) {
  return !this.invalid && !r.invalid && this.text() === r.text();
};
vt.addQuery = function(r) {
  this[this.length++] = r;
};
vt.selector = vt.toString;
var nt = {
  allAre: function(e) {
    var t = new lt(e);
...
nt.allAreNeighbours = nt.allAreNeighbors;
nt.has = nt.contains;
nt.equal = nt.equals = nt.same;
var Pr = function(e, t) {
  return function(n, i, s, o) {
    var u = n, l = this, v;
    if (u == null ? v = "" : Tr(u) && u.length === 1 && (v = u.id()), l.length === 1 && v) {
      var f = l[0]._private, c = f.traversalCache = f.traversalCache || {}, h = c[t] = c[t] || [], d = St(v), y = h[d];
...
Qt.forEachDown = function(r) {
  var e = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : !0;
  return uo(this, r, e, qv);
};
function _v(r, e, t) {
  if (t.isChild()) {
...
Qt.forEachUp = function(r) {
  var e = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : !0;
  return uo(this, r, e, _v);
};
function Hg(r, e, t) {
  _v(r, e, t), qv(r, e, t);
}
Qt.forEachUpAndDown = function(r) {
  var e = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : !0;
  return uo(this, r, e, Hg);
};
Qt.ancestors = Qt.parents;
var Ba, Gv;
Ba = Gv = {
  data: Oe.data({
    field: "data",
...
me(qn, {
  minDegree: It("degree", function(r, e) {
    return r < e;
  }),
  maxDegree: It("degree", function(r, e) {
    return r > e;
  }),
  minIndegree: It("indegree", function(r, e) {
    return r < e;
  }),
  maxIndegree: It("indegree", function(r, e) {
    return r > e;
  }),
  minOutdegree: It("outdegree", function(r, e) {
    return r < e;
  }),
  maxOutdegree: It("outdegree", function(r, e) {
    return r > e;
  })
});
me(qn, {
...
Or = Hv = {
  ...
  silentShift: function(e, t) {
    return Me(e) ? this.shift(e, !0) : he(e) && ae(t) && this.shift(e, t, !0), this;
  },
  // get/set the rendered (i.e. on screen) positon of the element
  renderedPosition: function(e, t) {
    var a = this[0], n = this.cy(), i = n.zoom(), s = n.pan(), o = Me(e) ? e : void 0, u = o !== void 0 || t !== void 0 && he(e);
    if (a && a.isNode())
      if (u)
        ...
        var f = a.position();
        return o = In(f, i, s), e === void 0 ? o : o[e];
      }
    else if (!u)
      return;
    return this;
  ...
  relativePosition: function(e, t) {
    var a = this[0], n = this.cy(), i = Me(e) ? e : void 0, s = i !== void 0 || t !== void 0 && he(e), o = n.hasCompoundNodes();
    if (a && a.isNode())
      if (s)
        for (var u = 0; u < this.length; u++) {
          var l = this[u], v = o ? l.parent() : null, f = v && v.length > 0, c = f;
          f && (v = v[0]);
          var h = c ? v.position() : {
            x: 0,
            y: 0
...
Xt = ht = {};
ht.renderedBoundingBox = function(r) {
...
ht.dirtyCompoundBoundsCache = function() {
...
ht.updateCompoundBounds = function() {
  var r = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : !1, e = this.cy();
  ...
  function t(s) {
    if (!s.isParent())
      return;
    var o = s._private, u = s.children(), l = s.pstyle("compound-sizing-wrt-labels").value === "include", v = {
      width: {
    ...
    function h(k, B, D) {
      var P = 0, A = 0, R = B + D;
      return k > 0 && R > 0 && (P = B / R * k, A = D / R * k), {
        biasDiff: P,
    ...
    function d(k, B, D, P) {
      if (D.units === "%")
        switch (P) {
          ...
          case "average":
            return k > 0 && B > 0 ? D.pfValue * (k + B) / 2 : 0;
          case "min":
            return k > 0 && B > 0 ? k > B ? D.pfValue * B : D.pfValue * k : 0;
          case "max":
            return k > 0 && B > 0 ? k > B ? D.pfValue * k : D.pfValue * B : 0;
          default:
            return 0;
        }
    ...
    var b = h(v.width.val - f.w, y, g), w = b.biasDiff, E = b.biasComplementDiff, C = h(v.height.val - f.h, p, m), x = C.biasDiff, T = C.biasComplementDiff;
...
var Br = function(e) {
  ...
  if (!t.cy().headless()) {
    ...
    if (o !== "none") {
      ...
      f.x1 = u - s, f.y1 = l - s, f.x2 = u + s, f.y2 = l + s, f.w = f.x2 - f.x1, f.h = f.y2 - f.y1, on(f, 1), Ir(e, f.x1, f.y1, f.x2, f.y2);
    }
  }
}, ps = function(e, t, a) {
  if (!t.cy().headless()) {
    ...
    if (o) {
      var u = t.pstyle("text-halign"), l = t.pstyle("text-valign"), v = fa(s, "labelWidth", a), f = fa(s, "labelHeight", a), c = fa(s, "labelX", a), h = fa(s, "labelY", a), d = t.pstyle(n + "text-margin-x").pfValue, y = t.pstyle(n + "text-margin-y").pfValue, g = t.isEdge(), p = t.pstyle(n + "text-rotation"), m = t.pstyle("text-outline-width").pfValue, b = t.pstyle("text-border-width").pfValue, w = b / 2, E = t.pstyle("text-background-padding").pfValue, C = 2, x = f, T = v, k = T / 2, B = x / 2, D, P, A, R;
      if (g)
        D = c - k, P = c + k, A = h - B, R = h + B;
      else {
        switch (Jt(u.value)) {
          case "left":
            D = c - T, P = c;
      ...
      var L = d - Math.max(m, w) - E - C, I = d + Math.max(m, w) + E + C, M = y - Math.max(m, w) - E - C, N = y + Math.max(m, w) + E + C;
      D += L, P += I, A += M, R += N;
      var F = a || "main", _ = i.labelBounds, z = _[F] = _[F] || {};
      z.x1 = D, z.y1 = A, z.x2 = P, z.y2 = R, z.w = P - D, z.h = R - A, z.leftPad = L, z.rightPad = I, z.topPad = M, z.botPad = N;
      var q = g && p.strValue === "autorotate", Z = p.pfValue != null && p.pfValue !== 0;
      if (q || Z) {
        var Q = q ? fa(i.rstyle, "labelAngle", a) : p.pfValue, X = Math.cos(Q), J = Math.sin(Q), j = (D + P) / 2, ne = (A + R) / 2;
        if (!g) {
          switch (Jt(u.value)) {
            case "left":
              j = P;
        ...
        var Y = function(we, ye) {
          return we = we - j, ye = ye - ne, {
            x: we * X - ye * J + j,
            y: we * J + ye * X + ne
          };
        }, V = Y(D, A), H = Y(D, R), $ = Y(P, A), K = Y(P, R);
        D = Math.min(V.x, H.x, $.x, K.x), P = Math.max(V.x, H.x, $.x, K.x), A = Math.min(V.y, H.y, $.y, K.y), R = Math.max(V.y, H.y, $.y, K.y);
      }
      var te = F + "Rot", ve = _[te] = _[te] || {};
      ve.x1 = D, ve.y1 = A, ve.x2 = P, ve.y2 = R, ve.w = P - D, ve.h = R - A, Ir(e, D, A, P, R), Ir(i.labelBounds.all, D, A, P, R);
    }
    return e;
  }
}, sl = function(e, t) {
...
}, $v = function(e, t, a, n, i, s) {
  if (!(a === 0 || n <= 0 || i === "inside")) {
    var o = t.cy(), u = o.renderer(), l = u.nodeShapes[u.getNodeShape(t)];
    if (l) {
      var v = t.position(), f = v.x, c = v.y, h = t.width(), d = t.height();
      if (l.hasMiterBounds) {
        i === "center" && (n /= 2);
        var y = l.miterBounds(f, c, h, d, n);
        et(e, y);
      } else s != null && s > 0 && un(e, [s, s, s, s]);
    }
  }
}, Kg = function(e, t) {
  if (!t.cy().headless()) {
  ...
  var a = e._private.cy, n = a.styleEnabled(), i = a.headless(), s = yr(), o = e._private, u = e.isNode(), l = e.isEdge(), v, f, c, h, d, y, g = o.rstyle, p = u && n ? e.pstyle("bounds-expansion").pfValue : [0], m = function(De) {
  ...
  if (b) {
    ...
    var T = Math.max(E, x), k = 0, B = 0;
    if (n && (k = e.pstyle("width").pfValue, B = k / 2), u && t.includeNodes) {
      var D = e.position();
      d = D.x, y = D.y;
      var P = e.outerWidth(), A = P / 2, R = e.outerHeight(), L = R / 2;
      v = d - A, f = d + A, c = y - L, h = y + L, Ir(s, v, c, f, h), n && sl(s, e), n && t.includeOutlines && !i && sl(s, e), n && Kg(s, e);
    } else if (l && t.includeEdges)
      if (n && !i) {
        var I = e.pstyle("curve-style").strValue;
        if (v = Math.min(g.srcX, g.midX, g.tgtX), f = Math.max(g.srcX, g.midX, g.tgtX), c = Math.min(g.srcY, g.midY, g.tgtY), h = Math.max(g.srcY, g.midY, g.tgtY), v -= B, f += B, c -= B, h += B, Ir(s, v, c, f, h), I === "haystack") {
          var M = g.haystackPts;
          if (M && M.length === 2) {
            ...
            Ir(s, v - B, c - B, f + B, h + B);
          }
        } else if (I === "bezier" || I === "unbundled-bezier" || rt(I, "segments") || rt(I, "taxi")) {
          var _;
          switch (I) {
            case "bezier":
          ...
          if (_ != null)
            for (var z = 0; z < _.length; z++) {
              var q = _[z];
              v = q.x - B, f = q.x + B, c = q.y - B, h = q.y + B, Ir(s, v, c, f, h);
            }
        }
      } else {
        var Z = e.source(), Q = Z.position(), X = e.target(), J = X.position();
        ...
        v -= B, f += B, c -= B, h += B, Ir(s, v, c, f, h);
      }
    if (n && t.includeEdges && l && (Ja(s, e, "mid-source"), Ja(s, e, "mid-target"), Ja(s, e, "source"), Ja(s, e, "target")), n) {
      var Y = e.pstyle("ghost").value === "yes";
      if (Y) {
        var V = e.pstyle("ghost-offset-x").pfValue, H = e.pstyle("ghost-offset-y").pfValue;
        Ir(s, s.x1 + V, s.y1 + H, s.x2 + V, s.y2 + H);
      }
    }
    var $ = o.bodyBounds = o.bodyBounds || {};
    $o($, s), un($, p), on($, 1), n && (v = s.x1, f = s.x2, c = s.y1, h = s.y2, Ir(s, v - T, c - T, f + T, h + T));
    var K = o.overlayBounds = o.overlayBounds || {};
    $o(K, s), un(K, p), on(K, 1);
    var te = o.labelBounds = o.labelBounds || {};
    te.all != null ? Bd(te.all) : te.all = yr(), n && t.includeLabels && (t.includeMainLabels && ps(s, e, null), l && (t.includeSourceLabels && ps(s, e, "source"), t.includeTargetLabels && ps(s, e, "target")));
  }
  return s.x1 = Br(s.x1), s.y1 = Br(s.y1), s.x2 = Br(s.x2), s.y2 = Br(s.y2), s.w = Br(s.x2 - s.x1), s.h = Br(s.y2 - s.y1), s.w > 0 && s.h > 0 && b && (un(s, p), on(s, 1)), s;
}, Uv = function(e) {
  ...
  if (e.isEdge()) {
    ...
    return Vo([t(a.x), t(a.y), t(n.x), t(n.y)]);
  } else {
    var i = e.position();
    return Vo([t(i.x), t(i.y)]);
  }
}, ol = function(e, t) {
  var a = e._private, n, i = e.isEdge(), s = t == null ? ul : Uv(t), o = s === ul;
  if (a.bbCache == null ? (n = Xg(e, Pa), a.bbCache = n, a.bbCachePosKey = Kv(e)) : n = a.bbCache, !o) {
    var u = e.isNode();
    n = yr(), (t.includeNodes && u || t.includeEdges && !u) && (t.includeOverlays ? et(n, a.overlayBounds) : et(n, a.bodyBounds)), t.includeLabels && (t.includeMainLabels && (!i || t.includeSourceLabels && t.includeTargetLabels) ? et(n, a.labelBounds.all) : (t.includeMainLabels && et(n, a.labelBounds.mainRot), t.includeSourceLabels && et(n, a.labelBounds.sourceRot), t.includeTargetLabels && et(n, a.labelBounds.targetRot))), n.w = n.x2 - n.x1, n.h = n.y2 - n.y1;
  }
  return n;
}, Pa = {
  includeNodes: !0,
...
ht.boundingBox = function(r) {
  var e, t = r === void 0 || r.useCache === void 0 || r.useCache === !0, a = Yt(function(v) {
    var f = v._private;
    return f.bbCache == null || f.styleDirty || f.bbCachePosKey !== Kv(v);
  }, function(v) {
    return v.id();
  });
  if (t && this.length === 1 && !a(this[0]))
    ...
    for (var u = 0; u < i.length; u++) {
      var l = i[u];
      a(l) && l.dirtyBoundingBoxCache(), et(e, ol(l, n));
    }
  }
  return e.x1 = Br(e.x1), e.y1 = Br(e.y1), e.x2 = Br(e.x2), e.y2 = Br(e.y2), e.w = Br(e.x2 - e.x1), e.h = Br(e.y2 - e.y1), e;
};
ht.dirtyBoundingBoxCache = function() {
...
ht.boundingBoxAt = function(r) {
  ...
  var u = Dd(this.boundingBox({
    useCache: !1
  }));
  return e.silentPositions(o), a && (n.dirtyCompoundBoundsCache(), n.dirtyBoundingBoxCache(), n.updateCompoundBounds(!0)), t.endBatch(), u;
};
Xt.boundingbox = Xt.bb = Xt.boundingBox;
Xt.renderedBoundingbox = Xt.renderedBoundingBox;
var Yg = ht, ma, qa;
ma = qa = {};
var Xv = function(e) {
  e.uppercaseName = To(e.name), e.autoName = "auto" + e.uppercaseName, e.labelName = "label" + e.uppercaseName, e.outerName = "outer" + e.uppercaseName, e.uppercaseOuterName = To(e.outerName), ma[e.name] = function() {
...
var Zg = qa, Qg = function(e, t) {
  if (e.isEdge() && e.takesUpSpace())
    return t(e);
}, Jg = function(e, t) {
  if (e.isEdge() && e.takesUpSpace()) {
    var a = e.cy();
    return In(t(e), a.zoom(), a.pan());
  }
}, jg = function(e, t) {
  if (e.isEdge() && e.takesUpSpace()) {
...
}, sp = Object.keys(vl).reduce(function(r, e) {
  var t = vl[e], a = ip(e);
  return r[e] = function() {
    return Qg(this, t.get);
  }, t.mult ? r[a] = function() {
    return jg(this, t.get);
  } : r[a] = function() {
    return Jg(this, t.get);
  }, r;
}, {}), op = me({}, $g, Yg, Zg, sp);
...
Yv.prototype = {
  ...
  recycle: function(e, t) {
    if (this.isImmediatePropagationStopped = this.isPropagationStopped = this.isDefaultPrevented = ca, e != null && e.preventDefault ? (this.type = e.type, this.isDefaultPrevented = e.defaultPrevented ? ja : ca) : e != null && e.type ? t = e : this.type = e, t != null && (this.originalEvent = t.originalEvent, this.type = t.type != null ? t.type : this.type, this.cy = t.cy, this.target = t.target, this.position = t.position, this.renderedPosition = t.renderedPosition, this.namespace = t.namespace, this.layout = t.layout), this.cy != null && this.position != null && this.renderedPosition == null) {
  ...
  stopImmediatePropagation: function() {
    this.isImmediatePropagationStopped = ja, this.stopPropagation();
  },
...
var Zv = /^([^.]+)(\.(?:[^.]+))?$/, up = ".*", Qv = {
  ...
  context: null
}, fl = Object.keys(Qv), lp = {};
function _n() {
  for (var r = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : lp, e = arguments.length > 1 ? arguments[1] : void 0, t = 0; t < fl.length; t++) {
    var a = fl[t];
    this[a] = r[a] || Qv[a];
  }
  this.context = e || this.context, this.listeners = [], this.emitting = 0;
}
var ft = _n.prototype, Jv = function(e, t, a, n, i, s, o) {
  He(n) && (i = n, n = null), o && (s == null ? s = o : s = me({}, s, o));
  for (var u = Fe(a) ? a : a.split(/\s+/), l = 0; l < u.length; l++) {
    var v = u[l];
    if (!st(v)) {
      var f = v.match(Zv);
      if (f) {
  ...
  for (var n = Fe(a) ? a : a.split(/\s+/), i = 0; i < n.length; i++) {
    var s = n[i];
    if (!st(s)) {
      var o = s.match(Zv);
      if (o) {
        var u = o[1], l = o[2] ? o[2] : null, v = cl(e, {
          type: u,
          namespace: l,
          target: e.context
        });
...
ft.on = ft.addListener = function(r, e, t, a, n) {
  return Jv(this, function(i, s, o, u, l, v, f) {
    He(v) && i.listeners.push({
      event: s,
      // full event string
      callback: v,
      // callback to run
...
ft.one = function(r, e, t, a) {
  return this.on(r, e, t, a, {
    one: !0
  });
};
ft.removeListener = ft.off = function(r, e, t, a) {
  var n = this;
  this.emitting !== 0 && (this.listeners = Zc(this.listeners));
  for (var i = this.listeners, s = function(l) {
    var v = i[l];
    Jv(n, function(f, c, h, d, y, g) {
      if ((v.type === h || r === "*") && (!d && v.namespace !== ".*" || v.namespace === d) && (!y || f.qualifierCompare(v.qualifier, y)) && (!g || v.callback === g))
...
ft.removeAllListeners = function() {
  return this.removeListener("*");
};
ft.emit = ft.trigger = function(r, e, t) {
  var a = this.listeners, n = a.length;
  return this.emitting++, Fe(e) || (e = [e]), vp(this, function(i, s) {
    t != null && (a = [{
      event: s.event,
      type: s.type,
    ...
    for (var o = function() {
      var v = a[u];
      if (v.type === s.type && (!v.namespace || v.namespace === s.namespace || v.namespace === up) && i.eventMatches(i.context, v, s)) {
        var f = [s];
        e != null && Jc(f, e), i.beforeEmit(i.context, v, s), v.conf && v.conf.one && (i.listeners = i.listeners.filter(function(d) {
          return d !== v;
        }));
...
var fp = {
  ...
  return he(e) ? new lt(e) : e;
}, jv = {
  createEmitter: function() {
    for (var e = 0; e < this.length; e++) {
      var t = this[e], a = t._private;
      a.emitter || (a.emitter = new _n(fp, t));
    }
    return this;
  },
  emitter: function() {
  ...
  on: function(e, t, a) {
    for (var n = en(t), i = 0; i < this.length; i++) {
      var s = this[i];
      s.emitter().on(e, n, a);
    }
    return this;
...
var ef = {
  ...
  xor: function(e) {
    ...
    var a = this.spawn(), n = this, i = e, s = function(u, l) {
      for (var v = 0; v < u.length; v++) {
        var f = u[v], c = f._private.data.id, h = l.hasElementWithId(c);
        h || a.push(f);
      }
    };
  ...
  diff: function(e) {
    var t = this._private.cy;
    he(e) && (e = t.$(e));
    var a = this.spawn(), n = this.spawn(), i = this.spawn(), s = this, o = e, u = function(v, f, c) {
      for (var h = 0; h < v.length; h++) {
        var d = v[h], y = d._private.data.id, g = f.hasElementWithId(y);
...
var cp = {
  ...
  function i(v) {
    ...
    return f.value === "auto" ? n ? v.zDepth() : 0 : f.value === "bottom" ? -1 : f.value === "top" ? Qs : 0;
  }
  var s = i(e) - i(t);
  if (s !== 0)
    return s;
...
Tn.each = Tn.forEach;
var dp = function() {
  var e = "undefined", t = (typeof Symbol > "u" ? "undefined" : je(Symbol)) != e && je(Symbol.iterator) != e;
  t && (Tn[Symbol.iterator] = function() {
    var a = this, n = {
      value: void 0,
      done: !1
    }, i = 0, s = this.length;
...
var hp = lr({
  ...
  layoutPositions: function(e, t, a) {
    ...
    var l = function(C, x, T) {
      ...
      if (!v)
        return null;
      for (var C = yr(), x = 0; x < n.length; x++) {
        var T = n[x], k = u(T, x);
        bv(C, k.x, k.y);
      }
      return C;
    }, c = f(), h = Yt(function(E, C) {
      var x = u(E, C);
      if (v) {
...
function lo(r) {
  ...
  return function() {
    ...
    if (i) {
      ...
      return t(u) && (!s || ys(u, t)) && (u === l || t(l) && (!s || ys(l, t)));
    }
  };
}
var aa = Gn("eleTakesUpSpace", function(r) {
  return r.pstyle("display").value === "element" && r.width() !== 0 && (r.isNode() ? r.height() !== 0 : !0);
});
or.takesUpSpace = Hn("takesUpSpace", lo({
  ok: aa
}));
var gp = Gn("eleInteractive", function(r) {
  return r.pstyle("events").value === "yes" && r.pstyle("visibility").value === "visible" && aa(r);
}), pp = Gn("parentInteractive", function(r) {
  return r.pstyle("visibility").value === "visible" && aa(r);
});
or.interactive = Hn("interactive", lo({
  ok: gp,
  parentOk: pp,
  edgeOkViaNode: aa
}));
or.noninteractive = function() {
  var r = this[0];
  if (r)
    return !r.interactive();
};
var yp = Gn("eleVisible", function(r) {
  return r.pstyle("visibility").value === "visible" && r.pstyle("opacity").pfValue !== 0 && aa(r);
}), mp = aa;
or.visible = Hn("visible", lo({
  ok: yp,
  edgeOkViaNode: mp
}));
or.hidden = function() {
...
or.isBundledBezier = Hn("isBundledBezier", function() {
  return this.cy().styleEnabled() ? !this.removed() && this.pstyle("curve-style").value === "bezier" && this.takesUpSpace() : !1;
});
or.bypass = or.css = or.style;
or.renderedCss = or.renderedStyle;
...
function dl(r) {
  return function() {
    ...
    if (e.length === 2) {
      ...
      var i = e[0];
      this.on(r.event, i);
    } else if (e.length === 0 || e.length === 1 && Fe(e[0])) {
      for (var s = e.length === 1 ? e[0] : null, o = 0; o < this.length; o++) {
        var u = this[o], l = !r.ableField || u._private[r.ableField], v = u._private[r.field] != r.value;
        if (r.overrideAble) {
          var f = r.overrideAble(u);
          if (f !== void 0 && (l = f, !f))
            return this;
        }
        l && (u._private[r.field] = r.value, v && t.push(u));
      }
      var c = this.spawn(t);
...
var cr = {}, hl = function(e) {
  return function(a) {
    for (var n = this, i = [], s = 0; s < n.length; s++) {
      var o = n[s];
      if (o.isNode()) {
        for (var u = !1, l = o.connectedEdges(), v = 0; v < l.length; v++) {
          var f = l[v], c = f.source(), h = f.target();
    ...
    for (var a = this, n = [], i = 0; i < a.length; i++) {
      ...
      if (s.isNode())
        for (var o = s.connectedEdges(), u = 0; u < o.length; u++) {
          var l = o[u], v = l.source(), f = l.target();
          e.outgoing && v === s ? (n.push(l), n.push(f)) : e.incoming && f === s && (n.push(l), n.push(v));
        }
    }
...
cr.clearTraversalCache = function() {
  for (var r = 0; r < this.length; r++)
...
cr.neighbourhood = cr.neighborhood;
cr.closedNeighbourhood = cr.closedNeighborhood;
cr.openNeighbourhood = cr.openNeighborhood;
me(cr, {
  ...
  return function(t) {
    ...
    for (var s = 0; s < t.length; s++)
      for (var o = t[s]._private.edges, u = 0; u < o.length; u++) {
        var l = o[u], v = l._private.data, f = this.hasElementWithId(v.source) && t.hasElementWithId(v.target), c = t.hasElementWithId(v.source) && this.hasElementWithId(v.target), h = f || c;
        h && ((i.thisIsSrc || i.thisIsTgt) && (i.thisIsSrc && !f || i.thisIsTgt && !c) || a.push(l));
      }
    return this.spawn(a, !0);
  };
}
me(cr, {
  connectedEdges: Pr(function(r) {
  ...
  parallelEdges: Pr(bl(), "parallelEdges"),
  codirectedEdges: Pr(bl({
    codirected: !0
  }), "codirectedEdges")
});
function bl(r) {
  ...
  return r = me({}, e, r), function(a) {
    for (var n = [], i = this.edges(), s = r, o = 0; o < i.length; o++)
      for (var u = i[o], l = u._private, v = l.source, f = v._private.data.id, c = l.data.target, h = v._private.edges, d = 0; d < h.length; d++) {
        var y = h[d], g = y._private.data, p = g.target, m = g.source, b = p === c && m === f, w = f === p && c === m;
...
var ur = function(e, t) {
  ...
  if (!t)
    t = [];
  else if (t.length > 0 && Me(t[0]) && !Ia(t[0])) {
    s = !0;
    for (var o = [], u = new ra(), l = 0, v = t.length; l < v; l++) {
      var f = t[l];
      f.data == null && (f.data = {});
      var c = f.data;
      if (c.id == null)
  ...
  this._private = {
    ...
    rebuildMap: function() {
      for (var b = this.lazyMap = new Ur(), w = this.eles, E = 0; E < w.length; E++) {
        var C = w[E];
        b.set(C.id(), {
          index: E,
          ele: C
...
}, qe = Ln.prototype = ur.prototype = Object.create(Array.prototype);
qe.instanceString = function() {
  return "collection";
};
qe.spawn = function(r, e) {
  return new ur(this.cy(), r, e);
};
...
qe.collection = function() {
  return rv(this) ? this : new ur(this._private.cy, [this]);
};
qe.unique = function() {
  return new ur(this._private.cy, this, !0);
};
qe.hasElementWithId = function(r) {
  return r = "" + r, this._private.map.has(r);
};
qe.getElementById = function(r) {
  r = "" + r;
  var e = this._private.cy, t = this._private.map.get(r);
  return t ? t.ele : new ur(e);
};
    ...
    if (Me(r)) {
      if (t.startBatch(), r.data) {
        ...
        if (e.isEdge()) {
          ...
          var l = "parent" in r.data, v = r.data.parent;
          l && (v != null || n.parent != null) && v != n.parent && (v === void 0 && (v = null), v != null && (v = "" + v), e = e.move({
            parent: v
          }));
        }
      }
...
qe.clone = function() {
  for (var r = this.cy(), e = [], t = 0; t < this.length; t++) {
    var a = this[t], n = a.json(), i = new Ln(r, n, !1);
    e.push(i);
  }
  return new ur(r, e);
};
...
qe.restore = function() {
  ...
  for (f = 0; f < o.length; f++) {
    ...
    if (h.clearTraversalCache(), !(!e && !d.removed)) {
      if (y.id === void 0)
        ...
        y.id = "" + y.id;
      else if (st(y.id) || !he(y.id)) {
        Ge("Can not create element with invalid string ID `" + y.id + "`"), c();
        continue;
      } else if (a.hasElementWithId(y.id)) {
        Ge("Can not create second element with ID `" + y.id + "`"), c();
        continue;
      }
    }
    var g = y.id;
    ...
    if (h.isEdge()) {
      for (var m = h, b = ["source", "target"], w = b.length, E = !1, C = 0; C < w; C++) {
        var x = b[C], T = y[x];
        ae(T) && (T = y[x] = "" + y[x]), T == null || T === "" ? (Ge("Can not create edge `" + g + "` with unspecified " + x), E = !0) : a.hasElementWithId(T) || (Ge("Can not create edge `" + g + "` with nonexistent " + x + " `" + T + "`"), E = !0);
      }
      if (E) {
        c();
        continue;
      }
      var k = a.getElementById(y.source), B = a.getElementById(y.target);
      k.same(B) ? k._private.edges.push(m) : (k._private.edges.push(m), B._private.edges.push(m)), m._private.source = k, m._private.target = B;
    }
    d.map = new Ur(), d.map.set(g, {
      ele: h,
      index: 0
    }), d.removed = !1, e && a.addToPool(h);
  }
  for (var D = 0; D < i.length; D++) {
    var P = i[D], A = P._private.data;
    ae(A.parent) && (A.parent = "" + A.parent);
    var R = A.parent, L = R != null;
    if (L || P._private.parent) {
      var I = P._private.parent ? a.collection().merge(P._private.parent) : a.getElementById(R);
      if (I.empty())
        A.parent = void 0;
      else if (I[0].removed())
        Ne("Node added with missing parent, reference to parent removed"), A.parent = void 0, P._private.parent = null;
      else {
        for (var M = !1, N = I; !N.empty(); ) {
          if (P.same(N)) {
            M = !0, A.parent = void 0;
            break;
          }
  ...
  if (o.length > 0) {
    for (var F = o.length === t.length ? t : new ur(a, o), _ = 0; _ < F.length; _++) {
      var z = F[_];
...
qe.remove = function() {
  ...
  function s(R) {
    for (var L = R._private.edges, I = 0; I < L.length; I++)
      u(L[I]);
  }
  function o(R) {
    for (var L = R._private.children, I = 0; I < L.length; I++)
      u(L[I]);
  }
  function u(R) {
    var L = n[R.id()];
  ...
  for (var l = 0, v = t.length; l < v; l++) {
    var f = t[l];
    u(f);
  }
  function c(R, L) {
    var I = R._private.edges;
    ot(I, L), R.clearTraversalCache();
  }
  function h(R) {
  ...
  function y(R, L) {
    L = L[0], R = R[0];
    var I = R._private.children, M = R.id();
    ot(I, L), L._private.parent = null, d.ids[M] || (d.ids[M] = !0, d.push(R));
  }
...
[Bv, Bg, ln, nt, Qt, Wg, qn, op, jv, ef, cp, Tn, vn, or, it, cr].forEach(function(r) {
  me(qe, r);
});
var bp = {
  add: function(e) {
    ...
    if (Tr(e)) {
      ...
      var u = e;
      t = new ur(a, u);
    } else if (Me(e) && (Fe(e.nodes) || Fe(e.edges))) {
      for (var l = e, v = [], f = ["nodes", "edges"], c = 0, h = f.length; c < h; c++) {
        var d = f[c], y = l[d];
        if (Fe(y))
...
function wp(r, e, t, a) {
  var n = 4, i = 1e-3, s = 1e-7, o = 10, u = 11, l = 1 / (u - 1), v = typeof Float32Array < "u";
  ...
  var c = v ? new Float32Array(u) : new Array(u);
  function h(B, D) {
    return 1 - 3 * D + 3 * B;
  }
  function d(B, D) {
  ...
  function g(B, D, P) {
    return ((h(D, P) * B + d(D, P)) * B + y(D)) * B;
  }
  function p(B, D, P) {
    return 3 * h(D, P) * B * B + 2 * d(D, P) * B + y(D);
  }
  function m(B, D) {
    for (var P = 0; P < n; ++P) {
      var A = p(D, r, t);
  ...
  function w(B, D, P) {
    var A, R, L = 0;
    do
      R = D + (P - D) / 2, A = g(R, r, t) - B, A > 0 ? P = R : D = R;
    while (Math.abs(A) > s && ++L < o);
    return R;
  }
  function E(B) {
    for (var D = 0, P = 1, A = u - 1; P !== A && c[P] <= B; ++P)
      D += l;
    --P;
    var R = (B - c[P]) / (c[P + 1] - c[P]), L = D + R * l, I = p(L, r, t);
    return I >= i ? m(B, L) : I === 0 ? L : w(B, D, D + l);
  }
  var C = !1;
  function x() {
    C = !0, (r !== e || t !== a) && b();
...
var xp = /* @__PURE__ */ (function() {
  ...
  function t(a, n) {
    var i = {
      dx: a.v,
      dv: r(a)
    }, s = e(a, n * 0.5, i), o = e(a, n * 0.5, s), u = e(a, n, o), l = 1 / 6 * (i.dx + 2 * (s.dx + o.dx) + u.dx), v = 1 / 6 * (i.dv + 2 * (s.dv + o.dv) + u.dv);
    return a.x = a.x + l * n, a.v = a.v + v * n, a;
  }
  return function a(n, i, s) {
    var o = {
      ...
      tension: null,
      friction: null
    }, u = [0], l = 0, v = 1 / 1e4, f = 16 / 1e3, c, h, d;
    for (n = parseFloat(n) || 500, i = parseFloat(i) || 20, s = s || null, o.tension = n, o.friction = i, c = s !== null, c ? (l = a(n, i), h = l / s * f) : h = f; d = t(d || o, h), u.push(1 + d.x), l += 16, Math.abs(d.x) > v && Math.abs(d.v) > v; )
      ;
    return c ? function(y) {
  ...
  // sine
  "ease-in-sine": Ve(0.47, 0, 0.745, 0.715),
  "ease-out-sine": Ve(0.39, 0.575, 0.565, 1),
  "ease-in-out-sine": Ve(0.445, 0.05, 0.55, 0.95),
  // quad
  "ease-in-quad": Ve(0.55, 0.085, 0.68, 0.53),
  "ease-out-quad": Ve(0.25, 0.46, 0.45, 0.94),
  "ease-in-out-quad": Ve(0.455, 0.03, 0.515, 0.955),
  // cubic
  "ease-in-cubic": Ve(0.55, 0.055, 0.675, 0.19),
  "ease-out-cubic": Ve(0.215, 0.61, 0.355, 1),
  "ease-in-out-cubic": Ve(0.645, 0.045, 0.355, 1),
  // quart
  "ease-in-quart": Ve(0.895, 0.03, 0.685, 0.22),
  "ease-out-quart": Ve(0.165, 0.84, 0.44, 1),
  "ease-in-out-quart": Ve(0.77, 0, 0.175, 1),
  // quint
  "ease-in-quint": Ve(0.755, 0.05, 0.855, 0.06),
  "ease-out-quint": Ve(0.23, 1, 0.32, 1),
  "ease-in-out-quint": Ve(0.86, 0, 0.07, 1),
  // expo
  "ease-in-expo": Ve(0.95, 0.05, 0.795, 0.035),
  "ease-out-expo": Ve(0.19, 1, 0.22, 1),
  "ease-in-out-expo": Ve(1, 0, 0, 1),
  // circ
  "ease-in-circ": Ve(0.6, 0.04, 0.98, 0.335),
  "ease-out-circ": Ve(0.075, 0.82, 0.165, 1),
  "ease-in-out-circ": Ve(0.785, 0.135, 0.15, 0.86),
  // user param easings...
...
function Ep(r, e, t, a) {
  var n = !a, i = r._private, s = e._private, o = s.easing, u = s.startTime, l = a ? r : r.cy(), v = l.style();
  if (!s.easingImpl)
    if (o == null)
      ...
      if (he(o)) {
        ...
        f = o;
      var h, d;
      he(f) ? (h = f, d = []) : (h = f[1], d = f.slice(2).map(function(F) {
        return +F;
  ...
  if (s.duration === 0 ? g = 1 : g = (t - u) / s.duration, s.applying && (g = s.progress), g < 0 ? g = 0 : g > 1 && (g = 1), s.delay == null) {
    ...
    if (m && n && !r.locked()) {
      var b = {};
      da(p.x, m.x) && (b.x = Ot(p.x, m.x, g, y)), da(p.y, m.y) && (b.y = Ot(p.y, m.y, g, y)), r.position(b);
    }
    var w = s.startPan, E = s.pan, C = i.pan, x = E != null && a;
    x && (da(w.x, E.x) && (C.x = Ot(w.x, E.x, g, y)), da(w.y, E.y) && (C.y = Ot(w.y, E.y, g, y)), r.emit("pan"));
    var T = s.startZoom, k = s.zoom, B = k != null && a;
    B && (da(T, k) && (i.zoom = ka(i.minZoom, Ot(T, k, g, y), i.maxZoom)), r.emit("zoom")), (x || B) && r.emit("viewport");
    var D = s.style;
    if (D && D.length > 0 && n) {
      for (var P = 0; P < D.length; P++) {
        var A = D[P], R = A.name, L = A, I = s.startStyle[R], M = v.properties[I.name], N = Ot(I, L, g, y, M);
        v.overrideBypass(r, R, N);
      }
      r.emit("style");
    }
  }
...
function El(r, e) {
  ...
  function n(v, f) {
    var c = v._private, h = c.animation.current, d = c.animation.queue, y = !1;
    if (h.length === 0) {
      var g = d.shift();
      g && h.push(g);
    }
    for (var p = function(C) {
      ...
      !w.playing && !w.applying || (w.playing && w.applying && (w.applying = !1), w.started || Cp(v, b, r), Ep(v, b, r, f), w.applying && (w.applying = !1), p(w.frames), w.step != null && w.step(r), b.completed() && (h.splice(m, 1), w.hooked = !1, w.playing = !1, w.started = !1, p(w.completes)), y = !0);
    }
...
var Tp = {
  ...
  startAnimationLoop: function() {
    ...
    if (e._private.animationsRunning = !0, !e.styleEnabled())
      return;
    function t() {
      e._private.animationsRunning && bn(function(i) {
        El(i, e), t();
      });
    }
    var a = e.renderer();
  ...
  createEmitter: function() {
    var e = this._private;
    return e.emitter || (e.emitter = new _n(Sp, this)), this;
  },
  emitter: function() {
    return this._private.emitter;
  },
  on: function(e, t, a) {
    return this.emitter().on(e, rn(t), a), this;
  },
  removeListener: function(e, t, a) {
    return this.emitter().removeListener(e, rn(t), a), this;
  },
  removeAllListeners: function() {
    return this.emitter().removeAllListeners(), this;
  },
  one: function(e, t, a) {
    return this.emitter().one(e, rn(t), a), this;
  },
  once: function(e, t, a) {
    return this.emitter().one(e, rn(t), a), this;
  },
...
var cn = {
  layout: function(e) {
    ...
    var i;
    he(e.eles) ? i = t.$(e.eles) : i = e.eles != null ? e.eles : t.$();
    var s = new n(me({}, e, {
      cy: t,
      eles: i
    }));
...
zs.invalidateDimensions = zs.resize;
var dn = {
  // get a collection
  ...
  collection: function(e, t) {
    return he(e) ? this.$(e) : Tr(e) ? e.collection() : Fe(e) ? (t || (t = {}), new ur(this, e, t.unique, t.removed)) : new ur(this);
  },
  nodes: function(e) {
...
sr.getPropertiesDiff = function(r, e) {
  var t = this, a = t._private.propDiffs = t._private.propDiffs || {}, n = r + "-" + e, i = a[n];
  if (i)
    return i;
  for (var s = [], o = {}, u = 0; u < t.length; u++) {
    var l = t[u], v = r[u] === wa, f = e[u] === wa, c = v !== f, h = l.mappedProperties.length > 0;
    if (c || f && h) {
      var d = void 0;
      c && h || c ? d = l.properties : h && (d = l.mappedProperties);
...
sr.applyContextStyle = function(r, e, t) {
  for (var a = this, n = r.diffPropNames, i = {}, s = a.types, o = 0; o < n.length; o++) {
    var u = n[o], l = e[u], v = t.pstyle(u);
    if (!l)
      if (v)
        v.bypass ? l = {
          name: u,
    ...
    if (v !== l) {
      if (l.mapped === s.fn && v != null && v.mapping != null && v.mapping.value === l.value) {
        var f = v.mapping, c = f.fnValue = l.value(t);
        if (c === f.prevFnValue)
          continue;
      }
      var h = i[u] = {
...
sr.updateStyleHints = function(r) {
  var e = r._private, t = this, a = t.propertyGroupNames, n = t.propertyGroupKeys, i = function($, K, te) {
    return t.getPropertiesHash($, K, te);
  }, s = e.styleKey;
  if (r.removed())
    return !1;
  ...
  for (var f = function($, K) {
    return e.styleKeys[K][0] = Ca($, e.styleKeys[K][0]);
  }, c = function($, K) {
    return e.styleKeys[K][1] = Ta($, e.styleKeys[K][1]);
  }, h = function($, K) {
    f($, K), c($, K);
  }, d = function($, K) {
    for (var te = 0; te < $.length; te++) {
      var ve = $.charCodeAt(te);
      f(ve, K), c(ve, K);
    }
  }, y = 2e9, g = function($) {
    return -128 < $ && $ < 128 && Math.floor($) !== $ ? y - ($ * 1024 | 0) : $;
  }, p = 0; p < a.length; p++) {
    var m = a[p], b = u[m];
    if (b != null) {
      ...
      var T = w.enums == null ? b.value : null, k = x != null, B = T != null, D = k || B, P = b.units;
  ...
  for (var R = [Et, _t], L = 0; L < n.length; L++) {
    var I = n[L], M = e.styleKeys[I];
    R[0] = Ca(M[0], R[0]), R[1] = Ta(M[1], R[1]);
  }
  e.styleKey = Gc(R[0], R[1]);
  var N = e.styleKeys;
  e.labelDimsKey = Jr(N.labelDimensions);
  var F = i(r, ["label"], N.labelDimensions);
  if (e.labelKey = Jr(F), e.labelStyleKey = Jr(Ka(N.commonLabel, F)), !o) {
    var _ = i(r, ["source-label"], N.labelDimensions);
    e.sourceLabelKey = Jr(_), e.sourceLabelStyleKey = Jr(Ka(N.commonLabel, _));
    var z = i(r, ["target-label"], N.labelDimensions);
    e.targetLabelKey = Jr(z), e.targetLabelStyleKey = Jr(Ka(N.commonLabel, z));
  }
  if (o) {
    var q = e.styleKeys, Z = q.nodeBody, Q = q.nodeBorder, X = q.nodeOutline, J = q.backgroundImage, j = q.compound, ne = q.pie, Y = q.stripe, V = [Z, Q, X, J, j, ne, Y].filter(function(H) {
      return H != null;
    }).reduce(Ka, [Et, _t]);
    e.nodeKey = Jr(V), e.hasPie = ne != null && ne[0] !== Et && ne[1] !== _t, e.hasStripe = Y != null && Y[0] !== Et && Y[1] !== _t;
  }
  return s !== e.styleKey;
};
sr.clearStyleHints = function(r) {
  var e = r._private;
...
sr.applyParsedProperty = function(r, e) {
  var t = this, a = e, n = r._private.style, i, s = t.types, o = t.properties[a.name].type, u = a.bypass, l = n[a.name], v = l && l.bypass, f = r._private, c = "mapping", h = function(Z) {
    return Z == null ? null : Z.pfValue != null ? Z.pfValue : Z.value;
  }, d = function() {
    var Z = h(l), Q = h(a);
    t.checkTriggers(r, a.name, Z, Q);
  };
  ...
  var y = function() {
    Ne("Do not assign mappings to elements without corresponding data (i.e. ele `" + r.id() + "` has no mapping for property `" + a.name + "` with data field `" + a.field + "`); try a `[" + a.field + "]` selector to limit scope to elements with `" + a.field + "` defined");
  };
  switch (a.mapped) {
    ...
    case s.mapData: {
      ...
      if (ae(p)) {
        ...
        return Ne("Do not use continuous mappers without specifying numeric data (i.e. `" + a.field + ": " + p + "` for `" + r.id() + "` is non-numeric)"), !1;
      if (w < 0 ? w = 0 : w > 1 && (w = 1), o.color) {
        var C = a.valueMin[0], x = a.valueMax[0], T = a.valueMin[1], k = a.valueMax[1], B = a.valueMin[2], D = a.valueMax[2], P = a.valueMin[3] == null ? 1 : a.valueMin[3], A = a.valueMax[3] == null ? 1 : a.valueMax[3], R = [Math.round(C + (x - C) * w), Math.round(T + (k - T) * w), Math.round(B + (D - B) * w), Math.round(P + (A - P) * w)];
        i = {
    ...
    // direct mapping
    case s.data: {
      for (var I = a.field.split("."), M = f.data, N = 0; N < I.length && M; N++) {
        var F = I[N];
        M = M[F];
      }
    ...
    case s.fn: {
      var _ = a.value, z = a.fnValue != null ? a.fnValue : _(r);
      if (a.prevFnValue = z, z == null)
        return Ne("Custom function mappers may not return null (i.e. `" + a.name + "` for ele `" + r.id() + "` is null)"), !1;
      if (i = this.parse(a.name, z, a.bypass, c), !i)
        return Ne("Custom function mappers may not return invalid values for the property type (i.e. `" + a.name + "` for ele `" + r.id() + "` is invalid)"), !1;
      i.mapping = _r(a), a = i;
      break;
    }
    case void 0:
  ...
  return u ? (v ? a.bypassed = l.bypassed : a.bypassed = l, n[a.name] = a) : v ? l.bypassed = a : n[a.name] = a, d(), !0;
};
sr.cleanElements = function(r, e) {
...
sr.updateTransitions = function(r, e) {
  ...
  if (n.length > 0 && i > 0) {
    for (var o = {}, u = !1, l = 0; l < n.length; l++) {
      var v = n[l], f = r.pstyle(v), c = e[v];
      if (c) {
        var h = c.prev, d = h, y = c.next != null ? c.next : f, g = !1, p = void 0, m = 1e-6;
        d && (ae(d.pfValue) && ae(y.pfValue) ? (g = y.pfValue - d.pfValue, p = d.pfValue + m * g) : ae(d.value) && ae(y.value) ? (g = y.value - d.value, p = d.value + m * g) : Fe(d.value) && Fe(y.value) && (g = d.value[0] !== y.value[0] || d.value[1] !== y.value[1] || d.value[2] !== y.value[2], p = d.strValue), g && (o[v] = y.strValue, this.applyBypass(r, v, p), u = !0));
      }
    }
    if (!u)
      return;
...
sr.checkZOrderTrigger = function(r, e, t, a) {
  var n = this;
...
sr.checkBoundsTrigger = function(r, e, t, a) {
...
sr.checkConnectedEdgesBoundsTrigger = function(r, e, t, a) {
  this.checkTrigger(r, e, t, a, function(n) {
...
sr.checkParallelEdgesBoundsTrigger = function(r, e, t, a) {
  this.checkTrigger(r, e, t, a, function(n) {
...
sr.checkTriggers = function(r, e, t, a) {
...
_a.applyBypass = function(r, e, t, a) {
  ...
  if (e === "*" || e === "**") {
    if (t !== void 0)
      for (var o = 0; o < n.properties.length; o++) {
        var u = n.properties[o], l = u.name, v = this.parse(l, t, !0);
        v && i.push(v);
      }
  } else if (he(e)) {
  ...
  for (var m = !1, b = 0; b < r.length; b++) {
    for (var w = r[b], E = {}, C = void 0, x = 0; x < i.length; x++) {
      ...
      m = this.applyParsedProperty(w, _r(T)) || m, a && (C.next = w.pstyle(T.name));
    }
...
_a.removeBypasses = function(r, e, t) {
  for (var a = !0, n = 0; n < r.length; n++) {
    for (var i = r[n], s = {}, o = 0; o < e.length; o++) {
      var u = e[o], l = this.properties[u], v = i.pstyle(l.name);
      if (!(!v || !v.bypass)) {
        var f = "", c = this.parse(u, f, !0), h = s[l.name] = {
          prev: v
        };
...
Gr.getRawStyle = function(r, e) {
  ...
  if (r = r[0], r) {
    for (var a = {}, n = 0; n < t.properties.length; n++) {
      ...
      s != null && (a[i.name] = s, a[Rn(i.name)] = s);
    }
    return a;
  }
};
    ...
    if (s) {
      ...
      if (t && i.number && o != null && ae(o)) {
        var v = r.cy().zoom(), f = function(g) {
          ...
          return f(g) + p;
        }, h = Fe(o), d = h ? u.every(function(y) {
          return y != null;
        }) : u != null;
        return d ? h ? o.map(function(y, g) {
          return c(y, u[g]);
        }).join(" ") : c(o, u) : h ? o.map(function(y) {
          return he(y) ? y : "" + f(y);
        }).join(" ") : "" + f(o);
      } else if (l != null)
        return l;
...
Gr.getPropsList = function(r) {
  ...
  if (a)
    for (var i = Object.keys(a), s = 0; s < i.length; s++) {
      var o = i[s], u = a[o], l = n[o] || n[Ys(o)], v = this.parse(l.name, u);
      v && t.push(v);
    }
  return t;
};
    ...
    if (n = e[u], i = r.pstyle(n, !1), i != null)
      if (i.pfValue != null)
        ...
        for (s = i.strValue, l = 0; l < s.length; l++)
          o = s.charCodeAt(l), a[0] = Ca(o, a[0]), a[1] = Ta(o, a[1]);
  return a;
};
Gr.getPropertiesHash = Gr.getNonDefaultPropertiesHash;
var Wn = {};
Wn.appendFromJson = function(r) {
...
var fo = {};
fo.appendFromString = function(r) {
  ...
  for (; ; ) {
    ...
    if (f !== "core") {
      var c = new lt(f);
      if (c.invalid) {
        Ne("Skipping parsing of block: Invalid selector found in string stylesheet: " + f), o();
        continue;
      }
    }
    var h = v[2], d = !1;
    ...
    for (var y = []; ; ) {
      ...
      if (!p) {
        Ne("Skipping parsing of block: Invalid formatting of style property and value definitions found in:" + h), d = !0;
        break;
      }
      s = p[0];
...
fo.fromString = function(r) {
  var e = this;
  return e.resetToDefault(), e.appendFromString(r), e;
};
var Ke = {};
(function() {
  var r = Je, e = wc, t = Ec, a = Cc, n = Tc, i = function(H) {
    return "^" + H + "\\s*\\(\\s*([\\w\\.]+)\\s*\\)$";
  }, s = function(H) {
    var $ = r + "|\\w+|" + e + "|" + t + "|" + a + "|" + n;
    return "^" + H + "\\s*\\(([\\w\\.]+)\\s*\\,\\s*(" + r + ")\\s*\\,\\s*(" + r + ")\\s*,\\s*(" + $ + ")\\s*\\,\\s*(" + $ + ")\\)$";
  }, o = [`^url\\s*\\(\\s*['"]?(.+?)['"]?\\s*\\)$`, "^(none)$", "^(.+)$"];
  Ke.types = {
    time: {
      number: !0,
    ...
    edgeEndpoint: {
      ...
      validate: function(H, $) {
        switch (H.length) {
          case 2:
            return $[0] !== "deg" && $[0] !== "rad" && $[1] !== "deg" && $[1] !== "rad";
          case 1:
            return he(H[0]) || $[0] === "deg" || $[0] === "rad";
          default:
            return !1;
        }
      }
  ...
  var u = {
    zeroNonZero: function(H, $) {
      return (H == null || $ == null) && H !== $ || H == 0 && $ != 0 ? !0 : H != 0 && $ == 0;
    },
    any: function(H, $) {
      return H != $;
    },
    emptyNonEmpty: function(H, $) {
      var K = st(H), te = st($);
      return K && !te || !K && te;
    }
  }, l = Ke.types, v = [{
    ...
    triggersBoundsOfParallelEdges: function(H, $, K) {
      return H === $ ? !1 : K.pstyle("curve-style").value === "bezier";
    }
  }, {
    name: "visibility",
    type: l.visibility,
    ...
    return $.value === "label" ? -H.poolIndex() : $.pfValue;
  }, E = [{
    name: "height",
    type: l.nodeSize,
    triggersBounds: u.any,
    ...
    type: l.curveStyle,
    triggersBounds: u.any,
    triggersBoundsOfParallelEdges: function(H, $) {
      return H === $ ? !1 : H === "bezier" || // remove from bundle
      $ === "bezier";
    }
  }, {
  ...
  for (var R = 1; R <= Ke.pieBackgroundN; R++)
    A.push({
  ...
  var L = [];
  Ke.stripeBackgroundN = 16, L.push({
    name: "stripe-size",
    type: l.sizeMaybePercent
  }), L.push({
  ...
  for (var I = 1; I <= Ke.stripeBackgroundN; I++)
    L.push({
  ...
  var M = [], N = Ke.arrowPrefixes = ["source", "mid-source", "target", "mid-target"];
  [{
    name: "arrow-shape",
    type: l.arrowShape,
    triggersBounds: u.any
    ...
    N.forEach(function(H) {
      var $ = H + "-" + V.name, K = V.type, te = V.triggersBounds;
      M.push({
        name: $,
        type: K,
        triggersBounds: te
  ...
  var F = Ke.properties = [].concat(y, b, g, p, m, D, d, h, v, f, c, E, C, x, T, A, L, k, B, M, P), _ = Ke.propertyGroups = {
    // common to all eles
    behavior: y,
    transition: b,
    visibility: g,
    ...
    edgeArrow: M,
    core: P
  }, z = Ke.propertyGroupNames = {}, q = Ke.propertyGroupKeys = Object.keys(_);
  q.forEach(function(V) {
    z[V] = _[V].map(function(H) {
      return H.name;
    }), _[V].forEach(function(H) {
      return H.groupKey = V;
    });
  });
  var Z = Ke.aliases = [{
  ...
  Ke.propertyNames = F.map(function(V) {
    return V.name;
  });
...
Ke.getDefaultProperty = function(r) {
  return this.getDefaultProperties()[r];
};
Ke.getDefaultProperties = function() {
  var r = this._private;
  ...
  for (var e = me({
    ...
    for (var v = 1; v <= Ke.pieBackgroundN; v++) {
      var f = l.name.replace("{{i}}", v), c = l.value;
      u[f] = c;
    }
    return u;
  }, {}), {
    ...
    for (var v = 1; v <= Ke.stripeBackgroundN; v++) {
      var f = l.name.replace("{{i}}", v), c = l.value;
      u[f] = c;
    }
    return u;
    ...
    return Ke.arrowPrefixes.forEach(function(v) {
      var f = v + "-" + l.name, c = l.value;
      u[f] = c;
    }), u;
...
Ke.addDefaultStylesheet = function() {
...
var $n = {};
$n.parse = function(r, e, t, a) {
  var n = this;
  if (He(e))
    return n.parseImplWarn(r, e, t, a);
  var i = a === "mapping" || a === !0 || a === !1 || a == null ? "dontcare" : a, s = t ? "t" : "f", o = "" + e, u = cv(r, o, s, i), l = n.propCache = n.propCache || [], v;
  return (v = l[u]) || (v = l[u] = n.parseImplWarn(r, e, t, a)), (t || a === "mapping") && (v = _r(v), v && (v.value = _r(v.value))), v;
};
$n.parseImplWarn = function(r, e, t, a) {
  var n = this.parseImpl(r, e, t, a);
  return !n && e != null && Ne("The style property `".concat(r, ": ").concat(e, "` is invalid")), n && (n.name === "width" || n.name === "height") && e === "label" && Ne("The style value of `label` is deprecated for `" + n.name + "`"), n;
};
$n.parseImpl = function(r, e, t, a) {
  var n = this;
  r = Ys(r);
  ...
  if (!(!u || a || e.length < 7 || e[1] !== "a")) {
    if (e.length >= 7 && e[0] === "d" && (v = new RegExp(o.data.regex).exec(e))) {
      ...
      if (d.pfValue === y.pfValue || d.strValue === y.strValue)
        return Ne("`" + r + ": " + e + "` is not a valid mapper because the output range is zero; converting to `" + r + ": " + d.strValue + "`"), this.parse(r, d.strValue);
      if (l.color) {
  ...
  if (l.multiple && a !== "multiple") {
    var b;
    if (u ? b = e.split(/\s+/) : Fe(e) ? b = e : b = [e], l.evenMultiple && b.length % 2 !== 0)
      return null;
    for (var w = [], E = [], C = [], x = "", T = !1, k = 0; k < b.length; k++) {
      var B = n.parse(r, b[k], t, "multiple");
      T = T || he(B.value), w.push(B.value), C.push(B.pfValue != null ? B.pfValue : B.value), E.push(B.units), x += (k > 0 ? " " : "") + B.strValue;
    }
    return l.validate && !l.validate(w, E) ? null : l.singleEnum && T ? w.length === 1 && he(w[0]) ? {
      name: r,
      value: w[0],
      strValue: w[0],
      bypass: t
  ...
  var D = function() {
    for (var Y = 0; Y < l.enums.length; Y++) {
      var V = l.enums[Y];
      if (V === e)
        return {
          name: r,
  ...
  if (l.number) {
    var P, A = "px";
    if (l.units && (P = l.units), l.implicitUnits && (A = l.implicitUnits), !l.unitless)
      if (u) {
        var R = "px|em" + (l.allowPercent ? "|\\%" : "");
        P && (R = P);
        var L = e.match("^(" + Je + ")(" + R + ")?$");
        L && (e = L[1], P = L[2] || A);
      } else (!P || l.implicitUnits) && (P = A);
    if (e = parseFloat(e), isNaN(e) && l.enums === void 0)
      return null;
    if (isNaN(e) && l.enums !== void 0)
      return e = s, D();
    if (l.integer && !ev(e) || l.min !== void 0 && (e < l.min || l.strictMin && e === l.min) || l.max !== void 0 && (e > l.max || l.strictMax && e === l.max))
      return null;
    var I = {
      name: r,
      value: e,
    ...
    return l.unitless || P !== "px" && P !== "em" ? I.pfValue = e : I.pfValue = P === "px" || !P ? e : this.getEmSizeInPixels() * e, (P === "ms" || P === "s") && (I.pfValue = P === "ms" ? e : 1e3 * e), (P === "deg" || P === "rad") && (I.pfValue = P === "rad" ? e : Td(e)), P === "%" && (I.pfValue = e / 100), I;
  } else if (l.propList) {
    var M = [], N = "" + e;
    if (N !== "none") {
      for (var F = N.split(/\s*,\s*|\s+/), _ = 0; _ < F.length; _++) {
        var z = F[_].trim();
        n.properties[z] ? M.push(z) : Ne("`" + z + "` is not a valid property name");
      }
      if (M.length === 0)
        return null;
    }
    ...
    for (var Q = l.regexes ? l.regexes : [l.regex], X = 0; X < Q.length; X++) {
      var J = new RegExp(Q[X]), j = J.exec(e);
      if (j)
        return {
          name: r,
...
dr.resetToDefault = function() {
  return this.clear(), this.addDefaultStylesheet(), this;
};
dr.core = function(r) {
  return this._private.coreStyle[r] || this.getDefaultProperty(r);
};
dr.selector = function(r) {
  var e = r === "core" ? null : new lt(r), t = this.length++;
  return this[t] = {
    selector: e,
    properties: [],
    mappedProperties: [],
...
dr.css = function() {
  ...
  if (e.length === 1)
    for (var t = e[0], a = 0; a < r.properties.length; a++) {
      ...
      i === void 0 && (i = t[Rn(n.name)]), i !== void 0 && this.cssRule(n.name, i);
    }
  else e.length === 2 && this.cssRule(e[0], e[1]);
  return this;
};
dr.style = dr.css;
dr.cssRule = function(r, e) {
...
dr.append = function(r) {
  return tv(r) ? r.appendToStyle(this) : Fe(r) ? this.appendFromJson(r) : he(r) && this.appendFromString(r), this;
};
ir.fromJson = function(r, e) {
  var t = new ir(r);
  return t.fromJson(e), t;
};
ir.fromString = function(r, e) {
  return new ir(r).fromString(e);
};
[sr, _a, vo, Gr, Wn, fo, Ke, $n].forEach(function(r) {
  me(dr, r);
});
ir.types = dr.types;
ir.properties = dr.properties;
ir.propertyGroups = dr.propertyGroups;
ir.propertyGroupNames = dr.propertyGroupNames;
ir.propertyGroupKeys = dr.propertyGroupKeys;
var Pp = {
  style: function(e) {
    if (e) {
  ...
  setStyle: function(e) {
    var t = this._private;
    return tv(e) ? t.style = e.generateStyle(this) : Fe(e) ? t.style = ir.fromJson(this, e) : he(e) ? t.style = ir.fromString(this, e) : t.style = ir(this), t.style;
  },
  ...
  selectionType: function(e) {
    var t = this._private;
    if (t.selectionType == null && (t.selectionType = Ap), e !== void 0)
  ...
  panBy: function(e, t) {
    ...
    switch (a.length) {
      case 1:
        Me(e) && (o = a[0], u = o.x, l = o.y, ae(u) && (n.x += u), ae(l) && (n.y += l), this.emit("pan viewport"));
        break;
      case 2:
  ...
  getFitViewport: function(e, t) {
    if (ae(e) && t === void 0 && (t = e, e = void 0), !(!this._private.panningEnabled || !this._private.zoomingEnabled)) {
      ...
      } else Tr(e) || (e = this.mutableElements());
      if (!(Tr(e) && e.empty())) {
        a = a || e.boundingBox();
  ...
  getZoomedViewport: function(e) {
    ...
    if (t.zoomingEnabled || (o = !0), ae(e) ? s = e : Me(e) && (s = e.level, e.position != null ? i = In(e.position, n, a) : e.renderedPosition != null && (i = e.renderedPosition), i != null && !t.panningEnabled && (o = !0)), s = s > t.maxZoom ? t.maxZoom : s, s = s < t.minZoom ? t.minZoom : s, o || !ae(s) || s === n || i != null && (!ae(i.x) || !ae(i.y)))
      return null;
    if (i != null) {
      var u = a, l = n, v = s, f = {
        x: -v / l * (i.x - u.x) + i.x,
  ...
  viewport: function(e) {
    ...
    if (!e)
      return this;
    if (ae(e.zoom) || (a = !1), Me(e.pan) || (n = !1), !a && !n)
      return this;
    if (a) {
      var u = e.zoom;
...
Bt.centre = Bt.center;
Bt.autolockNodes = Bt.autolock;
Bt.autoungrabifyNodes = Bt.autoungrabify;
var Aa = {
  data: Oe.data({
    field: "data",
    bindingEvent: "data",
...
var Ra = function(e) {
  ...
  a && (a._cyreg = n), n.cy = t;
  var s = Qe !== void 0 && a !== void 0 && !e.headless, o = e;
  o.layout = me({
    name: s ? "grid" : "null"
  }, o.layout), o.renderer = me({
    name: s ? "canvas" : "null"
  }, o.renderer);
  var u = function(d, y, g) {
    ...
    pan: {
      x: Me(o.pan) && ae(o.pan.x) ? o.pan.x : 0,
      y: Me(o.pan) && ae(o.pan.y) ? o.pan.y : 0
    },
    animation: {
      // object for currently-running animations
      current: [],
  ...
  var f = me({}, o, o.renderer);
  t.initRenderer(f);
  var c = function(d, y, g) {
    t.notifications(!1);
    var p = t.mutableElements();
    p.length > 0 && p.remove(), d != null && (Me(d) || Fe(d)) && t.add(d), t.one("layoutready", function(b) {
      t.notifications(!0), t.emit(b), t.one("load", y), t.emitAndNotify("load");
    }).one("layoutstop", function() {
      t.one("done", g), t.emit("done");
    });
    var m = me({}, t._private.options.layout);
    m.eles = t.elements(), t.layout(m).run();
  };
  v([o.style, o.elements], function(h) {
    var d = h[0], y = h[1];
    l.styleEnabled && t.style().append(d), c(y, function() {
      t.startAnimationLoop(), l.ready = !0, He(o.ready) && t.on("ready", o.ready);
...
me(Sn, {
  ...
  window: function() {
    ...
    return t === void 0 || t == null ? Qe : t.defaultView || Qe;
  },
  mount: function(e) {
    if (e != null) {
      var t = this, a = t._private, n = a.options;
      return !mn(e) && mn(e[0]) && (e = e[0]), t.stopAnimationLoop(), t.destroyRenderer(), a.container = e, a.styleEnabled = !0, t.invalidateSize(), t.initRenderer(me({}, n, n.renderer, {
  ...
  json: function(e) {
    ...
    if (Me(e)) {
      if (t.startBatch(), e.elements) {
        var s = {}, o = function(w, E) {
          for (var C = [], x = [], T = 0; T < w.length; T++) {
            ...
            var B = "" + k.data.id, D = t.getElementById(B);
            s[B] = !0, D.length !== 0 ? x.push({
              ele: D,
              json: k
            }) : (E && (k.group = E), C.push(k));
          }
          t.add(C);
          for (var P = 0; P < x.length; P++) {
            var A = x[P], R = A.ele, L = A.json;
            R.json(L);
          }
        };
        if (Fe(e.elements))
      ...
      })), this._private.styleEnabled && (p.style = t.style().json()), p.data = _r(t.data());
      var m = a.options;
...
Sn.$id = Sn.getElementById;
[bp, Tp, af, Ns, cn, kp, zs, dn, Pp, Bt, Aa].forEach(function(r) {
  me(Sn, r);
});
var Rp = {
  fit: !0,
...
function nf(r) {
  this.options = me({}, Rp, Mp, r);
}
nf.prototype.run = function() {
  var r = this.options, e = r.cy, t = r.eles, a = t.nodes().filter(function(pe) {
    return pe.isChildless();
  }), n = t, i = r.directed, s = r.acyclic || r.maximal || r.maximalAdjustments > 0, o = !!r.boundingBox, u = yr(o ? r.boundingBox : structuredClone(e.extent())), l;
  if (Tr(r.roots))
    l = r.roots;
  else if (Fe(r.roots)) {
    for (var v = [], f = 0; f < r.roots.length; f++) {
      var c = r.roots[f], h = e.getElementById(c);
      v.push(h);
    }
    l = e.collection(v);
  } else if (he(r.roots))
    ...
    l = e.collection();
    for (var y = function() {
      var se = d[g], de = se.maxDegree(!1), ge = se.filter(function(Ee) {
  ...
  var p = [], m = {}, b = function(se, de) {
    ...
    var ge = Nt(se), Ee = ge.depth, be = ge.index;
    p[Ee][be] = null, se.isChildless() && b(se, de);
  };
  n.bfs({
    roots: l,
    directed: r.directed,
    visit: function(se, de, ge, Ee, be) {
      var Te = se[0], Be = Te.id();
      Te.isChildless() && b(Te, be), m[Be] = !0;
    }
  });
  ...
  var T = function(se) {
    for (var de = p[se], ge = 0; ge < de.length; ge++) {
      var Ee = de[ge];
      if (Ee == null) {
        de.splice(ge, 1), ge--;
        continue;
    ...
    for (var ge = Nt(se), Ee = se.incomers().filter(function(S) {
      return S.isNode() && t.has(S);
    }), be = -1, Te = se.id(), Be = 0; Be < Ee.length; Be++) {
      var Ae = Ee[Be], Le = Nt(Ae);
      be = Math.max(be, Le.depth);
    }
    if (ge.depth <= be) {
      if (!r.acyclic && de[Te])
        return null;
      var ee = be + 1;
      return w(se, ee), de[Te] = ee, !0;
    }
    return !1;
  };
  if (i && s) {
    var B = [], D = {}, P = function(se) {
      return B.push(se);
    }, A = function() {
      return B.shift();
    };
    for (a.forEach(function(pe) {
      return B.push(pe);
    }); B.length > 0; ) {
      var R = A(), L = k(R, D);
      if (L)
        R.outgoers().filter(function(pe) {
          return pe.isNode() && t.has(pe);
        }).forEach(P);
      else if (L === null) {
  ...
  if (r.avoidOverlap)
    for (var M = 0; M < a.length; M++) {
      var N = a[M], F = N.layoutDimensions(r), _ = F.w, z = F.h;
      I = Math.max(I, _, z);
    }
  var q = {}, Z = function(se) {
    if (q[se.id()])
      return q[se.id()];
    for (var de = Nt(se).depth, ge = se.neighborhood(), Ee = 0, be = 0, Te = 0; Te < ge.length; Te++) {
      var Be = ge[Te];
      if (!(Be.isEdge() || Be.isParent() || !a.has(Be))) {
        var Ae = Nt(Be);
        if (Ae != null) {
          var Le = Ae.index, ee = Ae.depth;
          if (!(Le == null || ee == null)) {
            var S = p[ee].length;
            ee < de && (Ee += Le / S, be++);
          }
    ...
    return be = Math.max(1, be), Ee = Ee / be, be === 0 && (Ee = 0), q[se.id()] = Ee, Ee;
  }, Q = function(se, de) {
    var ge = Z(se), Ee = Z(de), be = ge - Ee;
    return be === 0 ? nv(se.id(), de.id()) : be;
  };
  r.depthSort !== void 0 && (Q = r.depthSort);
  for (var X = p.length, J = 0; J < X; J++)
    p[J].sort(Q), T(J);
  for (var j = [], ne = 0; ne < E.length; ne++)
    j.push(E[ne]);
  var Y = function() {
    for (var se = 0; se < X; se++)
      T(se);
  };
  j.length && (p.unshift(j), X = p.length, Y());
  for (var V = 0, H = 0; H < X; H++)
    V = Math.max(p[H].length, V);
  var $ = {
    x: u.x1 + u.w / 2,
    y: u.y1 + u.h / 2
  }, K = a.reduce(function(pe, se) {
    return (function(de) {
      return {
        w: pe.w === -1 ? de.w : (pe.w + de.w) / 2,
        h: pe.h === -1 ? de.h : (pe.h + de.h) / 2
      };
    })(se.boundingBox({
    ...
    X === 1 ? 0 : (
      ...
      o ? (u.h - r.padding * 2 - K.h) / (X - 1) : (u.h - r.padding * 2 - K.h) / (X + 1)
    ),
    I
  ), ve = p.reduce(function(pe, se) {
    return Math.max(pe, se.length);
  }, 0), De = function(se) {
    var de = Nt(se), ge = de.depth, Ee = de.index;
    if (r.circle) {
      var be = Math.min(u.w / 2 / X, u.h / 2 / X);
      be = Math.max(be, I);
      var Te = be * ge + be - (X > 0 && p[0].length <= 3 ? be / 2 : 0), Be = 2 * Math.PI / p[ge].length * Ee;
      return ge === 0 && p[0].length === 1 && (Te = 1), {
        x: $.x + Te * Math.cos(Be),
        y: $.y + Te * Math.sin(Be)
      };
    } else {
      var Ae = p[ge].length, Le = Math.max(
        // only one depth
        Ae === 1 ? 0 : (
          // inside a bounding box, no need for left & right padding
          o ? (u.w - r.padding * 2 - K.w) / ((r.grid ? ve : Ae) - 1) : (u.w - r.padding * 2 - K.w) / ((r.grid ? ve : Ae) + 1)
        ),
        I
      ), ee = {
        x: $.x + (Ee + 1 - (Ae + 1) / 2) * Le,
  ...
  Object.keys(we).indexOf(r.direction) === -1 && Ge("Invalid direction '".concat(r.direction, "' specified for breadthfirst layout. Valid values are: ").concat(Object.keys(we).join(", ")));
  var ye = function(se) {
    return Uc(De(se), u, we[r.direction]);
  };
  return t.nodes().layoutPositions(this, r, ye), this;
};
var Lp = {
  fit: !0,
  // whether to fit the viewport to the graph
...
sf.prototype.run = function() {
  ...
  for (var s = yr(e.boundingBox ? e.boundingBox : {
    x1: 0,
    y1: 0,
    w: t.width(),
    h: t.height()
    ...
    x: s.x1 + s.w / 2,
    y: s.y1 + s.h / 2
  }, u = e.sweep === void 0 ? 2 * Math.PI - 2 * Math.PI / i.length : e.sweep, l = u / Math.max(1, i.length - 1), v, f = 0, c = 0; c < i.length; c++) {
    var h = i[c], d = h.layoutDimensions(e), y = d.w, g = d.h;
    f = Math.max(f, y, g);
  }
  if (ae(e.radius) ? v = e.radius : i.length <= 1 ? v = 0 : v = Math.min(s.h, s.w) / 2 - f, i.length > 1 && e.avoidOverlap) {
    f *= 1.75;
    var p = Math.cos(l) - Math.cos(0), m = Math.sin(l) - Math.sin(0), b = Math.sqrt(f * f / (p * p + m * m));
    v = Math.max(b, v);
  }
  var w = function(C, x) {
    var T = e.startAngle + x * l * (n ? 1 : -1), k = v * Math.cos(T), B = v * Math.sin(T), D = {
      x: o.x + k,
      y: o.y + B
    };
    return D;
...
function of(r) {
  this.options = me({}, Ip, r);
}
of.prototype.run = function() {
  for (var r = this.options, e = r, t = e.counterclockwise !== void 0 ? !e.counterclockwise : e.clockwise, a = r.cy, n = e.eles, i = n.nodes().not(":parent"), s = yr(e.boundingBox ? e.boundingBox : {
    x1: 0,
    y1: 0,
    w: a.width(),
    h: a.height()
    ...
    x: s.x1 + s.w / 2,
    y: s.y1 + s.h / 2
  }, u = [], l = 0, v = 0; v < i.length; v++) {
    var f = i[v], c = void 0;
    c = e.concentric(f), u.push({
      value: c,
      node: f
  ...
  u.sort(function(te, ve) {
    return ve.value - te.value;
  });
  ...
  if (!e.avoidOverlap) {
    var x = p.length > 0 && p[0].length > 1, T = Math.min(s.w, s.h) / 2 - C, k = T / (p.length + x ? 1 : 0);
    C = Math.min(C, k);
  }
  for (var B = 0, D = 0; D < p.length; D++) {
    var P = p[D], A = e.sweep === void 0 ? 2 * Math.PI - 2 * Math.PI / P.length : e.sweep, R = P.dTheta = A / Math.max(1, P.length - 1);
    if (P.length > 1 && e.avoidOverlap) {
      var L = Math.cos(R) - Math.cos(0), I = Math.sin(R) - Math.sin(0), M = Math.sqrt(C * C / (L * L + I * I));
      B = Math.max(M, B);
    }
    P.r = B, B += C;
  }
  if (e.equidistant) {
    for (var N = 0, F = 0, _ = 0; _ < p.length; _++) {
      var z = p[_], q = z.r - F;
      N = Math.max(N, q);
    }
    F = 0;
  ...
  for (var X = {}, J = 0; J < p.length; J++)
    for (var j = p[J], ne = j.dTheta, Y = j.r, V = 0; V < j.length; V++) {
      var H = j[V], $ = e.startAngle + (t ? 1 : -1) * ne * V, K = {
        x: o.x + Y * Math.cos($),
        y: o.y + Y * Math.sin($)
      };
      X[H.node.id()] = K;
...
function Un(r) {
  this.options = me({}, Op, r), this.options.layout = this;
...
Un.prototype.run = function() {
  ...
  var a = Np(e, t, r);
  ms && Fp(a), r.randomize && Vp(a);
  var n = Kr(), i = function() {
    qp(a, e, r), r.fit === !0 && e.fit(r.padding);
  }, s = function(c) {
    return !(t.stopped || c >= r.numIter || (_p(a, r), a.temperature = a.temperature * r.coolingFactor, a.temperature < r.minTemp));
  }, o = function() {
    if (r.animate === !0 || r.animate === !1)
      ...
      var c = r.eles.nodes(), h = lf(a, r, c);
      c.layoutPositions(t, r, h);
    }
  }, u = 0, l = !0;
  if (r.animate === !0) {
    var v = function() {
      for (var c = 0; l && c < r.refresh; )
        l = s(u), u++, c++;
      if (!l)
        Sl(a, r), o();
      else {
        var h = Kr();
        h - n >= r.animationThreshold && i(), bn(v);
      }
    };
    v();
  } else {
...
var Np = function(e, t, a) {
  for (var n = a.eles.edges(), i = a.eles.nodes(), s = yr(a.boundingBox ? a.boundingBox : {
    x1: 0,
    y1: 0,
    w: e.width(),
    h: e.height()
    ...
    clientHeight: s.h,
    boundingBox: s
  }, u = a.eles.components(), l = {}, v = 0; v < u.length; v++)
    for (var f = u[v], c = 0; c < f.length; c++) {
      var h = f[c];
      l[h.id()] = v;
    }
  for (var v = 0; v < o.nodeSize; v++) {
    var d = i[v], y = d.layoutDimensions(a), g = {};
    g.isLocked = d.locked(), g.id = d.data("id"), g.parentId = d.data("parent"), g.cmptId = l[d.id()], g.children = [], g.positionX = d.position("x"), g.positionY = d.position("y"), g.offsetX = 0, g.offsetY = 0, g.height = y.w, g.width = y.h, g.maxX = g.positionX + g.width / 2, g.minX = g.positionX - g.width / 2, g.maxY = g.positionY + g.height / 2, g.minY = g.positionY - g.height / 2, g.padLeft = parseFloat(d.style("padding")), g.padRight = parseFloat(d.style("padding")), g.padTop = parseFloat(d.style("padding")), g.padBottom = parseFloat(d.style("padding")), g.nodeRepulsion = He(a.nodeRepulsion) ? a.nodeRepulsion(d) : a.nodeRepulsion, o.layoutNodes.push(g), o.idToIndex[g.id] = v;
  }
  ...
  for (var v = 0; v < o.graphSet.length; v++)
    for (var k = o.graphSet[v], c = 0; c < k.length; c++) {
      var B = o.idToIndex[k[c]];
      o.indexToGraph[B] = v;
    }
  for (var v = 0; v < o.edgeSize; v++) {
    var D = n[v], P = {};
    P.id = D.data("id"), P.sourceId = D.data("source"), P.targetId = D.data("target");
    var A = He(a.idealEdgeLength) ? a.idealEdgeLength(D) : a.idealEdgeLength, R = He(a.edgeElasticity) ? a.edgeElasticity(D) : a.edgeElasticity, L = o.idToIndex[P.sourceId], I = o.idToIndex[P.targetId], M = o.indexToGraph[L], N = o.indexToGraph[I];
    if (M != N) {
      for (var F = zp(P.sourceId, P.targetId, o), _ = o.graphSet[F], z = 0, g = o.layoutNodes[L]; _.indexOf(g.id) === -1; )
        g = o.layoutNodes[o.idToIndex[g.parentId]], z++;
      for (g = o.layoutNodes[I]; _.indexOf(g.id) === -1; )
        g = o.layoutNodes[o.idToIndex[g.parentId]], z++;
      A *= z * a.nestingFactor;
    }
  ...
  for (var s = 0, o = 0; o < i.length; o++) {
    var u = i[o], l = n.idToIndex[u], v = n.layoutNodes[l].children;
    if (v.length !== 0) {
      var f = n.indexToGraph[n.idToIndex[v[0]]], c = uf(e, t, f, n);
      if (c.count !== 0)
        if (c.count === 1) {
          if (s++, s === 2)
            break;
  ...
  return t.boundingBox && (a.forEach(function(s) {
    ...
    if (t.boundingBox) {
      var l = i.w === 0 ? 0.5 : (u.positionX - i.x1) / i.w, v = i.h === 0 ? 0.5 : (u.positionY - i.y1) / i.h;
      return {
        x: n.x1 + l * n.w,
        y: n.y1 + v * n.h
      };
  ...
  if (!(i !== s && !a.isCompound)) {
    ...
    o === 0 && u === 0 && (o = Tl(l), u = Tl(l));
    var v = Wp(e, t, o, u);
    if (v > 0)
      var f = n.nodeOverlap * v, c = Math.sqrt(o * o + u * u), h = f * o / c, d = f * u / c;
    else
      var y = kn(e, o, u), g = kn(t, -1 * o, -1 * u), p = g.x - y.x, m = g.y - y.y, b = p * p + m * m, c = Math.sqrt(b), f = (e.nodeRepulsion + t.nodeRepulsion) / b, h = f * p / c, d = f * m / c;
  ...
  var n = e.positionX, i = e.positionY, s = e.height || 1, o = e.width || 1, u = a / t, l = s / o, v = {};
  return t === 0 && 0 < a || t === 0 && 0 > a ? (v.x = n, v.y = i + s / 2, v) : 0 < t && -1 * l <= u && u <= l ? (v.x = n + o / 2, v.y = i + o * a / 2 / t, v) : 0 > t && -1 * l <= u && u <= l ? (v.x = n - o / 2, v.y = i - o * a / 2 / t, v) : 0 < a && (u <= -1 * l || u >= l) ? (v.x = n + s * t / 2 / a, v.y = i + s / 2, v) : (0 > a && (u <= -1 * l || u >= l) && (v.x = n - s * t / 2 / a, v.y = i - s / 2), v);
}, $p = function(e, t) {
  for (var a = 0; a < e.edgeSize; a++) {
    var n = e.layoutEdges[a], i = e.idToIndex[n.sourceId], s = e.layoutNodes[i], o = e.idToIndex[n.targetId], u = e.layoutNodes[o], l = u.positionX - s.positionX, v = u.positionY - s.positionY;
    if (!(l === 0 && v === 0)) {
      var f = kn(s, l, v), c = kn(u, -1 * l, -1 * v), h = c.x - f.x, d = c.y - f.y, y = Math.sqrt(h * h + d * d), g = Math.pow(n.idealLength - y, 2) / n.elasticity;
      if (y !== 0)
        var p = g * h / y, m = g * d / y;
      else
        var p = 0, m = 0;
  ...
  if (t.gravity !== 0)
    for (var a = 1, n = 0; n < e.graphSet.length; n++) {
      ...
      if (n === 0)
        ...
        var l = e.layoutNodes[e.idToIndex[i[0]]], v = e.layoutNodes[e.idToIndex[l.parentId]], o = v.positionX, u = v.positionY;
      for (var f = 0; f < s; f++) {
        var c = e.layoutNodes[e.idToIndex[i[f]]];
        if (!c.isLocked) {
          var h = o - c.positionX, d = u - c.positionY, y = Math.sqrt(h * h + d * d);
          if (y > a) {
  ...
  for (a.push.apply(a, e.graphSet[0]), i += e.graphSet[0].length; n <= i; ) {
    ...
    if (0 < l.length && !u.isLocked) {
      for (var v = u.offsetX, f = u.offsetY, c = 0; c < l.length; c++) {
        var h = e.layoutNodes[e.idToIndex[l[c]]];
        h.offsetX += v, h.offsetY += f, a[++i] = l[c];
      }
  ...
  for (var a = 0; a < e.nodeSize; a++) {
    ...
    if (!(0 < n.children.length || n.isLocked)) {
      var i = Yp(n.offsetX, n.offsetY, e.temperature);
  ...
  for (var l = 0, i = 0; i < n.length; i++) {
    ...
    if (v) {
      ...
      v.w = v.x2 - v.x1, v.h = v.y2 - v.y1, l += v.w * v.h;
    }
  }
  n.sort(function(m, b) {
  ...
  for (var h = 0, d = 0, y = 0, g = 0, p = Math.sqrt(l) * e.clientWidth / e.clientHeight, i = 0; i < n.length; i++) {
    ...
    if (v) {
      ...
      h += v.w + t.componentSpacing, y += v.w + t.componentSpacing, g = Math.max(g, v.h), y > p && (d += g + t.componentSpacing, h = 0, y = 0, g = 0);
    }
  }
}, Zp = {
  fit: !0,
...
ff.prototype.run = function() {
  ...
  if (i.h === 0 || i.w === 0)
    ...
    var s = n.size(), o = Math.sqrt(s * i.h / i.w), u = Math.round(o), l = Math.round(i.w / i.h * o), v = function(Q) {
      if (Q == null)
        return Math.min(u, l);
      var X = Math.min(u, l);
      X == u ? u = Q : l = Q;
    ...
    if (e.condense && (m = 0, b = 0), e.avoidOverlap)
      for (var w = 0; w < n.length; w++) {
        ...
        var x = E.layoutDimensions(e), T = e.avoidOverlapPadding, k = x.w + T, B = x.h + T;
        m = Math.max(m, k), b = Math.max(b, B);
      }
    for (var D = {}, P = function(Q, X) {
      return !!D["c-" + Q + "-" + X];
    }, A = function(Q, X) {
      D["c-" + Q + "-" + X] = !0;
    }, R = 0, L = 0, I = function() {
    ...
    var q = function(Q, X) {
      ...
      var ne = M[Q.id()];
      if (ne)
        J = ne.col * m + m / 2 + i.x1, j = ne.row * b + b / 2 + i.y1;
      else {
        for (; P(R, L); )
          I();
        J = L * m + m / 2 + i.x1, j = R * b + b / 2 + i.y1, A(R, L), I();
      }
      return {
        x: J,
        y: j
...
function cf(r) {
  this.options = me({}, Jp, r);
}
cf.prototype.run = function() {
  var r = this.options, e = r.eles, t = e.nodes(), a = He(r.positions);
  function n(i) {
    if (r.positions == null)
      return md(i.position());
    if (a)
...
df.prototype.run = function() {
  var r = this.options, e = r.cy, t = r.eles, a = yr(r.boundingBox ? r.boundingBox : {
    x1: 0,
    y1: 0,
    w: e.width(),
    h: e.height()
...
var ho = {};
ho.arrowShapeWidth = 0.3;
ho.registerArrowShapes = function() {
  var r = this.arrowShapes = {}, e = this, t = function(l, v, f, c, h, d, y) {
    var g = h.x - f / 2 - y, p = h.x + f / 2 + y, m = h.y - f / 2 - y, b = h.y + f / 2 + y, w = g <= l && l <= p && m <= v && v <= b;
    return w;
  }, a = function(l, v, f, c, h) {
    var d = l * Math.cos(c) - v * Math.sin(c), y = l * Math.sin(c) + v * Math.cos(c), g = d * f, p = y * f, m = g + h.x, b = p + h.y;
    return {
      x: m,
      y: b
    };
    ...
    he(v) && (v = r[v]), r[l] = me({
      ...
      collide: function(c, h, d, y, g, p) {
        var m = i(n(this.points, d + 2 * p, y, g)), b = Er(c, h, m);
        return b;
      },
      roughCollide: t,
  ...
  o("none", {
    ...
    controlPoint: [0, -0.15],
    roughCollide: t,
    draw: function(l, v, f, c, h) {
      var d = n(this.points, v, f, c), y = this.controlPoint, g = a(y[0], y[1], v, f, c);
    ...
    collide: function(l, v, f, c, h, d, y) {
      var g = i(n(this.points, f + 2 * y, c, h)), p = i(n(this.pointsTee, f + 2 * y, c, h)), m = Er(l, v, g) || Er(l, v, p);
      return m;
    },
    draw: function(l, v, f, c, h) {
      var d = n(this.points, v, f, c), y = n(this.pointsTee, v, f, c);
    ...
    collide: function(l, v, f, c, h, d, y) {
      var g = h, p = Math.pow(g.x - l, 2) + Math.pow(g.y - v, 2) <= Math.pow((f + 2 * y) * this.radius, 2), m = i(n(this.points, f + 2 * y, c, h));
      return Er(l, v, m) || p;
    },
    draw: function(l, v, f, c, h) {
      var d = n(this.pointsTr, v, f, c);
      e.arrowShapeImpl(this.name)(l, d, c.x, c.y, this.radius * v);
    },
    spacing: function(l) {
    ...
    crossLinePts: function(l, v) {
      var f = this.baseCrossLinePts.slice(), c = v / l, h = 3, d = 5;
      return f[h] = f[h] - c, f[d] = f[d] - c, f;
    },
    collide: function(l, v, f, c, h, d, y) {
      var g = i(n(this.points, f + 2 * y, c, h)), p = i(n(this.crossLinePts(f, d), f + 2 * y, c, h)), m = Er(l, v, g) || Er(l, v, p);
      return m;
    },
    draw: function(l, v, f, c, h) {
      var d = n(this.points, v, f, c), y = n(this.crossLinePts(v, h), v, f, c);
      e.arrowShapeImpl(this.name)(l, d, y);
    }
  }), o("vee", {
    ...
    radius: 0.15,
    collide: function(l, v, f, c, h, d, y) {
      var g = h, p = Math.pow(g.x - l, 2) + Math.pow(g.y - v, 2) <= Math.pow((f + 2 * y) * this.radius, 2);
      return p;
    },
    draw: function(l, v, f, c, h) {
      e.arrowShapeImpl(this.name)(l, c.x, c.y, this.radius * v);
    },
    spacing: function(l) {
      return e.getArrowWidth(l.pstyle("width").pfValue, l.pstyle("arrow-scale").value) * this.radius;
    }
...
var At = {};
At.projectIntoViewport = function(r, e) {
  var t = this.cy, a = this.findContainerClientCoords(), n = a[0], i = a[1], s = a[4], o = t.pan(), u = t.zoom(), l = ((r - n) / s - o.x) / u, v = ((e - i) / s - o.y) / u;
  return [l, v];
};
At.findContainerClientCoords = function() {
  if (this.containerBB)
  ...
  }, s = r.clientWidth, o = r.clientHeight, u = n.left + n.right, l = n.top + n.bottom, v = i.left + i.right, f = e.width / (s + v), c = s - u, h = o - l, d = e.left + n.left + i.left, y = e.top + n.top + i.top;
  return this.containerBB = [d, y, c, h, f];
};
At.invalidateContainerClientCoordsCache = function() {
  this.containerBB = null;
};
At.findNearestElement = function(r, e, t, a) {
  return this.findNearestElements(r, e, t, a)[0];
};
At.findNearestElements = function(r, e, t, a) {
  var n = this, i = this, s = i.getCachedZSortedEles(), o = [], u = i.cy.zoom(), l = i.cy.hasCompoundNodes(), v = (a ? 24 : 8) / u, f = (a ? 8 : 2) / u, c = (a ? 8 : 2) / u, h = 1 / 0, d, y;
  t && (s = s.interactive);
  function g(x, T) {
    if (x.isNode()) {
      if (y)
  ...
  function p(x) {
    var T = x.outerWidth() + 2 * f, k = x.outerHeight() + 2 * f, B = T / 2, D = k / 2, P = x.position(), A = x.pstyle("corner-radius").value === "auto" ? "auto" : x.pstyle("corner-radius").pfValue, R = x._private.rscratch;
    if (P.x - B <= r && r <= P.x + B && P.y - D <= e && e <= P.y + D) {
      var L = i.nodeShapes[n.getNodeShape(x)];
      if (L.checkPoint(r, e, 0, T, k, P.x, P.y, A, R))
        return g(x, 0), !0;
    }
  }
  function m(x) {
    var T = x._private, k = T.rscratch, B = x.pstyle("width").pfValue, D = x.pstyle("arrow-scale").value, P = B / 2 + v, A = P * P, R = P * 2, N = T.source, F = T.target, L;
    if (k.edgeType === "segments" || k.edgeType === "straight" || k.edgeType === "haystack") {
      for (var I = k.allpts, M = 0; M + 3 < I.length; M += 2)
        if (Ld(r, e, I[M], I[M + 1], I[M + 2], I[M + 3], R) && A > (L = Fd(r, e, I[M], I[M + 1], I[M + 2], I[M + 3])))
          return g(x, L), !0;
      ...
      for (var I = k.allpts, M = 0; M + 5 < k.allpts.length; M += 4)
        if (Id(r, e, I[M], I[M + 1], I[M + 2], I[M + 3], I[M + 4], I[M + 5], R) && A > (L = zd(r, e, I[M], I[M + 1], I[M + 2], I[M + 3], I[M + 4], I[M + 5])))
          return g(x, L), !0;
    }
    for (var N = N || T.source, F = F || T.target, _ = n.getArrowWidth(B, D), z = [{
      name: "source",
      x: k.arrowStartX,
      y: k.arrowStartY,
      ...
      var q = z[M], Z = i.arrowShapes[x.pstyle(q.name + "-arrow-shape").value], Q = x.pstyle("width").pfValue;
      if (Z.roughCollide(r, e, _, q.angle, {
        x: q.x,
        y: q.y
      }, Q, v) && Z.collide(r, e, _, q.angle, {
        x: q.x,
        y: q.y
      }, Q, v))
        return g(x), !0;
    }
    l && o.length > 0 && (p(N), p(F));
  }
  function b(x, T, k) {
    return pr(x, T, k);
  }
  function w(x, T) {
    var k = x._private, B = c, D;
    T ? D = T + "-" : D = "", x.boundingBox();
    var P = k.labelBounds[T || "main"], A = x.pstyle(D + "label").value, R = x.pstyle("text-events").strValue === "yes";
    if (!(!R || !A)) {
      var L = b(k.rscratch, "labelX", T), I = b(k.rscratch, "labelY", T), M = b(k.rscratch, "labelAngle", T), N = x.pstyle(D + "text-margin-x").pfValue, F = x.pstyle(D + "text-margin-y").pfValue, _ = P.x1 - B - N, z = P.x2 + B - N, q = P.y1 - B - F, Z = P.y2 + B - F;
      if (M) {
        var Q = Math.cos(M), X = Math.sin(M), J = function(K, te) {
          return K = K - L, te = te - I, {
            x: K * Q - te * X + L,
            y: K * X + te * Q + I
          };
        }, j = J(_, q), ne = J(_, Z), Y = J(z, q), V = J(z, Z), H = [
...
At.getAllInBox = function(r, e, t, a) {
  var n = this.getCachedZSortedEles().interactive, i = this.cy.zoom(), s = 2 / i, o = [], u = Math.min(r, t), l = Math.max(r, t), v = Math.min(e, a), f = Math.max(e, a);
  r = u, t = l, e = v, a = f;
  var c = yr({
    x1: r,
    y1: e,
  ...
  function g(K, te) {
    var ve = K._private, De = s, we = "";
    K.boundingBox();
    var ye = ve.labelBounds.main;
    if (!ye)
      return null;
    var pe = y(ve.rscratch, "labelX", te), se = y(ve.rscratch, "labelY", te), de = y(ve.rscratch, "labelAngle", te), ge = K.pstyle(we + "text-margin-x").pfValue, Ee = K.pstyle(we + "text-margin-y").pfValue, be = ye.x1 - De - ge, Te = ye.x2 + De - ge, Be = ye.y1 - De - Ee, Ae = ye.y2 + De - Ee;
    if (de) {
      var Le = Math.cos(de), ee = Math.sin(de), S = function(W, G) {
        return W = W - pe, G = G - se, {
          x: W * Le - G * ee + pe,
          y: W * ee + G * Le + se
        };
      };
      return [S(be, Be), S(Te, Be), S(Te, Ae), S(be, Ae)];
    } else
      return [{
        x: be,
        y: Be
  ...
  function p(K, te, ve, De) {
    function we(ye, pe, se) {
      return (se.y - ye.y) * (pe.x - ye.x) > (pe.y - ye.y) * (se.x - ye.x);
    }
    return we(K, ve, De) !== we(te, ve, De) && we(K, te, ve) !== we(K, te, De);
  }
  for (var m = 0; m < n.length; m++) {
    ...
    if (b.isNode()) {
      ...
      if (C === "none")
        continue;
      var T = (C === "overlap" || x) && E, k = w.boundingBox({
        includeNodes: !0,
        includeEdges: !1,
        includeLabels: T
      });
      if (C === "contain") {
        ...
        if (x && E) {
          var D = g(w);
          D && pi(D, h) && (o.push(w), B = !0);
        }
        !B && wv(c, k) && o.push(w);
      } else if (C === "overlap" && to(c, k)) {
        var P = w.boundingBox({
          includeNodes: !0,
          includeEdges: !0,
          includeLabels: !1,
      ...
      var L = b, I = L._private, M = I.rscratch, N = L.pstyle("box-selection").strValue;
      if (N === "none")
        continue;
      if (N === "contain") {
        if (M.startX != null && M.startY != null && !tt(c, M.startX, M.startY) || M.endX != null && M.endY != null && !tt(c, M.endX, M.endY))
          continue;
        if (M.edgeType === "bezier" || M.edgeType === "multibezier" || M.edgeType === "self" || M.edgeType === "compound" || M.edgeType === "segments" || M.edgeType === "haystack") {
          for (var F = I.rstyle.bezierPts || I.rstyle.linePts || I.rstyle.haystackPts, _ = !0, z = 0; z < F.length; z++)
            if (!Uo(c, F[z])) {
              _ = !1;
              break;
            }
        ...
        var q = !1;
        if (M.startX != null && M.startY != null && M.endX != null && M.endY != null && (tt(c, M.startX, M.startY) || tt(c, M.endX, M.endY)))
          o.push(L), q = !0;
        else if (!q && M.edgeType === "haystack") {
          for (var Z = I.rstyle.haystackPts, Q = 0; Q < Z.length; Q++)
            if (Uo(c, Z[Q])) {
              o.push(L), q = !0;
              break;
            }
        ...
        if (!q) {
          var X = I.rstyle.bezierPts || I.rstyle.linePts || I.rstyle.haystackPts;
          if ((!X || X.length < 2) && M.edgeType === "straight" && M.startX != null && M.startY != null && M.endX != null && M.endY != null && (X = [{
            x: M.startX,
            y: M.startY
          }, {
            x: M.endX,
          ...
          for (var J = 0; J < X.length - 1; J++) {
            for (var j = X[J], ne = X[J + 1], Y = 0; Y < d.length; Y++) {
              var V = Xe(d[Y], 2), H = V[0], $ = V[1];
              if (p(j, ne, H, $)) {
                o.push(L), q = !0;
                break;
              }
...
var Dn = {};
Dn.calculateArrowAngles = function(r) {
  var e = r._private.rscratch, t = e.edgeType === "haystack", a = e.edgeType === "bezier", n = e.edgeType === "multibezier", i = e.edgeType === "segments", s = e.edgeType === "compound", o = e.edgeType === "self", u, l, v, f, c, h, p, m;
  if (t ? (v = e.haystackPts[0], f = e.haystackPts[1], c = e.haystackPts[2], h = e.haystackPts[3]) : (v = e.arrowStartX, f = e.arrowStartY, c = e.arrowEndX, h = e.arrowEndY), p = e.midX, m = e.midY, i)
    u = v - e.segpts[0], l = f - e.segpts[1];
  else if (n || s || o || a) {
    var d = e.allpts, y = nr(d[0], d[2], d[4], 0.1), g = nr(d[1], d[3], d[5], 0.1);
    u = v - y, l = f - g;
  } else
    u = v - p, l = f - m;
  e.srcArrowAngle = Xa(u, l);
  var p = e.midX, m = e.midY;
  if (t && (p = (v + c) / 2, m = (f + h) / 2), u = c - v, l = h - f, i) {
    var d = e.allpts;
    if (d.length / 2 % 2 === 0) {
    ...
    var d = e.allpts, E = e.ctrlpts, C, x, T, k;
    if (E.length / 2 % 2 === 0) {
      var B = d.length / 2 - 1, D = B + 2, P = D + 2;
      C = nr(d[B], d[D], d[P], 0), x = nr(d[B + 1], d[D + 1], d[P + 1], 0), T = nr(d[B], d[D], d[P], 1e-4), k = nr(d[B + 1], d[D + 1], d[P + 1], 1e-4);
    } else {
      var D = d.length / 2 - 1, B = D - 2, P = D + 2;
      C = nr(d[B], d[D], d[P], 0.4999), x = nr(d[B + 1], d[D + 1], d[P + 1], 0.4999), T = nr(d[B], d[D], d[P], 0.5), k = nr(d[B + 1], d[D + 1], d[P + 1], 0.5);
    }
    u = T - C, l = k - x;
  }
  if (e.midtgtArrowAngle = Xa(u, l), e.midDispX = u, e.midDispY = l, u *= -1, l *= -1, i) {
    var d = e.allpts;
    if (d.length / 2 % 2 !== 0) {
      if (!e.isRound) {
        var b = d.length / 2 - 1, A = b + 2;
        u = -(d[A] - d[b]), l = -(d[A + 1] - d[b + 1]);
      }
    }
  }
  if (e.midsrcArrowAngle = Xa(u, l), i)
    u = c - e.segpts[e.segpts.length - 2], l = h - e.segpts[e.segpts.length - 1];
  else if (n || s || o || a) {
    var d = e.allpts, R = d.length, y = nr(d[R - 6], d[R - 4], d[R - 2], 0.9), g = nr(d[R - 5], d[R - 3], d[R - 1], 0.9);
    u = c - y, l = h - g;
  } else
    u = c - p, l = h - m;
  e.tgtArrowAngle = Xa(u, l);
};
Dn.getArrowWidth = Dn.getArrowHeight = function(r, e) {
  var t = this.arrowWidthCache = this.arrowWidthCache || {}, a = t[r + ", " + e];
  return a || (a = Math.max(Math.pow(r * 13.37, 0.9), 29) * e, t[r + ", " + e] = a, a);
};
var Fs, Vs, Vr = {}, Dr = {}, Bl, Pl, Ct, hn, $r, mt, xt, zr, zt, tn, gf, pf, qs, _s, Al, Rl = function(e, t, a) {
...
}, ty = function(e, t, a, n, i) {
  if (e !== Al ? Rl(t, e, Vr) : ry(Dr, Vr), Rl(t, a, Dr), Bl = Vr.nx * Dr.ny - Vr.ny * Dr.nx, Pl = Vr.nx * Dr.nx - Vr.ny * -Dr.ny, $r = Math.asin(Math.max(-1, Math.min(1, Bl))), Math.abs($r) < 1e-6) {
    Fs = t.x, Vs = t.y, xt = zt = 0;
    return;
  }
  Ct = 1, hn = !1, Pl < 0 ? $r < 0 ? $r = Math.PI + $r : ($r = Math.PI - $r, Ct = -1, hn = !0) : $r > 0 && (Ct = -1, hn = !0), t.radius !== void 0 ? zt = t.radius : zt = n, mt = $r / 2, tn = Math.min(Vr.len / 2, Dr.len / 2), i ? (zr = Math.abs(Math.cos(mt) * zt / Math.sin(mt)), zr > tn ? (zr = tn, xt = Math.abs(zr * Math.sin(mt) / Math.cos(mt))) : xt = zt) : (zr = Math.min(tn, zt), xt = Math.abs(zr * Math.sin(mt) / Math.cos(mt))), qs = t.x + Dr.nx * zr, _s = t.y + Dr.ny * zr, Fs = qs - Dr.ny * xt * Ct, Vs = _s + Dr.nx * xt * Ct, gf = t.x + Vr.nx * zr, pf = t.y + Vr.ny * zr, Al = t;
};
function yf(r, e) {
...
function go(r, e, t, a) {
  ...
  return a === 0 || e.radius === 0 ? {
    ...
    stopX: qs,
    stopY: _s,
    startAngle: Vr.ang + Math.PI / 2 * Ct,
    endAngle: Dr.ang - Math.PI / 2 * Ct,
    counterClockwise: hn
  });
}
var Ma = 0.01, ay = Math.sqrt(2 * Ma), hr = {};
hr.findMidptPtsEtc = function(r, e) {
  var t = e.posPts, a = e.intersectionPts, n = e.vectorNormInverse, i, s = r.pstyle("source-endpoint"), o = r.pstyle("target-endpoint"), u = s.units != null && o.units != null, l = function(E, C, x, T) {
    var k = T - C, B = x - E, D = Math.sqrt(B * B + k * k);
    return {
      x: -k / D,
      y: B / D
    };
  ...
  switch (v) {
    ...
    case "endpoints": {
      if (u) {
        var f = this.manualEndptToPx(r.source()[0], s), c = Xe(f, 2), h = c[0], d = c[1], y = this.manualEndptToPx(r.target()[0], o), g = Xe(y, 2), p = g[0], m = g[1], b = {
          x1: h,
          y1: d,
          x2: p,
          y2: m
        ...
        Ne("Edge ".concat(r.id(), " has edge-distances:endpoints specified without manual endpoints specified via source-endpoint and target-endpoint.  Falling back on edge-distances:intersection (default).")), i = a;
      break;
    }
  }
  return {
...
hr.findHaystackPoints = function(r) {
  for (var e = 0; e < r.length; e++) {
    ...
    var s = a.source, o = a.target, u = s.position(), l = o.position(), v = s.width(), f = o.width(), c = s.height(), h = o.height(), d = t.pstyle("haystack-radius").value, y = d / 2;
    n.haystackPts = n.allpts = [n.source.x * v * y + u.x, n.source.y * c * y + u.y, n.target.x * f * y + l.x, n.target.y * h * y + l.y], n.midX = (n.allpts[0] + n.allpts[2]) / 2, n.midY = (n.allpts[1] + n.allpts[3]) / 2, n.edgeType = "haystack", n.haystack = !0, this.storeEdgeProjections(t), this.calculateArrowAngles(t), this.recalculateEdgeLabelProjections(t), this.calculateLabelAngles(t);
  }
};
hr.findSegmentsPoints = function(r, e) {
  ...
  for (var v = 0; v < o; v++) {
    var f = a.pfValue[v], c = n.pfValue[v], h = 1 - f, d = f, y = this.findMidptPtsEtc(r, e), g = y.midptPts, p = y.vectorNormInverse, m = {
      x: g.x1 * h + g.x2 * d,
      y: g.y1 * h + g.y2 * d
    };
    t.segpts.push(m.x + p.x * c, m.y + p.y * c), t.radii.push(i.pfValue[v] !== void 0 ? i.pfValue[v] : u), t.isArcRadius.push((s.pfValue[v] !== void 0 ? s.pfValue[v] : l) === "arc-radius");
  }
};
hr.findLoopPoints = function(r, e, t, a) {
  var n = r._private.rscratch, i = e.dirCounts, s = e.srcPos, o = r.pstyle("control-point-distances"), u = o ? o.pfValue[0] : void 0, l = r.pstyle("loop-direction").pfValue, v = r.pstyle("loop-sweep").pfValue, f = r.pstyle("control-point-step-size").pfValue;
  n.edgeType = "self";
  var c = t, h = f;
  a && (c = 0, h = u);
  var d = l - Math.PI / 2, y = d - v / 2, g = d + v / 2, p = l + "_" + v;
  c = i[p] === void 0 ? i[p] = 0 : ++i[p], n.ctrlpts = [s.x + Math.cos(y) * 1.4 * h * (c / 3 + 1), s.y + Math.sin(y) * 1.4 * h * (c / 3 + 1), s.x + Math.cos(g) * 1.4 * h * (c / 3 + 1), s.y + Math.sin(g) * 1.4 * h * (c / 3 + 1)];
};
hr.findCompoundLoopPoints = function(r, e, t, a) {
  var n = r._private.rscratch;
  n.edgeType = "compound";
  var i = e.srcPos, s = e.tgtPos, o = e.srcW, u = e.srcH, l = e.tgtW, v = e.tgtH, f = r.pstyle("control-point-step-size").pfValue, c = r.pstyle("control-point-distances"), h = c ? c.pfValue[0] : void 0, d = t, y = f;
  a && (d = 0, y = h);
  var g = 50, p = {
    x: i.x - o / 2,
    y: i.y - u / 2
    ...
    x: Math.min(p.x, m.x),
    y: Math.min(p.y, m.y)
  }, w = 0.5, E = Math.max(w, Math.log(o * Ma)), C = Math.max(w, Math.log(l * Ma));
  n.ctrlpts = [b.x, b.y - (1 + Math.pow(g, 1.12) / 100) * y * (d / 3 + 1) * E, b.x - (1 + Math.pow(g, 1.12) / 100) * y * (d / 3 + 1) * C, b.y];
};
hr.findStraightEdgePoints = function(r) {
  r._private.rscratch.edgeType = "straight";
};
hr.findBezierPoints = function(r, e, t, a, n) {
  var i = r._private.rscratch, s = r.pstyle("control-point-step-size").pfValue, o = r.pstyle("control-point-distances"), u = r.pstyle("control-point-weights"), l = o && u ? Math.min(o.value.length, u.value.length) : 1, v = o ? o.pfValue[0] : void 0, f = u.value[0], c = a;
  i.edgeType = c ? "multibezier" : "bezier", i.ctrlpts = [];
  for (var h = 0; h < l; h++) {
    var d = (0.5 - e.eles.length / 2 + t) * s * (n ? -1 : 1), y = void 0, g = ro(d);
    c && (v = o ? o.pfValue[h] : s, f = u.value[h]), a ? y = v : y = v !== void 0 ? g * v : void 0;
    var p = y !== void 0 ? y : d, m = 1 - f, b = f, w = this.findMidptPtsEtc(r, e), E = w.midptPts, C = w.vectorNormInverse, x = {
      x: E.x1 * m + E.x2 * b,
      y: E.y1 * m + E.y2 * b
    };
...
hr.findTaxiPoints = function(r, e) {
  ...
  var Q = function(G) {
    return Math.abs(G) < x || Math.abs(G) >= Math.abs(M);
  }, X = Q(z), J = Q(Math.abs(M) - Math.abs(z)), j = X || J;
  if (j && !_)
    if (I) {
      var ne = Math.abs(N) <= c / 2, Y = Math.abs(B) <= h / 2;
      if (ne) {
        var V = (v.x1 + v.x2) / 2, H = v.y1, $ = v.y2;
        t.segpts = [V, H, V, $];
      } else if (Y) {
        var K = (v.y1 + v.y2) / 2, te = v.x1, ve = v.x2;
        t.segpts = [te, K, ve, K];
      } else
        t.segpts = [v.x1, v.y2];
    } else {
      var De = Math.abs(N) <= f / 2, we = Math.abs(D) <= d / 2;
      if (De) {
        var ye = (v.y1 + v.y2) / 2, pe = v.x1, se = v.x2;
        t.segpts = [pe, ye, se, ye];
      } else if (we) {
        var de = (v.x1 + v.x2) / 2, ge = v.y1, Ee = v.y2;
        t.segpts = [de, ge, de, Ee];
      } else
        t.segpts = [v.x2, v.y1];
    }
  else if (I) {
    var be = v.y1 + z + (g ? c / 2 * F : 0), Te = v.x1, Be = v.x2;
    t.segpts = [Te, be, Be, be];
  } else {
    var Ae = v.x1 + z + (g ? f / 2 * F : 0), Le = v.y1, ee = v.y2;
    t.segpts = [Ae, Le, Ae, ee];
  }
  if (t.isRound) {
    var S = r.pstyle("taxi-radius").value, O = r.pstyle("radius-type").value[0] === "arc-radius";
    t.radii = new Array(t.segpts.length / 2).fill(S), t.isArcRadius = new Array(t.segpts.length / 2).fill(O);
  }
};
hr.tryToCorrectInvalidPoints = function(r, e) {
  var t = r._private.rscratch;
  if (t.edgeType === "bezier") {
    var a = e.srcPos, n = e.tgtPos, i = e.srcW, s = e.srcH, o = e.tgtW, u = e.tgtH, l = e.srcShape, v = e.tgtShape, f = e.srcCornerRadius, c = e.tgtCornerRadius, h = e.srcRs, d = e.tgtRs, y = !ae(t.startX) || !ae(t.startY), g = !ae(t.arrowStartX) || !ae(t.arrowStartY), p = !ae(t.endX) || !ae(t.endY), m = !ae(t.arrowEndX) || !ae(t.arrowEndY), b = 3, w = this.getArrowWidth(r.pstyle("width").pfValue, r.pstyle("arrow-scale").value) * this.arrowShapeWidth, E = b * w, C = kt({
      x: t.ctrlpts[0],
      y: t.ctrlpts[1]
    }, {
      x: t.startX,
    ...
    if (y || g || x) {
      ...
      var D = {
        ...
        x: t.ctrlpts[0] - a.x,
        y: t.ctrlpts[1] - a.y
      }, P = Math.sqrt(D.x * D.x + D.y * D.y), A = {
        // normalised delta
        x: D.x / P,
        y: D.y / P
      }, R = Math.max(i, s), L = {
        // *2 radius guarantees outside shape
        x: t.ctrlpts[0] + A.x * 2 * R,
        y: t.ctrlpts[1] + A.y * 2 * R
      }, I = l.intersectLine(a.x, a.y, i, s, L.x, L.y, 0, f, h);
      x ? (t.ctrlpts[0] = t.ctrlpts[0] + A.x * (E - C), t.ctrlpts[1] = t.ctrlpts[1] + A.y * (E - C)) : (t.ctrlpts[0] = I[0] + A.x * E, t.ctrlpts[1] = I[1] + A.y * E);
    }
    if (p || m || k) {
      B = !0;
      var M = {
      ...
      }, q = v.intersectLine(n.x, n.y, o, u, z.x, z.y, 0, c, d);
      k ? (t.ctrlpts[0] = t.ctrlpts[0] + F.x * (E - T), t.ctrlpts[1] = t.ctrlpts[1] + F.y * (E - T)) : (t.ctrlpts[0] = q[0] + F.x * E, t.ctrlpts[1] = q[1] + F.y * E);
    }
    B && this.findEndpoints(r);
  }
};
hr.storeAllpts = function(r) {
  ...
  if (e.edgeType === "multibezier" || e.edgeType === "bezier" || e.edgeType === "self" || e.edgeType === "compound") {
    ...
    var a, n;
    e.ctrlpts.length / 2 % 2 === 0 ? (a = e.allpts.length / 2 - 1, e.midX = e.allpts[a], e.midY = e.allpts[a + 1]) : (a = e.allpts.length / 2 - 3, n = 0.5, e.midX = nr(e.allpts[a], e.allpts[a + 2], e.allpts[a + 4], n), e.midY = nr(e.allpts[a + 1], e.allpts[a + 3], e.allpts[a + 5], n));
    ...
    if (e.segpts.length % 4 === 0) {
      ...
      if (!e.isRound)
        ...
        if (c.radius === 0) {
          ...
          var d = [f.x - c.cx, f.y - c.cy], y = c.radius / Math.sqrt(Math.pow(d[0], 2) + Math.pow(d[1], 2));
          d = d.map(function(g) {
            return g * y;
...
hr.checkForInvalidEdgeWarning = function(r) {
  var e = r[0]._private.rscratch;
  e.nodesOverlap || ae(e.startX) && ae(e.startY) && ae(e.endX) && ae(e.endY) ? e.loggedErr = !1 : e.loggedErr || (e.loggedErr = !0, Ne("Edge `" + r.id() + "` has invalid endpoints and so it is impossible to draw.  Adjust your edge style (e.g. control points) accordingly or use an alternative edge type.  This is expected behaviour when the source node and the target node overlap."));
};
hr.findEdgeControlPoints = function(r) {
  var e = this;
  if (!(!r || r.length === 0)) {
    for (var t = this, a = t.cy, n = a.hasCompoundNodes(), i = new Ur(), s = function(k, B) {
      return [].concat(yn(k), [B ? 1 : 0]).join("-");
    }, o = [], u = [], l = 0; l < r.length; l++) {
      var v = r[l], f = v._private, c = v.pstyle("curve-style").value;
      if (!(v.removed() || !v.takesUpSpace())) {
        if (c === "haystack") {
          u.push(v);
          continue;
        }
        var h = c === "unbundled-bezier" || rt(c, "segments") || c === "straight" || c === "straight-triangle" || rt(c, "taxi"), d = c === "unbundled-bezier" || c === "bezier", y = f.source, g = f.target, p = y.poolIndex(), m = g.poolIndex(), b = [p, m].sort(), w = s(b, h), E = i.get(w);
        E == null && (E = {
          eles: []
        }, o.push({
          pairId: b,
    ...
    for (var C = function() {
      var k = o[x], B = k.pairId, D = k.edgeIsUnbundled, P = s(B, D), A = i.get(P), R;
      if (!A.hasUnbundled) {
        var L = A.eles[0].parallelEdges().filter(function(O) {
          return O.isBundledBezier();
        });
        js(A.eles), L.forEach(function(O) {
          return A.eles.push(O);
        }), A.eles.sort(function(O, W) {
          return O.poolIndex() - W.poolIndex();
        });
      }
      var I = A.eles[0], M = I.source(), N = I.target();
      if (M.poolIndex() > N.poolIndex()) {
        var F = M;
        M = N, N = F;
      }
      var _ = A.srcPos = M.position(), z = A.tgtPos = N.position(), q = A.srcW = M.outerWidth(), Z = A.srcH = M.outerHeight(), Q = A.tgtW = N.outerWidth(), X = A.tgtH = N.outerHeight(), J = A.srcShape = t.nodeShapes[e.getNodeShape(M)], j = A.tgtShape = t.nodeShapes[e.getNodeShape(N)], ne = A.srcCornerRadius = M.pstyle("corner-radius").value === "auto" ? "auto" : M.pstyle("corner-radius").pfValue, Y = A.tgtCornerRadius = N.pstyle("corner-radius").value === "auto" ? "auto" : N.pstyle("corner-radius").pfValue, V = A.tgtRs = N._private.rscratch, H = A.srcRs = M._private.rscratch;
      A.dirCounts = {
        north: 0,
        west: 0,
        south: 0,
      ...
      for (var $ = 0; $ < A.eles.length; $++) {
        var K = A.eles[$], te = K[0]._private.rscratch, ve = K.pstyle("curve-style").value, De = ve === "unbundled-bezier" || rt(ve, "segments") || rt(ve, "taxi"), we = !M.same(K.source());
        if (!A.calculatedIntersection && M !== N && (A.hasBezier || A.hasUnbundled)) {
          A.calculatedIntersection = !0;
          var ye = J.intersectLine(_.x, _.y, q, Z, z.x, z.y, 0, ne, H), pe = A.srcIntn = ye, se = j.intersectLine(z.x, z.y, Q, X, _.x, _.y, 0, Y, V), de = A.tgtIntn = se, ge = A.intersectionPts = {
            x1: ye[0],
            x2: se[0],
            y1: ye[1],
            y2: se[1]
            ...
            y1: _.y,
            y2: z.y
          }, be = se[1] - ye[1], Te = se[0] - ye[0], Be = Math.sqrt(Te * Te + be * be);
          ae(Be) && Be >= ay || (Be = Math.sqrt(Math.max(Te * Te, Ma) + Math.max(be * be, Ma)));
          var Ae = A.vector = {
            x: Te,
            y: be
          }, Le = A.vectorNorm = {
          ...
          A.nodesOverlap = !ae(Be) || j.checkPoint(ye[0], ye[1], 0, Q, X, z.x, z.y, Y, V) || J.checkPoint(se[0], se[1], 0, q, Z, _.x, _.y, ne, H), A.vectorNormInverse = ee, R = {
        ...
        var S = we ? R : A;
        te.nodesOverlap = S.nodesOverlap, te.srcIntn = S.srcIntn, te.tgtIntn = S.tgtIntn, te.isRound = ve.startsWith("round"), n && (M.isParent() || M.isChild() || N.isParent() || N.isChild()) && (M.parents().anySame(N) || N.parents().anySame(M) || M.same(N) && M.isParent()) ? e.findCompoundLoopPoints(K, S, $, De) : M === N ? e.findLoopPoints(K, S, $, De) : ve.endsWith("segments") ? e.findSegmentsPoints(K, S) : ve.endsWith("taxi") ? e.findTaxiPoints(K, S) : ve === "straight" || !De && A.eles.length % 2 === 1 && $ === Math.floor(A.eles.length / 2) ? e.findStraightEdgePoints(K) : e.findBezierPoints(K, S, $, De, we), e.findEndpoints(K), e.tryToCorrectInvalidPoints(K, S), e.checkForInvalidEdgeWarning(K), e.storeAllpts(K), e.storeEdgeProjections(K), e.calculateArrowAngles(K), e.recalculateEdgeLabelProjections(K), e.calculateLabelAngles(K);
      }
    }, x = 0; x < o.length; x++)
      C();
...
hr.getSegmentPoints = function(r) {
  var e = r[0]._private.rscratch;
...
hr.getControlPoints = function(r) {
  var e = r[0]._private.rscratch;
  this.recalculateRenderedStyle(r);
  var t = e.edgeType;
...
Ga.manualEndptToPx = function(r, e) {
  ...
  if (e.value.length === 2) {
    ...
    var u = e.pfValue[0];
    u = -Math.PI / 2 + u;
    var l = 2 * Math.max(n, i), v = [a.x + Math.cos(u) * l, a.y + Math.sin(u) * l];
...
Ga.findEndpoints = function(r) {
  var e, t, a, n, i = this, s, o = r.source()[0], u = r.target()[0], l = o.position(), v = u.position(), f = r.pstyle("target-arrow-shape").value, c = r.pstyle("source-arrow-shape").value, h = r.pstyle("target-distance-from-node").pfValue, d = r.pstyle("source-distance-from-node").pfValue, y = o._private.rscratch, g = u._private.rscratch, p = r.pstyle("curve-style").value, m = r._private.rscratch, b = m.edgeType, w = rt(p, "taxi"), E = b === "self" || b === "compound", C = b === "bezier" || b === "multibezier" || E, x = b !== "bezier", T = b === "straight" || b === "segments", k = b === "segments", B = C || x || T, D = E || w, P = r.pstyle("source-endpoint"), A = D ? "outside-to-node" : P.value, R = o.pstyle("corner-radius").value === "auto" ? "auto" : o.pstyle("corner-radius").pfValue, L = r.pstyle("target-endpoint"), I = D ? "outside-to-node" : L.value, M = u.pstyle("corner-radius").value === "auto" ? "auto" : u.pstyle("corner-radius").pfValue;
  m.srcManEndpt = P, m.tgtManEndpt = L;
  var N, F, _, z, q = (e = (L == null || (t = L.pfValue) === null || t === void 0 ? void 0 : t.length) === 2 ? L.pfValue : null) !== null && e !== void 0 ? e : [0, 0], Z = (a = (P == null || (n = P.pfValue) === null || n === void 0 ? void 0 : n.length) === 2 ? P.pfValue : null) !== null && a !== void 0 ? a : [0, 0];
  if (C) {
    var Q = [m.ctrlpts[0], m.ctrlpts[1]], X = x ? [m.ctrlpts[m.ctrlpts.length - 2], m.ctrlpts[m.ctrlpts.length - 1]] : Q;
    N = X, F = Q;
  } else if (T) {
    var J = k ? m.segpts.slice(0, 2) : [v.x + q[0], v.y + q[1]], j = k ? m.segpts.slice(m.segpts.length - 2) : [l.x + Z[0], l.y + Z[1]];
    N = j, F = J;
  }
  if (I === "inside-to-node")
    s = [v.x, v.y];
  else if (L.units)
    s = this.manualEndptToPx(u, L);
  else if (I === "outside-to-line")
    s = m.tgtIntn;
  else if (I === "outside-to-node" || I === "outside-to-node-or-label" ? _ = N : (I === "outside-to-line" || I === "outside-to-line-or-label") && (_ = [l.x, l.y]), s = i.nodeShapes[this.getNodeShape(u)].intersectLine(v.x, v.y, u.outerWidth(), u.outerHeight(), _[0], _[1], 0, M, g), I === "outside-to-node-or-label" || I === "outside-to-line-or-label") {
    var ne = u._private.rscratch, Y = ne.labelWidth, V = ne.labelHeight, H = ne.labelX, $ = ne.labelY, K = Y / 2, te = V / 2, ve = u.pstyle("text-valign").value;
    ve = jt(ve), ve === "top" ? $ -= te : ve === "bottom" && ($ += te);
    var De = u.pstyle("text-halign").value;
    De = Jt(De), De === "left" ? H -= K : De === "right" && (H += K);
    var we = Da(_[0], _[1], [H - K, $ - te, H + K, $ - te, H + K, $ + te, H - K, $ + te], v.x, v.y);
    if (we.length > 0) {
      var ye = l, pe = wt(ye, Gt(s)), se = wt(ye, Gt(we)), de = pe;
      if (se < pe && (s = we, de = se), we.length > 2) {
        var ge = wt(ye, {
          x: we[2],
          y: we[3]
        });
  ...
  var Ee = Ya(s, N, i.arrowShapes[f].spacing(r) + h), be = Ya(s, N, i.arrowShapes[f].gap(r) + h);
  if (m.endX = be[0], m.endY = be[1], m.arrowEndX = Ee[0], m.arrowEndY = Ee[1], A === "inside-to-node")
    s = [l.x, l.y];
  else if (P.units)
    s = this.manualEndptToPx(o, P);
  else if (A === "outside-to-line")
    s = m.srcIntn;
  else if (A === "outside-to-node" || A === "outside-to-node-or-label" ? z = F : (A === "outside-to-line" || A === "outside-to-line-or-label") && (z = [v.x, v.y]), s = i.nodeShapes[this.getNodeShape(o)].intersectLine(l.x, l.y, o.outerWidth(), o.outerHeight(), z[0], z[1], 0, R, y), A === "outside-to-node-or-label" || A === "outside-to-line-or-label") {
    var Te = o._private.rscratch, Be = Te.labelWidth, Ae = Te.labelHeight, Le = Te.labelX, ee = Te.labelY, S = Be / 2, O = Ae / 2, W = o.pstyle("text-valign").value;
    W = jt(W), W === "top" ? ee -= O : W === "bottom" && (ee += O);
    var G = o.pstyle("text-halign").value;
    G = Jt(G), G === "left" ? Le -= S : G === "right" && (Le += S);
    var U = Da(z[0], z[1], [Le - S, ee - O, Le + S, ee - O, Le + S, ee + O, Le - S, ee + O], l.x, l.y);
    if (U.length > 0) {
      var ue = v, re = wt(ue, Gt(s)), oe = wt(ue, Gt(U)), ie = re;
      if (oe < re && (s = [U[0], U[1]], ie = oe), U.length > 2) {
        var fe = wt(ue, {
          x: U[2],
          y: U[3]
        });
  ...
  var Ce = Ya(s, F, i.arrowShapes[c].spacing(r) + d), xe = Ya(s, F, i.arrowShapes[c].gap(r) + d);
  m.startX = xe[0], m.startY = xe[1], m.arrowStartX = Ce[0], m.arrowStartY = Ce[1], B && (!ae(m.startX) || !ae(m.startY) || !ae(m.endX) || !ae(m.endY) ? m.badLine = !0 : m.badLine = !1);
};
...
po.storeEdgeProjections = function(r) {
  ...
  if (e.rstyle.bezierPts = null, e.rstyle.linePts = null, e.rstyle.haystackPts = null, a === "multibezier" || a === "bezier" || a === "self" || a === "compound") {
    ...
    for (var n = 0; n + 5 < t.allpts.length; n += 4)
      ny(this, r, t.allpts.slice(n, n + 6));
  } else if (a === "segments")
...
po.recalculateEdgeProjections = function(r) {
...
Hr.recalculateNodeLabelProjection = function(r) {
  ...
  if (!st(e)) {
    var t, a, n = r._private, i = r.width(), s = r.height(), o = r.padding(), u = r.position(), l = r.pstyle("text-halign").strValue, v = r.pstyle("text-valign").strValue, f = n.rscratch, c = n.rstyle;
    switch (l) {
      case "left":
        t = u.x - i / 2 - o;
        break;
...
var bf = function(e, t) {
  ...
  var i = ka(0, n - 1e-3, 1), s = ka(0, n + 1e-3, 1), o = $t(e, t, a, i), u = $t(e, t, a, s);
  return wf(o, u);
};
Hr.recalculateEdgeLabelProjections = function(r) {
  ...
  if (i.mid || i.source || i.target) {
    ...
    var s = function(f, c, h) {
      qr(t.rscratch, f, c, h), qr(t.rstyle, f, c, h);
    };
    ...
    var u = function() {
      ...
      function m(x, T, k, B, D) {
        var P = kt(T, k), A = x.segments[x.segments.length - 1], R = {
          p0: T,
          p1: k,
          t0: B,
          t1: D,
      ...
      if (i[f]) {
        ...
        switch (a.edgeType) {
          ...
          case "multibezier": {
            ...
            var T = g.cp, k = g.segment, B = (d - p) / k.length, D = k.t1 - k.t0, P = h ? k.t0 + D * B : k.t1 - D * B;
            P = ka(0, P, 1), e = $t(T.p0, T.p1, T.p2, P), c = iy(T.p0, T.p1, T.p2, P);
            break;
          }
          case "straight":
          case "segments":
          case "haystack": {
            for (var A = 0, R, L, I, M, N = a.allpts.length, F = 0; F + 3 < N && (h ? (I = {
              x: a.allpts[F],
              y: a.allpts[F + 1]
            }, M = {
              x: a.allpts[F + 2],
              ...
              x: a.allpts[N - 4 - F],
              y: a.allpts[N - 3 - F]
            }), R = kt(I, M), L = A, A += R, !(A >= d)); F += 2)
              ;
            var _ = d - L, z = _ / R;
            z = ka(0, z, 1), e = kd(I, M, z), c = wf(I, M);
            break;
          }
        }
...
Hr.applyPrefixedLabelDimensions = function(r, e) {
  var t = r._private, a = this.getLabelText(r, e), n = St(a, r._private.labelDimsKey);
  if (pr(t.rscratch, "prefixedLabelDimsKey", e) !== n) {
    qr(t.rscratch, "prefixedLabelDimsKey", e, n);
    var i = this.calculateLabelDimensions(r, a), s = r.pstyle("line-height").pfValue, o = r.pstyle("font-size").pfValue, u = r.pstyle("text-wrap").strValue, l = pr(t.rscratch, "labelWrapCachedLines", e) || [], v = u !== "wrap" ? 1 : Math.max(l.length, 1), f = o * s, c = i.width, h = i.height + (v - 1) * (s - 1) * o;
    qr(t.rstyle, "labelWidth", e, c), qr(t.rscratch, "labelWidth", e, c), qr(t.rstyle, "labelHeight", e, h), qr(t.rscratch, "labelHeight", e, h), qr(t.rscratch, "labelLineHeight", e, f), qr(t.rscratch, "labelActualDescent", e, i.labelActualDescent);
  }
};
Hr.getLabelText = function(r, e) {
  var t = r._private, a = e ? e + "-" : "", n = r.pstyle(a + "label").strValue, i = r.pstyle("text-transform").value, s = function(Z, Q) {
    return Q ? (qr(t.rscratch, Z, e, Q), Q) : pr(t.rscratch, Z, e);
  };
  if (!n)
    return "";
  ...
  if (o === "wrap") {
    ...
    for (var l = "​", v = n.split(`
`), f = r.pstyle("text-max-width").pfValue, c = r.pstyle("text-overflow-wrap").value, h = c === "anywhere", d = [], y = /[\s\u200b]+|$/g, g = 0; g < v.length; g++) {
      var p = v[g], m = this.calculateLabelDimensions(r, p), b = m.width;
      if (h) {
        var w = p.split("").join(l);
        p = w;
      }
      if (b > f) {
        var E = p.matchAll(y), C = "", x = 0, T = Cr(E), k;
        try {
          for (T.s(); !(k = T.n()).done; ) {
            var B = k.value, D = B[0], P = p.substring(x, B.index);
            x = B.index + D.length;
            var A = C.length === 0 ? P : C + P + D, R = this.calculateLabelDimensions(r, A), L = R.width;
            L <= f ? C += P + D : (C && d.push(C), C = P + D);
          }
        } catch (q) {
          T.e(q);
        } finally {
...
`)), s("labelWrapKey", u);
    ...
    var I = r.pstyle("text-max-width").pfValue, M = "", N = "…", F = !1;
    if (this.calculateLabelDimensions(r, n).width < I)
      return n;
    for (var _ = 0; _ < n.length; _++) {
      var z = this.calculateLabelDimensions(r, M + n[_] + N).width;
      if (z > I)
        break;
      M += n[_], _ === n.length - 1 && (F = !0);
    }
    return F || (M += N), M;
  }
  return n;
...
Hr.getLabelJustification = function(r) {
  ...
  return e === "auto" ? r.isNode() ? Ug(t) : "center" : e;
};
Hr.calculateLabelDimensions = function(r, e) {
  var t = this, a = t.cy.window(), n = a.document, i = 0, s = r.pstyle("font-style").strValue, o = r.pstyle("font-size").pfValue, u = r.pstyle("font-family").strValue, l = r.pstyle("font-weight").strValue, v = r.pstyle("text-metrics").strValue || "font", f = this.labelCalcCanvas, c = this.labelCalcCanvasContext;
  if (!f) {
  ...
  for (var d = 0, y = 0, g = e.split(`
`), p = g.length, m = 0, b = 0, w = 0; w < p; w++) {
    var E = g[w], C = c.measureText(E), x = Math.ceil(C.width), T = o;
    v === "glyph" && (w === 0 && (b = C.actualBoundingBoxAscent), w === p - 1 && (m = C.actualBoundingBoxDescent)), d = Math.max(x, d), y += T;
  }
  return v === "glyph" && (y -= o - b - m), d += i, y += i, {
    width: d,
    height: y,
    labelActualAscent: b,
...
xf.getNodeShape = function(r) {
  ...
  if (t === "cutrectangle" && (r.width() < Ml || r.height() < Ml))
    return Ll || (Ne("The `cutrectangle` node shape can not be used at small sizes so `rectangle` is used instead"), Ll = !0), "rectangle";
  if (r.isParent())
...
var Kn = {};
Kn.registerCalculationListeners = function() {
  var r = this.cy, e = r.collection(), t = this, a = function(s) {
    var o = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : !0;
    if (e.merge(s), o)
      for (var u = 0; u < s.length; u++) {
        var l = s[u], v = l._private, f = v.rstyle;
  ...
  var n = function(s) {
    if (s) {
      ...
      for (var u = 0; u < e.length; u++) {
        var l = e[u], v = l._private.rstyle;
        l.isNode() && !v.cleanConnected && (a(l.connectedEdges()), v.cleanConnected = !0);
      }
      if (o)
...
Kn.onUpdateEleCalcs = function(r) {
  var e = this.onUpdateEleCalcsFns = this.onUpdateEleCalcsFns || [];
  e.push(r);
};
Kn.recalculateRenderedStyle = function(r, e) {
  var t = function(w) {
  ...
  if (r.length !== 0) {
    ...
    if (!this.destroyed) {
      ...
      for (var l = 0; l < n.length; l++) {
        var v = n[l], f = v._private, c = f.rstyle, h = v.position();
...
var Xn = {};
Xn.updateCachedGrabbedEles = function() {
...
Xn.invalidateCachedZSortedEles = function() {
  this.cachedZSortedEles = null;
};
Xn.getCachedZSortedEles = function(r) {
  if (r || !this.cachedZSortedEles) {
    var e = this.cy.mutableElements().toArray();
    e.sort(rf), e.interactive = e.filter(function(t) {
...
var Ef = {};
[At, Dn, hr, Ga, po, Hr, xf, Kn, Xn].forEach(function(r) {
  me(Ef, r);
});
var Cf = {};
...
var Tf = function(e, t) {
  var a = e[0];
  !a || a._private.grabbed === t || (a._private.grabbed = t, e.updateStyle(!1));
}, sy = function(e) {
  Tf(e, !0);
}, oy = function(e) {
  Tf(e, !1);
...
ia.binder = function(r) {
  var e = this, t = e.cy.window(), a = r === t || r === t.document || r === t.document.body || gc(r);
...
ia.load = function() {
  var r = this, e = r.cy.window(), t = function(S) {
    ...
    var O = S.getRootNode();
    if (O && O.nodeType === 11 && O.host !== void 0)
      return O;
  }, n = function(S, O, W, G) {
    S == null && (S = r.cy);
    ...
    var W = O.addToList, G = W.has(S);
    !G && S.grabbable() && !S.locked() && (W.merge(S), sy(S));
  }, c = function(S, O) {
    if (S.cy().hasCompoundNodes() && !(O.inDragLayer == null && O.addToList == null)) {
      var W = S.descendants();
      O.inDragLayer && (W.forEach(o), W.connectedEdges().forEach(o)), O.addToList && f(W, O);
    }
  }, h = function(S, O) {
    O = O || {};
    var W = S.cy().hasCompoundNodes();
    O.inDragLayer && (S.forEach(o), S.neighborhood().stdFilter(function(G) {
      return !W || G.isEdge();
    }).forEach(o)), O.addToList && S.forEach(function(G) {
      f(G, O);
    }), c(S, O), g(S, {
      inDragLayer: O.inDragLayer
    }), r.updateCachedGrabbedEles();
  }, d = h, y = function(S) {
    S && (r.getCachedZSortedEles().forEach(function(O) {
      oy(O), u(O), v(O);
    }), r.updateCachedGrabbedEles());
  }, g = function(S, O) {
    if (!(O.inDragLayer == null && O.addToList == null) && S.cy().hasCompoundNodes()) {
      var W = S.ancestors().orphans();
      if (!W.same(S)) {
        var G = W.descendants().spawnSelf().merge(W).unmerge(S).unmerge(S.descendants()), U = G.connectedEdges();
        O.inDragLayer && (U.forEach(o), G.forEach(o)), O.addToList && G.forEach(function(ue) {
          f(ue, O);
        });
      }
    }
  ...
  m ? (r.removeObserver = new MutationObserver(function(ee) {
    for (var S = 0; S < ee.length; S++) {
      var O = ee[S], W = O.removedNodes;
      if (W)
    ...
    childList: !0
  })) : r.registerBinding(r.container, "DOMNodeRemoved", function(ee) {
    r.destroy();
  });
  var w = Fa(function() {
    r.cy.resize();
  }, 100);
  m && (r.styleObserver = new MutationObserver(w), r.styleObserver.observe(r.container, {
    attributes: !0
  })), r.registerBinding(e, "resize", w), b && (r.resizeObserver = new ResizeObserver(w), r.resizeObserver.observe(r.container));
  var E = function(S, O) {
    for (; S != null; )
      O(S), S = S.parentNode;
  }, C = function() {
  ...
  E(r.container, function(ee) {
    r.registerBinding(ee, "transitionend", C), r.registerBinding(ee, "animationend", C), r.registerBinding(ee, "scroll", C);
  }), r.registerBinding(r.container, "contextmenu", function(ee) {
    ee.preventDefault();
  });
  var x = function() {
    return r.selection[4] !== 0;
  }, T = function(S) {
    for (var O = r.findContainerClientCoords(), W = O[0], G = O[1], U = O[2], ue = O[3], re = S.touches ? S.touches : [S], oe = !1, ie = 0; ie < re.length; ie++) {
      var fe = re[ie];
      if (W <= fe.clientX && fe.clientX <= W + U && G <= fe.clientY && fe.clientY <= G + ue) {
        oe = !0;
        break;
      }
    }
    if (!oe)
      return !1;
    for (var Ce = r.container, xe = S.target, ce = xe.parentNode, ke = !1; ce; ) {
      if (ce === Ce) {
        ke = !0;
        break;
      }
  ...
  r.registerBinding(r.container, "mousedown", function(S) {
    if (T(S) && !(r.hoverData.which === 1 && S.which !== 1)) {
      S.preventDefault(), p(), r.hoverData.capture = !0, r.hoverData.which = S.which;
      var O = r.cy, W = [S.clientX, S.clientY], G = r.projectIntoViewport(W[0], W[1]), U = r.selection, ue = r.findNearestElements(G[0], G[1], !0, !1), re = ue[0], oe = r.dragData.possibleDragElements;
      r.hoverData.mdownPos = G, r.hoverData.mdownGPos = W;
      var ie = function(Pe) {
        return {
          originalEvent: S,
          type: Pe,
        ...
        r.hoverData.tapholdCancelled = !1, clearTimeout(r.hoverData.tapholdTimeout), r.hoverData.tapholdTimeout = setTimeout(function() {
          if (!r.hoverData.tapholdCancelled) {
            ...
            Pe ? Pe.emit(ie("taphold")) : O.emit(ie("taphold"));
          }
        }, r.tapholdDuration);
      };
      if (S.which == 3) {
        ...
        re ? (re.activate(), re.emit(Ce), r.hoverData.down = re) : O.emit(Ce), r.hoverData.downTime = (/* @__PURE__ */ new Date()).getTime(), r.hoverData.cxtDragged = !1;
      } else if (S.which == 1) {
        re && re.activate();
        {
          if (re != null && r.nodeIsGrabbable(re)) {
            ...
            if (l(re), !re.selected())
              oe = r.dragData.possibleDragElements = O.collection(), d(re, {
                addToList: oe
              }), re.emit(ie("grabon")).emit(ie("grab"));
            else {
              oe = r.dragData.possibleDragElements = O.collection();
              var ce = O.$(function(ke) {
                return ke.isNode() && ke.selected() && r.nodeIsGrabbable(ke);
              });
              h(ce, {
                addToList: oe
              }), re.emit(ie("grabon")), ce.forEach(xe);
            }
        ...
        n(re, ["mousedown", "tapstart", "vmousedown"], S, {
          x: G[0],
          y: G[1]
        }), re == null ? (U[4] = 1, r.data.bgActivePosistion = {
          x: G[0],
          y: G[1]
        }, r.redrawHint("select", !0), r.redraw()) : re.pannable() && (U[4] = 1), fe();
      }
      U[0] = U[2] = G[0], U[1] = U[3] = G[1];
    }
  }, !1);
  var k = a(r.container);
  r.registerBinding([e, k], "mousemove", function(S) {
    var O = r.hoverData.capture;
    if (!(!O && !T(S))) {
      var W = !1, G = r.cy, U = G.zoom(), ue = [S.clientX, S.clientY], re = r.projectIntoViewport(ue[0], ue[1]), oe = r.hoverData.mdownPos, ie = r.hoverData.mdownGPos, fe = r.selection, Ce = null;
      !r.hoverData.draggingEles && !r.hoverData.dragging && !r.hoverData.selecting && (Ce = r.findNearestElement(re[0], re[1], !0, !1));
      var xe = r.hoverData.last, ce = r.hoverData.down, ke = [re[0] - fe[2], re[1] - fe[3]], Pe = r.dragData.possibleDragElements, rr;
      if (ie) {
        var tr = ue[0] - ie[0], br = tr * tr, Ye = ue[1] - ie[1], Ze = Ye * Ye, We = br + Ze;
        r.hoverData.isOverThresholdDrag = rr = We >= r.desktopTapThreshold2;
      }
      var fr = i(S);
      rr && (r.hoverData.tapholdCancelled = !0);
      var Ar = function() {
        var kr = r.hoverData.dragDelta = r.hoverData.dragDelta || [];
        kr.length === 0 ? (kr.push(ke[0]), kr.push(ke[1])) : (kr[0] += ke[0], kr[1] += ke[1]);
      };
      W = !0, n(Ce, ["mousemove", "vmousemove", "tapdrag"], S, {
        x: re[0],
        y: re[1]
      });
      var $e = function(kr) {
        ...
        r.data.bgActivePosistion = void 0, r.hoverData.selecting || G.emit($e("boxstart")), fe[4] = 1, r.hoverData.selecting = !0, r.redrawHint("select", !0), r.redraw();
      };
      if (r.hoverData.which === 3) {
        if (rr) {
          var Rr = $e("cxtdrag");
          ce ? ce.emit(Rr) : G.emit(Rr), r.hoverData.cxtDragged = !0, (!r.hoverData.cxtOver || Ce !== r.hoverData.cxtOver) && (r.hoverData.cxtOver && r.hoverData.cxtOver.emit($e("cxtdragout")), r.hoverData.cxtOver = Ce, Ce && Ce.emit($e("cxtdragover")));
        }
      } else if (r.hoverData.dragging) {
        if (W = !0, G.panningEnabled() && G.userPanningEnabled()) {
          var Qr;
          if (r.hoverData.justStartedPan) {
            var Mt = r.hoverData.mdownPos;
            Qr = {
              x: (re[0] - Mt[0]) * U,
              y: (re[1] - Mt[1]) * U
          ...
          G.panBy(Qr), G.emit($e("dragpan")), r.hoverData.dragged = !0;
        }
        re = r.projectIntoViewport(S.clientX, S.clientY);
      } else if (fe[4] == 1 && (ce == null || ce.pannable())) {
        if (rr) {
          if (!r.hoverData.dragging && G.boxSelectionEnabled() && (fr || !G.panningEnabled() || !G.userPanningEnabled()))
            Sr();
          else if (!r.hoverData.selecting && G.panningEnabled() && G.userPanningEnabled()) {
            var yt = s(ce, r.hoverData.downs);
            yt && (r.hoverData.dragging = !0, r.hoverData.justStartedPan = !0, fe[4] = 0, r.data.bgActivePosistion = Gt(oe), r.redrawHint("select", !0), r.redraw());
          }
          ce && ce.pannable() && ce.active() && ce.unactivate();
        }
      } else {
        if (ce && ce.pannable() && ce.active() && ce.unactivate(), (!ce || !ce.grabbed()) && Ce != xe && (xe && n(xe, ["mouseout", "tapdragout"], S, {
          x: re[0],
          y: re[1]
        }), Ce && n(Ce, ["mouseover", "tapdragover"], S, {
          x: re[0],
          y: re[1]
        }), r.hoverData.last = Ce), ce)
          if (rr) {
            if (G.boxSelectionEnabled() && fr)
              ce && ce.grabbed() && (y(Pe), ce.emit($e("freeon")), Pe.emit($e("free")), r.dragData.didDrag && (ce.emit($e("dragfreeon")), Pe.emit($e("dragfree")))), Sr();
            else if (ce && ce.grabbed() && r.nodeIsDraggable(ce)) {
              var wr = !r.dragData.didDrag;
              wr && r.redrawHint("eles", !0), r.dragData.didDrag = !0, r.hoverData.draggingEles || h(Pe, {
                inDragLayer: !0
              });
              var ar = {
                x: 0,
              ...
              if (ae(ke[0]) && ae(ke[1]) && (ar.x += ke[0], ar.y += ke[1], wr)) {
                var xr = r.hoverData.dragDelta;
                xr && ae(xr[0]) && ae(xr[1]) && (ar.x += xr[0], ar.y += xr[1]);
              }
              r.hoverData.draggingEles = !0, Pe.silentShift(ar).emit($e("position")).emit($e("drag")), r.redrawHint("drag", !0), r.redraw();
            }
          } else
            Ar();
        W = !0;
      }
      if (fe[2] = re[0], fe[3] = re[1], W)
  ...
  r.registerBinding(e, "mouseup", function(S) {
    if (!(r.hoverData.which === 1 && S.which !== 1 && r.hoverData.capture)) {
      ...
      if (O) {
        ...
        var W = r.cy, G = r.projectIntoViewport(S.clientX, S.clientY), U = r.selection, ue = r.findNearestElement(G[0], G[1], !0, !1), re = r.dragData.possibleDragElements, oe = r.hoverData.down, ie = i(S);
        r.data.bgActivePosistion && (r.redrawHint("select", !0), r.redraw()), r.hoverData.tapholdCancelled = !0, r.data.bgActivePosistion = void 0, oe && oe.unactivate();
        var fe = function(tr) {
          return {
            originalEvent: S,
            type: tr,
        ...
        if (r.hoverData.which === 3) {
          var Ce = fe("cxttapend");
          if (oe ? oe.emit(Ce) : W.emit(Ce), !r.hoverData.cxtDragged) {
            var xe = fe("cxttap");
            oe ? oe.emit(xe) : W.emit(xe);
          }
          ...
          !r.hoverData.isOverThresholdDrag && (n(oe, ["click", "tap", "vclick"], S, {
            x: G[0],
            y: G[1]
          }), D = !1, S.timeStamp - P <= W.multiClickDebounceTime() ? (B && clearTimeout(B), D = !0, P = null, n(oe, ["dblclick", "dbltap", "vdblclick"], S, {
            x: G[0],
            y: G[1]
          })) : (B = setTimeout(function() {
            D || n(oe, ["oneclick", "onetap", "voneclick"], S, {
              x: G[0],
              y: G[1]
            });
          }, W.multiClickDebounceTime()), P = S.timeStamp)), oe == null && !r.dragData.didDrag && !r.hoverData.selecting && !r.hoverData.dragged && !i(S) && (W.$(t).unselect(["tapunselect"]), re.length > 0 && r.redrawHint("eles", !0), r.dragData.possibleDragElements = re = W.collection()), ue == oe && !r.dragData.didDrag && !r.hoverData.selecting && ue != null && ue._private.selectable && (r.hoverData.dragging || (W.selectionType() === "additive" || ie ? ue.selected() ? ue.unselect(["tapunselect"]) : ue.select(["tapselect"]) : ie || (W.$(t).unmerge(ue).unselect(["tapunselect"]), ue.select(["tapselect"]))), r.redrawHint("eles", !0)), r.hoverData.selecting) {
            var ce = W.collection(r.getAllInBox(U[0], U[1], U[2], U[3]));
            r.redrawHint("select", !0), ce.length > 0 && r.redrawHint("eles", !0), W.emit(fe("boxend"));
            var ke = function(tr) {
              return tr.selectable() && !tr.selected();
            };
            W.selectionType() === "additive" || ie || W.$(t).unmerge(ce).unselect(), ce.emit(fe("box")).stdFilter(ke).select().emit(fe("boxselect")), r.redraw();
          }
          if (r.hoverData.dragging && (r.hoverData.dragging = !1, r.redrawHint("select", !0), r.redrawHint("eles", !0), r.redraw()), !U[4]) {
            r.redrawHint("drag", !0), r.redrawHint("eles", !0);
            var Pe = oe && oe.grabbed();
            y(re), Pe && (oe.emit(fe("freeon")), re.emit(fe("free")), r.dragData.didDrag && (oe.emit(fe("dragfreeon")), re.emit(fe("dragfree"))));
          }
        }
        U[4] = 0, r.hoverData.down = null, r.hoverData.cxtStarted = !1, r.hoverData.draggingEles = !1, r.hoverData.selecting = !1, r.hoverData.isOverThresholdDrag = !1, r.dragData.didDrag = !1, r.hoverData.dragged = !1, r.hoverData.dragDelta = [], r.hoverData.mdownPos = null, r.hoverData.mdownGPos = null, r.hoverData.which = null;
      }
    }
  }, !1);
  var A = [], R = 4, L, I = 1e5, M = function(S) {
    for (var O = Math.abs(S[0]), W = 1; W < S.length; W++)
      if (Math.abs(S[W]) !== O)
        return !1;
    return !0;
  }, N = function(S) {
    var O = !1, W = S.deltaY;
    if (W == null && (S.wheelDeltaY != null ? W = S.wheelDeltaY / 4 : S.wheelDelta != null && (W = S.wheelDelta / 4)), W !== 0) {
      if (L == null)
        if (A.length >= R) {
          L = !1;
          var G = A;
          if (G[0] >= 5) {
            var U;
            M(G) ? U = G[0] : U = Cd(G), U > 1 && (L = !0, I = U);
          }
        } else
          A.push(Math.abs(W)), O = !0;
      else L && (I = Math.min(Math.abs(W), I));
      if (!r.scrollingPage) {
        var ue = r.cy, re = ue.zoom(), oe = ue.pan(), ie = r.projectIntoViewport(S.clientX, S.clientY), fe = [ie[0] * re + oe.x, ie[1] * re + oe.y];
        if (r.hoverData.draggingEles || r.hoverData.dragging || r.hoverData.cxtStarted || x()) {
          S.preventDefault();
          return;
        }
        if (ue.panningEnabled() && ue.userPanningEnabled() && ue.zoomingEnabled() && ue.userZoomingEnabled()) {
          ...
          var Ce;
          O && Math.abs(W) > 5 && (W = ro(W) * 5), Ce = W / -250, L && (Ce /= I, Ce *= 3), Ce = Ce * r.wheelSensitivity;
          var xe = S.deltaMode === 1;
          xe && (Ce *= 33);
          var ce = ue.zoom() * Math.pow(10, Ce);
          S.type === "gesturechange" && (ce = r.gestureStartZoom * S.scale), ue.zoom({
            level: ce,
            renderedPosition: {
              x: fe[0],
              y: fe[1]
  ...
  r.registerBinding(r.container, "wheel", N, !0), r.registerBinding(e, "scroll", function(S) {
  ...
  }, !0), r.registerBinding(r.container, "gesturechange", function(ee) {
    r.hasTouchStarted || N(ee);
  }, !0), r.registerBinding(r.container, "mouseout", function(S) {
    var O = r.projectIntoViewport(S.clientX, S.clientY);
    r.cy.emit({
      originalEvent: S,
      type: "mouseout",
      position: {
  ...
  var F, _, z, q, Z, Q, X, J, j, ne, Y, V, H, $ = function(S, O, W, G) {
    return Math.sqrt((W - S) * (W - S) + (G - O) * (G - O));
  }, K = function(S, O, W, G) {
    return (W - S) * (W - S) + (G - O) * (G - O);
  }, te;
  r.registerBinding(r.container, "touchstart", te = function(S) {
    if (r.hasTouchStarted = !0, !!T(S)) {
      p(), r.touchData.capture = !0, r.data.bgActivePosistion = void 0;
      var O = r.cy, W = r.touchData.now, G = r.touchData.earlier;
      if (S.touches[0]) {
        var U = r.projectIntoViewport(S.touches[0].clientX, S.touches[0].clientY);
        W[0] = U[0], W[1] = U[1];
      }
      if (S.touches[1]) {
        var U = r.projectIntoViewport(S.touches[1].clientX, S.touches[1].clientY);
        W[2] = U[0], W[3] = U[1];
      }
      if (S.touches[2]) {
        var U = r.projectIntoViewport(S.touches[2].clientX, S.touches[2].clientY);
        W[4] = U[0], W[5] = U[1];
      }
      var ue = function(fr) {
        return {
      ...
      if (S.touches[1]) {
        r.touchData.singleTouchMoved = !0, y(r.dragData.touchDragEles);
        var re = r.findContainerClientCoords();
        j = re[0], ne = re[1], Y = re[2], V = re[3], F = S.touches[0].clientX - j, _ = S.touches[0].clientY - ne, z = S.touches[1].clientX - j, q = S.touches[1].clientY - ne, H = 0 <= F && F <= Y && 0 <= z && z <= Y && 0 <= _ && _ <= V && 0 <= q && q <= V;
        var oe = O.pan(), ie = O.zoom();
        Z = $(F, _, z, q), Q = K(F, _, z, q), X = [(F + z) / 2, (_ + q) / 2], J = [(X[0] - oe.x) / ie, (X[1] - oe.y) / ie];
        var fe = 200, Ce = fe * fe;
        if (Q < Ce && !S.touches[2]) {
          var xe = r.findNearestElement(W[0], W[1], !0, !0), ce = r.findNearestElement(W[2], W[3], !0, !0);
          xe && xe.isNode() ? (xe.activate().emit(ue("cxttapstart")), r.touchData.start = xe) : ce && ce.isNode() ? (ce.activate().emit(ue("cxttapstart")), r.touchData.start = ce) : O.emit(ue("cxttapstart")), r.touchData.start && (r.touchData.start._private.grabbed = !1), r.touchData.cxt = !0, r.touchData.cxtDragged = !1, r.data.bgActivePosistion = void 0, r.redraw();
          return;
        }
      }
      if (S.touches[2])
        O.boxSelectionEnabled() && S.preventDefault();
      else if (!S.touches[1]) {
        if (S.touches[0]) {
          var ke = r.findNearestElements(W[0], W[1], !0, !0), Pe = ke[0];
          if (Pe != null && (Pe.activate(), r.touchData.start = Pe, r.touchData.starts = ke, r.nodeIsGrabbable(Pe))) {
            var rr = r.dragData.touchDragEles = O.collection(), tr = null;
            r.redrawHint("eles", !0), r.redrawHint("drag", !0), Pe.selected() ? (tr = O.$(function(We) {
              return We.selected() && r.nodeIsGrabbable(We);
            }), h(tr, {
              addToList: rr
            })) : d(Pe, {
              addToList: rr
            }), l(Pe), Pe.emit(ue("grabon")), tr ? tr.forEach(function(We) {
              We.emit(ue("grab"));
            }) : Pe.emit(ue("grab"));
          }
          n(Pe, ["touchstart", "tapstart", "vmousedown"], S, {
            x: W[0],
            y: W[1]
      ...
      if (S.touches.length >= 1) {
        for (var br = r.touchData.startPosition = [null, null, null, null, null, null], Ye = 0; Ye < W.length; Ye++)
          br[Ye] = G[Ye] = W[Ye];
        var Ze = S.touches[0];
        r.touchData.startGPosition = [Ze.clientX, Ze.clientY];
      }
    }
  }, !1);
  var ve;
  r.registerBinding(e, "touchmove", ve = function(S) {
    var O = r.touchData.capture;
    if (!(!O && !T(S))) {
      var W = r.selection, G = r.cy, U = r.touchData.now, ue = r.touchData.earlier, re = G.zoom();
      if (S.touches[0]) {
        var oe = r.projectIntoViewport(S.touches[0].clientX, S.touches[0].clientY);
        U[0] = oe[0], U[1] = oe[1];
      }
      if (S.touches[1]) {
        var oe = r.projectIntoViewport(S.touches[1].clientX, S.touches[1].clientY);
        U[2] = oe[0], U[3] = oe[1];
      }
      if (S.touches[2]) {
        var oe = r.projectIntoViewport(S.touches[2].clientX, S.touches[2].clientY);
        U[4] = oe[0], U[5] = oe[1];
      }
      var ie = function(rc) {
        return {
      ...
      }, fe = r.touchData.startGPosition, Ce;
      if (O && S.touches[0] && fe) {
        for (var xe = [], ce = 0; ce < U.length; ce++)
          xe[ce] = U[ce] - ue[ce];
        var ke = S.touches[0].clientX - fe[0], Pe = ke * ke, rr = S.touches[0].clientY - fe[1], tr = rr * rr, br = Pe + tr;
        Ce = br >= r.touchTapThreshold2;
      }
      if (O && r.touchData.cxt) {
        S.preventDefault();
        var Ye = S.touches[0].clientX - j, Ze = S.touches[0].clientY - ne, We = S.touches[1].clientX - j, fr = S.touches[1].clientY - ne, Ar = K(Ye, Ze, We, fr), $e = Ar / Q, Sr = 150, Rr = Sr * Sr, Qr = 1.5, Mt = Qr * Qr;
        if ($e >= Mt || Ar >= Rr) {
          r.touchData.cxt = !1, r.data.bgActivePosistion = void 0, r.redrawHint("select", !0);
          var yt = ie("cxttapend");
          r.touchData.start ? (r.touchData.start.unactivate().emit(yt), r.touchData.start = null) : G.emit(yt);
        }
      }
      if (O && r.touchData.cxt) {
        var yt = ie("cxtdrag");
        r.data.bgActivePosistion = void 0, r.redrawHint("select", !0), r.touchData.start ? r.touchData.start.emit(yt) : G.emit(yt), r.touchData.start && (r.touchData.start._private.grabbed = !1), r.touchData.cxtDragged = !0;
        var wr = r.findNearestElement(U[0], U[1], !0, !0);
        (!r.touchData.cxtOver || wr !== r.touchData.cxtOver) && (r.touchData.cxtOver && r.touchData.cxtOver.emit(ie("cxtdragout")), r.touchData.cxtOver = wr, wr && wr.emit(ie("cxtdragover")));
      } else if (O && S.touches[2] && G.boxSelectionEnabled())
        S.preventDefault(), r.data.bgActivePosistion = void 0, this.lastThreeTouch = +/* @__PURE__ */ new Date(), r.touchData.selecting || G.emit(ie("boxstart")), r.touchData.selecting = !0, r.touchData.didSelect = !0, W[4] = 1, !W || W.length === 0 || W[0] === void 0 ? (W[0] = (U[0] + U[2] + U[4]) / 3, W[1] = (U[1] + U[3] + U[5]) / 3, W[2] = (U[0] + U[2] + U[4]) / 3 + 1, W[3] = (U[1] + U[3] + U[5]) / 3 + 1) : (W[2] = (U[0] + U[2] + U[4]) / 3, W[3] = (U[1] + U[3] + U[5]) / 3), r.redrawHint("select", !0), r.redraw();
      else if (O && S.touches[1] && !r.touchData.didSelect && G.zoomingEnabled() && G.panningEnabled() && G.userZoomingEnabled() && G.userPanningEnabled()) {
        S.preventDefault(), r.data.bgActivePosistion = void 0, r.redrawHint("select", !0);
        var ar = r.dragData.touchDragEles;
        if (ar) {
          r.redrawHint("drag", !0);
          for (var xr = 0; xr < ar.length; xr++) {
            var oa = ar[xr]._private;
            oa.grabbed = !1, oa.rscratch.inDragLayer = !1;
          }
        }
        var kr = r.touchData.start, Ye = S.touches[0].clientX - j, Ze = S.touches[0].clientY - ne, We = S.touches[1].clientX - j, fr = S.touches[1].clientY - ne, bo = $(Ye, Ze, We, fr), Uf = bo / Z;
        if (H) {
          var Kf = Ye - F, Xf = Ze - _, Yf = We - z, Zf = fr - q, Qf = (Kf + Yf) / 2, Jf = (Xf + Zf) / 2, ua = G.zoom(), Yn = ua * Uf, $a = G.pan(), wo = J[0] * ua + $a.x, xo = J[1] * ua + $a.y, jf = {
            x: -Yn / ua * (wo - $a.x - Qf) + wo,
            y: -Yn / ua * (xo - $a.y - Jf) + xo
          };
          if (kr && kr.active()) {
            var ar = r.dragData.touchDragEles;
            y(ar), r.redrawHint("drag", !0), r.redrawHint("eles", !0), kr.unactivate().emit(ie("freeon")), ar && ar.emit(ie("free")), r.dragData.didDrag && (kr.emit(ie("dragfreeon")), ar && ar.emit(ie("dragfree")));
          }
          G.viewport({
            zoom: Yn,
            pan: jf,
            cancelOnFailedZoom: !0
          }), G.emit(ie("pinchzoom")), Z = bo, F = Ye, _ = Ze, z = We, q = fr, r.pinching = !0;
        }
        if (S.touches[0]) {
          var oe = r.projectIntoViewport(S.touches[0].clientX, S.touches[0].clientY);
          U[0] = oe[0], U[1] = oe[1];
        ...
        var Mr = r.touchData.start, Zn = r.touchData.last, wr;
        if (!r.hoverData.draggingEles && !r.swipePanning && (wr = r.findNearestElement(U[0], U[1], !0, !0)), O && Mr != null && S.preventDefault(), O && Mr != null && r.nodeIsDraggable(Mr))
          if (Ce) {
            var ar = r.dragData.touchDragEles, Eo = !r.dragData.didDrag;
            Eo && h(ar, {
              inDragLayer: !0
            ...
            if (ae(xe[0]) && ae(xe[1]) && (la.x += xe[0], la.y += xe[1], Eo)) {
              r.redrawHint("eles", !0);
              var Lr = r.touchData.dragDelta;
              Lr && ae(Lr[0]) && ae(Lr[1]) && (la.x += Lr[0], la.y += Lr[1]);
            }
            r.hoverData.draggingEles = !0, ar.silentShift(la).emit(ie("position")).emit(ie("drag")), r.redrawHint("drag", !0), r.touchData.startPosition[0] == ue[0] && r.touchData.startPosition[1] == ue[1] && r.redrawHint("eles", !0), r.redraw();
          } else {
            var Lr = r.touchData.dragDelta = r.touchData.dragDelta || [];
            Lr.length === 0 ? (Lr.push(xe[0]), Lr.push(xe[1])) : (Lr[0] += xe[0], Lr[1] += xe[1]);
          }
        if (n(Mr || wr, ["touchmove", "tapdrag", "vmousemove"], S, {
          x: U[0],
          y: U[1]
        }), (!Mr || !Mr.grabbed()) && wr != Zn && (Zn && Zn.emit(ie("tapdragout")), wr && wr.emit(ie("tapdragover"))), r.touchData.last = wr, O)
          for (var xr = 0; xr < U.length; xr++)
            U[xr] && r.touchData.startPosition[xr] && Ce && (r.touchData.singleTouchMoved = !0);
        if (O && (Mr == null || Mr.pannable()) && G.panningEnabled() && G.userPanningEnabled()) {
          var ec = s(Mr, r.touchData.starts);
          ec && (S.preventDefault(), r.data.bgActivePosistion || (r.data.bgActivePosistion = Gt(r.touchData.startPosition)), r.swipePanning ? (G.panBy({
            x: xe[0] * re,
            y: xe[1] * re
          }), G.emit(ie("dragpan"))) : Ce && (r.swipePanning = !0, G.panBy({
            x: ke * re,
            y: rr * re
          }), G.emit(ie("dragpan")), Mr && (Mr.unactivate(), r.redrawHint("select", !0), r.touchData.start = null)));
          var oe = r.projectIntoViewport(S.touches[0].clientX, S.touches[0].clientY);
          U[0] = oe[0], U[1] = oe[1];
        }
      }
      for (var ce = 0; ce < U.length; ce++)
        ue[ce] = U[ce];
      O && S.touches.length > 0 && !r.hoverData.draggingEles && !r.swipePanning && r.data.bgActivePosistion != null && (r.data.bgActivePosistion = void 0, r.redrawHint("select", !0), r.redraw());
    }
  }, !1);
  var De;
  r.registerBinding(e, "touchcancel", De = function(S) {
    var O = r.touchData.start;
    r.touchData.capture = !1, O && O.unactivate();
  });
  var we, ye, pe, se;
  if (r.registerBinding(e, "touchend", we = function(S) {
    var O = r.touchData.start, W = r.touchData.capture;
    if (W)
    ...
    var U = r.cy, ue = U.zoom(), re = r.touchData.now, oe = r.touchData.earlier;
    if (S.touches[0]) {
    ...
    var Ce;
    if (r.touchData.cxt) {
      if (Ce = fe("cxttapend"), O ? O.emit(Ce) : U.emit(Ce), !r.touchData.cxtDragged) {
        var xe = fe("cxttap");
        O ? O.emit(xe) : U.emit(xe);
      }
      r.touchData.start && (r.touchData.start._private.grabbed = !1), r.touchData.cxt = !1, r.touchData.start = null, r.redraw();
      return;
    }
    if (!S.touches[2] && U.boxSelectionEnabled() && r.touchData.selecting) {
      r.touchData.selecting = !1;
      var ce = U.collection(r.getAllInBox(G[0], G[1], G[2], G[3]));
      G[0] = void 0, G[1] = void 0, G[2] = void 0, G[3] = void 0, G[4] = 0, r.redrawHint("select", !0), U.emit(fe("boxend"));
      var ke = function(Rr) {
        return Rr.selectable() && !Rr.selected();
      };
      ce.emit(fe("box")).stdFilter(ke).select().emit(fe("boxselect")), ce.nonempty() && r.redrawHint("eles", !0), r.redraw();
    }
    if (O?.unactivate(), S.touches[2])
      ...
      if (!S.touches[0]) {
        if (!S.touches[0]) {
          ...
          if (O != null) {
            var rr = O._private.grabbed;
            y(Pe), r.redrawHint("drag", !0), r.redrawHint("eles", !0), rr && (O.emit(fe("freeon")), Pe.emit(fe("free")), r.dragData.didDrag && (O.emit(fe("dragfreeon")), Pe.emit(fe("dragfree")))), n(O, ["touchend", "tapend", "vmouseup", "tapdragout"], S, {
              x: re[0],
              y: re[1]
            }), O.unactivate(), r.touchData.start = null;
          } else {
            var tr = r.findNearestElement(re[0], re[1], !0, !0);
            n(tr, ["touchend", "tapend", "vmouseup", "tapdragout"], S, {
              x: re[0],
              y: re[1]
            });
          }
          var br = r.touchData.startPosition[0] - re[0], Ye = br * br, Ze = r.touchData.startPosition[1] - re[1], We = Ze * Ze, fr = Ye + We, Ar = fr * ue * ue;
          r.touchData.singleTouchMoved || (O || U.$(":selected").unselect(["tapunselect"]), n(O, ["tap", "vclick"], S, {
            x: re[0],
            y: re[1]
          }), ye = !1, S.timeStamp - se <= U.multiClickDebounceTime() ? (pe && clearTimeout(pe), ye = !0, se = null, n(O, ["dbltap", "vdblclick"], S, {
            x: re[0],
            y: re[1]
          })) : (pe = setTimeout(function() {
            ye || n(O, ["onetap", "voneclick"], S, {
              x: re[0],
              y: re[1]
            });
          }, U.multiClickDebounceTime()), se = S.timeStamp)), O != null && !r.dragData.didDrag && O._private.selectable && Ar < r.touchTapThreshold2 && !r.pinching && (U.selectionType() === "single" ? (U.$(t).unmerge(O).unselect(["tapunselect"]), O.select(["tapselect"])) : O.selected() ? O.unselect(["tapunselect"]) : O.select(["tapselect"]), r.redrawHint("eles", !0)), r.touchData.singleTouchMoved = !0;
        }
      }
    }
    ...
    var de = [], ge = function(S) {
      ...
      var O = de.filter(function(W) {
        return W.event.pointerId === S.pointerId;
      })[0];
      O.event = S, O.touch = ge(S);
    }, Ae = function(S) {
      S.touches = de.map(function(O) {
        return O.touch;
      });
    }, Le = function(S) {
      return S.pointerType === "mouse" || S.pointerType === 4;
    };
    r.registerBinding(r.container, "pointerdown", function(ee) {
      Le(ee) || (ee.preventDefault(), be(ee), Ae(ee), te(ee));
    }), r.registerBinding(r.container, "pointerup", function(ee) {
      Le(ee) || (Te(ee), Ae(ee), we(ee));
    }), r.registerBinding(r.container, "pointercancel", function(ee) {
      Le(ee) || (Te(ee), Ae(ee), De(ee));
    }), r.registerBinding(r.container, "pointermove", function(ee) {
      Le(ee) || (ee.preventDefault(), Be(ee), Ae(ee), ve(ee));
    });
  }
};
var Yr = {};
Yr.generatePolygon = function(r, e) {
  return this.nodeShapes[r] = {
    ...
    intersectLine: function(a, n, i, s, o, u, l, v) {
      return Da(o, u, this.points, a, n, i / 2, s / 2, l);
    },
    checkPoint: function(a, n, i, s, o, u, l, v) {
      return Xr(a, n, this.points, u, l, s, o, [0, -1], i);
    },
    hasMiterBounds: r !== "rectangle",
    miterBounds: function(a, n, i, s, o, u) {
      return Md(this.points, a, n, i, s, o);
    }
  };
};
Yr.generateEllipse = function() {
  return this.nodeShapes.ellipse = {
    ...
    intersectLine: function(e, t, a, n, i, s, o, u) {
      return qd(i, s, e, t, a / 2 + o, n / 2 + o);
    },
    checkPoint: function(e, t, a, n, i, s, o, u) {
      return Tt(e, t, n, i, s, o, a);
    }
  };
};
Yr.generateRoundPolygon = function(r, e) {
  return this.nodeShapes[r] = {
    renderer: this,
    name: r,
    points: e,
    getOrCreateCorners: function(a, n, i, s, o, u, l) {
      if (u[l] !== void 0 && u[l + "-cx"] === a && u[l + "-cy"] === n && u[l + "-w"] === i && u[l + "-h"] === s && u[l + "-corner-radius"] === o)
        return u[l];
      u[l] = new Array(e.length / 2), u[l + "-cx"] = a, u[l + "-cy"] = n, u[l + "-w"] = i, u[l + "-h"] = s, u[l + "-corner-radius"] = o;
      var v = i / 2, f = s / 2;
      o = o === "auto" ? Cv(i, s) : o;
      ...
      var d, y, g, p, m = c.length;
      for (y = c[m - 1], d = 0; d < m; d++)
        g = c[d % m], p = c[(d + 1) % m], u[l][d] = go(y, g, p, o), y = g, g = p;
      return u[l];
    },
    ...
    intersectLine: function(a, n, i, s, o, u, l, v, f) {
      return Gd(o, u, this.points, a, n, i, s, l, this.getOrCreateCorners(a, n, i, s, v, f, "corners"));
    },
    checkPoint: function(a, n, i, s, o, u, l, v, f) {
      return Vd(a, n, this.points, u, l, s, o, this.getOrCreateCorners(u, l, s, o, v, f, "corners"));
    }
  };
};
Yr.generateRoundRectangle = function() {
  return this.nodeShapes["round-rectangle"] = this.nodeShapes.roundrectangle = {
    ...
    checkPoint: function(e, t, a, n, i, s, o, u) {
      var l = n / 2, v = i / 2;
      u = u === "auto" ? ut(n, i) : u, u = Math.min(l, v, u);
      var f = u * 2;
      return !!(Xr(e, t, this.points, s, o, n, i - f, [0, -1], a) || Xr(e, t, this.points, s, o, n - f, i, [0, -1], a) || Tt(e, t, f, f, s - l + u, o - v + u, a) || Tt(e, t, f, f, s + l - u, o - v + u, a) || Tt(e, t, f, f, s + l - u, o + v - u, a) || Tt(e, t, f, f, s - l + u, o + v - u, a));
    }
  };
};
Yr.generateCutRectangle = function() {
  return this.nodeShapes["cut-rectangle"] = this.nodeShapes.cutrectangle = {
    ...
    generateCutTrianglePts: function(e, t, a, n, i) {
      var s = i === "auto" ? this.cornerLength : i, o = t / 2, u = e / 2, l = a - u, v = a + u, f = n - o, c = n + o;
      return {
        topLeft: [l, f + s, l + s, f, l + s, f + s],
        topRight: [v - s, f, v, f + s, v - s, f + s],
        bottomRight: [v, c - s, v - s, c, v - s, c - s],
        bottomLeft: [l + s, c, l, c - s, l + s, c - s]
      };
    },
    intersectLine: function(e, t, a, n, i, s, o, u) {
      var l = this.generateCutTrianglePts(a + 2 * o, n + 2 * o, e, t, u), v = [].concat.apply([], [l.topLeft.splice(0, 4), l.topRight.splice(0, 4), l.bottomRight.splice(0, 4), l.bottomLeft.splice(0, 4)]);
      return Da(i, s, v, e, t);
    },
    checkPoint: function(e, t, a, n, i, s, o, u) {
      var l = u === "auto" ? this.cornerLength : u;
      if (Xr(e, t, this.points, s, o, n, i - 2 * l, [0, -1], a) || Xr(e, t, this.points, s, o, n - 2 * l, i, [0, -1], a))
        return !0;
      var v = this.generateCutTrianglePts(n, i, s, o);
      return Er(e, t, v.topLeft) || Er(e, t, v.topRight) || Er(e, t, v.bottomRight) || Er(e, t, v.bottomLeft);
    }
  };
};
Yr.generateBarrel = function() {
  return this.nodeShapes.barrel = {
    ...
    intersectLine: function(e, t, a, n, i, s, o, u) {
      var l = 0.15, v = 0.5, f = 0.85, c = this.generateBarrelBezierPts(a + 2 * o, n + 2 * o, e, t), h = function(g) {
        var p = $t({
          x: g[0],
          y: g[1]
        }, {
    ...
    generateBarrelBezierPts: function(e, t, a, n) {
      var i = t / 2, s = e / 2, o = a - s, u = a + s, l = n - i, v = n + i, f = Ps(e, t), c = f.heightOffset, h = f.widthOffset, d = f.ctrlPtOffsetPct * e, y = {
        topLeft: [o, l + c, o + d, l, o + h, l],
        topRight: [u - h, l, u - d, l, u, l + c],
        bottomRight: [u, v - c, u - d, v, u - h, v],
    ...
    checkPoint: function(e, t, a, n, i, s, o, u) {
      var l = Ps(n, i), v = l.heightOffset, f = l.widthOffset;
      if (Xr(e, t, this.points, s, o, n, i - 2 * v, [0, -1], a) || Xr(e, t, this.points, s, o, n - 2 * f, i, [0, -1], a))
        return !0;
      for (var c = this.generateBarrelBezierPts(n, i, s, o), h = function(T, k, B) {
        var D = B[4], P = B[2], A = B[0], R = B[5], L = B[1], I = Math.min(D, A), M = Math.max(D, A), N = Math.min(R, L), F = Math.max(R, L);
        if (I <= T && T <= M && N <= k && k <= F) {
          var _ = Hd(D, P, A), z = Od(_[0], _[1], _[2], T), q = z.filter(function(Z) {
            return 0 <= Z && Z <= 1;
          });
          if (q.length > 0)
            return q[0];
        ...
        return null;
      }, d = Object.keys(c), y = 0; y < d.length; y++) {
        var g = d[y], p = c[g], m = h(e, t, p);
        if (m != null) {
          var b = p[5], w = p[3], E = p[1], C = nr(b, w, E, m);
...
Yr.generateBottomRoundrectangle = function() {
  return this.nodeShapes["bottom-round-rectangle"] = this.nodeShapes.bottomroundrectangle = {
    ...
    intersectLine: function(e, t, a, n, i, s, o, u) {
      var l = e - (a / 2 + o), v = t - (n / 2 + o), f = v, c = e + (a / 2 + o), h = at(i, s, e, t, l, v, c, f, !1);
      return h.length > 0 ? h : xv(i, s, e, t, a, n, o, u);
    },
    checkPoint: function(e, t, a, n, i, s, o, u) {
      u = u === "auto" ? ut(n, i) : u;
      var l = 2 * u;
      if (Xr(e, t, this.points, s, o, n, i - l, [0, -1], a) || Xr(e, t, this.points, s, o, n - l, i, [0, -1], a))
        return !0;
      var v = n / 2 + 2 * a, f = i / 2 + 2 * a, c = [s - v, o - f, s - v, o, s + v, o, s + v, o - f];
      return !!(Er(e, t, c) || Tt(e, t, l, l, s + n / 2 - u, o + i / 2 - u, a) || Tt(e, t, l, l, s - n / 2 + u, o + i / 2 - u, a));
    }
  };
};
Yr.registerNodeShapes = function() {
  var r = this.nodeShapes = {}, e = this;
  this.generateEllipse(), this.generatePolygon("triangle", gr(3, 0)), this.generateRoundPolygon("round-triangle", gr(3, 0)), this.generatePolygon("rectangle", gr(4, 0)), r.square = r.rectangle, this.generateRoundRectangle(), this.generateCutRectangle(), this.generateBarrel(), this.generateBottomRoundrectangle();
  {
    var t = [0, 1, 1, 0, 0, -1, -1, 0];
    this.generatePolygon("diamond", t), this.generateRoundPolygon("round-diamond", t);
  }
  this.generatePolygon("pentagon", gr(5, 0)), this.generateRoundPolygon("round-pentagon", gr(5, 0)), this.generatePolygon("hexagon", gr(6, 0)), this.generateRoundPolygon("round-hexagon", gr(6, 0)), this.generatePolygon("heptagon", gr(7, 0)), this.generateRoundPolygon("round-heptagon", gr(7, 0)), this.generatePolygon("octagon", gr(8, 0)), this.generateRoundPolygon("round-octagon", gr(8, 0));
  var a = new Array(20);
  {
  ...
  r.makePolygon = function(l) {
    var v = l.join("$"), f = "polygon-" + v, c;
    return (c = this[f]) ? c : e.generatePolygon(f, l);
  };
};
var Ha = {};
...
[ho, Ef, Cf, ia, Yr, Ha].forEach(function(r) {
  me(sa, r);
});
var bs = 1e3 / 60, kf = {
  setupDequeueing: function(e) {
    return function() {
      ...
      if (!a.dequeueingSetup) {
        ...
        }, e.deqRedrawThreshold), s = function(l, v) {
          var f = Kr(), c = n.averageRedrawTime, h = n.lastRedrawTime, d = [], y = n.cy.extent(), g = n.getPixelRatio();
          for (l || n.flushRenderedStyleQueue(); ; ) {
            var p = Kr(), m = p - f, b = p - v;
            if (h < bs) {
              var w = bs - (l ? c : 0);
              if (b >= e.deqFastCost * w)
                break;
            } else if (l) {
              if (m >= e.deqCost * h || m >= e.deqAvgCost * c)
                break;
  ...
  function r(e) {
    var t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : wn;
    ct(this, r), this.idsByKey = new Ur(), this.keyForId = new Ur(), this.cachesByLvl = new Ur(), this.lvls = [], this.getKey = e, this.doesEleInvalidateKey = t;
  }
  return dt(r, [{
    key: "getIdsFor",
    value: function(t) {
      t == null && Ge("Can not get id list for null key");
    ...
    value: function(t) {
      ...
      return i || (i = new Ur(), a.set(t, i), n.push(t)), i;
    }
  }, {
    key: "getCache",
    value: function(t, a) {
...
})(), Ol = 25, an = 50, gn = -4, Gs = 3, Df = 7.99, vy = 8, fy = 1024, cy = 1024, dy = 1024, hy = 0.2, gy = 0.8, py = 10, yy = 0.15, my = 0.1, by = 0.9, wy = 0.9, xy = 100, Ey = 1, Wt = {
  dequeue: "dequeue",
  downscale: "downscale",
  highQuality: "highQuality"
}, Cy = lr({
  getKey: null,
  doesEleInvalidateKey: wn,
  drawElement: null,
  getBoundingBox: null,
...
er.getElement = function(r, e, t, a, n) {
  ...
  if (!e || e.w === 0 || e.h === 0 || isNaN(e.w) || isNaN(e.h) || !r.visible() || r.removed() || !i.allowEdgeTxrCaching && r.isEdge() || !i.allowParentTxrCaching && r.isParent())
    return null;
  if (a == null && (a = Math.ceil(eo(o * t))), a < gn)
    a = gn;
  else if (o >= Df || a > Gs)
    return null;
  var l = Math.pow(2, a), v = e.h * l, f = e.w * l, c = s.eleTextBiggerThanMin(r, l);
  ...
  if (h && h.invalidated && (h.invalidated = !1, h.texture.invalidatedWidth -= h.width), h)
    return h;
  var d;
  if (v <= Ol ? d = Ol : v <= an ? d = an : d = Math.ceil(v / an) * an, v > dy || f > cy)
    return null;
  ...
  }, b = n && n === Wt.dequeue, w = n && n === Wt.highQuality, E = n && n === Wt.downscale, C, x = a + 1; x <= Gs; x++) {
    var T = u.get(r, x);
    if (T) {
      C = T;
      break;
  ...
  var k = C && C.level === a + 1 ? C : null, B = function() {
    g.context.drawImage(k.texture.canvas, k.x, 0, k.width, k.height, g.usedWidth, 0, f, v);
  };
  if (g.context.setTransform(1, 0, 0, 1, 0, 0), g.context.clearRect(g.usedWidth, 0, f, d), m(k))
    B();
  else if (m(C))
    if (w) {
      for (var D = C.level; D > a; D--)
        k = i.getElement(r, e, t, D, Wt.downscale);
      B();
    } else
    ...
    g.context.translate(g.usedWidth, 0), g.context.scale(l, l), this.drawElement(g.context, r, e, c, !1), g.context.scale(1 / l, 1 / l), g.context.translate(-g.usedWidth, 0);
  }
  return h = {
    x: g.usedWidth,
    texture: g,
    ...
    height: v,
    scaledLabelShown: c
  }, g.usedWidth += Math.ceil(f + vy), g.eleCaches.push(h), u.set(r, a, h), i.checkTextureFullness(g), h;
};
er.invalidateElements = function(r) {
  for (var e = 0; e < r.length; e++)
    this.invalidateElement(r[e]);
};
er.invalidateElement = function(r) {
  ...
  if (n) {
    ...
    if (o)
      for (var u = 0; u < a.length; u++) {
        var l = a[u], v = l.texture;
        v.invalidatedWidth += l.width, l.invalidated = !0, e.checkTextureUtility(v);
      }
    e.removeFromQueue(r);
  }
};
er.checkTextureUtility = function(r) {
  r.invalidatedWidth >= hy * r.width && this.retireTexture(r);
};
er.checkTextureFullness = function(r) {
  var e = this, t = e.getTextureQueue(r.height);
  r.usedWidth / r.width > gy && r.fullnessChecks >= py ? ot(t, r) : r.fullnessChecks++;
};
er.retireTexture = function(r) {
...
er.addTexture = function(r, e) {
  var t = this, a = t.getTextureQueue(r), n = {};
  return a.push(n), n.eleCaches = [], n.height = r, n.width = Math.max(fy, e), n.usedWidth = 0, n.invalidatedWidth = 0, n.fullnessChecks = 0, n.canvas = t.renderer.makeOffscreenCanvas(n.width, n.height), n.context = n.canvas.getContext("2d"), n;
};
er.recycleTexture = function(r, e) {
  for (var t = this, a = t.getTextureQueue(r), n = t.getRetiredTextureQueue(r), i = 0; i < n.length; i++) {
    var s = n[i];
    if (s.width >= e)
      return s.retired = !1, s.usedWidth = 0, s.invalidatedWidth = 0, s.fullnessChecks = 0, js(s.eleCaches), s.context.setTransform(1, 0, 0, 1, 0, 0), s.context.clearRect(0, 0, s.width, s.height), ot(n, s), a.push(s), s;
  }
};
er.queueElement = function(r, e) {
...
er.dequeue = function(r) {
  for (var e = this, t = e.getElementQueue(), a = e.getElementKeyToQueue(), n = [], i = e.lookup, s = 0; s < Ey && t.size() > 0; s++) {
    var o = t.pop(), u = o.key, l = o.eles[0], v = i.hasCache(l, o.level);
    if (a[u] = null, v)
      continue;
    n.push(o);
    var f = e.getBoundingBox(l);
    e.getElement(l, f, r, o.level, Wt.dequeue);
  }
  return n;
};
er.removeFromQueue = function(r) {
  var e = this, t = e.getElementQueue(), a = e.getElementKeyToQueue(), n = this.getKey(r), i = a[n];
  i != null && (i.eles.length === 1 ? (i.reqs = Qs, t.updateItem(i), t.pop(), a[n] = null) : i.eles.unmerge(r));
};
er.onDequeue = function(r) {
  this.onDequeues.push(r);
};
er.offDequeue = function(r) {
  ot(this.onDequeues, r);
};
er.setupDequeueing = kf.setupDequeueing({
...
var Ty = 1, xa = -4, Bn = 2, Sy = 3.99, ky = 50, Dy = 50, By = 0.15, Py = 0.1, Ay = 0.9, Ry = 0.9, My = 1, Nl = 250, Ly = 4e3 * 4e3, zl = 32767, Iy = !0, Bf = function(e) {
  var t = this, a = t.renderer = e, n = a.cy;
  t.layersByLevel = {}, t.firstGet = !0, t.lastInvalidationTime = Kr() - 2 * Nl, t.skipping = !1, t.eleTxrDeqs = n.collection(), t.scheduleElementRefinement = Fa(function() {
    t.refineElementTextures(t.eleTxrDeqs), t.eleTxrDeqs.unmerge(t.eleTxrDeqs);
  }, Dy), a.beforeRender(function(s, o) {
...
}, vr = Bf.prototype, Fl = 0, Oy = Math.pow(2, 53) - 1;
vr.makeLayer = function(r, e) {
...
vr.getLayers = function(r, e, t) {
  var a = this, n = a.renderer, i = n.cy, s = i.zoom(), o = a.firstGet;
  if (a.firstGet = !1, t == null) {
    if (t = Math.ceil(eo(s * e)), t < xa)
      t = xa;
    else if (s >= Sy || t > Bn)
      return null;
  }
  a.validateLayersElesOrdering(t, r);
  var u = a.layersByLevel, l = Math.pow(2, t), v = u[t] = u[t] || [], f, c = a.levelIsComplete(t, r), h, d = function() {
    var B = function(L) {
      if (a.validateLayersElesOrdering(L, r), a.levelIsComplete(L, r))
        return h = u[L], !0;
    }, D = function(L) {
      if (!h)
        for (var I = t + L; xa <= I && I <= Bn && !B(I); I += L)
          ;
    };
    D(1), D(-1);
  ...
  var y = function() {
    ...
    var D = B.after;
    y();
    var P = Math.ceil(f.w * l), A = Math.ceil(f.h * l);
    if (P > zl || A > zl)
      return null;
    var R = P * A;
    if (R > Ly)
    ...
    if (D != null) {
      var I = v.indexOf(D) + 1;
      v.splice(I, 0, L);
    } else (B.insert === void 0 || B.insert) && v.unshift(L);
    return L;
  };
  if (a.skipping && !o)
    return null;
  for (var p = null, m = r.length / Ty, b = !o, w = 0; w < r.length; w++) {
...
vr.getEleLevelForLayerLevel = function(r, e) {
  return r;
};
vr.drawEleInLayer = function(r, e, t, a) {
  var n = this, i = this.renderer, s = r.context, o = e.boundingBox();
  o.w === 0 || o.h === 0 || !e.visible() || (t = n.getEleLevelForLayerLevel(t, a), i.setImgSmoothing(s, !1), i.drawCachedElement(s, e, null, null, t, Iy), i.setImgSmoothing(s, !0));
};
vr.levelIsComplete = function(r, e) {
...
vr.validateLayersElesOrdering = function(r, e) {
...
vr.updateElementsInLayers = function(r, e) {
  for (var t = this, a = Ia(r[0]), n = 0; n < r.length; n++)
    for (var i = a ? null : r[n], s = a ? r[n] : r[n].ele, o = s._private.rscratch, u = o.imgLayerCaches = o.imgLayerCaches || {}, l = xa; l <= Bn; l++) {
      var v = u[l];
      v && (i && t.getEleLevelForLayerLevel(v.level) !== i.level || e(v, s, i));
    }
};
vr.haveLayers = function() {
  for (var r = this, e = !1, t = xa; t <= Bn; t++) {
...
vr.invalidateElements = function(r) {
  var e = this;
  r.length !== 0 && (e.lastInvalidationTime = Kr(), !(r.length === 0 || !e.haveLayers()) && e.updateElementsInLayers(r, function(a, n, i) {
    e.invalidateLayer(a);
  }));
};
vr.invalidateLayer = function(r) {
  if (this.lastInvalidationTime = Kr(), !r.invalid) {
    var e = r.level, t = r.eles, a = this.layersByLevel[e];
    ot(a, r), r.elesQueue = [], r.invalid = !0, r.replacement && (r.replacement.invalid = !0);
...
vr.refineElementTextures = function(r) {
  var e = this;
...
vr.enqueueElementRefinement = function(r) {
  this.eleTxrDeqs.merge(r), this.scheduleElementRefinement();
};
vr.queueLayer = function(r, e) {
...
vr.dequeue = function(r) {
  for (var e = this, t = e.layersQueue, a = [], n = 0; n < My && t.size() !== 0; ) {
    var i = t.peek();
    if (i.replacement) {
      t.pop();
      continue;
...
vr.applyLayerReplacement = function(r) {
...
vr.requestRedraw = Fa(function() {
  var r = this.renderer;
  r.redrawHint("eles", !0), r.redrawHint("drag", !0), r.redraw();
}, 100);
vr.setupDequeueing = kf.setupDequeueing({
  deqRedrawThreshold: ky,
  deqCost: By,
  deqAvgCost: Py,
  deqNoDrawCost: Ay,
  deqFastCost: Ry,
...
Wr.drawCachedElementPortion = function(r, e, t, a, n, i, s, o) {
  ...
  if (!(l.w === 0 || l.h === 0)) {
    var v = t.getElement(e, l, a, n, i);
    if (v != null) {
      var f = o(u, e);
      if (f === 0)
        return;
      var c = s(u, e), h = l.x1, d = l.y1, y = l.w, g = l.h, p, m, b, w, E;
      if (c !== 0) {
        var C = t.getRotationPoint(e);
        b = C.x, w = C.y, r.translate(b, w), r.rotate(c), E = u.getImgSmoothing(r), E || u.setImgSmoothing(r, !0);
        var x = t.getRotationOffset(e);
        p = x.x, m = x.y;
      } else
        p = h, m = d;
      var T;
      f !== 1 && (T = r.globalAlpha, r.globalAlpha = T * f), r.drawImage(v.texture.canvas, v.x, 0, v.width, v.height, p, m, y, g), f !== 1 && (r.globalAlpha = T), c !== 0 && (r.rotate(-c), r.translate(-b, -w), E || u.setImgSmoothing(r, !1));
    } else
      t.drawElement(r, e);
  }
};
...
Wr.drawCachedElement = function(r, e, t, a, n, i) {
  var s = this, o = s.data, u = o.eleTxrCache, l = o.lblTxrCache, v = o.slbTxrCache, f = o.tlbTxrCache, c = e.boundingBox(), h = i === !0 ? u.reasons.highQuality : null;
  if (!(c.w === 0 || c.h === 0 || !e.visible()) && (!a || to(c, a))) {
    var d = e.isEdge(), y = e.element()._private.rscratch.badLine;
    s.drawElementUnderlay(r, e), s.drawCachedElementPortion(r, e, u, t, n, h, qy, Wy), (!d || !y) && s.drawCachedElementPortion(r, e, l, t, n, h, _y, ws), d && !y && (s.drawCachedElementPortion(r, e, v, t, n, h, Gy, ws), s.drawCachedElementPortion(r, e, f, t, n, h, Hy, ws)), s.drawElementOverlay(r, e);
  }
};
...
Zr.drawEdge = function(r, e, t) {
  ...
  if (!(i && !e.visible()) && !(o.badLine || o.allpts == null || isNaN(o.allpts[0]))) {
    ...
    var l = i ? e.pstyle("opacity").value : 1, v = i ? e.pstyle("line-opacity").value : 1, f = e.pstyle("curve-style").value, c = e.pstyle("line-style").value, h = e.pstyle("width").pfValue, d = e.pstyle("line-cap").value, y = e.pstyle("line-outline-width").value, g = e.pstyle("line-outline-color").value, p = l * v, m = l * v, b = function() {
      var L = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : p;
      f === "straight-triangle" ? (s.eleStrokeStyle(r, e, L), s.drawEdgeTrianglePath(e, r, o.allpts)) : (r.lineWidth = h, r.lineCap = d, s.eleStrokeStyle(r, e, L), s.drawEdgePath(e, r, o.allpts, c), r.lineCap = "butt");
    }, w = function() {
      var L = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : p;
    ...
    if (k) {
      var B = e.pstyle("ghost-offset-x").pfValue, D = e.pstyle("ghost-offset-y").pfValue, P = e.pstyle("ghost-opacity").value, A = p * P;
      r.translate(B, D), b(A), x(A), r.translate(-B, -D);
    } else
      w();
...
var Af = function(e) {
  ...
  return function(t, a) {
    if (a.visible()) {
      ...
      if (n !== 0) {
        var i = this, s = i.usePaths(), o = a._private.rscratch, u = a.pstyle("".concat(e, "-padding")).pfValue, l = 2 * u, v = a.pstyle("".concat(e, "-color")).value;
        t.lineWidth = l, o.edgeType === "self" && !s ? t.lineCap = "butt" : t.lineCap = "round", i.colorStrokeStyle(t, v[0], v[1], v[2], n), i.drawEdgePath(a, t, o.allpts, "solid");
      }
    }
  };
};
Zr.drawEdgeOverlay = Af("overlay");
Zr.drawEdgeUnderlay = Af("underlay");
Zr.drawEdgePath = function(r, e, t, a) {
  var n = r._private.rscratch, i = e, s, o = !1, u = this.usePaths(), l = r.pstyle("line-dash-pattern").pfValue, v = r.pstyle("line-dash-offset").pfValue;
  if (u) {
  ...
  if (i.setLineDash)
    switch (a) {
      case "dotted":
        ...
        break;
      case "dashed":
        i.setLineDash(l), i.lineDashOffset = v;
        break;
      case "solid":
        i.setLineDash([]);
        break;
...
Zr.drawEdgeTrianglePath = function(r, e, t) {
...
Zr.drawArrowheads = function(r, e, t) {
...
Zr.drawArrowhead = function(r, e, t, a, n, i, s) {
  if (!(isNaN(a) || a == null || isNaN(n) || n == null || isNaN(i) || i == null)) {
    var o = this, u = e.pstyle(t + "-arrow-shape").value;
    if (u !== "none") {
      var l = e.pstyle(t + "-arrow-fill").value === "hollow" ? "both" : "filled", v = e.pstyle(t + "-arrow-fill").value, f = e.pstyle("width").pfValue, c = e.pstyle(t + "-arrow-width"), h = c.value === "match-line" ? f : c.pfValue;
      c.units === "%" && (h *= f);
      var d = e.pstyle("opacity").value;
      s === void 0 && (s = d);
      var y = r.globalCompositeOperation;
      (s !== 1 || v === "hollow") && (r.globalCompositeOperation = "destination-out", o.colorFillStyle(r, 255, 255, 255, 1), o.colorStrokeStyle(r, 255, 255, 255, 1), o.drawArrowShape(e, r, l, f, u, h, a, n, i), r.globalCompositeOperation = y);
      var g = e.pstyle(t + "-arrow-color").value;
      o.colorFillStyle(r, g[0], g[1], g[2], s), o.colorStrokeStyle(r, g[0], g[1], g[2], s), o.drawArrowShape(e, r, v, f, u, h, a, n, i);
    }
  }
};
Zr.drawArrowShape = function(r, e, t, a, n, i, s, o, u) {
  var l = this, v = this.usePaths() && n !== "triangle-cross", f = !1, c, h = e, d = {
    x: s,
    y: o
  }, y = r.pstyle("arrow-scale").value, g = this.getArrowWidth(a, y), p = l.arrowShapes[n];
  if (v) {
    var m = l.arrowPathCache = l.arrowPathCache || [], b = St(n), w = m[b];
    w != null ? (c = e = w, f = !0) : (c = e = new Path2D(), m[b] = c);
  }
  f || (e.beginPath && e.beginPath(), v ? p.draw(e, 1, 0, {
    x: 0,
    y: 0
  }, 1) : p.draw(e, g, u, d, a), e.closePath && e.closePath()), e = h, v && (e.translate(s, o), e.rotate(u), e.scale(g, g)), (t === "filled" || t === "both") && (v ? e.fill(c) : e.fill()), (t === "hollow" || t === "both") && (e.lineWidth = i / (v ? g : 1), e.lineJoin = "miter", v ? e.stroke(c) : e.stroke()), v && (e.scale(1 / g, 1 / g), e.rotate(-u), e.translate(-s, -o));
};
var yo = {};
yo.safeDrawImage = function(r, e, t, a, n, i, s, o, u, l) {
  if (!(n <= 0 || i <= 0 || u <= 0 || l <= 0))
    try {
...
yo.drawInscribedImage = function(r, e, t, a, n) {
  ...
  var B = T, D = k;
  if (v(t, "background-width", "value", a) !== "auto" && (v(t, "background-width", "units", a) === "%" ? B = v(t, "background-width", "pfValue", a) * g : B = v(t, "background-width", "pfValue", a)), v(t, "background-height", "value", a) !== "auto" && (v(t, "background-height", "units", a) === "%" ? D = v(t, "background-height", "pfValue", a) * p : D = v(t, "background-height", "pfValue", a)), !(B === 0 || D === 0)) {
    if (f === "contain") {
      var P = Math.min(g / B, p / D);
      B *= P, D *= P;
    } else if (f === "cover") {
      var P = Math.max(g / B, p / D);
      B *= P, D *= P;
    }
    var A = o - g / 2, R = v(t, "background-position-x", "units", a), L = v(t, "background-position-x", "pfValue", a);
    R === "%" ? A += (g - B) * L : A += L;
    var I = v(t, "background-offset-x", "units", a), M = v(t, "background-offset-x", "pfValue", a);
    I === "%" ? A += (g - B) * M : A += M;
    var N = u - p / 2, F = v(t, "background-position-y", "units", a), _ = v(t, "background-position-y", "pfValue", a);
    F === "%" ? N += (p - D) * _ : N += _;
    var z = v(t, "background-offset-y", "units", a), q = v(t, "background-offset-y", "pfValue", a);
    z === "%" ? N += (p - D) * q : N += q, m.pathCache && (A -= o, N -= u, o = 0, u = 0);
    var Z = r.globalAlpha;
    r.globalAlpha = E;
    var Q = i.getImgSmoothing(r), X = !1;
    if (C === "no" && Q ? (i.setImgSmoothing(r, !1), X = !0) : C === "yes" && !Q && (i.setImgSmoothing(r, !0), X = !0), c === "no-repeat")
      w && (r.save(), m.pathCache ? r.clip(m.pathCache) : (i.nodeShapes[i.getNodeShape(t)].draw(r, o, u, g, p, x, m), r.clip())), i.safeDrawImage(r, e, 0, 0, T, k, A, N, B, D), w && r.restore();
    else {
      var J = r.createPattern(e, c);
      r.fillStyle = J, i.nodeShapes[i.getNodeShape(t)].draw(r, o, u, g, p, x, m), r.translate(A, N), r.fill(), r.translate(-A, -N);
    }
    r.globalAlpha = Z, X && i.setImgSmoothing(r, Q);
  }
};
var Rt = {};
Rt.eleTextBiggerThanMin = function(r, e) {
  if (!e) {
    var t = r.cy().zoom(), a = this.getPixelRatio(), n = Math.ceil(eo(t * a));
    e = Math.pow(2, n);
  }
  var i = r.pstyle("font-size").pfValue * e, s = r.pstyle("min-zoomed-font-size").pfValue;
  return !(i < s);
};
Rt.drawElementText = function(r, e, t, a, n) {
  ...
  if (e.isNode()) {
    ...
    if (!o || !o.value)
      return;
    var u = s.getLabelJustification(e), l = e.pstyle("text-metrics").strValue === "glyph";
    r.textAlign = u, r.textBaseline = l ? "alphabetic" : "bottom";
  } else {
    var v = e.element()._private.rscratch.badLine, f = e.pstyle("label"), c = e.pstyle("source-label"), h = e.pstyle("target-label");
    if (v || (!f || !f.value) && (!c || !c.value) && (!h || !h.value))
      return;
    r.textAlign = "center", r.textBaseline = "bottom";
  }
  var d = !t, y;
  t && (y = t, r.translate(-y.x1, -y.y1)), n == null ? (s.drawText(r, e, null, d, i), e.isEdge() && (s.drawText(r, e, "source", d, i), s.drawText(r, e, "target", d, i))) : s.drawText(r, e, n, d, i), t && r.translate(y.x1, y.y1);
};
Rt.getFontCache = function(r) {
  var e;
...
Rt.setupTextStyle = function(r, e) {
  var t = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : !0, a = e.pstyle("font-style").strValue, n = e.pstyle("font-size").pfValue + "px", i = e.pstyle("font-family").strValue, s = e.pstyle("font-weight").strValue, o = t ? e.effectiveOpacity() * e.pstyle("text-opacity").value : 1, u = e.pstyle("text-outline-opacity").value * o, l = e.pstyle("color").value, v = e.pstyle("text-outline-color").value;
  r.font = a + " " + s + " " + n + " " + i, r.lineJoin = "round", this.colorFillStyle(r, l[0], l[1], l[2], o), this.colorStrokeStyle(r, v[0], v[1], v[2], u);
};
function $y(r, e, t, a, n) {
  var i = Math.min(a, n), s = i / 2, o = e + a / 2, u = t + n / 2;
  r.beginPath(), r.arc(o, u, s, 0, Math.PI * 2), r.closePath();
}
function _l(r, e, t, a, n) {
...
Rt.drawText = function(r, e, t) {
  ...
  if (!(n && (o === 0 || e.pstyle("text-opacity").value === 0))) {
    t === "main" && (t = null);
    var u = pr(s, "labelX", t), l = pr(s, "labelY", t), v, f, c = this.getLabelText(e, t);
    if (c != null && c !== "" && !isNaN(u) && !isNaN(l)) {
      this.setupTextStyle(r, e, n);
      var h = t ? t + "-" : "", d = pr(s, "labelWidth", t), y = pr(s, "labelHeight", t), g = pr(s, "labelActualDescent", t), p = e.pstyle(h + "text-margin-x").pfValue, m = e.pstyle(h + "text-margin-y").pfValue, b = e.isEdge(), w = e.pstyle("text-halign").value, E = e.pstyle("text-valign").value;
      b && (w = "center", E = "center"), u += p, l += m;
      var C;
      a ? C = this.getTextAngle(e, t) : C = 0, C !== 0 && (v = u, f = l, r.translate(v, f), r.rotate(C), u = 0, l = 0);
      var x = Jt(w), T = jt(E);
      switch (T) {
        case "top":
          break;
      ...
      var k = e.pstyle("text-background-opacity").value, B = e.pstyle("text-border-opacity").value, D = e.pstyle("text-border-width").pfValue, P = e.pstyle("text-background-padding").pfValue, A = e.pstyle("text-background-shape").strValue, R = A === "round-rectangle" || A === "roundrectangle", L = A === "circle", I = 2;
      if (k > 0 || D > 0 && B > 0) {
        var M = r.fillStyle, N = r.strokeStyle, F = r.lineWidth, _ = e.pstyle("text-background-color").value, z = e.pstyle("text-border-color").value, q = e.pstyle("text-border-style").value, Z = k > 0, Q = D > 0 && B > 0, X = u - P;
        switch (x) {
          case "left":
            X -= d;
            break;
        ...
        var J = l - y - P, j = d + 2 * P, ne = y + 2 * P;
        if (Z && (r.fillStyle = "rgba(".concat(_[0], ",").concat(_[1], ",").concat(_[2], ",").concat(k * o, ")")), Q && (r.strokeStyle = "rgba(".concat(z[0], ",").concat(z[1], ",").concat(z[2], ",").concat(B * o, ")"), r.lineWidth = D, r.setLineDash))
          switch (q) {
            case "dotted":
              r.setLineDash([1, 1]);
              break;
        ...
        if (R ? (r.beginPath(), _l(r, X, J, j, ne, I)) : L ? (r.beginPath(), $y(r, X, J, j, ne)) : (r.beginPath(), r.rect(X, J, j, ne)), Z && r.fill(), Q && r.stroke(), Q && q === "double") {
          var Y = D / 2;
          r.beginPath(), R ? _l(r, X + Y, J + Y, j - 2 * Y, ne - 2 * Y, I) : r.rect(X + Y, J + Y, j - 2 * Y, ne - 2 * Y), r.stroke();
        }
        r.fillStyle = M, r.strokeStyle = N, r.lineWidth = F, r.setLineDash && r.setLineDash([]);
      }
      var V = 2 * e.pstyle("text-outline-width").pfValue;
      if (V > 0 && (r.lineWidth = V), l -= g, e.pstyle("text-wrap").value === "wrap") {
        var H = pr(s, "labelWrapCachedLines", t), $ = pr(s, "labelLineHeight", t), K = d / 2, te = this.getLabelJustification(e);
        switch (te === "auto" || (x === "left" ? te === "left" ? u += -d : te === "center" && (u += -K) : x === "center" ? te === "left" ? u += -K : te === "right" && (u += K) : x === "right" && (te === "center" ? u += K : te === "right" && (u += d))), T) {
          case "top":
            l -= (H.length - 1) * $;
            break;
          case "center":
        ...
        for (var ve = 0; ve < H.length; ve++)
          V > 0 && r.strokeText(H[ve], u, l), r.fillText(H[ve], u, l), l += $;
      } else
        V > 0 && r.strokeText(c, u, l), r.fillText(c, u, l);
      C !== 0 && (r.rotate(-C), r.translate(-v, -f));
    }
  }
};
var gt = {};
gt.drawNode = function(r, e, t) {
  var a = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : !0, n = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : !0, i = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : !0, s = this, o, u, l = e._private, v = l.rscratch, f = e.position();
  if (!(!ae(f.x) || !ae(f.y)) && !(i && !e.visible())) {
    var c = i ? e.effectiveOpacity() : 1, h = s.usePaths(), d, y = !1, g = e.padding();
    ...
    for (var m = e.pstyle("background-image"), b = m.value, w = new Array(b.length), E = new Array(b.length), C = 0, x = 0; x < b.length; x++) {
      ...
      if (k) {
        ...
        C++, E[x] = s.getCachedImage(T, B, function() {
          l.backgroundTimestamp = Date.now(), e.emitAndNotify("background");
        });
      }
    }
    var D = e.pstyle("background-blacken").value, P = e.pstyle("border-width").pfValue, A = e.pstyle("background-opacity").value * c, R = e.pstyle("border-color").value, L = e.pstyle("border-style").value, I = e.pstyle("border-join").value, M = e.pstyle("border-cap").value, N = e.pstyle("border-position").value, F = e.pstyle("border-dash-pattern").pfValue, _ = e.pstyle("border-dash-offset").pfValue, z = e.pstyle("border-opacity").value * c, q = e.pstyle("outline-width").pfValue, Z = e.pstyle("outline-color").value, Q = e.pstyle("outline-style").value, X = e.pstyle("outline-opacity").value * c, J = e.pstyle("outline-offset").value, j = e.pstyle("corner-radius").value;
    j !== "auto" && (j = e.pstyle("corner-radius").pfValue);
    var ne = function() {
      var O = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : A;
      s.eleFillStyle(r, e, O);
    }, Y = function() {
      var O = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : z;
      s.colorStrokeStyle(r, R[0], R[1], R[2], O);
    }, V = function() {
      var O = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : X;
      s.colorStrokeStyle(r, Z[0], Z[1], Z[2], O);
    }, H = function(O, W, G, U) {
      var ue = s.nodePathCache = s.nodePathCache || [], re = cv(G === "polygon" ? G + "," + U.join(",") : G, "" + W, "" + O, "" + j), oe = ue[re], ie, fe = !1;
      return oe != null ? (ie = oe, fe = !0, v.pathCache = ie) : (ie = new Path2D(), ue[re] = v.pathCache = ie), {
        path: ie,
        cacheHit: fe
      };
    }, $ = e.pstyle("shape").strValue, K = e.pstyle("shape-polygon-points").pfValue;
    if (h) {
      r.translate(f.x, f.y);
      var te = H(o, u, $, K);
    ...
    var ve = function() {
      if (!y) {
        ...
        h && (O = {
          x: 0,
          y: 0
        }), s.nodeShapes[s.getNodeShape(e)].draw(d || r, O.x, O.y, o, u, j, v);
      }
      h ? r.fill(d) : r.fill();
    }, De = function() {
      for (var O = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : c, W = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : !0, G = l.backgrounding, U = 0, ue = 0; ue < E.length; ue++) {
        var re = e.cy().style().getIndexedStyle(e, "background-image-containment", "value", ue);
        if (W && re === "over" || !W && re === "inside") {
          U++;
          continue;
        }
        w[ue] && E[ue].complete && !E[ue].error && (U++, s.drawInscribedImage(r, E[ue], e, ue, O));
      }
      l.backgrounding = U !== C, G !== l.backgrounding && e.updateStyle(!1);
    }, we = function() {
      var O = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : !1, W = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : c;
      s.hasPie(e) && (s.drawPie(r, e, W), O && (h || s.nodeShapes[s.getNodeShape(e)].draw(r, f.x, f.y, o, u, j, v)));
    }, ye = function() {
      var O = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : !1, W = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : c;
      s.hasStripe(e) && (r.save(), h ? r.clip(v.pathCache) : (s.nodeShapes[s.getNodeShape(e)].draw(r, f.x, f.y, o, u, j, v), r.clip()), s.drawStripe(r, e, W), r.restore(), O && (h || s.nodeShapes[s.getNodeShape(e)].draw(r, f.x, f.y, o, u, j, v)));
    }, pe = function() {
      var O = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : c, W = (D > 0 ? D : -D) * O, G = D > 0 ? 0 : 255;
      D !== 0 && (s.colorFillStyle(r, G, G, G, W), h ? r.fill(d) : r.fill());
    }, se = function() {
      if (P > 0) {
        ...
        if (N !== "center") {
          if (r.save(), r.lineWidth *= 2, N === "inside")
            h ? r.clip(d) : r.clip();
          else {
            var O = new Path2D();
            O.rect(-o / 2 - P, -u / 2 - P, o + 2 * P, u + 2 * P), O.addPath(d), r.clip(O, "evenodd");
          }
        ...
        if (L === "double") {
          r.lineWidth = P / 3;
          var W = r.globalCompositeOperation;
          r.globalCompositeOperation = "destination-out", h ? r.stroke(d) : r.stroke(), r.globalCompositeOperation = W;
        }
      ...
      if (q > 0) {
        ...
        var W = s.getNodeShape(e), G = P;
        N === "inside" && (G = 0), N === "outside" && (G *= 2);
        var U = (o + G + (q + J)) / o, ue = (u + G + (q + J)) / u, re = o * U, oe = u * ue, ie = s.nodeShapes[W].points, fe;
        if (h) {
          var Ce = H(re, oe, W, ie);
          fe = Ce.path;
        }
        if (W === "ellipse")
          s.drawEllipsePath(fe || r, O.x, O.y, re, oe);
        else if (["round-diamond", "round-heptagon", "round-hexagon", "round-octagon", "round-pentagon", "round-polygon", "round-triangle", "round-tag"].includes(W)) {
          var xe = 0, ce = 0, ke = 0;
          W === "round-diamond" ? xe = (G + J + q) * 1.4 : W === "round-heptagon" ? (xe = (G + J + q) * 1.075, ke = -(G / 2 + J + q) / 35) : W === "round-hexagon" ? xe = (G + J + q) * 1.12 : W === "round-pentagon" ? (xe = (G + J + q) * 1.13, ke = -(G / 2 + J + q) / 15) : W === "round-tag" ? (xe = (G + J + q) * 1.12, ce = (G / 2 + q + J) * 0.07) : W === "round-triangle" && (xe = (G + J + q) * (Math.PI / 2), ke = -(G + J / 2 + q) / Math.PI), xe !== 0 && (U = (o + xe) / o, re = o * U, ["round-hexagon", "round-tag"].includes(W) || (ue = (u + xe) / u, oe = u * ue)), j = j === "auto" ? Cv(re, oe) : j;
          for (var Pe = re / 2, rr = oe / 2, tr = j + (G + q + J) / 2, br = new Array(ie.length / 2), Ye = new Array(ie.length / 2), Ze = 0; Ze < ie.length / 2; Ze++)
            br[Ze] = {
              x: O.x + ce + Pe * ie[Ze * 2],
              y: O.y + ke + rr * ie[Ze * 2 + 1]
            };
          var We, fr, Ar, $e, Sr = br.length;
          for (fr = br[Sr - 1], We = 0; We < Sr; We++)
            Ar = br[We % Sr], $e = br[(We + 1) % Sr], Ye[We] = go(fr, Ar, $e, tr), fr = Ar, Ar = $e;
          s.drawRoundPolygonPath(fe || r, O.x + ce, O.y + ke, o * U, u * ue, ie, Ye);
        } else if (["roundrectangle", "round-rectangle"].includes(W))
          j = j === "auto" ? ut(re, oe) : j, s.drawRoundRectanglePath(fe || r, O.x, O.y, re, oe, j + (G + q + J) / 2);
        else if (["cutrectangle", "cut-rectangle"].includes(W))
          j = j === "auto" ? ao() : j, s.drawCutRectanglePath(fe || r, O.x, O.y, re, oe, null, j + (G + q + J) / 4);
        else if (["bottomroundrectangle", "bottom-round-rectangle"].includes(W))
          j = j === "auto" ? ut(re, oe) : j, s.drawBottomRoundRectanglePath(fe || r, O.x, O.y, re, oe, j + (G + q + J) / 2);
        else if (W === "barrel")
          s.drawBarrelPath(fe || r, O.x, O.y, re, oe);
        else if (W.startsWith("polygon") || ["rhomboid", "right-rhomboid", "round-tag", "tag", "vee"].includes(W)) {
          var Rr = (G + q + J) / o;
          ie = xn(En(ie, Rr)), s.drawPolygonPath(fe || r, O.x, O.y, o, u, ie);
        } else {
          var Qr = (G + q + J) / o;
          ie = xn(En(ie, -Qr)), s.drawPolygonPath(fe || r, O.x, O.y, o, u, ie);
        }
        if (h ? r.stroke(fe) : r.stroke(), Q === "double") {
          r.lineWidth = G / 3;
          var Mt = r.globalCompositeOperation;
          r.globalCompositeOperation = "destination-out", h ? r.stroke(fe) : r.stroke(), r.globalCompositeOperation = Mt;
        }
        r.setLineDash && r.setLineDash([]);
      }
    }, ge = function() {
      ...
      s.drawElementText(r, e, null, a);
    }, Te = e.pstyle("ghost").value === "yes";
    if (Te) {
      var Be = e.pstyle("ghost-offset-x").pfValue, Ae = e.pstyle("ghost-offset-y").pfValue, Le = e.pstyle("ghost-opacity").value, ee = Le * c;
      r.translate(Be, Ae), V(), de(), ne(Le * A), ve(), De(ee, !0), Y(Le * z), se(), we(D !== 0 || P !== 0), ye(D !== 0 || P !== 0), De(ee, !1), pe(ee), r.translate(-Be, -Ae);
    }
    h && r.translate(-f.x, -f.y), Ee(), h && r.translate(f.x, f.y), V(), de(), ne(), ve(), De(c, !0), Y(), se(), we(D !== 0 || P !== 0), ye(D !== 0 || P !== 0), De(c, !1), pe(), h && r.translate(-f.x, -f.y), be(), ge(), t && r.translate(p.x1, p.y1);
  }
};
var Rf = function(e) {
  if (!["overlay", "underlay"].includes(e))
  ...
  return function(t, a, n, i, s) {
    var o = this;
    if (a.visible()) {
      var u = a.pstyle("".concat(e, "-padding")).pfValue, l = a.pstyle("".concat(e, "-opacity")).value, v = a.pstyle("".concat(e, "-color")).value, f = a.pstyle("".concat(e, "-shape")).value, c = a.pstyle("".concat(e, "-corner-radius")).value;
      if (l > 0) {
        if (n = n || a.position(), i == null || s == null) {
          var h = a.padding();
          i = a.width() + 2 * h, s = a.height() + 2 * h;
        }
        o.colorFillStyle(t, v[0], v[1], v[2], l), o.nodeShapes[f].draw(t, n.x, n.y, i + u * 2, s + u * 2, c), t.fill();
      }
    }
  };
};
gt.drawNodeOverlay = Rf("overlay");
gt.drawNodeUnderlay = Rf("underlay");
gt.hasPie = function(r) {
  return r = r[0], r._private.hasPie;
};
gt.hasStripe = function(r) {
  return r = r[0], r._private.hasStripe;
};
gt.drawPie = function(r, e, t, a) {
  e = e[0], a = a || e.position();
  var n = e.cy().style(), i = e.pstyle("pie-size"), s = e.pstyle("pie-hole"), o = e.pstyle("pie-start-angle").pfValue, u = a.x, l = a.y, v = e.width(), f = e.height(), c = Math.min(v, f) / 2, h, d = 0, y = this.usePaths();
  if (y && (u = 0, l = 0), i.units === "%" ? c = c * i.pfValue : i.pfValue !== void 0 && (c = i.pfValue / 2), s.units === "%" ? h = c * s.pfValue : s.pfValue !== void 0 && (h = s.pfValue / 2), !(h >= c))
    for (var g = 1; g <= n.pieBackgroundN; g++) {
      ...
      p === 0 || d >= 1 || d + w > 1 || (h === 0 ? (r.beginPath(), r.moveTo(u, l), r.arc(u, l, c, E, x), r.closePath()) : (r.beginPath(), r.arc(u, l, c, E, x), r.arc(u, l, h, x, E, !0), r.closePath()), this.colorFillStyle(r, m[0], m[1], m[2], b), r.fill(), d += w);
    }
};
gt.drawStripe = function(r, e, t, a) {
  e = e[0], a = a || e.position();
  var n = e.cy().style(), i = a.x, s = a.y, o = e.width(), u = e.height(), l = 0, v = this.usePaths();
  r.save();
...
mr.createGradientStyleFor = function(r, e, t, a, n) {
  ...
  if (a === "radial-gradient")
    if (t.isEdge()) {
      var l = t.sourceEndpoint(), v = t.targetEndpoint(), f = t.midpoint(), c = kt(l, f), h = kt(v, f);
  ...
  if (!i) return null;
  for (var k = u.length === o.length, B = o.length, D = 0; D < B; D++)
    i.addColorStop(k ? u[D] : D / (B - 1), "rgba(" + o[D][0] + "," + o[D][1] + "," + o[D][2] + "," + n + ")");
  return i;
};
...
mr.eleFillStyle = function(r, e, t) {
...
mr.eleStrokeStyle = function(r, e, t) {
...
mr.matchCanvasSize = function(r) {
  ...
  if (!(u === e.canvasWidth && l === e.canvasHeight)) {
    ...
    for (var c = 0; c < e.CANVAS_LAYERS; c++)
      v = t.canvases[c], v.width = u, v.height = l, v.style.width = n + "px", v.style.height = i + "px";
    for (var c = 0; c < e.BUFFER_COUNT; c++)
      v = t.bufferCanvases[c], v.width = u, v.height = l, v.style.width = n + "px", v.style.height = i + "px";
    e.textureMult = 1, s <= 1 && (v = t.bufferCanvases[e.TEXTURE_BUFFER], e.textureMult = 2, v.width = u * e.textureMult, v.height = l * e.textureMult), e.canvasWidth = u, e.canvasHeight = l, e.pixelRatio = s;
  }
};
mr.renderTo = function(r, e, t, a) {
  this.render({
    forcedContext: r,
    forcedZoom: e,
    forcedPan: t,
...
mr.render = function(r) {
  ...
  }, T = e.prevViewport, k = T === void 0 || x.zoom !== T.zoom || x.pan.x !== T.pan.x || x.pan.y !== T.pan.y;
  !k && !(y && !d) && (e.motionBlurPxRatio = 1), o && (C = o), w *= u, C.x *= u, C.y *= u;
  var B = e.getCachedZSortedEles();
  function D(Y, V, H, $, K) {
    var te = Y.globalCompositeOperation;
    Y.globalCompositeOperation = "destination-out", e.colorFillStyle(Y, 255, 255, 255, e.motionBlurTransparency), Y.fillRect(V, H, $, K), Y.globalCompositeOperation = te;
  }
  function P(Y, V) {
    var H, $, K, te;
    !e.clearingMotionBlur && (Y === l.bufferContexts[e.MOTIONBLUR_BUFFER_NODE] || Y === l.bufferContexts[e.MOTIONBLUR_BUFFER_DRAG]) ? (H = {
      x: E.x * h,
      y: E.y * h
    }, $ = b * h, K = e.canvasWidth * h, te = e.canvasHeight * h) : (H = C, $ = w, K = e.canvasWidth, te = e.canvasHeight), Y.setTransform(1, 0, 0, 1, 0, 0), V === "motionBlur" ? D(Y, 0, 0, K, te) : !a && (V === void 0 || V) && Y.clearRect(0, 0, K, te), n || (Y.translate(H.x, H.y), Y.scale($, $)), o && Y.translate(o.x, o.y), s && Y.scale(s, s);
  }
  if (f || (e.textureDrawLastFrame = !1), f) {
    if (e.textureDrawLastFrame = !0, !e.textureCache) {
      ...
      A.setTransform(1, 0, 0, 1, 0, 0), A.clearRect(0, 0, e.canvasWidth * e.textureMult, e.canvasHeight * e.textureMult), e.render({
        forcedContext: A,
        drawOnlyNodeLayer: !0,
    ...
    var R = l.contexts[e.NODE], L = e.textureCache.texture, x = e.textureCache.viewport;
    R.setTransform(1, 0, 0, 1, 0, 0), c ? D(R, 0, 0, x.width, x.height) : R.clearRect(0, 0, x.width, x.height);
    var I = m.core("outside-texture-bg-color").value, M = m.core("outside-texture-bg-opacity").value;
    e.colorFillStyle(R, I[0], I[1], I[2], M), R.fillRect(0, 0, x.width, x.height);
    var b = t.zoom();
    P(R, !1), R.clearRect(x.mpan.x, x.mpan.y, x.width / x.zoom / u, x.height / x.zoom / u), R.drawImage(L, x.mpan.x, x.mpan.y, x.width / x.zoom / u, x.height / x.zoom / u);
  } else e.textureOnViewport && !a && (e.textureCache = null);
  var N = t.extent(), F = e.pinching || e.hoverData.dragging || e.swipePanning || e.data.wheelZooming || e.hoverData.draggingEles || e.cy.animated(), _ = e.hideEdgesOnViewport && F, z = [];
  if (z[e.NODE] = !v[e.NODE] && c && !e.clearedForMotionBlur[e.NODE] || e.clearingMotionBlur, z[e.NODE] && (e.clearedForMotionBlur[e.NODE] = !0), z[e.DRAG] = !v[e.DRAG] && c && !e.clearedForMotionBlur[e.DRAG] || e.clearingMotionBlur, z[e.DRAG] && (e.clearedForMotionBlur[e.DRAG] = !0), v[e.NODE] || n || i || z[e.NODE]) {
    var q = c && !z[e.NODE] && h !== 1, R = a || (q ? e.data.bufferContexts[e.MOTIONBLUR_BUFFER_NODE] : l.contexts[e.NODE]), Z = c && !q ? "motionBlur" : void 0;
    P(R, Z), _ ? e.drawCachedNodes(R, B.nondrag, u, N) : e.drawLayeredElements(R, B.nondrag, u, N), e.debug && e.drawDebugPoints(R, B.nondrag), !n && !c && (v[e.NODE] = !1);
  }
  if (!i && (v[e.DRAG] || n || z[e.DRAG])) {
    var q = c && !z[e.DRAG] && h !== 1, R = a || (q ? e.data.bufferContexts[e.MOTIONBLUR_BUFFER_DRAG] : l.contexts[e.DRAG]);
    P(R, c && !q ? "motionBlur" : void 0), _ ? e.drawCachedNodes(R, B.drag, u, N) : e.drawCachedElements(R, B.drag, u, N), e.debug && e.drawDebugPoints(R, B.drag), !n && !c && (v[e.DRAG] = !1);
  }
  if (this.drawSelectionRectangle(r, P), c && h !== 1) {
    var Q = l.contexts[e.NODE], X = e.data.bufferCanvases[e.MOTIONBLUR_BUFFER_NODE], J = l.contexts[e.DRAG], j = e.data.bufferCanvases[e.MOTIONBLUR_BUFFER_DRAG], ne = function(V, H, $) {
      V.setTransform(1, 0, 0, 1, 0, 0), $ || !p ? V.clearRect(0, 0, e.canvasWidth, e.canvasHeight) : D(V, 0, 0, e.canvasWidth, e.canvasHeight);
      var K = h;
      V.drawImage(
        H,
        // img
    ...
    (v[e.NODE] || z[e.NODE]) && (ne(Q, X, z[e.NODE]), v[e.NODE] = !1), (v[e.DRAG] || z[e.DRAG]) && (ne(J, j, z[e.DRAG]), v[e.DRAG] = !1);
  }
...
var ha;
mr.drawSelectionRectangle = function(r, e) {
  ...
  if (t.showFps || !s && u[t.SELECT_BOX] && !o) {
    var v = l || n.contexts[t.SELECT_BOX];
...
function Ky(r, e, t) {
  var a = Gl(r, r.VERTEX_SHADER, e), n = Gl(r, r.FRAGMENT_SHADER, t), i = r.createProgram();
...
function Zy(r, e, t, a, n) {
  var i = a * t + e.x, s = n * t + e.y;
  return s = Math.round(r.canvasHeight - s), [i, s];
}
function Qy(r, e) {
  return e.picking ? !0 : r.pstyle("background-fill").value !== "solid" || r.pstyle("background-image").strValue !== "none" ? !1 : r.pstyle("border-width").value === 0 || r.pstyle("border-opacity").value === 0 ? !0 : r.pstyle("border-style").value === "solid";
}
function Jy(r, e) {
...
function tm(r, e, t, a) {
  var n = Mf(r, e), i = Xe(n, 2), s = i[0], o = i[1], u = Lf(r, o, a), l = r.createBuffer();
...
function Fr(r, e, t, a) {
  var n = Mf(r, t), i = Xe(n, 3), s = i[0], o = i[1], u = i[2], l = Lf(r, o, e * s), v = s * u, f = r.createBuffer();
  ...
  for (var c = new Array(e), h = 0; h < e; h++)
    c[h] = rm(r, o, l, v, s, h);
  return f.dataArray = l, f.stride = v, f.size = s, f.getView = function(d) {
    return c[d];
...
function am(r, e, t) {
  ...
  for (var l = 0; l < 3; l++) {
    var v = t + l;
    r.enableVertexAttribArray(v), r.vertexAttribPointer(v, 3, r.FLOAT, !1, 36, l * 12), r.vertexAttribDivisor(v, 1);
  }
  return r.bindBuffer(r.ARRAY_BUFFER, null), u.getMatrixView = function(f) {
    return i[f];
  }, u.setData = function(f, c) {
    i[c].set(f, 0);
...
var Hl = typeof Float32Array < "u" ? Float32Array : Array;
...
function xs() {
  var r = new Hl(9);
  return Hl != Float32Array && (r[1] = 0, r[2] = 0, r[3] = 0, r[5] = 0, r[6] = 0, r[7] = 0), r[0] = 1, r[4] = 1, r[8] = 1, r;
}
function Wl(r) {
  return r[0] = 1, r[1] = 0, r[2] = 0, r[3] = 0, r[4] = 1, r[5] = 0, r[6] = 0, r[7] = 0, r[8] = 1, r;
}
function im(r, e, t) {
  var a = e[0], n = e[1], i = e[2], s = e[3], o = e[4], u = e[5], l = e[6], v = e[7], f = e[8], c = t[0], h = t[1], d = t[2], y = t[3], g = t[4], p = t[5], m = t[6], b = t[7], w = t[8];
  return r[0] = c * a + h * s + d * l, r[1] = c * n + h * o + d * v, r[2] = c * i + h * u + d * f, r[3] = y * a + g * s + p * l, r[4] = y * n + g * o + p * v, r[5] = y * i + g * u + p * f, r[6] = m * a + b * s + w * l, r[7] = m * n + b * o + w * v, r[8] = m * i + b * u + w * f, r;
}
function pn(r, e, t) {
  var a = e[0], n = e[1], i = e[2], s = e[3], o = e[4], u = e[5], l = e[6], v = e[7], f = e[8], c = t[0], h = t[1];
  return r[0] = a, r[1] = n, r[2] = i, r[3] = s, r[4] = o, r[5] = u, r[6] = c * a + h * s + l, r[7] = c * n + h * o + v, r[8] = c * i + h * u + f, r;
}
function $l(r, e, t) {
  var a = e[0], n = e[1], i = e[2], s = e[3], o = e[4], u = e[5], l = e[6], v = e[7], f = e[8], c = Math.sin(t), h = Math.cos(t);
  return r[0] = h * a + c * s, r[1] = h * n + c * o, r[2] = h * i + c * u, r[3] = h * s - c * a, r[4] = h * o - c * n, r[5] = h * u - c * i, r[6] = l, r[7] = v, r[8] = f, r;
}
function Hs(r, e, t) {
  var a = t[0], n = t[1];
...
var om = /* @__PURE__ */ (function() {
  function r(e, t, a, n) {
    ct(this, r), this.debugID = Math.floor(Math.random() * 1e4), this.r = e, this.texSize = t, this.texRows = a, this.texHeight = Math.floor(t / a), this.enableWrapping = !0, this.locked = !1, this.texture = null, this.needsBuffer = !0, this.freePointer = {
      x: 0,
      row: 0
  ...
  return dt(r, [{
    ...
    value: function(t, a, n) {
      ...
      var s = this.texSize, o = this.texRows, u = this.texHeight, l = this.getScale(a), v = l.scale, f = l.texW, c = l.texH, h = function(b, w) {
        if (n && w) {
          var E = w.context, C = b.x, x = b.row, T = C, k = u * x;
        ...
        var E = s - i.freePointer.x, C = f - E, x = u;
        {
          var T = i.freePointer.x, k = i.freePointer.row * u, B = E;
          w.context.drawImage(b, 0, 0, B, x, T, k, B, x), d[0] = {
            x: T,
            y: k,
            w: B,
            h: c
        ...
        {
          var D = E, P = (i.freePointer.row + 1) * u, A = C;
          w && w.context.drawImage(b, D, 0, A, x, 0, P, A, x), d[1] = {
            x: 0,
            y: P,
            w: A,
            h: c
    ...
    key: "bufferIfNeeded",
    value: function(t) {
      this.texture || (this.texture = em(t, this.debugID)), this.needsBuffer && (this.texture.buffer(this.canvas), this.needsBuffer = !1, this.locked && (this.canvas = null, this.scratch = null));
    }
  }, {
    key: "dispose",
    value: function() {
  ...
  function r(e, t, a, n) {
    ct(this, r), this.r = e, this.texSize = t, this.texRows = a, this.createTextureCanvas = n, this.atlases = [], this.styleKeyToAtlas = /* @__PURE__ */ new Map(), this.markedKeys = /* @__PURE__ */ new Set();
  }
  return dt(r, [{
    key: "getKeys",
    value: function() {
    ...
    value: function() {
      ...
      var n = [], i = /* @__PURE__ */ new Map(), s = null, o = Cr(this.atlases), u;
      try {
        var l = function() {
          var f = u.value, c = f.getKeys(), h = lm(a, c);
          if (h.size === 0)
          ...
          try {
            for (d.s(); !(y = d.n()).done; ) {
              var g = y.value;
              if (!h.has(g)) {
                var p = f.getOffsets(g), m = Xe(p, 2), b = m[0], w = m[1];
                s.canFit({
                  w: b.w + w.w,
                  h: b.h
    ...
    value: function(t, a, n) {
      var i = a.getOffsets(t), s = Xe(i, 2), o = s[0], u = s[1];
      if (u.w === 0)
...
function lm(r, e) {
  return r.intersection ? r.intersection(e) : new Set(yn(r).filter(function(t) {
    return e.has(t);
  }));
}
var vm = /* @__PURE__ */ (function() {
  function r(e, t) {
    ct(this, r), this.r = e, this.globalOptions = t, this.atlasSize = t.webglTexSize, this.maxAtlasesPerBatch = t.webglTexPerBatch, this.renderTypes = /* @__PURE__ */ new Map(), this.collections = /* @__PURE__ */ new Map(), this.typeAndIdToKey = /* @__PURE__ */ new Map();
  }
  return dt(r, [{
    key: "getAtlasSize",
    value: function() {
    ...
    value: function(t, a) {
      var n = this.globalOptions, i = n.webglTexSize, s = n.createTextureCanvas, o = a.texRows, u = this._cacheScratchCanvas(s), l = new um(this.r, i, o, u);
    ...
    value: function(t, a) {
      ...
      var i = this.collections.get(n), s = me({
        type: t,
        atlasCollection: i
      }, a);
    ...
    value: function(t) {
      var a = this, n = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, i = n.forceRedraw, s = i === void 0 ? !1 : i, o = n.filterEle, u = o === void 0 ? function() {
        return !0;
      } : o, l = n.filterType, v = l === void 0 ? function() {
        return !0;
      } : l, f = !1, c = !1, h = Cr(t), d;
      try {
        for (h.s(); !(d = h.n()).done; ) {
          var y = d.value;
          if (u(y)) {
            var g = Cr(this.renderTypes.values()), p;
            try {
              var m = function() {
                ...
                if (v(E)) {
                  ...
                  if (s)
                    ...
                    var k = w.getID ? w.getID(y) : y.id(), B = a._key(E, k), D = a.typeAndIdToKey.get(B);
                    D !== void 0 && !Jy(T, D) && (f = !0, a.typeAndIdToKey.delete(B), D.forEach(function(P) {
                      return C.markKeyForGC(P);
                    }));
                  }
                }
    ...
    key: "gc",
    value: function() {
      var t = Cr(this.collections.values()), a;
      try {
        for (t.s(); !(a = t.n()).done; ) {
          var n = a.value;
          n.gc();
    ...
    value: function(t, a, n, i) {
      var s = this.renderTypes.get(a), o = this.collections.get(s.collection), u = !1, l = o.draw(i, n, function(c) {
        s.drawClipped ? (c.save(), c.beginPath(), c.rect(0, 0, n.w, n.h), c.clip(), s.drawElement(c, t, n, !0, !0), c.restore()) : s.drawElement(c, t, n, !0, !0), u = !0;
      });
      if (u) {
    ...
    value: function(t, a) {
      ...
      return o.map(function(u) {
        var l = i.getBoundingBox(t, u), v = n.getOrCreateAtlas(t, a, l, u), f = v.getOffsets(u), c = Xe(f, 2), h = c[0], d = c[1];
        return {
          atlas: v,
          tex: h,
          tex1: h,
    ...
    key: "getDebugInfo",
    value: function() {
      var t = [], a = Cr(this.collections), n;
      try {
        for (a.s(); !(n = a.n()).done; ) {
          var i = Xe(n.value, 2), s = i[0], o = i[1], u = o.getCounts(), l = u.keyCount, v = u.atlasCount;
          t.push({
            type: s,
            keyCount: l,
            atlasCount: v
  ...
  function r(e) {
    ct(this, r), this.globalOptions = e, this.atlasSize = e.webglTexSize, this.maxAtlasesPerBatch = e.webglTexPerBatch, this.batchAtlases = [];
  }
  return dt(r, [{
...
}, Es = 0, Ul = 1, Kl = 2, Cs = 3, Vt = 4, nn = 5, ga = 6, pa = 7, pm = /* @__PURE__ */ (function() {
  function r(e, t, a) {
    ct(this, r), this.r = e, this.gl = t, this.maxInstances = a.webglBatchSize, this.atlasSize = a.webglTexSize, this.bgColor = a.bgColor, this.debug = a.webglDebug, this.batchDebugInfo = [], a.enableWrapping = !0, a.createTextureCanvas = Xy, this.atlasManager = new vm(e, a), this.batchManager = new fm(a), this.simpleShapeOptions = /* @__PURE__ */ new Map(), this.program = this._createShaderProgram(Ea.SCREEN), this.pickingProgram = this._createShaderProgram(Ea.PICKING), this.vao = this._createVAO();
  }
  return dt(r, [{
    key: "addAtlasCollection",
    value: function(t, a) {
    ...
    */
    ...
    value: function(t) {
      ...
      void main(void) {
        ...
        else if(aVertType == `).concat(Vt, " || aVertType == ").concat(pa, ` 
             || aVertType == `).concat(nn, " || aVertType == ").concat(ga, `) { // simple shapes
        ...
        else if(aVertType == `).concat(Cs, ` && vid < 3) {
	...
	`), `
      ...
      void main(void) {
        ...
        else if(vVertType == `).concat(Vt, " || vVertType == ").concat(pa, ` 
          || vVertType == `).concat(nn, " || vVertType == ").concat(ga, `) { // use SDF
    ...
    value: function(t, a, n) {
      ...
      if (this._isVisible(t, o) && !(t.isEdge() && !this._isValidEdge(t))) {
        ...
        var l = i.getAtlasInfo(t, n), v = Cr(l), f;
        try {
          for (v.s(); !(f = v.n()).done; ) {
            var c = f.value, h = c.atlas, d = c.tex1, y = c.tex2;
            s.canAddToCurrentBatch(h) || this.endBatch();
            for (var g = s.getAtlasIndexForBatch(h), p = 0, m = [[d, !0], [y, !1]]; p < m.length; p++) {
              var b = Xe(m[p], 2), w = b[0], E = b[1];
              if (w.w != 0) {
                var C = this.instanceCount;
                this.vertTypeBuffer.getView(C)[0] = Es;
                ...
                var B = this.transformBuffer.getMatrixView(C);
                this.setTransformMatrix(t, B, o, c, E), this.instanceCount++, E || this.wrappedCount++, this.instanceCount >= this.maxInstances && this.endBatch();
              }
            }
          }
        } catch (D) {
    ...
    value: function(t, a, n, i) {
      ...
      if (n.shapeProps && n.shapeProps.padding && (o = t.pstyle(n.shapeProps.padding).pfValue), i) {
        var u = i.bb, l = i.tex1, v = i.tex2, f = l.w / (l.w + v.w);
        s || (f = 1 - f);
        var c = this._getAdjustedBB(u, o, s, f);
    ...
    value: function(t, a, n, i) {
      ...
      if (u !== 0) {
        var l = n.getRotationPoint(i), v = l.x, f = l.y;
        pn(t, t, [v, f]), $l(t, t, u);
        var c = n.getRotationOffset(i);
        s = c.x + (a.xOffset || 0), o = c.y + (a.yOffset || 0);
      } else
        s = a.x1, o = a.y1;
      pn(t, t, [s, o]), Hs(t, t, [a.w, a.h]);
    }
    /**
    ...
    key: "_getAdjustedBB",
    value: function(t, a, n, i) {
      var s = t.x1, o = t.y1, u = t.w, l = t.h, v = t.yOffset;
      a && (s -= a, o -= a, u += 2 * a, l += 2 * a);
      var f = 0, c = u * i;
      return n && i < 1 ? u = c : !n && i < 1 && (f = u - c, s += f, u = c), {
        x1: s,
        y1: o,
        w: u,
        h: l,
    ...
    value: function(t, a, n) {
      ...
      this.vertTypeBuffer.getView(s)[0] = Vt;
    ...
    value: function(t, a, n) {
      ...
      if (this._isVisible(t, i)) {
        ...
        if (this.vertTypeBuffer.getView(u)[0] = o, o === nn || o === ga) {
          var l = i.getBoundingBox(t), v = this._getCornerRadius(t, s.radius, l), f = this.cornerRadiusBuffer.getView(u);
          f[0] = v, f[1] = v, f[2] = v, f[3] = v, o === ga && (f[0] = 0, f[2] = 0);
        }
        var c = this.indexBuffer.getView(u);
        Ft(a, c);
        var h = this.renderTarget.picking ? 1 : n === "node-body" ? t.effectiveOpacity() : 1, d = this.renderTarget.picking ? 1 : t.pstyle(s.opacity).value * h, y = t.pstyle(s.color).value, g = this.colorBuffer.getView(u);
        bt(y, d, g);
        var p = this.lineWidthBuffer.getView(u);
        if (p[0] = 0, p[1] = 0, s.border) {
          var m = t.pstyle("border-width").value;
          if (m > 0) {
            var b = t.pstyle("border-color").value, w = h * t.pstyle("border-opacity").value, E = this.borderColorBuffer.getView(u);
            bt(b, w, E);
        ...
        var T = this.transformBuffer.getMatrixView(u);
        this.setTransformMatrix(t, T, i), this.simpleCount++, this.instanceCount++, this.instanceCount >= this.maxInstances && this.endBatch();
      }
    }
  }, {
    ...
    value: function(t, a, n) {
      if (t.visible()) {
        ...
        if (n === "source" ? (s = i.arrowStartX, o = i.arrowStartY, u = i.srcArrowAngle) : (s = i.arrowEndX, o = i.arrowEndY, u = i.tgtArrowAngle), !(isNaN(s) || s == null || isNaN(o) || o == null || isNaN(u) || u == null)) {
          ...
          if (l !== "none") {
            var v = t.pstyle(n + "-arrow-color").value, f = t.pstyle("opacity").value, c = t.pstyle("line-opacity").value, h = f * c, d = t.pstyle("width").pfValue, y = t.pstyle("arrow-scale").value, g = this.r.getArrowWidth(d, y), p = this.instanceCount, m = this.transformBuffer.getMatrixView(p);
            Wl(m), pn(m, m, [s, o]), Hs(m, m, [g, g]), $l(m, m, u), this.vertTypeBuffer.getView(p)[0] = Cs;
            var b = this.indexBuffer.getView(p);
            Ft(a, b);
            var w = this.colorBuffer.getView(p);
            bt(v, h, w), this.instanceCount++, this.instanceCount >= this.maxInstances && this.endBatch();
          }
        }
      }
    }
      ...
      if (t.visible()) {
        ...
        if (n) {
          ...
          if (n.length / 2 + this.instanceCount > this.maxInstances && this.endBatch(), n.length == 4) {
            ...
            this.vertTypeBuffer.getView(v)[0] = Ul;
            ...
            for (var y = 0; y < n.length - 2; y += 2) {
              ...
              this.vertTypeBuffer.getView(g)[0] = Kl;
              ...
              b[0] = o;
              var w = n[y - 2], E = n[y - 1], C = n[y], x = n[y + 1], T = n[y + 2], k = n[y + 3], B = n[y + 4], D = n[y + 5];
              y == 0 && (w = 2 * C - T + 1e-3, E = 2 * x - k + 1e-3), y == n.length - 4 && (B = 2 * T - C + 1e-3, D = 2 * k - x + 1e-3);
              var P = this.pointAPointBBuffer.getView(g);
              P[0] = w, P[1] = E, P[2] = C, P[3] = x;
              var A = this.pointCPointDBuffer.getView(g);
              A[0] = T, A[1] = k, A[2] = B, A[3] = D, this.instanceCount++, this.instanceCount >= this.maxInstances && this.endBatch();
            }
        }
      }
    }
    ...
    value: function() {
      ...
      if (i !== 0) {
        ...
        t.uniform1f(s.uZoom, Yy(this.r)), t.uniformMatrix3fv(s.uPanZoomMatrix, !1, this.panZoomMatrix), t.uniform1i(s.uAtlasSize, this.batchManager.getAtlasSize());
        var h = bt(this.bgColor, 1);
...
If.initWebgl = function(r, e) {
  var t = this, a = t.data.contexts[t.WEBGL];
  r.bgColor = ym(t), r.webglTexSize = Math.min(r.webglTexSize, a.getParameter(a.MAX_TEXTURE_SIZE)), r.webglTexRows = Math.min(r.webglTexRows, 54), r.webglTexRowsNodes = Math.min(r.webglTexRowsNodes, 54), r.webglBatchSize = Math.min(r.webglBatchSize, 16384), r.webglTexPerBatch = Math.min(r.webglTexPerBatch, a.getParameter(a.MAX_TEXTURE_IMAGE_UNITS)), t.webglDebug = r.webglDebug, t.webglDebugShowAtlases = r.webglDebugShowAtlases, t.pickingFrameBuffer = nm(a), t.pickingFrameBuffer.needsDraw = !0, t.drawing = new pm(t, a, r);
  var n = function(f) {
    return function(c) {
    ...
    return c ? Pn.USE_BB : Pn.IGNORE;
  }, u = function(f) {
    var c = f.position(), h = c.x, d = c.y, y = f.outerWidth(), g = f.outerHeight();
    return {
      w: y,
      h: g,
      x1: h - y / 2,
  ...
  t.drawing.addAtlasCollection("node", {
    ...
    collection: "label",
    getTexPickingMode: o,
    getKey: Ts(e.getLabelKey, null),
    getBoundingBox: Ss(e.getLabelBox, null),
    drawClipped: !0,
    ...
    collection: "label",
    getTexPickingMode: o,
    getKey: Ts(e.getSourceLabelKey, "source"),
    getBoundingBox: Ss(e.getSourceLabelBox, "source"),
    drawClipped: !0,
    ...
    collection: "label",
    getTexPickingMode: o,
    getKey: Ts(e.getTargetLabelKey, "target"),
    getBoundingBox: Ss(e.getTargetLabelBox, "target"),
    drawClipped: !0,
  ...
  t.onUpdateEleCalcs(function(v, f) {
    var c = !1;
    f && f.length > 0 && (c |= t.drawing.invalidate(f)), c && l();
  }), mm(t);
};
function ym(r) {
...
function Of(r, e) {
  var t = r._private.rscratch;
  return pr(t, "labelWrapCachedLines", e) || [];
}
var Ts = function(e, t) {
  return function(a) {
    var n = e(a), i = Of(a, t);
  ...
  return function(a, n) {
    ...
    if (typeof n == "string") {
      var s = n.indexOf("_");
      if (s > 0) {
        var o = Number(n.substring(s + 1)), u = Of(a, t), l = i.h / u.length, v = l * o, f = i.y1 + v;
        return {
          x1: i.x1,
          w: i.w,
          y1: f,
...
function mm(r) {
  {
    ...
    r.render = function(i) {
      i = i || {};
      var s = r.cy;
      r.webgl && (s.zoom() > Df ? (bm(r), e.call(r, i)) : (wm(r), zf(r, i, Ea.SCREEN)));
    };
  }
  {
...
function xm(r) {
  var e = r.canvasWidth, t = r.canvasHeight, a = mo(r), n = a.pan, i = a.zoom, s = xs();
  pn(s, s, [n.x, n.y]), Hs(s, s, [i, i]);
  var o = xs();
  sm(o, e, t);
  var u = xs();
  return im(u, o, s), u;
...
function Nf(r, e) {
  var t = r.canvasWidth, a = r.canvasHeight, n = mo(r), i = n.pan, s = n.zoom;
...
function Cm(r) {
  ...
  e.save(), Nf(r, e), e.strokeStyle = "rgba(0, 0, 0, 0.3)", e.beginPath(), e.moveTo(-1e3, 0), e.lineTo(1e3, 0), e.stroke(), e.beginPath(), e.moveTo(0, -1e3), e.lineTo(0, 1e3), e.stroke(), e.restore();
}
function Tm(r) {
  var e = function(n, i, s) {
    for (var o = n.atlasManager.getAtlasCollection(i), u = r.data.contexts[r.NODE], l = o.atlases, v = 0; v < l.length; v++) {
      var f = l[v], c = f.canvas;
      if (c) {
        var h = c.width, d = c.height, y = h * v, g = c.height * s, p = 0.4;
        u.save(), u.scale(p, p), u.drawImage(c, y, g), u.strokeStyle = "black", u.rect(y, g, h, d), u.stroke(), u.restore();
      }
    }
  }, t = 0;
...
function Sm(r, e, t, a, n) {
  var i, s, o, u, l = mo(r), v = l.pan, f = l.zoom;
  {
    var c = Zy(r, v, f, e, t), h = Xe(c, 2), d = h[0], y = h[1], g = 6;
    i = d - g / 2, s = y - g / 2, o = g, u = g;
  }
  if (o === 0 || u === 0)
    return [];
  var p = r.data.contexts[r.WEBGL];
  p.bindFramebuffer(p.FRAMEBUFFER, r.pickingFrameBuffer), r.pickingFrameBuffer.needsDraw && (p.viewport(0, 0, p.canvas.width, p.canvas.height), zf(r, null, Ea.PICKING), r.pickingFrameBuffer.needsDraw = !1);
  ...
  for (var w = /* @__PURE__ */ new Set(), E = 0; E < m; E++) {
    var C = b.slice(E * 4, E * 4 + 4), x = jy(C) - 1;
    x >= 0 && w.add(x);
  }
  return w;
}
function km(r, e, t) {
  var a = Sm(r, e, t), n = r.getCachedZSortedEles(), i, s, o = Cr(a), u;
  try {
    for (o.s(); !(u = o.n()).done; ) {
      var l = u.value, v = n[l];
...
function zf(r, e, t) {
  ...
  var n = r.drawing, i = 0;
  if (t.screen && r.data.canvasNeedsRedraw[r.SELECT_BOX] && Em(r, e), r.data.canvasNeedsRedraw[r.NODE] || t.picking) {
    ...
    var o = xm(r), u = r.getCachedZSortedEles();
    if (i = u.length, n.startFrame(o, t), t.screen) {
      for (var l = 0; l < u.nondrag.length; l++)
        ks(r, l, u.nondrag[l]);
      for (var v = 0; v < u.drag.length; v++)
        ks(r, v, u.drag[v]);
    } else if (t.picking)
      for (var f = 0; f < u.length; f++)
        ks(r, f, u[f]);
    n.endFrame(), t.screen && r.webglDebugShowAtlases && (Cm(r), Tm(r)), r.data.canvasNeedsRedraw[r.NODE] = !1, r.data.canvasNeedsRedraw[r.DRAG] = !1;
  }
  if (r.webglDebug) {
    var c = performance.now(), h = !1, d = Math.ceil(c - a), y = n.getDebugInfo(), g = ["".concat(i, " elements"), "".concat(y.totalInstances, " instances"), "".concat(y.batchCount, " batches"), "".concat(y.totalAtlases, " atlases"), "".concat(y.wrappedCount, " wrapped textures"), "".concat(y.simpleCount, " simple shapes")].join(", ");
    if (h)
...
var pt = {};
pt.drawPolygonPath = function(r, e, t, a, n, i) {
  var s = a / 2, o = n / 2;
...
pt.drawRoundPolygonPath = function(r, e, t, a, n, i, s) {
  s.forEach(function(o) {
    return yf(r, o);
  }), r.closePath();
};
pt.drawRoundRectanglePath = function(r, e, t, a, n, i) {
  var s = a / 2, o = n / 2, u = i === "auto" ? ut(a, n) : Math.min(i, o, s);
...
pt.drawBottomRoundRectanglePath = function(r, e, t, a, n, i) {
  var s = a / 2, o = n / 2, u = i === "auto" ? ut(a, n) : i;
...
pt.drawCutRectanglePath = function(r, e, t, a, n, i, s) {
  var o = a / 2, u = n / 2, l = s === "auto" ? ao() : s;
...
pt.drawBarrelPath = function(r, e, t, a, n) {
  var i = a / 2, s = n / 2, o = e - i, u = e + i, l = t - s, v = t + s, f = Ps(a, n), c = f.widthOffset, h = f.heightOffset, d = f.ctrlPtOffsetPct * c;
  r.beginPath && r.beginPath(), r.moveTo(o, l + h), r.lineTo(o, v - h), r.quadraticCurveTo(o + d, v, o + c, v), r.lineTo(u - c, v), r.quadraticCurveTo(u - d, v, u, v - h), r.lineTo(u, l + h), r.quadraticCurveTo(u - d, l, u - c, l), r.lineTo(o + c, l), r.quadraticCurveTo(o + d, l, o, l + h), r.closePath();
};
var Xl = Math.sin(0), Yl = Math.cos(0), Ws = {}, $s = {}, Ff = Math.PI / 40;
for (var qt = 0 * Math.PI; qt < 2 * Math.PI; qt += Ff)
  Ws[qt] = Math.sin(qt), $s[qt] = Math.cos(qt);
pt.drawEllipsePath = function(r, e, t, a, n) {
  if (r.beginPath && r.beginPath(), r.ellipse)
    r.ellipse(e, t, a / 2, n / 2, 0, 0, 2 * Math.PI);
  else
    for (var i, s, o = a / 2, u = n / 2, l = 0 * Math.PI; l < 2 * Math.PI; l += Ff)
      i = e - o * Ws[l] * Xl + o * $s[l] * Yl, s = t + u * $s[l] * Xl + u * Ws[l] * Yl, l === 0 ? r.moveTo(i, s) : r.lineTo(i, s);
  r.closePath();
};
var Wa = {};
...
Wa.bufferCanvasImage = function(r) {
  ...
  if (r.scale !== void 0)
    ...
    var v = 1 / 0, f = 1 / 0;
    ae(r.maxWidth) && (v = l * r.maxWidth / i), ae(r.maxHeight) && (f = l * r.maxHeight / s), l = Math.min(v, f), i *= l, s *= l;
  }
  o || (i *= u, s *= u, l *= u);
...
Wa.png = function(r) {
  return Vf(r, this.bufferCanvasImage(r), "image/png");
};
Wa.jpg = function(r) {
  return Vf(r, this.bufferCanvasImage(r), "image/jpeg");
};
var qf = {};
qf.nodeShapeImpl = function(r, e, t, a, n, i, s, o) {
  switch (r) {
    case "ellipse":
...
function _f(r) {
  ...
  r.webgl && (Se.CANVAS_LAYERS = e.CANVAS_LAYERS = 4, console.log("webgl rendering enabled")), e.data = {
  ...
  mc() && (u["-ms-touch-action"] = "none", u["touch-action"] = "none");
  for (var l = 0; l < Se.CANVAS_LAYERS; l++) {
    var v = e.data.canvases[l] = a.createElement("canvas"), f = Se.CANVAS_TYPES[l];
    e.data.contexts[l] = v.getContext(f), e.data.contexts[l] || Ge("Could not create canvas of type " + f), Object.keys(u).forEach(function(Y) {
      v.style[Y] = u[Y];
    }), v.style.position = "absolute", v.setAttribute("data-id", "layer" + l), v.style.zIndex = String(Se.CANVAS_LAYERS - l), e.data.canvasContainer.appendChild(v), e.data.canvasNeedsRedraw[l] = !1;
  }
  ...
  var c = yr(), h = function(V) {
    ...
    var H = V[0]._private, $ = H.oldBackgroundTimestamp === H.backgroundTimestamp;
    return !$;
  }, g = function(V) {
    ...
    return e.drawElement(V, H, $, !1, !1, te);
  }, E = function(V, H, $, K, te) {
    return e.drawElementText(V, H, $, K, "main", te);
  }, C = function(V, H, $, K, te) {
    return e.drawElementText(V, H, $, K, "source", te);
  }, x = function(V, H, $, K, te) {
    return e.drawElementText(V, H, $, K, "target", te);
  }, T = function(V) {
    return V.boundingBox(), V[0]._private.bodyBounds;
  }, k = function(V) {
    return V.boundingBox(), V[0]._private.labelBounds.main || c;
  }, B = function(V) {
    return V.boundingBox(), V[0]._private.labelBounds.source || c;
  }, D = function(V) {
    return V.boundingBox(), V[0]._private.labelBounds.target || c;
  }, P = function(V, H) {
    return H;
  }, A = function(V) {
    return h(T(V));
    ...
    var K = V ? V + "-" : "";
    return {
      x: H.x + $.pstyle(K + "text-margin-x").pfValue,
      y: H.y + $.pstyle(K + "text-margin-y").pfValue
    };
  }, L = function(V, H, $) {
    var K = V[0]._private.rscratch;
    return {
      x: K[H],
      y: K[$]
    };
  }, I = function(V) {
    return R("", L(V, "labelX", "labelY"), V);
  }, M = function(V) {
    return R("source", L(V, "sourceLabelX", "sourceLabelY"), V);
  }, N = function(V) {
    return R("target", L(V, "targetLabelX", "targetLabelY"), V);
  }, F = function(V) {
    return d(T(V));
  }, _ = function(V) {
    return d(B(V));
    ...
    var H = k(V), $ = d(k(V));
    if (V.isNode()) {
      switch (Jt(V.pstyle("text-halign").value)) {
        case "left":
          $.x = -H.w - (H.leftPad || 0);
          break;
        case "right":
      ...
      switch (jt(V.pstyle("text-valign").value)) {
        case "top":
          $.y = -H.h - (H.topPad || 0);
          break;
        case "bottom":
    ...
    getRotationOffset: z,
    isVisible: P
  }), j = e.data.lyrTxrCache = new Bf(e);
  e.onUpdateEleCalcs(function(V, H) {
    Z.invalidateElements(H), Q.invalidateElements(H), X.invalidateElements(H), J.invalidateElements(H), j.invalidateElements(H);
    for (var $ = 0; $ < H.length; $++) {
      var K = H[$]._private;
  ...
  var ne = function(V) {
    for (var H = 0; H < V.length; H++)
      j.enqueueElementRefinement(V[H].ele);
  };
  Z.onDequeue(ne), Q.onDequeue(ne), X.onDequeue(ne), J.onDequeue(ne), r.webgl && e.initWebgl(r, {
    getStyleKey: g,
    getLabelKey: p,
    getSourceLabelKey: m,
    getTargetLabelKey: b,
...
Se.makeOffscreenCanvas = function(r, e) {
  var t;
  if ((typeof OffscreenCanvas > "u" ? "undefined" : je(OffscreenCanvas)) !== "undefined")
...
[Pf, Wr, Zr, yo, Rt, gt, mr, If, pt, Wa, qf].forEach(function(r) {
  me(Se, r);
});
var Am = [{
  name: "null",
...
function Wf(r, e, t) {
  var a = t, n = function(T) {
    Ne("Can not register `" + e + "` for `" + r + "` since `" + T + "` already exists in the prototype and can not be overridden");
  };
  if (r === "core") {
    if (Ra.prototype[e])
      return n(e);
    ...
    me(s, {
      createEmitter: function() {
        return this._private.emitter = new _n(c, this), this;
      },
      emitter: function() {
        return this._private.emitter;
      },
    ...
    var h = $f("renderer", "base"), d = h.prototype, y = t, g = t.prototype, p = function() {
    ...
    d.clientFunctions.forEach(function(x) {
      m[x] = m[x] || function() {
        Ge("Renderer does not implement `renderer." + x + "()` on its prototype");
      };
    }), a = p;
  } else if (r === "__proto__" || r === "constructor" || r === "prototype")
    return Ge(r + " is an illegal type to be registered, possibly lead to prototype pollutions");
  return sv({
    map: Gf,
    keys: [r, e],
    value: a
...
Pt.css = function(r, e) {
  ...
  if (he(r))
    ...
    for (var a = r, n = Object.keys(a), i = 0; i < n.length; i++) {
      var s = n[i], o = a[s];
      if (o != null) {
        var u = ir.properties[s] || ir.properties[Rn(s)];
        if (u != null) {
          var l = u.name, v = o;
          this[t].properties.push({
            name: l,
...
Pt.style = Pt.css;
Pt.generateStyle = function(r) {
  var e = new ir(r);
  return this.appendToStyle(e);
};
Pt.appendToStyle = function(r) {
  for (var e = 0; e < this.length; e++) {
...
var Im = "3.34.3", ea = function(e) {
  if (e === void 0 && (e = {}), Me(e))
    return new Ra(e);
  if (he(e))
    return Us.apply(Us, arguments);
};
ea.use = function(r) {
...
ea.version = Im;
ea.stylesheet = ea.Stylesheet = An;
export {
  ea as c
};
