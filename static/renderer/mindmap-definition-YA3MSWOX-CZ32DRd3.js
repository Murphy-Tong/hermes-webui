import { g as oe } from "./chunk-XXDRQBXY-BqGCxoxg.js";
import { s as ae } from "./chunk-POPQ4Y6H-CQN0Kh15.js";
import { _ as l, l as C, u as ce, v as le, y as he, B as G, c as B, i as F, b3 as de, ab as ge, ac as ue, ad as pe } from "./mermaid.core-CE4XPZv1.js";
const E = [];
for (let e = 0; e < 256; ++e)
  E.push((e + 256).toString(16).slice(1));
function fe(e, n = 0) {
  return (E[e[n + 0]] + E[e[n + 1]] + E[e[n + 2]] + E[e[n + 3]] + "-" + E[e[n + 4]] + E[e[n + 5]] + "-" + E[e[n + 6]] + E[e[n + 7]] + "-" + E[e[n + 8]] + E[e[n + 9]] + "-" + E[e[n + 10]] + E[e[n + 11]] + E[e[n + 12]] + E[e[n + 13]] + E[e[n + 14]] + E[e[n + 15]]).toLowerCase();
}
const me = new Uint8Array(16);
function ye() {
  return crypto.getRandomValues(me);
}
function Ee(e, n, g) {
  return crypto.randomUUID ? crypto.randomUUID() : _e(e);
}
function _e(e, n, g) {
  e = e || {};
  const a = e.random ?? e.rng?.() ?? ye();
  if (a.length < 16)
    throw new Error("Random bytes length must be >= 16");
  return a[6] = a[6] & 15 | 64, a[8] = a[8] & 63 | 128, fe(a);
}
var Y = (function() {
  var e = /* @__PURE__ */ l(function(D, s, i, o) {
    for (i = i || {}, o = D.length; o--; i[D[o]] = s) ;
    return i;
  }, "o"), n = [1, 4], g = [1, 13], a = [1, 12], t = [1, 15], h = [1, 16], f = [1, 20], m = [1, 19], _ = [6, 7, 8], T = [1, 26], I = [1, 24], w = [1, 25], d = [6, 7, 11], R = [1, 6, 13, 15, 16, 19, 22], q = [1, 33], J = [1, 34], A = [1, 6, 7, 11, 13, 15, 16, 19, 22], j = {
    ...
    performAction: /* @__PURE__ */ l(function(s, i, o, c, p, r, $) {
      var u = r.length - 1;
      switch (p) {
        case 6:
        case 7:
    ...
    parse: /* @__PURE__ */ l(function(s) {
      var i = this, o = [0], c = [], p = [null], r = [], $ = this.table, u = "", M = 0, K = 0, ne = 2, Q = 1, ie = r.slice.call(arguments, 1), y = Object.create(this.lexer), L = { yy: {} };
      for (var H in this.yy)
        Object.prototype.hasOwnProperty.call(this.yy, H) && (L.yy[H] = this.yy[H]);
      y.setInput(s, L.yy), L.yy.lexer = y, L.yy.parser = this, typeof y.yylloc > "u" && (y.yylloc = {});
      var W = y.yylloc;
      r.push(W);
      ...
      function re(k) {
        o.length = o.length - 2 * k, p.length = p.length - k, r.length = r.length - k;
      }
      l(re, "popStack");
      function Z() {
        var k;
        return k = c.pop() || y.lex() || Q, typeof k != "number" && (k instanceof Array && (c = k, k = c.pop()), k = i.symbols_[k] || k), k;
      }
      l(Z, "lex");
      for (var b, v, S, z, O = {}, U, x, ee, V; ; ) {
        if (v = o[o.length - 1], this.defaultActions[v] ? S = this.defaultActions[v] : ((b === null || typeof b > "u") && (b = Z()), S = $[v] && $[v][b]), typeof S > "u" || !S.length || !S[0]) {
          var X = "";
          V = [];
          for (U in $[v])
            this.terminals_[U] && U > ne && V.push("'" + this.terminals_[U] + "'");
          y.showPosition ? X = "Parse error on line " + (M + 1) + `:
` + y.showPosition() + `
Expecting ` + V.join(", ") + ", got '" + (this.terminals_[b] || b) + "'" : X = "Parse error on line " + (M + 1) + ": Unexpected " + (b == Q ? "end of input" : "'" + (this.terminals_[b] || b) + "'"), this.parseError(X, {
            text: y.match,
        ...
        switch (S[0]) {
          case 1:
            o.push(b), p.push(y.yytext), r.push(y.yylloc), o.push(S[1]), b = null, K = y.yyleng, u = y.yytext, M = y.yylineno, W = y.yylloc;
            break;
          case 2:
            if (x = this.productions_[S[1]][1], O.$ = p[p.length - x], O._$ = {
              ...
              p,
              r
            ].concat(ie)), typeof z < "u")
              return z;
            x && (o = o.slice(0, -1 * x * 2), p = p.slice(0, -1 * x), r = r.slice(0, -1 * x)), o.push(this.productions_[S[1]][0]), p.push(O.$), r.push(O._$), ee = $[o[o.length - 2]][o[o.length - 1]], o.push(ee);
            break;
          case 3:
            return !0;
        }
...
` + this.showPosition(), {
      ...
      performAction: /* @__PURE__ */ l(function(i, o, c, p) {
        switch (c) {
          case 0:
...
var be = Y, ke = 12, N = {
  ...
  addNode(e, n, g, a) {
    C.info("addNode", e, n, g, a);
    let t = !1;
    this.nodes.length === 0 ? (this.baseLevel = e, e = 0, t = !0) : this.baseLevel !== void 0 && (e = e - this.baseLevel, t = !1);
    const h = B();
    let f = h.mindmap?.padding ?? G.mindmap.padding;
    switch (a) {
    ...
    const m = {
      ...
      type: a,
      children: [],
      width: h.mindmap?.maxNodeWidth ?? G.mindmap.maxNodeWidth,
      padding: f,
      isRoot: t
    }, _ = this.getParent(e);
    if (_)
      _.children.push(m), this.nodes.push(m);
    else if (t)
      this.nodes.push(m);
    else
      throw new Error(
        `There can be only one root. No parent could be found for ("${m.descr}")`
      );
  }
  getType(e, n) {
  ...
  decorateNode(e) {
    if (!e)
      return;
    const n = B(), g = this.nodes[this.nodes.length - 1];
    e.icon && (g.icon = F(e.icon, n)), e.class && (g.class = F(e.class, n));
  }
  type2Str(e) {
    switch (e) {
  ...
  assignSections(e, n) {
    if (e.level === 0 ? e.section = void 0 : e.section = n, e.children)
      for (const [g, a] of e.children.entries()) {
        const t = e.level === 0 ? g % (ke - 1) : n;
        this.assignSections(a, t);
      }
  }
  /**
  ...
  generateEdges(e, n) {
    ...
    for (const a of e.children) {
      let t = "edge";
      a.section !== void 0 && (t += ` section-edge-${a.section}`);
      const h = e.level + 1;
      t += ` edge-depth-${h}`;
      const f = {
        id: `edge_${e.id}_${a.id}`,
        start: e.id.toString(),
        end: a.id.toString(),
        type: "normal",
        curve: "basis",
      ...
      n.push(f), this.generateEdges(a, n);
    }
  }
  /**
   ...
   */
  getData() {
    const e = this.getMindmap(), n = B(), a = de().layout !== void 0, t = n;
    if (a || (t.layout = "cose-bilkent"), !e)
      return {
        nodes: [],
        edges: [],
        config: t
    ...
    const h = [], f = [];
    this.flattenNodes(e, h), this.generateEdges(e, f), C.debug(
      `getData: processed ${h.length} nodes and ${f.length} edges`
    );
    ...
    return {
      ...
      shapes: Object.fromEntries(m),
      // Additional properties that layout algorithms might expect
      type: "mindmap",
      diagramId: "mindmap-" + Ee()
    };
  }
...
}, xe = /* @__PURE__ */ l(async (e, n, g, a) => {
  C.debug(`Rendering mindmap diagram
` + e);
  const t = a.db, h = t.getData(), f = oe(n, h.config.securityLevel);
  if (h.type = a.type, h.layoutAlgorithm = ce(h.config.layout, {
    fallback: "cose-bilkent"
  }), h.diagramId = n, !t.getMindmap())
    return;
  h.nodes.forEach((d) => {
    d.shape === "rounded" ? (d.radius = 15, d.taper = 15, d.stroke = "none", d.width = 0, d.padding = 15) : d.shape === "circle" ? d.padding = 10 : d.shape === "rect" ? (d.width = 0, d.padding = 10) : d.shape === "hexagon" && (d.width = 0, d.height = 0);
  }), await le(h, f);
  const { themeVariables: _ } = he(), { useGradient: T, gradientStart: I, gradientStop: w } = _;
  if (T && I && w) {
    const d = f.attr("id"), R = f.append("defs").append("linearGradient").attr("id", `${d}-gradient`).attr("gradientUnits", "objectBoundingBox").attr("x1", "0%").attr("y1", "0%").attr("x2", "100%").attr("y2", "0%");
    R.append("stop").attr("offset", "0%").attr("stop-color", I).attr("stop-opacity", 1), R.append("stop").attr("offset", "100%").attr("stop-color", w).attr("stop-opacity", 1);
  }
  ae(
    f,
    h.config.mindmap?.padding ?? G.mindmap.padding,
    "mindmapDiagram",
    h.config.mindmap?.useMaxWidth ?? G.mindmap.useMaxWidth
  );
}, "draw"), Ne = {
  draw: xe
}, De = /* @__PURE__ */ l((e) => {
  const { theme: n, look: g } = e;
  let a = "";
  for (let t = 0; t < e.THEME_COLOR_LIMIT; t++)
    e["lineColor" + t] = e["lineColor" + t] || e["cScaleInv" + t], ge(e["lineColor" + t]) ? e["lineColor" + t] = ue(e["lineColor" + t], 20) : e["lineColor" + t] = pe(e["lineColor" + t], 20);
  for (let t = 0; t < e.THEME_COLOR_LIMIT; t++) {
    const h = "" + (g === "neo" ? Math.max(10 - (t - 1) * 2, 2) : 17 - 3 * t);
    a += `
  ...
  return a;
}, "genSections"), Le = /* @__PURE__ */ l((e, n, g) => {
  let a = "";
  for (let t = 0; t < e; t++)
    a += `
    [data-look="neo"].mindmap-node.section-${t - 1} rect, [data-look="neo"].mindmap-node.section-${t - 1} path, [data-look="neo"].mindmap-node.section-${t - 1} circle, [data-look="neo"].mindmap-node.section-${t - 1} polygon {
  ...
  return a;
}, "genGradient"), ve = /* @__PURE__ */ l((e) => {
  const { theme: n } = e, g = e.svgId, a = e.dropShadow ? e.dropShadow.replace("url(#drop-shadow)", `url(${g}-drop-shadow)`) : "none";
  return `
  .edge {
    stroke-width: 3;
  }
  ...
  ${e.useGradient && g && e.mainBkg ? Le(e.THEME_COLOR_LIMIT, g, e.mainBkg) : ""}
`;
}, "getStyles"), Te = ve, we = {
  get db() {
    return new Se();
