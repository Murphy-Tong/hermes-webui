import { s as R, a as W, S as N } from "./chunk-IMKFNOWR-DkJUXbwe.js";
import { _ as f, c as t, j as H, l as S, d as P, a7 as _, k as z, a8 as U, a9 as C, M as F, x as O } from "./mermaid.core-CE4XPZv1.js";
...
var X = /* @__PURE__ */ f((e) => e.append("circle").attr("class", "start-state").attr("r", t().state.sizeUnit).attr("cx", t().state.padding + t().state.sizeUnit).attr("cy", t().state.padding + t().state.sizeUnit), "drawStartState"), D = /* @__PURE__ */ f((e) => e.append("line").style("stroke", "grey").style("stroke-dasharray", "3").attr("x1", t().state.textHeight).attr("class", "divider").attr("x2", t().state.textHeight * 2).attr("y1", 0).attr("y2", 0), "drawDivider"), Y = /* @__PURE__ */ f((e, i) => {
  ...
  const n = i.points, l = U().x(function(s) {
    ...
    return s.y;
  }).curve(C), p = e.append("path").attr("d", l(n)).attr("id", "edge" + A).attr("class", "transition");
  let a = "";
  if (t().state.arrowMarkerAbsolute && (a = F(!0)), p.attr(
    "marker-end",
    "url(" + a + "#" + c(N.relationType.DEPENDENCY) + "End)"
  ), d.title !== void 0) {
    const s = e.append("g").attr("class", "stateLabel"), { x: B, y: x } = O.calcLabelPosition(i.points), g = z.getRows(d.title);
    let o = 0;
    const m = [];
    let y = 0, v = 0;
...
}, "draw"), at = /* @__PURE__ */ f((e) => e ? e.length * b.fontSizeFactor : 1, "getLabelWidth"), G = /* @__PURE__ */ f((e, i, d, c, n, l, p) => {
  const a = new _({
    compound: !0,
    multigraph: !0
  });
