import { g as tt } from "./chunk-5VM5RSS4-GIn7YGKa.js";
import { g as st } from "./chunk-XXDRQBXY-BqGCxoxg.js";
import { s as it } from "./chunk-POPQ4Y6H-CQN0Kh15.js";
import { _ as f, l as Ie, c as F, u as at, v as nt, x as Oe, j as de, b as rt, a as ut, s as lt, g as ct, n as ot, o as ht, k as I, p as dt, q as pt, i as At, a6 as G } from "./mermaid.core-CE4XPZv1.js";
import { f as ft } from "./chunk-F27PBJKO-BGhD49_V.js";
import { cm as gt } from "./index-WjDCRcCV.js";
var we = (function() {
  var t = /* @__PURE__ */ f(function(O, o, h, p) {
    for (h = h || {}, p = O.length; p--; h[O[p]] = o) ;
    return h;
  }, "o"), i = [1, 18], a = [1, 19], n = [1, 20], r = [1, 41], c = [1, 26], u = [1, 42], d = [1, 24], m = [1, 25], g = [1, 32], N = [1, 33], Ae = [1, 34], b = [1, 45], fe = [1, 35], ge = [1, 36], me = [1, 37], Ce = [1, 38], be = [1, 27], ke = [1, 28], Ee = [1, 29], Te = [1, 30], ye = [1, 31], k = [1, 44], E = [1, 46], T = [1, 43], y = [1, 47], De = [1, 9], A = [1, 8, 9], Z = [1, 58], $ = [1, 59], ee = [1, 60], te = [1, 61], se = [1, 62], Fe = [1, 63], Be = [1, 64], _ = [1, 8, 9, 41], Pe = [1, 77], M = [1, 8, 9, 12, 13, 22, 39, 41, 44, 46, 68, 69, 70, 71, 72, 73, 74, 79, 81], ie = [1, 8, 9, 12, 13, 18, 20, 22, 39, 41, 44, 46, 47, 60, 68, 69, 70, 71, 72, 73, 74, 79, 81, 86, 100, 102, 103], ae = [13, 60, 86, 100, 102, 103], U = [13, 60, 73, 74, 86, 100, 102, 103], Me = [13, 60, 68, 69, 70, 71, 72, 86, 100, 102, 103], ne = [1, 103], z = [1, 121], Y = [1, 117], K = [1, 113], W = [1, 119], Q = [1, 114], j = [1, 115], X = [1, 116], q = [1, 118], H = [1, 120], Re = [22, 50, 60, 61, 82, 86, 87, 88, 89, 90], Ge = [1, 128], re = [12, 39], _e = [1, 8, 9, 39, 41, 44, 46], ue = [1, 8, 9, 22], Ue = [1, 153], ze = [1, 8, 9, 61], x = [1, 8, 9, 22, 50, 60, 61, 82, 86, 87, 88, 89, 90], Se = {
    ...
    performAction: /* @__PURE__ */ f(function(o, h, p, l, C, e, J) {
      var s = e.length - 1;
      switch (C) {
        case 8:
          this.$ = e[s - 1];
        ...
        case 19:
          ...
          break;
        case 20:
          e[s - 1].title = l.cleanupLabel(e[s]), l.addRelation(e[s - 1]);
          break;
        case 31:
          this.$ = e[s].trim(), l.setAccTitle(this.$);
          break;
        case 32:
        case 33:
          this.$ = e[s].trim(), l.setAccDescription(this.$);
          break;
        case 34:
          l.addClassesToNamespace(e[s - 3], e[s - 1][0], e[s - 1][1]), l.popNamespace();
          break;
        case 35:
          l.addClassesToNamespace(e[s - 4], e[s - 1][0], e[s - 1][1]), l.popNamespace();
          break;
        case 36:
          this.$ = l.addNamespace(e[s]);
          break;
        case 37:
          this.$ = l.addNamespace(e[s - 1], e[s]);
          break;
        case 38:
          this.$ = [[e[s]], []];
          break;
        ...
        case 46:
          ...
          break;
        case 48:
          l.setCssClass(e[s - 2], e[s]);
          break;
        case 49:
          l.addMembers(e[s - 3], e[s - 1]);
          break;
        case 51:
          l.setCssClass(e[s - 5], e[s - 3]), l.addMembers(e[s - 5], e[s - 1]);
          break;
        case 52:
          l.addAnnotation(e[s - 3], e[s - 1]);
          break;
        case 53:
          l.addAnnotation(e[s - 6], e[s - 4]), l.addMembers(e[s - 6], e[s - 1]);
          break;
        case 54:
          l.addAnnotation(e[s - 5], e[s - 3]);
          break;
        case 55:
          this.$ = e[s], l.addClass(e[s]);
          break;
        case 56:
          this.$ = e[s - 1], l.addClass(e[s - 1]), l.setClassLabel(e[s - 1], e[s]);
          break;
        case 60:
          l.addAnnotation(e[s], e[s - 2]);
          break;
        case 61:
        case 74:
          this.$ = [e[s]];
        ...
        case 63:
          break;
        case 64:
          l.addMember(e[s - 1], l.cleanupLabel(e[s]));
          break;
        case 65:
          break;
        case 66:
        ...
        case 70:
          ...
          break;
        case 71:
          this.$ = l.addNote(e[s], e[s - 1]);
          break;
        case 72:
          this.$ = l.addNote(e[s]);
          break;
        case 73:
          this.$ = e[s - 2], l.defineClass(e[s - 1], e[s]);
          break;
        case 75:
        ...
        case 91:
        case 97:
          this.$ = e[s - 2], l.setClickEvent(e[s - 1], e[s]);
          break;
        case 92:
        case 98:
          this.$ = e[s - 3], l.setClickEvent(e[s - 2], e[s - 1]), l.setTooltip(e[s - 2], e[s]);
          break;
        case 93:
          this.$ = e[s - 2], l.setLink(e[s - 1], e[s]);
          break;
        case 94:
          this.$ = e[s - 3], l.setLink(e[s - 2], e[s - 1], e[s]);
          break;
        case 95:
          this.$ = e[s - 3], l.setLink(e[s - 2], e[s - 1]), l.setTooltip(e[s - 2], e[s]);
          break;
        case 96:
          this.$ = e[s - 4], l.setLink(e[s - 3], e[s - 2], e[s]), l.setTooltip(e[s - 3], e[s - 1]);
          break;
        case 99:
          this.$ = e[s - 3], l.setClickEvent(e[s - 2], e[s - 1], e[s]);
          break;
        case 100:
          this.$ = e[s - 4], l.setClickEvent(e[s - 3], e[s - 2], e[s - 1]), l.setTooltip(e[s - 3], e[s]);
          break;
        case 101:
          this.$ = e[s - 3], l.setLink(e[s - 2], e[s]);
          break;
        case 102:
          this.$ = e[s - 4], l.setLink(e[s - 3], e[s - 1], e[s]);
          break;
        case 103:
          this.$ = e[s - 4], l.setLink(e[s - 3], e[s - 1]), l.setTooltip(e[s - 3], e[s]);
          break;
        case 104:
          this.$ = e[s - 5], l.setLink(e[s - 4], e[s - 2], e[s]), l.setTooltip(e[s - 4], e[s - 1]);
          break;
        case 105:
          this.$ = e[s - 2], l.setCssStyle(e[s - 1], e[s]);
          break;
        case 106:
          l.setCssClass(e[s - 1], e[s]);
          break;
        case 107:
          this.$ = [e[s]];
          break;
    ...
    parse: /* @__PURE__ */ f(function(o) {
      var h = this, p = [0], l = [], C = [null], e = [], J = this.table, s = "", ce = 0, Ye = 0, Je = 2, Ke = 1, Ze = e.slice.call(arguments, 1), D = Object.create(this.lexer), w = { yy: {} };
      for (var Ne in this.yy)
        Object.prototype.hasOwnProperty.call(this.yy, Ne) && (w.yy[Ne] = this.yy[Ne]);
      D.setInput(o, w.yy), w.yy.lexer = D, w.yy.parser = this, typeof D.yylloc > "u" && (D.yylloc = {});
      var Le = D.yylloc;
      e.push(Le);
      var $e = D.options && D.options.ranges;
      typeof w.yy.parseError == "function" ? this.parseError = w.yy.parseError : this.parseError = Object.getPrototypeOf(this).parseError;
      function et(S) {
        p.length = p.length - 2 * S, C.length = C.length - S, e.length = e.length - S;
      }
      f(et, "popStack");
      function We() {
        var S;
        return S = l.pop() || D.lex() || Ke, typeof S != "number" && (S instanceof Array && (l = S, S = l.pop()), S = h.symbols_[S] || S), S;
      }
      f(We, "lex");
      for (var B, V, L, xe, R = {}, oe, v, Qe, he; ; ) {
        if (V = p[p.length - 1], this.defaultActions[V] ? L = this.defaultActions[V] : ((B === null || typeof B > "u") && (B = We()), L = J[V] && J[V][B]), typeof L > "u" || !L.length || !L[0]) {
          var ve = "";
          he = [];
          for (oe in J[V])
            this.terminals_[oe] && oe > Je && he.push("'" + this.terminals_[oe] + "'");
          D.showPosition ? ve = "Parse error on line " + (ce + 1) + `:
` + D.showPosition() + `
Expecting ` + he.join(", ") + ", got '" + (this.terminals_[B] || B) + "'" : ve = "Parse error on line " + (ce + 1) + ": Unexpected " + (B == Ke ? "end of input" : "'" + (this.terminals_[B] || B) + "'"), this.parseError(ve, {
            text: D.match,
        ...
        switch (L[0]) {
          case 1:
            p.push(B), C.push(D.yytext), e.push(D.yylloc), p.push(L[1]), B = null, Ye = D.yyleng, s = D.yytext, ce = D.yylineno, Le = D.yylloc;
            break;
          case 2:
            if (v = this.productions_[L[1]][1], R.$ = C[C.length - v], R._$ = {
              first_line: e[e.length - (v || 1)].first_line,
              last_line: e[e.length - 1].last_line,
              first_column: e[e.length - (v || 1)].first_column,
              last_column: e[e.length - 1].last_column
            }, $e && (R._$.range = [
              e[e.length - (v || 1)].range[0],
              e[e.length - 1].range[1]
            ]), xe = this.performAction.apply(R, [
              s,
              Ye,
              ce,
              w.yy,
              ...
              C,
              e
            ].concat(Ze)), typeof xe < "u")
              return xe;
            v && (p = p.slice(0, -1 * v * 2), C = C.slice(0, -1 * v), e = e.slice(0, -1 * v)), p.push(this.productions_[L[1]][0]), C.push(R.$), e.push(R._$), Qe = J[p[p.length - 2]][p[p.length - 1]], p.push(Qe);
            break;
          case 3:
            return !0;
        }
    ...
    var O = {
      ...
      unput: /* @__PURE__ */ f(function(o) {
        ...
        return this.yylloc = {
          ...
          last_column: p ? (p.length === l.length ? this.yylloc.first_column : 0) + l[l.length - p.length].length - p[0].length : this.yylloc.first_column - h
...
` + h + "^";
      ...
      test_match: /* @__PURE__ */ f(function(o, h) {
        ...
        }, this.options.ranges && (C.yylloc.range = this.yylloc.range.slice(0))), l = o[0].match(/(?:\r\n?|\n).*/g), l && (this.yylineno += l.length), this.yylloc = {
      ...
      next: /* @__PURE__ */ f(function() {
        ...
        for (var C = this._currentRules(), e = 0; e < C.length; e++)
          if (p = this._input.match(this.rules[C[e]]), p && (!h || p[0].length > h[0].length)) {
            if (h = p, l = e, this.options.backtrack_lexer) {
        ...
        return h ? (o = this.test_match(h, C[l]), o !== !1 ? o : !1) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
          text: "",
          token: null,
          line: this.yylineno
      ...
      options: {},
      performAction: /* @__PURE__ */ f(function(h, p, l, C) {
        switch (l) {
          case 0:
            return 62;
          case 1:
  ...
  return f(le, "Parser"), le.prototype = Se, Se.Parser = le, new le();
})();
we.parser = we;
var _t = we, je = ["#", "+", "~", "-", ""], Xe = class {
  static {
    f(this, "ClassMember");
  }
  constructor(t, i) {
  ...
  parseMember(t) {
    ...
    if (this.memberType === "method") {
      ...
      if (r) {
        ...
        if (je.includes(c) && (this.visibility = c), this.id = r[2], this.parameters = r[3] ? r[3].trim() : "", i = r[4] ? r[4].trim() : "", this.returnType = r[5] ? r[5].trim() : "", i === "") {
          const u = this.returnType.substring(this.returnType.length - 1);
          /[$*]/.exec(u) && (i = u, this.returnType = this.returnType.substring(0, this.returnType.length - 1));
        }
      }
    } else {
      const n = t.length, r = t.substring(0, 1), c = t.substring(n - 1);
      je.includes(r) && (this.visibility = r), /[$*]/.exec(c) && (i = c), this.id = t.substring(
        this.visibility === "" ? 0 : 1,
        i === "" ? n : n - 1
      );
    }
    this.classifier = i, this.id = this.id.startsWith(" ") ? " " + this.id.trim() : this.id.trim();
    const a = `${this.visibility ? "\\" + this.visibility : ""}${G(this.id)}${this.memberType === "method" ? `(${G(this.parameters)})${this.returnType ? " : " + G(this.returnType) : ""}` : ""}`;
    this.text = a.replaceAll("<", "&lt;").replaceAll(">", "&gt;"), this.text.startsWith("\\&lt;") && (this.text = this.text.replace("\\&lt;", "~"));
  }
  parseClassifier() {
...
}, pe = "classId-", qe = 0, P = /* @__PURE__ */ f((t) => I.sanitizeText(t, F()), "sanitizeText"), St = class Ve {
  constructor() {
   ...
   */
  addClass(i) {
    const a = I.sanitizeText(i, F()), { className: n, type: r } = this.splitClassNameAndType(a);
    if (this.classes.has(n))
      return;
    const c = I.sanitizeText(n, F());
    this.classes.set(c, {
      id: c,
      type: r,
      label: c,
  ...
  lookUpDomId(i) {
    ...
    if (this.classes.has(a)) {
      const n = this.classes.get(a).domId;
      return this.diagramId ? `${this.diagramId}-${n}` : n;
    }
    throw new Error("Class not found: " + a);
  }
  clear() {
    this.relations = [], this.classes = /* @__PURE__ */ new Map(), this.notes = /* @__PURE__ */ new Map(), this.interfaces = [], this.functions = [], this.functions.push(this.setupToolTips.bind(this)), this.namespaces = /* @__PURE__ */ new Map(), this.namespaceCounter = 0, this.namespaceStack = [], this.diagramId = "", this.direction = "TB", dt();
  }
  getClass(i) {
  ...
  addRelation(i) {
    Ie.debug("Adding relation: " + JSON.stringify(i));
    const a = [
   ...
   */
  addAnnotation(i, a) {
    const n = this.splitClassNameAndType(i).className;
    this.classes.get(n).annotations.push(a);
  }
  /**
  ...
  addMember(i, a) {
    this.addClass(i);
    const n = this.splitClassNameAndType(i).className, r = this.classes.get(n);
    if (typeof a == "string") {
      const c = a.trim();
      c.startsWith("<<") && c.endsWith(">>") ? r.annotations.push(P(c.substring(2, c.length - 2))) : c.indexOf(")") > 0 ? r.methods.push(new Xe(c, "method")) : c && r.members.push(new Xe(c, "attribute"));
    }
  }
  addMembers(i, a) {
    Array.isArray(a) && (a.reverse(), a.forEach((n) => this.addMember(i, n)));
  }
  addNote(i, a) {
    const n = this.notes.size, r = {
      id: `note${n}`,
      class: a,
      text: i,
      index: n
  ...
  cleanupLabel(i) {
    return i.startsWith(":") && (i = i.substring(1)), P(i.trim());
  }
  /**
  ...
  setCssClass(i, a) {
    i.split(",").forEach((n) => {
      let r = n;
      /\d/.exec(n[0]) && (r = pe + r), r = this.splitClassNameAndType(r).className;
      const c = this.classes.get(r);
      c && (c.cssClasses += " " + a);
    });
  }
  defineClass(i, a) {
    for (const n of i) {
      let r = this.styleClasses.get(n);
      r === void 0 && (r = { id: n, styles: [], textStyles: [] }, this.styleClasses.set(n, r)), a && a.forEach((c) => {
        if (/color/.exec(c)) {
          const u = c.replace("fill", "bgFill");
          r.textStyles.push(u);
        }
        r.styles.push(c);
      }), this.classes.forEach((c) => {
        c.cssClasses.includes(n) && c.styles.push(...a.flatMap((u) => u.split(",")));
      });
    }
  }
  /**
  ...
  setTooltip(i, a) {
    i.split(",").forEach((n) => {
      if (a !== void 0) {
        const r = this.splitClassNameAndType(n).className, c = this.classes.get(r);
        c && (c.tooltip = P(a));
      }
    });
  }
  ...
  setLink(i, a, n) {
    ...
    i.split(",").forEach((c) => {
      let u = c;
      /\d/.exec(c[0]) && (u = pe + u), u = this.splitClassNameAndType(u).className;
      const d = this.classes.get(u);
      d && (d.link = Oe.formatUrl(a, r), r.securityLevel === "sandbox" ? d.linkTarget = "_top" : typeof n == "string" ? d.linkTarget = P(n) : d.linkTarget = "_blank");
  ...
  setClickEvent(i, a, n) {
    i.split(",").forEach((r) => {
      this.setClickFunc(r, a, n);
      const c = this.splitClassNameAndType(r).className, u = this.classes.get(c);
      u && (u.haveCallback = !0);
    }), this.setCssClass(i, "clickable");
  }
  setClickFunc(i, a, n) {
    const r = I.sanitizeText(i, F());
    if (F().securityLevel !== "loose" || a === void 0)
      return;
    const u = this.splitClassNameAndType(r).className;
    if (this.classes.has(u)) {
      ...
      if (typeof n == "string") {
        ...
        for (let m = 0; m < d.length; m++) {
          let g = d[m].trim();
          g.startsWith('"') && g.endsWith('"') && (g = g.substr(1, g.length - 2)), d[m] = g;
        }
      }
      d.length === 0 && d.push(u), this.functions.push(() => {
        const m = this.lookUpDomId(u), g = document.querySelector(`[id="${m}"]`);
  ...
  static resolveQualifiedId(i, a) {
    const n = a.at(-1);
    return n ? `${n}.${i}` : i;
  }
  static getAncestorIds(i) {
    const a = i.split("."), n = new Array(a.length);
    n[0] = a[0];
    for (let r = 1; r < a.length; r++)
      n[r] = `${n[r - 1]}.${a[r]}`;
    return n;
  }
  createNamespaceNode(i, a, n, r = !1) {
    return {
      id: i,
      label: a,
  ...
  linkParentChild(i, a) {
    const n = this.namespaces.get(i), r = this.namespaces.get(a);
    !n || !r || (n.children.has(a) || n.children.set(a, r), r.parent ??= i);
  }
  addNamespace(i, a) {
    const n = Ve.resolveQualifiedId(i, this.namespaceStack);
    if (this.namespaceStack.push(n), this.namespaces.has(n)) {
      const u = this.namespaces.get(n);
      return u.explicit = !0, a && (u.label = a), n;
    }
    const r = n.split("."), c = Ve.getAncestorIds(n);
    for (let u = 0; u < c.length; u++) {
      const d = c[u], m = u > 0 ? c[u - 1] : void 0, g = u === c.length - 1, N = g && a ? a : r[u];
      this.namespaces.has(d) ? g && (this.namespaces.get(d).explicit = !0) : this.namespaces.set(
        d,
        this.createNamespaceNode(d, N, m, g)
      ), m && this.linkParentChild(m, d);
    }
    return n;
  }
  popNamespace() {
   ...
   * @public
   */
  addClassesToNamespace(i, a, n) {
    if (this.namespaces.has(i)) {
      for (const r of a) {
        const { className: c } = this.splitClassNameAndType(r), u = this.getClass(c);
        u.parent = i, this.namespaces.get(i).classes.set(c, u);
      }
      for (const r of n) {
        const c = this.getNote(r);
        c.parent = i, this.namespaces.get(i).notes.set(r, c);
      }
    }
  }
  setCssStyle(i, a) {
    const n = this.classes.get(i);
    if (!(!a || !n))
      for (const r of a)
        r.includes(",") ? n.styles.push(...r.split(",")) : n.styles.push(r);
  }
  /**
   ...
   */
  resolveExplicitAncestor(i) {
    let a = i;
    for (; a; ) {
      const n = this.namespaces.get(a);
      if (!n)
        return;
      if (n.explicit)
        return a;
  ...
  getData() {
    const i = [], a = [], n = F(), r = n.class?.hierarchicalNamespaces ?? !0;
    for (const u of this.namespaces.values()) {
      if (!r && !u.explicit)
        continue;
      const d = {
        id: u.id,
        label: r ? u.label : u.id,
        isGroup: !0,
        ...
        cssStyles: [],
        look: n.look,
        parentId: r ? u.parent : void 0
      };
      i.push(d);
    }
    for (const u of this.classes.values()) {
      const d = r ? u.parent : this.resolveExplicitAncestor(u.parent), m = {
        ...u,
        type: void 0,
        isGroup: !1,
        parentId: d,
    ...
    for (const u of this.notes.values()) {
      const d = r ? u.parent : this.resolveExplicitAncestor(u.parent), m = {
        id: u.id,
        label: u.text,
        isGroup: !1,
      ...
      i.push(m);
      const g = this.classes.get(u.class)?.id;
      if (g) {
        const N = {
          id: `edgeNote${u.index}`,
          start: u.id,
    ...
    for (const u of this.interfaces) {
      const d = {
        id: u.id,
        label: u.label,
        isGroup: !1,
    ...
    for (const u of this.relations) {
      ...
      const d = {
        ...
        thickness: "normal",
        classes: "relation",
        arrowTypeStart: this.getArrowMarker(u.relation.type1),
        arrowTypeEnd: this.getArrowMarker(u.relation.type2),
    ...
    return { nodes: i, edges: a, other: {}, config: n, direction: this.getDirection() };
  }
}, mt = /* @__PURE__ */ f((t) => `g.classGroup text {
...
.edgeLabel[data-look="neo"] {
  ...
  ${tt()}
`, "getStyles"), Nt = mt, Ct = /* @__PURE__ */ f((t, i = "TB") => {
  if (!t.doc)
    return i;
  let a = i;
  for (const n of t.doc)
    n.stmt === "dir" && (a = n.value);
  return a;
}, "getDir"), bt = /* @__PURE__ */ f(function(t, i) {
  return i.db.getClasses();
}, "getClasses"), kt = /* @__PURE__ */ f(async function(t, i, a, n) {
  Ie.info("REF0:"), Ie.info("Drawing class diagram (v3)", i);
  const { securityLevel: r, state: c, layout: u } = F();
  n.db.setDiagramId(i);
  const d = n.db.getData(), m = st(i, r);
  d.type = n.type, d.layoutAlgorithm = at(u), d.nodeSpacing = c?.nodeSpacing || 50, d.rankSpacing = c?.rankSpacing || 50, d.markers = ["aggregation", "extension", "composition", "dependency", "lollipop"], d.diagramId = i, await nt(d, m);
  const g = 8;
  Oe.insertTitle(
    m,
  ...
  ), it(m, g, "classDiagram", c?.useMaxWidth ?? !0);
}, "draw"), Lt = {
  getClasses: bt,
  draw: kt,
  getDir: Ct
