import { p as Ze } from "./chunk-JWPE2WC7-BhcJkOCu.js";
import { _ as ct, D as qe, ae as Qe, l as Se, b as Je, a as Ke, n as je, o as _e, g as tr, s as er, p as rr, A as ir, y as ar, B as nr, c as me, b4 as Ee, aj as ve, i as or, j as sr, q as hr, ak as lr, b5 as fr } from "./mermaid.core-CE4XPZv1.js";
import { p as cr } from "./cynefin-OW5HDTMX-gHq-wzJD.js";
import { c as Fe } from "./cytoscape.esm--ZJvtnOL.js";
import { cO as gr } from "./index-WjDCRcCV.js";
var se = { exports: {} }, he = { exports: {} }, le = { exports: {} }, ur = le.exports, Ae;
function dr() {
  return Ae || (Ae = 1, (function(w, F) {
    (function(G, N) {
      w.exports = N();
    })(ur, function() {
      return (
        ...
        (function(M) {
          ...
          function N(v) {
            ...
            return M[v].call(h.exports, h, h.exports, N), h.l = !0, h.exports;
          }
          return N.m = M, N.c = G, N.i = function(v) {
            return v;
          }, N.d = function(v, h, a) {
            N.o(v, h) || Object.defineProperty(v, h, {
              /******/
              configurable: !1,
              /******/
              enumerable: !0,
          ...
          /***/
          (function(M, G, N) {
            var v = N(2), h = N(8), a = N(9);
            function e(f, r, u) {
              v.call(this, u), this.isOverlapingSourceAndTarget = !1, this.vGraphObject = u, this.bendpoints = [], this.source = f, this.target = r;
            }
            ...
            e.prototype.getSource = function() {
              ...
              for (var u = this.getOtherEnd(f), t = r.getGraphManager().getRoot(); ; ) {
                if (u.getOwner() == r)
                  return u;
                if (u.getOwner() == t)
                  break;
          ...
          /***/
          (function(M, G, N) {
            var v = N(2), h = N(10), a = N(13), e = N(0), i = N(16), f = N(5);
            function r(t, s, o, c) {
              o == null && c == null && (c = s), v.call(this, c), t.graphManager != null && (t = t.graphManager), this.estimatedSize = h.MIN_VALUE, this.inclusionTreeDepth = h.MAX_VALUE, this.vGraphObject = c, this.edges = [], this.graphManager = t, o != null && s != null ? this.rect = new a(s.x, s.y, o.width, o.height) : this.rect = new a();
            }
          ...
          (function(M, G, N) {
            ...
            v.prototype.getX = function() {
              ...
              return this.y;
            }, v.prototype.setX = function(h) {
              this.x = h;
            }, v.prototype.setY = function(h) {
              this.y = h;
            }, v.prototype.getDifference = function(h) {
              return new DimensionD(this.x - h.x, this.y - h.y);
            }, v.prototype.getCopy = function() {
              return new v(this.x, this.y);
            }, v.prototype.translate = function(h) {
          ...
          /***/
          (function(M, G, N) {
            var v = N(2), h = N(10), a = N(0), e = N(7), i = N(3), f = N(1), r = N(13), u = N(12), t = N(11);
            function s(c, l, T) {
              v.call(this, T), this.estimatedSize = h.MIN_VALUE, this.margin = a.DEFAULT_GRAPH_MARGIN, this.edges = [], this.nodes = [], this.isConnected = !1, this.parent = c, l != null && l instanceof e ? this.graphManager = l : l != null && l instanceof Layout && (this.graphManager = l.graphManager);
            }
            ...
            s.prototype.getNodes = function() {
              ...
              if (c instanceof i) {
                ...
                for (var T = l.edges.slice(), g, d = T.length, L = 0; L < d; L++)
                  g = T[L], g.isInterGraph ? this.graphManager.remove(g) : g.source.owner.remove(g);
                var R = this.nodes.indexOf(l);
                if (R == -1)
                ...
                var C = g.source.edges.indexOf(g), P = g.target.edges.indexOf(g);
                if (!(C > -1 && P > -1))
                  throw "Source and/or target doesn't know this edge!";
                g.source.edges.splice(C, 1), g.target != g.source && g.target.edges.splice(P, 1);
                var R = g.source.owner.getEdges().indexOf(g);
                if (R == -1)
                  throw "Not in owner's edge list!";
                g.source.owner.getEdges().splice(R, 1);
              }
            }, s.prototype.updateLeftTop = function() {
              for (var c = h.MAX_VALUE, l = h.MAX_VALUE, T, g, d, L = this.getNodes(), R = L.length, C = 0; C < R; C++) {
                var P = L[C];
                T = P.getTop(), g = P.getLeft(), c > T && (c = T), l > g && (l = g);
              }
              return c == h.MAX_VALUE ? null : (L[0].getParent().paddingLeft != null ? d = L[0].getParent().paddingLeft : d = this.margin, this.left = l - d, this.top = c - d, new u(this.left, this.top));
            }, s.prototype.updateBounds = function(c) {
              for (var l = h.MAX_VALUE, T = -h.MAX_VALUE, g = h.MAX_VALUE, d = -h.MAX_VALUE, L, R, C, P, V, Y = this.nodes, z = Y.length, A = 0; A < z; A++) {
                var _ = Y[A];
                c && _.child != null && _.updateBounds(), L = _.getLeft(), R = _.getRight(), C = _.getTop(), P = _.getBottom(), l > L && (l = L), T < R && (T = R), g > C && (g = C), d < P && (d = P);
              }
              var n = new r(l, g, T - l, d - g);
              l == h.MAX_VALUE && (this.left = this.parent.getLeft(), this.right = this.parent.getRight(), this.top = this.parent.getTop(), this.bottom = this.parent.getBottom()), Y[0].getParent().paddingLeft != null ? V = Y[0].getParent().paddingLeft : V = this.margin, this.left = n.x - V, this.right = n.x + n.width + V, this.top = n.y - V, this.bottom = n.y + n.height + V;
            }, s.calculateBounds = function(c) {
              for (var l = h.MAX_VALUE, T = -h.MAX_VALUE, g = h.MAX_VALUE, d = -h.MAX_VALUE, L, R, C, P, V = c.length, Y = 0; Y < V; Y++) {
                var z = c[Y];
                L = z.getLeft(), R = z.getRight(), C = z.getTop(), P = z.getBottom(), l > L && (l = L), T < R && (T = R), g > C && (g = C), d < P && (d = P);
              }
              var A = new r(l, g, T - l, d - g);
              return A;
              ...
              var l = new t(), T = /* @__PURE__ */ new Set(), g = this.nodes[0], d, L, R = g.withChildren();
              for (R.forEach(function(A) {
                l.push(A), T.add(A);
              }); l.length !== 0; ) {
                g = l.shift(), d = g.getEdges();
                for (var C = d.length, P = 0; P < C; P++) {
                  var V = d[P];
                  if (L = V.getOtherEndInGraph(g, this), L != null && !T.has(L)) {
          ...
          (function(M, G, N) {
            var v, h = N(1);
            function a(e) {
              v = N(6), this.layout = e, this.graphs = [], this.edges = [];
            }
            a.prototype.addRoot = function() {
            ...
            }, a.prototype.add = function(e, i, f, r, u) {
              if (f == null && r == null && u == null) {
                ...
                u = f, r = i, f = e;
                var t = r.getOwner(), s = u.getOwner();
                if (!(t != null && t.getGraphManager() == this))
                  throw "Source not in this graph mgr!";
                if (!(s != null && s.getGraphManager() == this))
                  throw "Target not in this graph mgr!";
                if (t == s)
                  return f.isInterGraph = !1, t.add(f, r, u);
                if (f.isInterGraph = !0, f.source = r, f.target = u, this.edges.indexOf(f) > -1)
              ...
              if (e instanceof v) {
                ...
                for (var r, u = f.length, t = 0; t < u; t++)
                  r = f[t], i.remove(r);
                var s = [];
              ...
              for (var e, i, f, r, u, t = this.getAllEdges(), s = t.length, o = 0; o < s; o++) {
              ...
              for (var f, r = e.getNodes(), u = r.length, t = 0; t < u; t++)
          ...
          (function(M, G, N) {
            ...
            h.calcSeparationAmount = function(a, e, i, f) {
              ...
              var f = a.getCenterX(), r = a.getCenterY(), u = e.getCenterX(), t = e.getCenterY();
              if (a.intersects(e))
                return i[0] = f, i[1] = r, i[2] = u, i[3] = t, !0;
              var s = a.getX(), o = a.getY(), c = a.getRight(), l = a.getX(), T = a.getBottom(), g = a.getRight(), d = a.getWidthHalf(), L = a.getHeightHalf(), R = e.getX(), C = e.getY(), P = e.getRight(), V = e.getX(), Y = e.getBottom(), z = e.getRight(), A = e.getWidthHalf(), _ = e.getHeightHalf(), n = !1, E = !1;
              if (f === u) {
                if (r > t)
                  return i[0] = f, i[1] = o, i[2] = u, i[3] = Y, !1;
                if (r < t)
                  return i[0] = f, i[1] = T, i[2] = u, i[3] = C, !1;
              } else if (r === t) {
                if (f > u)
                  return i[0] = s, i[1] = r, i[2] = P, i[3] = t, !1;
                if (f < u)
                  return i[0] = c, i[1] = r, i[2] = R, i[3] = t, !1;
              } else {
                var p = a.height / a.width, m = e.height / e.width, y = (t - r) / (u - f), I = void 0, D = void 0, S = void 0, W = void 0, x = void 0, Q = void 0;
                if (-p === y ? f > u ? (i[0] = l, i[1] = T, n = !0) : (i[0] = c, i[1] = o, n = !0) : p === y && (f > u ? (i[0] = s, i[1] = o, n = !0) : (i[0] = g, i[1] = T, n = !0)), -m === y ? u > f ? (i[2] = V, i[3] = Y, E = !0) : (i[2] = P, i[3] = C, E = !0) : m === y && (u > f ? (i[2] = R, i[3] = C, E = !0) : (i[2] = z, i[3] = Y, E = !0)), n && E)
                  return !1;
                if (f > u ? r > t ? (I = this.getCardinalDirection(p, y, 4), D = this.getCardinalDirection(m, y, 2)) : (I = this.getCardinalDirection(-p, y, 3), D = this.getCardinalDirection(-m, y, 1)) : r > t ? (I = this.getCardinalDirection(-p, y, 1), D = this.getCardinalDirection(-m, y, 3)) : (I = this.getCardinalDirection(p, y, 2), D = this.getCardinalDirection(m, y, 4)), !n)
                  switch (I) {
                    case 1:
                      W = o, S = f + -L / y, i[0] = S, i[1] = W;
                      break;
                    case 2:
                      S = g, W = r + d * y, i[0] = S, i[1] = W;
                      break;
                    case 3:
                      W = T, S = f + L / y, i[0] = S, i[1] = W;
                      break;
                    case 4:
                      S = l, W = r + -d * y, i[0] = S, i[1] = W;
                      break;
                  }
                if (!E)
                  switch (D) {
                    case 1:
                      Q = C, x = u + -_ / y, i[2] = x, i[3] = Q;
                      break;
                    case 2:
                      x = z, Q = t + A * y, i[2] = x, i[3] = Q;
                      break;
                    case 3:
                      Q = Y, x = u + _ / y, i[2] = x, i[3] = Q;
                      break;
                    case 4:
                      x = V, Q = t + -A * y, i[2] = x, i[3] = Q;
                      break;
                  }
              }
              return !1;
              ...
              var r = a.x, u = a.y, t = e.x, s = e.y, o = i.x, c = i.y, l = f.x, T = f.y, g = void 0, d = void 0, L = void 0, R = void 0, C = void 0, P = void 0, V = void 0, Y = void 0, z = void 0;
              return L = s - u, C = r - t, V = t * u - r * s, R = T - c, P = o - l, Y = l * c - o * T, z = L * P - R * C, z === 0 ? null : (g = (C * Y - P * V) / z, d = (R * V - L * Y) / z, new v(g, d));
              ...
              var r = a.x, u = a.y, t = e.x, s = e.y, o = i.x, c = i.y, l = f.x, T = f.y, g = (t - r) * (T - c) - (l - o) * (s - u);
              if (g === 0)
                return !1;
              var d = ((T - c) * (l - r) + (o - l) * (T - u)) / g, L = ((u - s) * (l - r) + (t - r) * (T - u)) / g;
              return 0 < d && d < 1 && 0 < L && L < 1;
            }, h.findCircleLineIntersections = function(a, e, i, f, r, u, t) {
              var s = (i - a) * (i - a) + (f - e) * (f - e), o = 2 * ((a - r) * (i - a) + (e - u) * (f - e)), c = (a - r) * (a - r) + (e - u) * (e - u) - t * t, l = o * o - 4 * s * c;
              if (l >= 0) {
                var T = (-o + Math.sqrt(o * o - 4 * s * c)) / (2 * s), g = (-o - Math.sqrt(o * o - 4 * s * c)) / (2 * s), d = null;
                return T >= 0 && T <= 1 ? [T] : g >= 0 && g <= 1 ? [g] : d;
              } else return null;
          ...
          (function(M, G, N) {
            ...
            v.MAX_VALUE = 2147483647, v.MIN_VALUE = -2147483648, M.exports = v;
          }),
          /* 11 */
          /***/
          (function(M, G, N) {
            var v = /* @__PURE__ */ (function() {
              ...
              return function(u, t, s) {
                return t && r(u.prototype, t), s && r(u, s), u;
              };
            })();
            function h(r, u) {
              if (!(r instanceof u))
            ...
            var a = function(u) {
              ...
              function r(u) {
                var t = this;
                h(this, r), this.length = 0, this.head = null, this.tail = null, u?.forEach(function(s) {
                  return t.push(s);
                });
              }
              return v(r, [{
          ...
          (function(M, G, N) {
            ...
            v.prototype.getX = function() {
              ...
              return new v(this.x, this.y);
            }, v.prototype.setLocation = function(h, a, e) {
            ...
            }, v.prototype.move = function(h, a) {
              this.x = h, this.y = a;
            }, v.prototype.translate = function(h, a) {
              this.x += h, this.y += a;
          ...
          /***/
          (function(M, G, N) {
            var v = typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? function(a) {
              return typeof a;
            } : function(a) {
            ...
            h.lastID = 0, h.createID = function(a) {
              ...
              var e = typeof a > "u" ? "undefined" : v(a);
          ...
          (function(M, G, N) {
            ...
            var h = N(0), a = N(7), e = N(3), i = N(1), f = N(6), r = N(5), u = N(17), t = N(29);
            function s(o) {
            ...
            s.RANDOM_SEED = 1, s.prototype = Object.create(t.prototype), s.prototype.getGraphManager = function() {
              ...
              if (o == null)
                ...
                if (l != null) {
                  ...
                  for (var T = this.getAllNodes(), g, d = 0; d < T.length; d++)
                    g = T[d], g.transform(c);
                }
              }
              ...
              if (!T)
                return o;
              var d = /* @__PURE__ */ new Set(), L = [], R = /* @__PURE__ */ new Map(), C = [];
              for (C = C.concat(l); C.length > 0 && c; ) {
                for (L.push(C[0]); L.length > 0 && c; ) {
                  var P = L[0];
                  L.splice(0, 1), d.add(P);
                  for (var V = P.getEdges(), g = 0; g < V.length; g++) {
                    var Y = V[g].getOtherEnd(P);
                    if (R.get(P) != Y)
                      if (!d.has(Y))
                        L.push(Y), R.set(Y, P);
                      else {
                ...
                if (!c)
                  ...
                  for (var g = 0; g < z.length; g++) {
                    var A = z[g], _ = C.indexOf(A);
                    _ > -1 && C.splice(_, 1);
                  }
                  d = /* @__PURE__ */ new Set(), R = /* @__PURE__ */ new Map();
                }
              }
              return o;
              ...
              for (var c = [], l = o.source, T = this.graphManager.calcLowestCommonAncestor(o.source, o.target), g = 0; g < o.bendpoints.length; g++) {
                ...
                this.graphManager.add(L, l, d), c.add(d), l = d;
              }
              var L = this.newEdge(null);
              return this.graphManager.add(L, l, o.target), this.edgeToDummyNodes.set(o, c), o.isInterGraph() ? this.graphManager.remove(o) : T.remove(o), c;
            }, s.prototype.createBendpointsFromDummyNodes = function() {
              var o = [];
              o = o.concat(this.graphManager.getAllEdges()), o = [].concat(v(this.edgeToDummyNodes.keys())).concat(o);
              for (var c = 0; c < o.length; c++) {
                var l = o[c];
                if (l.bendpoints.length > 0) {
                  for (var T = this.edgeToDummyNodes.get(l), g = 0; g < T.length; g++) {
                    var d = T[g], L = new r(d.getCenterX(), d.getCenterY()), R = l.bendpoints.get(g);
                    R.x = L.x, R.y = L.y, d.getOwner().remove(d);
                  }
              ...
              if (l != null && T != null) {
                ...
                var R, C;
                return o <= 50 ? (R = 9 * c / 500, C = c / 10) : (R = 9 * c / 50, C = -8 * c), R * o + C;
              }
            }, s.findCenterOfTree = function(o) {
              var c = [];
              c = c.concat(o);
              var l = [], T = /* @__PURE__ */ new Map(), g = !1, d = null;
              (c.length == 1 || c.length == 2) && (g = !0, d = c[0]);
              for (var L = 0; L < c.length; L++) {
                var R = c[L], C = R.getNeighborsList().size;
                T.set(R, R.getNeighborsList().size), C == 1 && l.push(R);
              }
              var P = [];
              for (P = P.concat(l); !g; ) {
                var V = [];
                V = V.concat(P), P = [];
                for (var L = 0; L < c.length; L++) {
                  var R = c[L], Y = c.indexOf(R);
                  Y >= 0 && c.splice(Y, 1);
                  var z = R.getNeighborsList();
                ...
                l = l.concat(P), (c.length == 1 || c.length == 2) && (g = !0, d = c[0]);
              }
              return d;
          ...
          (function(M, G, N) {
            ...
            h.prototype.getWorldOrgX = function() {
              ...
              var e = new v(this.inverseTransformX(a.x), this.inverseTransformY(a.y));
              return e;
            }, M.exports = h;
          }),
          /* 18 */
          ...
          (function(M, G, N) {
            ...
            var h = N(15), a = N(4), e = N(0), i = N(8), f = N(9);
            function r() {
            ...
            r.prototype.initParameters = function() {
              ...
              var t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : !0, s = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : !1, o, c, l, T, g = this.getAllNodes(), d;
              if (this.useFRGridVariant)
                for (this.totalIterations % a.GRID_CALCULATION_CHECK_PERIOD == 1 && t && this.updateGrid(), d = /* @__PURE__ */ new Set(), o = 0; o < g.length; o++)
                  l = g[o], this.calculateRepulsionForceOfANode(l, d, t, s), d.add(l);
              else
              ...
              var o = t.getSource(), c = t.getTarget(), l, T, g, d;
              if (this.uniformLeafNodeSizes && o.getChild() == null && c.getChild() == null)
                ...
                return;
              l = t.getLength(), l != 0 && (T = t.edgeElasticity * (l - s), g = T * (t.lengthX / l), d = T * (t.lengthY / l), o.springForceX += g, o.springForceY += d, c.springForceX -= g, c.springForceY -= d);
            }, r.prototype.calcRepulsionForce = function(t, s) {
              var o = t.getRect(), c = s.getRect(), l = new Array(2), T = new Array(4), g, d, L, R, C, P, V;
              if (o.intersects(c)) {
                i.calcSeparationAmount(o, c, l, a.DEFAULT_EDGE_LENGTH / 2), P = 2 * l[0], V = 2 * l[1];
                var Y = t.noOfChildren * s.noOfChildren / (t.noOfChildren + s.noOfChildren);
                t.repulsionForceX -= Y * P, t.repulsionForceY -= Y * V, s.repulsionForceX += Y * P, s.repulsionForceY += Y * V;
              } else
                this.uniformLeafNodeSizes && t.getChild() == null && s.getChild() == null ? (g = c.getCenterX() - o.getCenterX(), d = c.getCenterY() - o.getCenterY()) : (i.getIntersection(o, c, T), g = T[2] - T[0], d = T[3] - T[1]), Math.abs(g) < a.MIN_REPULSION_DIST && (g = f.sign(g) * a.MIN_REPULSION_DIST), Math.abs(d) < a.MIN_REPULSION_DIST && (d = f.sign(d) * a.MIN_REPULSION_DIST), L = g * g + d * d, R = Math.sqrt(L), C = (t.nodeRepulsion / 2 + s.nodeRepulsion / 2) * t.noOfChildren * s.noOfChildren / L, P = C * g / R, V = C * d / R, t.repulsionForceX -= P, t.repulsionForceY -= V, s.repulsionForceX += P, s.repulsionForceY += V;
            }, r.prototype.calcGravitationalForce = function(t) {
              var s, o, c, l, T, g, d, L;
              s = t.getOwner(), o = (s.getRight() + s.getLeft()) / 2, c = (s.getTop() + s.getBottom()) / 2, l = t.getCenterX() - o, T = t.getCenterY() - c, g = Math.abs(l) + t.getWidth() / 2, d = Math.abs(T) + t.getHeight() / 2, t.getOwner() == this.graphManager.getRoot() ? (L = s.getEstimatedSize() * this.gravityRangeFactor, (g > L || d > L) && (t.gravitationForceX = -this.gravityConstant * l, t.gravitationForceY = -this.gravityConstant * T)) : (L = s.getEstimatedSize() * this.compoundGravityRangeFactor, (g > L || d > L) && (t.gravitationForceX = -this.gravityConstant * l * this.compoundGravityConstant, t.gravitationForceY = -this.gravityConstant * T * this.compoundGravityConstant));
              ...
              for (var d = c; d <= l; d++)
                for (var L = T; L <= g; L++)
                  this.grid[d][L].push(t), t.setGridCoordinates(c, l, T, g);
              ...
              if (this.totalIterations % a.GRID_CALCULATION_CHECK_PERIOD == 1 && o || c) {
                ...
                for (var T, g = this.grid, d = t.startX - 1; d < t.finishX + 2; d++)
                  for (var L = t.startY - 1; L < t.finishY + 2; L++)
                    if (!(d < 0 || L < 0 || d >= g.length || L >= g[0].length)) {
                      for (var R = 0; R < g[d][L].length; R++)
                        if (T = g[d][L][R], !(t.getOwner() != T.getOwner() || t == T) && !s.has(T) && !l.has(T)) {
                          var C = Math.abs(t.getCenterX() - T.getCenterX()) - (t.getWidth() / 2 + T.getWidth() / 2), P = Math.abs(t.getCenterY() - T.getCenterY()) - (t.getHeight() / 2 + T.getHeight() / 2);
                          C <= this.repulsionRange && P <= this.repulsionRange && l.add(T);
                        }
                    }
                t.surrounding = [].concat(v(l));
              }
          ...
          (function(M, G, N) {
            var v = N(1), h = N(4);
            function a(i, f, r) {
              v.call(this, i, f, r), this.idealLength = h.DEFAULT_EDGE_LENGTH, this.edgeElasticity = h.DEFAULT_SPRING_STRENGTH;
            }
          ...
          (function(M, G, N) {
            var v = N(3), h = N(4);
            function a(i, f, r, u) {
              v.call(this, i, f, r, u), this.nodeRepulsion = h.DEFAULT_REPULSION_STRENGTH, this.springForceX = 0, this.springForceY = 0, this.repulsionForceX = 0, this.repulsionForceY = 0, this.gravitationForceX = 0, this.gravitationForceY = 0, this.displacementX = 0, this.displacementY = 0, this.startX = 0, this.finishX = 0, this.startY = 0, this.finishY = 0, this.surrounding = [];
            }
            a.prototype = Object.create(v.prototype);
            for (var e in v)
              a[e] = v[e];
            a.prototype.setGridCoordinates = function(i, f, r, u) {
              this.startX = i, this.finishX = f, this.startY = r, this.finishY = u;
            }, M.exports = a;
          }),
          /* 21 */
          /***/
          ...
          (function(M, G, N) {
            ...
            h.prototype.put = function(a, e) {
              ...
              return v.createID(a), this.map[a] != null;
          ...
          (function(M, G, N) {
            ...
            h.prototype.add = function(a) {
              ...
              delete this.set[v.createID(a)];
            }, h.prototype.clear = function() {
              this.set = {};
            }, h.prototype.contains = function(a) {
              return this.set[v.createID(a)] == a;
          ...
          (function(M, G, N) {
            ...
            v.multMat = function(h, a) {
              ...
              return a;
            }, v.multCons = function(h, a) {
              for (var e = [], i = 0; i < h.length; i++)
                e[i] = h[i] * a;
              return e;
            }, v.minusOp = function(h, a) {
              for (var e = [], i = 0; i < h.length; i++)
                e[i] = h[i] - a[i];
              return e;
            }, v.dotProduct = function(h, a) {
              ...
              for (var f = 0; f < h.length; f++)
                a[f] = e + h[f];
              return a;
            }, v.multL = function(h, a, e) {
              for (var i = [], f = [], r = [], u = 0; u < a[0].length; u++) {
              ...
              for (var T = 0; T < a.length; T++) {
                for (var g = 0, d = 0; d < a[0].length; d++)
                  g += a[T][d] * r[d];
                i[T] = g;
              }
              return i;
          ...
          (function(M, G, N) {
            var v = /* @__PURE__ */ (function() {
              ...
              return function(f, r, u) {
                return r && i(f.prototype, r), u && i(f, u), f;
              };
            })();
            function h(i, f) {
              if (!(i instanceof f))
            ...
            var a = N(11), e = (function() {
              ...
              return v(i, [{
                ...
                value: function(r, u, t) {
                  if (u < t) {
                    var s = this._partition(r, u, t);
                    this._quicksort(r, u, s), this._quicksort(r, s + 1, t);
                  }
                }
              }, {
                key: "_partition",
                value: function(r, u, t) {
                  for (var s = this._get(r, u), o = u, c = t; ; ) {
                ...
                key: "_get",
                value: function(r, u) {
                  return r instanceof a ? r.get_object_at(u) : r[u];
                }
              }, {
                key: "_set",
                value: function(r, u, t) {
                  r instanceof a ? r.set_object_at(u, t) : r[u] = t;
                }
              }, {
                key: "_swap",
                value: function(r, u, t) {
                  var s = this._get(r, u);
                  this._set(r, u, this._get(r, t)), this._set(r, t, s);
                }
              }, {
            ...
            v.svd = function(h) {
              ...
              for (var e = (function(Tt) {
                ...
                for (var wt = []; Tt-- > 0; )
                  wt.push(0);
                return wt;
              })(this.m), f = !0, r = Math.min(this.m - 1, this.n), u = Math.max(0, Math.min(this.n - 2, this.m)), t = 0; t < Math.max(r, u); t++) {
                if (t < r) {
                  this.s[t] = 0;
                  for (var s = t; s < this.m; s++)
                    this.s[t] = v.hypot(this.s[t], h[s][t]);
                  if (this.s[t] !== 0) {
                ...
                if (t < u) {
                  ...
                  if (e[t] = -e[t], /* @__PURE__ */ (function(Tt, wt) {
                    return Tt && wt;
                  })(t + 1 < this.m, e[t] !== 0)) {
                    for (var C = t + 1; C < this.m; C++)
                      i[C] = 0;
                    for (var P = t + 1; P < this.n; P++)
                      for (var V = t + 1; V < this.m; V++)
                        i[V] += e[P] * h[V][P];
                    for (var Y = t + 1; Y < this.n; Y++)
                      for (var z = -e[Y] / e[t + 1], A = t + 1; A < this.m; A++)
                        h[A][Y] += z * i[A];
                  }
                  for (var _ = t + 1; _ < this.n; _++)
                    this.V[_][t] = e[_];
                }
              }
              var n = Math.min(this.n, this.m + 1);
              r < this.n && (this.s[r] = h[r][r]), this.m < n && (this.s[n - 1] = 0), u + 1 < n && (e[u] = h[u][n - 1]), e[n - 1] = 0;
              {
                for (var E = r; E < a; E++) {
                ...
                for (var m = r - 1; m >= 0; m--)
                  if (this.s[m] !== 0) {
                    for (var y = m + 1; y < a; y++) {
                      for (var I = 0, D = m; D < this.m; D++)
                        I += this.U[D][m] * this.U[D][y];
                      I = -I / this.U[m][m];
                      for (var S = m; S < this.m; S++)
                        this.U[S][y] += I * this.U[S][m];
                    }
                    for (var W = m; W < this.m; W++)
                      this.U[W][m] = -this.U[W][m];
              ...
              for (var $ = this.n - 1; $ >= 0; $--) {
                if (/* @__PURE__ */ (function(Tt, wt) {
                  ...
                  for (var X = $ + 1; X < a; X++) {
                    for (var rt = 0, B = $ + 1; B < this.n; B++)
                      rt += this.V[B][$] * this.V[B][X];
                    rt = -rt / this.V[$ + 1][$];
                    for (var O = $ + 1; O < this.n; O++)
                      this.V[O][X] += rt * this.V[O][$];
                  }
                for (var H = 0; H < this.n; H++)
                  this.V[H][$] = 0;
                this.V[$][$] = 1;
              }
              for (var k = n - 1, tt = Math.pow(2, -52), ht = Math.pow(2, -966); n > 0; ) {
                var J = void 0, It = void 0;
                for (J = n - 2; J >= -1 && J !== -1; J--)
                ...
                if (J === n - 2)
                  ...
                  var Nt = void 0;
                  for (Nt = n - 1; Nt >= J && Nt !== J; Nt--) {
                    var vt = (Nt !== n ? Math.abs(e[Nt]) : 0) + (Nt !== J + 1 ? Math.abs(e[Nt - 1]) : 0);
                    if (Math.abs(this.s[Nt]) <= ht + tt * vt) {
                      this.s[Nt] = 0;
                      break;
                    }
                  }
                  Nt === J ? It = 3 : Nt === n - 1 ? It = 1 : (It = 2, J = Nt);
                }
                switch (J++, It) {
                  case 1:
                    {
                      ...
                      for (var ut = n - 2; ut >= J; ut--) {
                        var Et = v.hypot(this.s[ut], it), Ct = this.s[ut] / Et, Dt = it / Et;
                        this.s[ut] = Et, ut !== J && (it = -Dt * e[ut - 1], e[ut - 1] = Ct * e[ut - 1]);
                        for (var mt = 0; mt < this.n; mt++)
                          Et = Ct * this.V[mt][ut] + Dt * this.V[mt][n - 1], this.V[mt][n - 1] = -Dt * this.V[mt][ut] + Ct * this.V[mt][n - 1], this.V[mt][ut] = Et;
                      }
                    }
                    break;
                  case 2:
                    {
                      var Ot = e[J - 1];
                      e[J - 1] = 0;
                      for (var Rt = J; Rt < n; Rt++) {
                        var Ht = v.hypot(this.s[Rt], Ot), Ut = this.s[Rt] / Ht, Pt = Ot / Ht;
                        this.s[Rt] = Ht, Ot = -Pt * e[Rt], e[Rt] = Ut * e[Rt];
                        for (var Ft = 0; Ft < this.m; Ft++)
                          Ht = Ut * this.U[Ft][Rt] + Pt * this.U[Ft][J - 1], this.U[Ft][J - 1] = -Pt * this.U[Ft][Rt] + Ut * this.U[Ft][J - 1], this.U[Ft][Rt] = Ht;
                      }
                    }
                    break;
                  case 3:
                    {
                      var Yt = Math.max(Math.max(Math.max(Math.max(Math.abs(this.s[n - 1]), Math.abs(this.s[n - 2])), Math.abs(e[n - 2])), Math.abs(this.s[J])), Math.abs(e[J])), Vt = this.s[n - 1] / Yt, b = this.s[n - 2] / Yt, U = e[n - 2] / Yt, Z = this.s[J] / Yt, K = e[J] / Yt, q = ((b + Vt) * (b - Vt) + U * U) / 2, at = Vt * U * (Vt * U), gt = 0;
                      /* @__PURE__ */ (function(Tt, wt) {
                        return Tt || wt;
                      })(q !== 0, at !== 0) && (gt = Math.sqrt(q * q + at), q < 0 && (gt = -gt), gt = at / (q + gt));
                      for (var nt = (Z + Vt) * (Z - Vt) + gt, et = Z * K, j = J; j < n - 1; j++) {
                        var dt = v.hypot(nt, et), Mt = nt / dt, pt = et / dt;
                        j !== J && (e[j - 1] = dt), nt = Mt * this.s[j] + pt * e[j], e[j] = Mt * e[j] - pt * this.s[j], et = pt * this.s[j + 1], this.s[j + 1] = Mt * this.s[j + 1];
                        for (var xt = 0; xt < this.n; xt++)
                          dt = Mt * this.V[xt][j] + pt * this.V[xt][j + 1], this.V[xt][j + 1] = -pt * this.V[xt][j] + Mt * this.V[xt][j + 1], this.V[xt][j] = dt;
                        if (dt = v.hypot(nt, et), Mt = nt / dt, pt = et / dt, this.s[j] = dt, nt = Mt * e[j] + pt * this.s[j + 1], this.s[j + 1] = -pt * e[j] + Mt * this.s[j + 1], et = pt * e[j + 1], e[j + 1] = Mt * e[j + 1], j < this.m - 1)
                          for (var lt = 0; lt < this.m; lt++)
                            dt = Mt * this.U[lt][j] + pt * this.U[lt][j + 1], this.U[lt][j + 1] = -pt * this.U[lt][j] + Mt * this.U[lt][j + 1], this.U[lt][j] = dt;
                      }
                      e[n - 2] = nt;
                    }
                    break;
          ...
          (function(M, G, N) {
            ...
            var a = (function() {
              function e(i, f) {
                var r = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 1, u = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : -1, t = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : -1;
                h(this, e), this.sequence1 = i, this.sequence2 = f, this.match_score = r, this.mismatch_penalty = u, this.gap_penalty = t, this.iMax = i.length + 1, this.jMax = f.length + 1, this.grid = new Array(this.iMax);
              ...
              return v(e, [{
                ...
                value: function() {
                  ...
                  for (f.push({
                    ...
                    var r = f[0], u = this.tracebackGrid[r.pos[0]][r.pos[1]];
                    u[0] && f.push({
                ...
                key: "getAllIndexes",
                value: function(f, r) {
                  for (var u = [], t = -1; (t = f.indexOf(r, t + 1)) !== -1; )
                    u.push(t);
                  return u;
                }
              }, {
        ...
        (() => {
          var G = {
            ...
            765: (
              /***/
              ((a, e, i) => {
                var f = i(551).FDLayout, r = i(578), u = i(880), t = i(991), s = i(767), o = i(806), c = i(902), l = i(551).FDLayoutConstants, T = i(551).LayoutConstants, g = i(551).Point, d = i(551).PointD, L = i(551).DimensionD, R = i(551).Layout, C = i(551).Integer, P = i(551).IGeometry, V = i(551).LGraph, Y = i(551).Transform, z = i(551).LinkedList;
                function A() {
                ...
                A.prototype.newGraphManager = function() {
                ...
                }, A.prototype.newGraph = function(n) {
                  return new u(null, this.graphManager, n);
                }, A.prototype.newNode = function(n) {
                  return new t(this.graphManager, n);
                }, A.prototype.newEdge = function(n) {
                  ...
                  if (this.nodesWithGravity = this.calculateNodesToApplyGravitationTo(), this.graphManager.setAllNodesToApplyGravitation(this.nodesWithGravity), this.calcNoOfChildrenForAllNodes(), this.graphManager.calcLowestCommonAncestors(), this.graphManager.calcInclusionTreeDepths(), this.graphManager.getRoot().calcEstimatedSize(), this.calcIdealEdgeLengths(), this.incremental) {
                    if (o.TREE_REDUCTION_ON_INCREMENTAL) {
                      ...
                      var E = new Set(this.getAllNodes()), p = this.nodesWithGravity.filter(function(I) {
                        return E.has(I);
                      });
                    ...
                    if (n.length > 0)
                      ...
                      this.reduceTrees(), this.graphManager.resetAllNodesToApplyGravitation();
                      var E = new Set(this.getAllNodes()), p = this.nodesWithGravity.filter(function(m) {
                        return E.has(m);
                      });
                  ...
                  if (this.isTreeGrowing) {
                    if (this.growTreeIterations % 10 == 0)
                      if (this.prunedNodesAll.length > 0) {
                        ...
                        var n = new Set(this.getAllNodes()), E = this.nodesWithGravity.filter(function(y) {
                          return n.has(y);
                        });
                        this.graphManager.setAllNodesToApplyGravitation(E), this.graphManager.updateBounds(), this.updateGrid(), o.PURE_INCREMENTAL ? this.coolingFactor = l.DEFAULT_COOLING_FACTOR_INCREMENTAL / 2 : this.coolingFactor = l.DEFAULT_COOLING_FACTOR_INCREMENTAL;
                      } else
                  ...
                  var p = !this.isTreeGrowing && !this.isGrowthFinished, m = this.growTreeIterations % 10 == 1 && this.isTreeGrowing || this.afterGrowthIterations % 10 == 1 && this.isGrowthFinished;
                  return this.totalDisplacement = 0, this.graphManager.updateBounds(), this.calcSpringForces(), this.calcRepulsionForces(p, m), this.calcGravitationalForces(), this.moveNodes(), this.animate(), !1;
                }, A.prototype.getPositionsData = function() {
                  for (var n = this.graphManager.getAllNodes(), E = {}, p = 0; p < n.length; p++) {
                    var m = n[p].rect, y = n[p].id;
                    E[y] = {
                      id: y,
                      x: m.getCenterX(),
                      y: m.getCenterY(),
                  ...
                  var y = function O(H) {
                    for (var k = H.getChild().getNodes(), tt, ht = 0, J = 0; J < k.length; J++)
                      tt = k[J], tt.getChild() == null ? n.fixedNodeSet.has(tt.id) && (ht += 100) : ht += O(tt);
                    return ht;
                  };
                  if (this.constraints.fixedNodeConstraint) {
                    this.constraints.fixedNodeConstraint.forEach(function(k) {
                      n.fixedNodeSet.add(k.nodeId);
                    });
                    for (var E = this.graphManager.getAllNodes(), m, p = 0; p < E.length; p++)
                      if (m = E[p], m.getChild() != null) {
                        var I = y(m);
                        I > 0 && (m.fixedNodeWeight = I);
                      }
                  }
                  if (this.constraints.relativePlacementConstraint) {
                    var D = /* @__PURE__ */ new Map(), S = /* @__PURE__ */ new Map();
                      ...
                      if (this.constraints.alignmentConstraint.vertical)
                        for (var W = this.constraints.alignmentConstraint.vertical, p = 0; p < W.length; p++)
                          this.dummyToNodeForVerticalAlignment.set("dummy" + p, []), W[p].forEach(function(H) {
                            D.set(H, "dummy" + p), n.dummyToNodeForVerticalAlignment.get("dummy" + p).push(H), n.fixedNodeSet.has(H) && n.fixedNodesOnHorizontal.add("dummy" + p);
                          });
                    ...
                    if (o.RELAX_MOVEMENT_ON_CONSTRAINTS)
                      this.shuffle = function(O) {
                        ...
                        for (tt = O.length - 1; tt >= 2 * O.length / 3; tt--)
                          H = Math.floor(Math.random() * (tt + 1)), k = O[tt], O[tt] = O[H], O[H] = k;
                        return O;
                      ...
                      }, rt = X(Q, n.fixedNodesOnHorizontal);
                      this.componentsOnHorizontal = rt.components, this.fixedComponentsOnHorizontal = rt.isFixed;
                      var B = X($, n.fixedNodesOnVertical);
                  ...
                  if (this.constraints.fixedNodeConstraint && this.constraints.fixedNodeConstraint.forEach(function(B) {
                    var O = n.idToNodeMap.get(B.nodeId);
                    O.displacementX = 0, O.displacementY = 0;
                  }), this.constraints.alignmentConstraint) {
                    if (this.constraints.alignmentConstraint.vertical)
                      for (var E = this.constraints.alignmentConstraint.vertical, p = 0; p < E.length; p++) {
                        for (var m = 0, y = 0; y < E[p].length; y++) {
                          if (this.fixedNodeSet.has(E[p][y])) {
                            m = 0;
                            break;
                          }
                          m += this.idToNodeMap.get(E[p][y]).displacementX;
                        }
                        for (var I = m / E[p].length, y = 0; y < E[p].length; y++)
                          this.idToNodeMap.get(E[p][y]).displacementX = I;
                      }
                    if (this.constraints.alignmentConstraint.horizontal)
                      for (var D = this.constraints.alignmentConstraint.horizontal, p = 0; p < D.length; p++) {
                        for (var S = 0, y = 0; y < D[p].length; y++) {
                          if (this.fixedNodeSet.has(D[p][y])) {
                            S = 0;
                            break;
                          }
                          S += this.idToNodeMap.get(D[p][y]).displacementY;
                        }
                        for (var W = S / D[p].length, y = 0; y < D[p].length; y++)
                          this.idToNodeMap.get(D[p][y]).displacementY = W;
                      }
                  }
                  if (this.constraints.relativePlacementConstraint)
                    if (o.RELAX_MOVEMENT_ON_CONSTRAINTS)
                      this.totalIterations % 10 == 0 && (this.shuffle(this.nodesInRelativeHorizontal), this.shuffle(this.nodesInRelativeVertical)), this.nodesInRelativeHorizontal.forEach(function(B) {
                        if (!n.fixedNodesOnHorizontal.has(B)) {
                          var O = 0;
                          n.dummyToNodeForVerticalAlignment.has(B) ? O = n.idToNodeMap.get(n.dummyToNodeForVerticalAlignment.get(B)[0]).displacementX : O = n.idToNodeMap.get(B).displacementX, n.nodeToRelativeConstraintMapHorizontal.get(B).forEach(function(H) {
                            if (H.right) {
                              var k = n.nodeToTempPositionMapHorizontal.get(H.right) - n.nodeToTempPositionMapHorizontal.get(B) - O;
                              k < H.gap && (O -= H.gap - k);
                            } else {
                              var k = n.nodeToTempPositionMapHorizontal.get(B) - n.nodeToTempPositionMapHorizontal.get(H.left) + O;
                              k < H.gap && (O += H.gap - k);
                            }
                          }), n.nodeToTempPositionMapHorizontal.set(B, n.nodeToTempPositionMapHorizontal.get(B) + O), n.dummyToNodeForVerticalAlignment.has(B) ? n.dummyToNodeForVerticalAlignment.get(B).forEach(function(H) {
                            n.idToNodeMap.get(H).displacementX = O;
                          }) : n.idToNodeMap.get(B).displacementX = O;
                        }
                      }), this.nodesInRelativeVertical.forEach(function(B) {
                        if (!n.fixedNodesOnHorizontal.has(B)) {
                          var O = 0;
                          n.dummyToNodeForHorizontalAlignment.has(B) ? O = n.idToNodeMap.get(n.dummyToNodeForHorizontalAlignment.get(B)[0]).displacementY : O = n.idToNodeMap.get(B).displacementY, n.nodeToRelativeConstraintMapVertical.get(B).forEach(function(H) {
                            if (H.bottom) {
                              var k = n.nodeToTempPositionMapVertical.get(H.bottom) - n.nodeToTempPositionMapVertical.get(B) - O;
                              k < H.gap && (O -= H.gap - k);
                            } else {
                              var k = n.nodeToTempPositionMapVertical.get(B) - n.nodeToTempPositionMapVertical.get(H.top) + O;
                              k < H.gap && (O += H.gap - k);
                            }
                          }), n.nodeToTempPositionMapVertical.set(B, n.nodeToTempPositionMapVertical.get(B) + O), n.dummyToNodeForHorizontalAlignment.has(B) ? n.dummyToNodeForHorizontalAlignment.get(B).forEach(function(H) {
                            n.idToNodeMap.get(H).displacementY = O;
                          }) : n.idToNodeMap.get(B).displacementY = O;
                        }
                      });
                    else {
                      for (var p = 0; p < this.componentsOnHorizontal.length; p++) {
                        ...
                        if (this.fixedComponentsOnHorizontal[p])
                          ...
                          for (var Q = 0, $ = 0, y = 0; y < x.length; y++)
                            if (this.dummyToNodeForVerticalAlignment.has(x[y])) {
                              ...
                              Q += this.idToNodeMap.get(x[y]).displacementX, $++;
                          for (var rt = Q / $, y = 0; y < x.length; y++)
                            this.dummyToNodeForVerticalAlignment.has(x[y]) ? this.dummyToNodeForVerticalAlignment.get(x[y]).forEach(function(H) {
                              n.idToNodeMap.get(H).displacementX = rt;
                            }) : this.idToNodeMap.get(x[y]).displacementX = rt;
                        }
                      }
                      for (var p = 0; p < this.componentsOnVertical.length; p++) {
                        ...
                        if (this.fixedComponentsOnVertical[p])
                          for (var y = 0; y < x.length; y++)
                            this.dummyToNodeForHorizontalAlignment.has(x[y]) ? this.dummyToNodeForHorizontalAlignment.get(x[y]).forEach(function(k) {
                              n.idToNodeMap.get(k).displacementY = 0;
                          ...
                          for (var Q = 0, $ = 0, y = 0; y < x.length; y++)
                            if (this.dummyToNodeForHorizontalAlignment.has(x[y])) {
                              ...
                              Q += this.idToNodeMap.get(x[y]).displacementY, $++;
                          for (var rt = Q / $, y = 0; y < x.length; y++)
                            this.dummyToNodeForHorizontalAlignment.has(x[y]) ? this.dummyToNodeForHorizontalAlignment.get(x[y]).forEach(function(J) {
                              n.idToNodeMap.get(J).displacementY = rt;
                            }) : this.idToNodeMap.get(x[y]).displacementY = rt;
                        }
                      }
                    }
                }, A.prototype.calculateNodesToApplyGravitationTo = function() {
                  var n = [], E, p = this.graphManager.getGraphs(), m = p.length, y;
                  for (y = 0; y < m; y++)
                    E = p[y], E.updateConnected(), E.isConnected || (n = n.concat(E.getNodes()));
                  return n;
                  ...
                  for (p = 0; p < n.length; p++) {
                    var m = n[p];
                    if (!E.has(m)) {
                      var y = m.getSource(), I = m.getTarget();
                      if (y == I)
                        m.getBendpoints().push(new d()), m.getBendpoints().push(new d()), this.createDummyNodesForBendpoints(m), E.add(m);
                      else {
                        var D = [];
                        if (D = D.concat(y.getEdgeListToNode(I)), D = D.concat(I.getEdgeListToNode(y)), !E.has(D[0])) {
                          if (D.length > 1) {
                            var S;
                ...
                }, A.prototype.positionNodesRadially = function(n) {
                  for (var E = new g(0, 0), p = Math.ceil(Math.sqrt(n.length)), m = 0, y = 0, I = 0, D = new d(0, 0), S = 0; S < n.length; S++) {
                    S % p == 0 && (I = 0, y = m, S != 0 && (y += o.DEFAULT_COMPONENT_SEPERATION), m = 0);
                    var W = n[S], x = R.findCenterOfTree(W);
                    E.x = I, E.y = y, D = A.radialLayout(W, x, E), D.y > m && (m = Math.floor(D.y)), I = Math.floor(D.x + o.DEFAULT_COMPONENT_SEPERATION);
                  }
                  this.transform(new d(T.WORLD_CENTER_X - D.x / 2, T.WORLD_CENTER_Y - D.y / 2));
                }, A.radialLayout = function(n, E, p) {
                  var m = Math.max(this.maxDiagonalInTree(n), o.DEFAULT_RADIAL_SEPARATION);
                  A.branchRadialLayout(E, null, 0, 359, 0, m);
                  var y = V.calculateBounds(n), I = new Y();
                ...
                }, A.branchRadialLayout = function(n, E, p, m, y, I) {
                  var D = (m - p + 1) / 2;
                  D < 0 && (D += 180);
                  var S = (D + p) % 360, W = S * P.TWO_PI / 360, x = y * Math.cos(W), Q = y * Math.sin(W);
                  n.setCenter(x, Q);
                  var $ = [];
                  $ = $.concat(n.getEdges());
                  var X = $.length;
                  E != null && X--;
                  for (var rt = 0, B = $.length, O, H = n.getEdgesBetween(E); H.length > 1; ) {
                    var k = H[0];
                    H.splice(0, 1);
                    var tt = $.indexOf(k);
                    tt >= 0 && $.splice(tt, 1), B--, X--;
                  }
                  E != null ? O = ($.indexOf(H[0]) + 1) % B : O = 0;
                  for (var ht = Math.abs(m - p) / X, J = O; rt != X; J = ++J % B) {
                    var It = $[J].getOtherEnd(n);
                    if (It != E) {
                      var Nt = (p + rt * ht) % 360, vt = (Nt + ht) % 360;
                      A.branchRadialLayout(It, n, Nt, vt, y + I, I), rt++;
                    }
                  }
                }, A.maxDiagonalInTree = function(n) {
                  for (var E = C.MIN_VALUE, p = 0; p < n.length; p++) {
                    var m = n[p], y = m.getDiagonal();
                    y > E && (E = y);
                  }
                  return E;
                  ...
                  for (var p = [], m = this.graphManager.getAllNodes(), y = 0; y < m.length; y++) {
                    var I = m[y], D = I.getParent();
                    this.getNodeDegreeWithChildren(I) === 0 && (D.id == null || !this.getToBeTiled(D)) && p.push(I);
                  }
                  for (var y = 0; y < p.length; y++) {
                    var I = p[y], S = I.getParent().id;
                    typeof E[S] > "u" && (E[S] = []), E[S] = E[S].concat(I);
                  }
                  Object.keys(E).forEach(function(W) {
                    if (E[W].length > 1) {
                      var x = "DummyCompound_" + W;
                      n.memberGroups[x] = E[W];
                      var Q = E[W][0].getParent(), $ = new t(n.graphManager);
                      $.id = x, $.paddingLeft = Q.paddingLeft || 0, $.paddingRight = Q.paddingRight || 0, $.paddingBottom = Q.paddingBottom || 0, $.paddingTop = Q.paddingTop || 0, n.idToDummyNode[x] = $;
                      var X = n.getGraphManager().add(n.newGraph(), $), rt = Q.getChild();
                      rt.add($);
                      for (var B = 0; B < E[W].length; B++) {
                        var O = E[W][B];
                        rt.remove(O), X.add(O);
                      }
                    }
                  ...
                  for (var m = p.getNodes(), y = 0; y < m.length; y++) {
                    var I = m[y];
                ...
                }, A.prototype.getNodeDegree = function(n) {
                  n.id;
                  for (var E = n.getEdges(), p = 0, m = 0; m < E.length; m++) {
                    var y = E[m];
                    y.getSource().id !== y.getTarget().id && (p = p + 1);
                  }
                  return p;
                }, A.prototype.getNodeDegreeWithChildren = function(n) {
                  var E = this.getNodeDegree(n);
                  if (n.getChild() == null)
                    return E;
                  for (var p = n.getChild().getNodes(), m = 0; m < p.length; m++) {
                    var y = p[m];
                ...
                }, A.prototype.fillCompexOrderByDFS = function(n) {
                  for (var E = 0; E < n.length; E++) {
                    var p = n[E];
                    p.getChild() != null && this.fillCompexOrderByDFS(p.getChild().getNodes()), this.getToBeTiled(p) && this.compoundOrder.push(p);
                  }
                }, A.prototype.adjustLocations = function(n, E, p, m, y, I, D) {
                  E += m + I, p += y + D;
                  for (var S = E, W = 0; W < n.rows.length; W++) {
                    var x = n.rows[W];
                    E = S;
                    for (var Q = 0, $ = 0; $ < x.length; $++) {
                      var X = x[$];
                      X.rect.x = E, X.rect.y = p, E += X.rect.width + n.horizontalPadding, X.rect.height > Q && (Q = X.rect.height);
                    }
                    p += Q + n.verticalPadding;
                  }
                }, A.prototype.tileCompoundMembers = function(n, E) {
                  var p = this;
                  this.tiledMemberPack = [], Object.keys(n).forEach(function(m) {
                    var y = E[m];
                    if (p.tiledMemberPack[m] = p.tileNodes(n[m], y.paddingLeft + y.paddingRight), y.rect.width = p.tiledMemberPack[m].width, y.rect.height = p.tiledMemberPack[m].height, y.setCenter(p.tiledMemberPack[m].centerX, p.tiledMemberPack[m].centerY), y.labelMarginLeft = 0, y.labelMarginTop = 0, o.NODE_DIMENSIONS_INCLUDE_LABELS) {
                      var I = y.rect.width, D = y.rect.height;
                ...
                }, A.prototype.tileNodes = function(n, E) {
                  var p = this.tileNodesByFavoringDim(n, E, !0), m = this.tileNodesByFavoringDim(n, E, !1), y = this.getOrgRatio(p), I = this.getOrgRatio(m), D;
                  return I < y ? D = m : D = p, D;
                }, A.prototype.getOrgRatio = function(n) {
                  var E = n.width, p = n.height, m = E / p;
                  return m < 1 && (m = 1 / m), m;
                }, A.prototype.calcIdealRowWidth = function(n, E) {
                  var p = o.TILING_PADDING_VERTICAL, m = o.TILING_PADDING_HORIZONTAL, y = n.length, I = 0, D = 0, S = 0;
                  n.forEach(function(B) {
                    I += B.getWidth(), D += B.getHeight(), B.getWidth() > S && (S = B.getWidth());
                  });
                  var W = I / y, x = D / y, Q = Math.pow(p - m, 2) + 4 * (W + m) * (x + p) * y, $ = (m - p + Math.sqrt(Q)) / (2 * (W + m)), X;
                  E ? (X = Math.ceil($), X == $ && X++) : X = Math.floor($);
                  var rt = X * (W + m) - m;
                  return S > rt && (rt = S), rt += m * 2, rt;
                }, A.prototype.tileNodesByFavoringDim = function(n, E, p) {
                  var m = o.TILING_PADDING_VERTICAL, y = o.TILING_PADDING_HORIZONTAL, I = o.TILING_COMPARE_BY, D = {
                    rows: [],
                    rowWidth: [],
                    rowHeight: [],
                    width: 0,
                  ...
                  I && (D.idealRowWidth = this.calcIdealRowWidth(n, p));
                  var S = function(O) {
                  ...
                  n.sort(function(B, O) {
                    var H = W;
                    return D.idealRowWidth ? (H = I, H(B.id, O.id)) : H(B, O);
                  });
                  for (var x = 0, Q = 0, $ = 0; $ < n.length; $++) {
                    var X = n[$];
                    x += X.getCenterX(), Q += X.getCenterY();
                  }
                  D.centerX = x / n.length, D.centerY = Q / n.length;
                  for (var $ = 0; $ < n.length; $++) {
                    var X = n[$];
                    if (D.rows.length == 0)
                      this.insertNodeToRow(D, X, 0, E);
                    else if (this.canAddHorizontal(D, X.rect.width, X.rect.height)) {
                      var rt = D.rows.length - 1;
                      D.idealRowWidth || (rt = this.getShortestRowIndex(D)), this.insertNodeToRow(D, X, rt, E);
                    } else
                      this.insertNodeToRow(D, X, D.rows.length, E);
                    this.shiftToLastRow(D);
                  }
                  return D;
                }, A.prototype.insertNodeToRow = function(n, E, p, m) {
                  var y = m;
                  if (p == n.rows.length) {
                    var I = [];
                    n.rows.push(I), n.rowWidth.push(y), n.rowHeight.push(0);
                  }
                  var D = n.rowWidth[p] + E.rect.width;
                  n.rows[p].length > 0 && (D += n.horizontalPadding), n.rowWidth[p] = D, n.width < D && (n.width = D);
                  var S = E.rect.height;
                  p > 0 && (S += n.verticalPadding);
                  var W = 0;
                  S > n.rowHeight[p] && (W = n.rowHeight[p], n.rowHeight[p] = S, W = n.rowHeight[p] - W), n.height += W, n.rows[p].push(E);
                }, A.prototype.getShortestRowIndex = function(n) {
                  for (var E = -1, p = Number.MAX_VALUE, m = 0; m < n.rows.length; m++)
                    n.rowWidth[m] < p && (E = m, p = n.rowWidth[m]);
                  return E;
                }, A.prototype.getLongestRowIndex = function(n) {
                  for (var E = -1, p = Number.MIN_VALUE, m = 0; m < n.rows.length; m++)
                    n.rowWidth[m] > p && (E = m, p = n.rowWidth[m]);
                  return E;
                }, A.prototype.canAddHorizontal = function(n, E, p) {
                  if (n.idealRowWidth) {
                    var m = n.rows.length - 1, y = n.rowWidth[m];
                    return y + E + n.horizontalPadding <= n.idealRowWidth;
                  }
                  var I = this.getShortestRowIndex(n);
                  if (I < 0)
                    return !0;
                  var D = n.rowWidth[I];
                  if (D + n.horizontalPadding + E <= n.width) return !0;
                  var S = 0;
                  n.rowHeight[I] < p && I > 0 && (S = p + n.verticalPadding - n.rowHeight[I]);
                  var W;
                  n.width - D >= E + n.horizontalPadding ? W = (n.height + S) / (D + E + n.horizontalPadding) : W = (n.height + S) / n.width, S = p + n.verticalPadding;
                  var x;
                  return n.width < E ? x = (n.height + S) / E : x = (n.height + S) / n.width, x < 1 && (x = 1 / x), W < 1 && (W = 1 / W), W < x;
                }, A.prototype.shiftToLastRow = function(n) {
                  var E = this.getLongestRowIndex(n), p = n.rowWidth.length - 1, m = n.rows[E], y = m[m.length - 1], I = y.width + n.horizontalPadding;
                  if (n.width - n.rowWidth[p] > I && E != p) {
                    m.splice(-1, 1), n.rows[p].push(y), n.rowWidth[E] = n.rowWidth[E] - I, n.rowWidth[p] = n.rowWidth[p] + I, n.width = n.rowWidth[instance.getLongestRowIndex(n)];
                    for (var D = Number.MIN_VALUE, S = 0; S < m.length; S++)
                      m[S].height > D && (D = m[S].height);
                    E > 0 && (D += n.verticalPadding);
                    var W = n.rowHeight[E] + n.rowHeight[p];
                    n.rowHeight[E] = D, n.rowHeight[p] < y.height + n.verticalPadding && (n.rowHeight[p] = y.height + n.verticalPadding);
                    var x = n.rowHeight[E] + n.rowHeight[p];
                  ...
                  for (var n = [], E = !0, p; E; ) {
                    var m = this.graphManager.getAllNodes(), y = [];
                    E = !1;
                    for (var I = 0; I < m.length; I++)
                      if (p = m[I], p.getEdges().length == 1 && !p.getEdges()[0].isInterGraph && p.getChild() == null) {
                        if (o.PURE_INCREMENTAL) {
                          var D = p.getEdges()[0].getOtherEnd(p), S = new L(p.getCenterX() - D.getCenterX(), p.getCenterY() - D.getCenterY());
                ...
                }, A.prototype.growTree = function(n) {
                  for (var E = n.length, p = n[E - 1], m, y = 0; y < p.length; y++)
                    m = p[y], this.findPlaceforPrunedNode(m), m[2].add(m[0]), m[2].add(m[1], m[1].source, m[1].target);
                  n.splice(n.length - 1, 1), this.graphManager.resetAllNodes(), this.graphManager.resetAllEdges();
                }, A.prototype.findPlaceforPrunedNode = function(n) {
                  var E, p, m = n[0];
                  if (m == n[1].source ? p = n[1].target : p = n[1].source, o.PURE_INCREMENTAL)
                    m.setCenter(p.getCenterX() + n[3].getWidth(), p.getCenterY() + n[3].getHeight());
                  else {
                    var y = p.startX, I = p.finishX, D = p.startY, S = p.finishY, W = 0, x = 0, Q = 0, $ = 0, X = [W, Q, x, $];
                    if (D > 0)
                      for (var rt = y; rt <= I; rt++)
                        X[0] += this.grid[rt][D - 1].length + this.grid[rt][D].length - 1;
                    if (I < this.grid.length - 1)
                      for (var rt = D; rt <= S; rt++)
                        X[1] += this.grid[I + 1][rt].length + this.grid[I][rt].length - 1;
                    if (S < this.grid[0].length - 1)
                      for (var rt = y; rt <= I; rt++)
                        X[2] += this.grid[rt][S + 1].length + this.grid[rt][S].length - 1;
                    if (y > 0)
                      for (var rt = D; rt <= S; rt++)
                        X[3] += this.grid[y - 1][rt].length + this.grid[y][rt].length - 1;
                    for (var B = C.MAX_VALUE, O, H, k = 0; k < X.length; k++)
                      X[k] < B ? (B = X[k], O = 1, H = k) : X[k] == B && O++;
                    if (O == 3 && B == 0)
                      X[0] == 0 && X[1] == 0 && X[2] == 0 ? E = 1 : X[0] == 0 && X[1] == 0 && X[3] == 0 ? E = 0 : X[0] == 0 && X[2] == 0 && X[3] == 0 ? E = 3 : X[1] == 0 && X[2] == 0 && X[3] == 0 && (E = 2);
                    else if (O == 2 && B == 0) {
                      var tt = Math.floor(Math.random() * 2);
                      X[0] == 0 && X[1] == 0 ? tt == 0 ? E = 0 : E = 1 : X[0] == 0 && X[2] == 0 ? tt == 0 ? E = 0 : E = 2 : X[0] == 0 && X[3] == 0 ? tt == 0 ? E = 0 : E = 3 : X[1] == 0 && X[2] == 0 ? tt == 0 ? E = 1 : E = 2 : X[1] == 0 && X[3] == 0 ? tt == 0 ? E = 1 : E = 3 : tt == 0 ? E = 2 : E = 3;
                    } else if (O == 4 && B == 0) {
                      var tt = Math.floor(Math.random() * 4);
                      E = tt;
                    } else
                      E = H;
                    E == 0 ? m.setCenter(p.getCenterX(), p.getCenterY() - p.getHeight() / 2 - l.DEFAULT_EDGE_LENGTH - m.getHeight() / 2) : E == 1 ? m.setCenter(p.getCenterX() + p.getWidth() / 2 + l.DEFAULT_EDGE_LENGTH + m.getWidth() / 2, p.getCenterY()) : E == 2 ? m.setCenter(p.getCenterX(), p.getCenterY() + p.getHeight() / 2 + l.DEFAULT_EDGE_LENGTH + m.getHeight() / 2) : m.setCenter(p.getCenterX() - p.getWidth() / 2 - l.DEFAULT_EDGE_LENGTH - m.getWidth() / 2, p.getCenterY());
                  }
                }, a.exports = A;
              })
            ),
            ...
            902: (
              ...
              ((a, e, i) => {
                ...
                var r = i(806), u = i(551).LinkedList, t = i(551).Matrix, s = i(551).SVD;
                function o() {
                }
                o.handleConstraints = function(c) {
                  ...
                  for (var T = /* @__PURE__ */ new Map(), g = /* @__PURE__ */ new Map(), d = [], L = [], R = c.getAllNodes(), C = 0, P = 0; P < R.length; P++) {
                    var V = R[P];
                    V.getChild() == null && (g.set(V.id, C++), d.push(V.getCenterX()), L.push(V.getCenterY()), T.set(V.id, V));
                  }
                  l.relativePlacementConstraint && l.relativePlacementConstraint.forEach(function(b) {
                    !b.gap && b.gap != 0 && (b.left ? b.gap = r.DEFAULT_EDGE_LENGTH + T.get(b.left).getWidth() / 2 + T.get(b.right).getWidth() / 2 : b.gap = r.DEFAULT_EDGE_LENGTH + T.get(b.top).getHeight() / 2 + T.get(b.bottom).getHeight() / 2);
                  });
                  var Y = function(U, Z) {
                    ...
                    return U.forEach(function(q) {
                      Z += d[g.get(q)], K += L[g.get(q)];
                    }), { x: Z / U.size, y: K / U.size };
                  }, A = function(U, Z, K, q, at) {
                    function gt(lt, ot) {
                    ...
                    var et = /* @__PURE__ */ new Map(), j = /* @__PURE__ */ new Map(), dt = new u();
                    nt.forEach(function(lt, ot) {
                      lt == 0 ? (dt.push(ot), K || (Z == "horizontal" ? et.set(ot, g.has(ot) ? d[g.get(ot)] : q.get(ot)) : et.set(ot, g.has(ot) ? L[g.get(ot)] : q.get(ot)))) : et.set(ot, Number.NEGATIVE_INFINITY), K && j.set(ot, /* @__PURE__ */ new Set([ot]));
                      ...
                      if (lt.forEach(function(st) {
                        ...
                        ot.forEach(function(st) {
                          Z == "horizontal" ? (et.set(st, g.has(st) ? d[g.get(st)] : q.get(st)), Lt += et.get(st)) : (et.set(st, g.has(st) ? L[g.get(st)] : q.get(st)), Lt += et.get(st));
                        }), Lt = Lt / ot.length, lt.forEach(function(st) {
                          K.has(st) || et.set(st, Lt);
                        });
                      } else {
                        var ft = 0;
                        lt.forEach(function(st) {
                          Z == "horizontal" ? ft += g.has(st) ? d[g.get(st)] : q.get(st) : ft += g.has(st) ? L[g.get(st)] : q.get(st);
                    ...
                    for (var Mt = function() {
                      var ot = dt.shift(), Lt = U.get(ot);
                      Lt.forEach(function(ft) {
                        if (et.get(ft.id) < et.get(ot) + ft.gap)
                          if (K && K.has(ft.id)) {
                            var st = void 0;
                            if (Z == "horizontal" ? st = g.has(ft.id) ? d[g.get(ft.id)] : q.get(ft.id) : st = g.has(ft.id) ? L[g.get(ft.id)] : q.get(ft.id), et.set(ft.id, st), st < et.get(ot) + ft.gap) {
                            ...
                            et.set(ft.id, et.get(ot) + ft.gap);
                        nt.set(ft.id, nt.get(ft.id) - 1), nt.get(ft.id) == 0 && dt.push(ft.id), K && j.set(ft.id, gt(j.get(ot), j.get(ft.id)));
                      });
                    }; dt.length != 0; )
                      Mt();
                    if (K) {
                      ...
                      j.forEach(function(lt, ot) {
                        ...
                        var Lt = Number.POSITIVE_INFINITY, ft = Number.POSITIVE_INFINITY, st = Number.NEGATIVE_INFINITY, Xt = Number.NEGATIVE_INFINITY, Tt = !0, wt = !1, $t = void 0;
                        try {
                          for (var bt = lt[Symbol.iterator](), zt; !(Tt = (zt = bt.next()).done); Tt = !0) {
                            var St = zt.value, kt = void 0;
                            Z == "horizontal" ? kt = g.has(St) ? d[g.get(St)] : q.get(St) : kt = g.has(St) ? L[g.get(St)] : q.get(St);
                            var Kt = et.get(St);
                        ...
                        var fe = (Lt + st) / 2 - (ft + Xt) / 2, Qt = !0, jt = !1, _t = void 0;
                        try {
                          for (var Jt = lt[Symbol.iterator](), ne; !(Qt = (ne = Jt.next()).done); Qt = !0) {
                            var te = ne.value;
                            et.set(te, et.get(te) + fe);
                          }
                        } catch (ee) {
                          jt = !0, _t = ee;
                        } finally {
                    ...
                    var Z = 0, K = 0, q = 0, at = 0;
                    if (U.forEach(function(j) {
                      j.left ? d[g.get(j.left)] - d[g.get(j.right)] >= 0 ? Z++ : K++ : L[g.get(j.top)] - L[g.get(j.bottom)] >= 0 ? q++ : at++;
                    }), Z > K && q > at)
                      for (var gt = 0; gt < g.size; gt++)
                        d[gt] = -1 * d[gt], L[gt] = -1 * L[gt];
                    else if (Z > K)
                      for (var nt = 0; nt < g.size; nt++)
                        d[nt] = -1 * d[nt];
                    else if (q > at)
                      for (var et = 0; et < g.size; et++)
                        L[et] = -1 * L[et];
                  }, n = function(U) {
                    var Z = [], K = new u(), q = /* @__PURE__ */ new Set(), at = 0;
                    return U.forEach(function(gt, nt) {
                      if (!q.has(nt)) {
                        Z[at] = [];
                        var et = nt;
                        for (K.push(et), q.add(et), Z[at].push(et); K.length != 0; ) {
                          et = K.shift();
                          var j = U.get(et);
                          j.forEach(function(dt) {
                            q.has(dt.id) || (K.push(dt.id), q.add(dt.id), Z[at].push(dt.id));
                          });
                        }
                        at++;
                      }
                    ...
                    return U.forEach(function(K, q) {
                      Z.set(q, []);
                    }), U.forEach(function(K, q) {
                  ...
                  }, m = [], y = [], I = !1, D = !1, S = /* @__PURE__ */ new Set(), W = /* @__PURE__ */ new Map(), x = /* @__PURE__ */ new Map(), Q = [];
                  ...
                  }), x = E(W), Q = n(x)), r.TRANSFORM_ON_CONSTRAINT_HANDLING) {
                    if (l.fixedNodeConstraint && l.fixedNodeConstraint.length > 1)
                      l.fixedNodeConstraint.forEach(function(b, U) {
                        m[U] = [b.position.x, b.position.y], y[U] = [d[g.get(b.nodeId)], L[g.get(b.nodeId)]];
                      }), I = !0;
                    else if (l.alignmentConstraint)
                      (function() {
                        var b = 0;
                        if (l.alignmentConstraint.vertical) {
                          for (var U = l.alignmentConstraint.vertical, Z = function(et) {
                            var j = /* @__PURE__ */ new Set();
                            U[et].forEach(function(pt) {
                              j.add(pt);
                            });
                            var dt = new Set([].concat(f(j)).filter(function(pt) {
                              return S.has(pt);
                            })), Mt = void 0;
                            dt.size > 0 ? Mt = d[g.get(dt.values().next().value)] : Mt = z(j).x, U[et].forEach(function(pt) {
                              m[b] = [Mt, L[g.get(pt)]], y[b] = [d[g.get(pt)], L[g.get(pt)]], b++;
                            });
                          }, K = 0; K < U.length; K++)
                            Z(K);
                          I = !0;
                        ...
                        if (l.alignmentConstraint.horizontal) {
                          for (var q = l.alignmentConstraint.horizontal, at = function(et) {
                            var j = /* @__PURE__ */ new Set();
                            ...
                            dt.size > 0 ? Mt = d[g.get(dt.values().next().value)] : Mt = z(j).y, q[et].forEach(function(pt) {
                              m[b] = [d[g.get(pt)], Mt], y[b] = [d[g.get(pt)], L[g.get(pt)]], b++;
                            });
                          }, gt = 0; gt < q.length; gt++)
                            at(gt);
                          I = !0;
                        }
                        l.relativePlacementConstraint && (D = !0);
                      })();
                    else if (l.relativePlacementConstraint) {
                      for (var $ = 0, X = 0, rt = 0; rt < Q.length; rt++)
                        Q[rt].length > $ && ($ = Q[rt].length, X = rt);
                      if ($ < x.size / 2)
                        _(l.relativePlacementConstraint), I = !1, D = !1;
                      else {
                        var B = /* @__PURE__ */ new Map(), O = /* @__PURE__ */ new Map(), H = [];
                        Q[X].forEach(function(b) {
                          W.get(b).forEach(function(U) {
                            U.direction == "horizontal" ? (B.has(b) ? B.get(b).push(U) : B.set(b, [U]), B.has(U.id) || B.set(U.id, []), H.push({ left: b, right: U.id })) : (O.has(b) ? O.get(b).push(U) : O.set(b, [U]), O.has(U.id) || O.set(U.id, []), H.push({ top: b, bottom: U.id }));
                          });
                        }), _(H), D = !1;
                        var k = A(B, "horizontal"), tt = A(O, "vertical");
                        Q[X].forEach(function(b, U) {
                          y[U] = [d[g.get(b)], L[g.get(b)]], m[U] = [], k.has(b) ? m[U][0] = k.get(b) : m[U][0] = d[g.get(b)], tt.has(b) ? m[U][1] = tt.get(b) : m[U][1] = L[g.get(b)];
                        }), I = !0;
                      }
                    }
                    if (I) {
                      ...
                      var vt = t.multMat(J, t.transpose(It)), it = s.svd(vt);
                      ht = t.multMat(it.V, t.transpose(it.U));
                      for (var ut = 0; ut < g.size; ut++) {
                        var Et = [d[ut], L[ut]], Ct = [ht[0][0], ht[1][0]], Dt = [ht[0][1], ht[1][1]];
                        d[ut] = t.dotProduct(Et, Ct), L[ut] = t.dotProduct(Et, Dt);
                      }
                      D && _(l.relativePlacementConstraint);
                    }
                  }
                  if (r.ENFORCE_CONSTRAINTS) {
                    if (l.fixedNodeConstraint && l.fixedNodeConstraint.length > 0) {
                      var mt = { x: 0, y: 0 };
                      l.fixedNodeConstraint.forEach(function(b, U) {
                        var Z = { x: d[g.get(b.nodeId)], y: L[g.get(b.nodeId)] }, K = b.position, q = Y(K, Z);
                        mt.x += q.x, mt.y += q.y;
                      }), mt.x /= l.fixedNodeConstraint.length, mt.y /= l.fixedNodeConstraint.length, d.forEach(function(b, U) {
                        d[U] += mt.x;
                      }), L.forEach(function(b, U) {
                        L[U] += mt.y;
                      }), l.fixedNodeConstraint.forEach(function(b) {
                        d[g.get(b.nodeId)] = b.position.x, L[g.get(b.nodeId)] = b.position.y;
                      });
                    }
                    if (l.alignmentConstraint) {
                      if (l.alignmentConstraint.vertical)
                        for (var Ot = l.alignmentConstraint.vertical, Rt = function(U) {
                          var Z = /* @__PURE__ */ new Set();
                          Ot[U].forEach(function(at) {
                            Z.add(at);
                          });
                          var K = new Set([].concat(f(Z)).filter(function(at) {
                            return S.has(at);
                          })), q = void 0;
                          K.size > 0 ? q = d[g.get(K.values().next().value)] : q = z(Z).x, Z.forEach(function(at) {
                            S.has(at) || (d[g.get(at)] = q);
                          });
                        }, Ht = 0; Ht < Ot.length; Ht++)
                          Rt(Ht);
                      if (l.alignmentConstraint.horizontal)
                        for (var Ut = l.alignmentConstraint.horizontal, Pt = function(U) {
                          ...
                          K.size > 0 ? q = L[g.get(K.values().next().value)] : q = z(Z).y, Z.forEach(function(at) {
                            S.has(at) || (L[g.get(at)] = q);
                          });
                        }, Ft = 0; Ft < Ut.length; Ft++)
                          Pt(Ft);
                    }
                    l.relativePlacementConstraint && (function() {
                      var b = /* @__PURE__ */ new Map(), U = /* @__PURE__ */ new Map(), Z = /* @__PURE__ */ new Map(), K = /* @__PURE__ */ new Map(), q = /* @__PURE__ */ new Map(), at = /* @__PURE__ */ new Map(), gt = /* @__PURE__ */ new Set(), nt = /* @__PURE__ */ new Set();
                      if (S.forEach(function(Gt) {
                        gt.add(Gt), nt.add(Gt);
                      }), l.alignmentConstraint) {
                        if (l.alignmentConstraint.vertical)
                          for (var et = l.alignmentConstraint.vertical, j = function(yt) {
                            Z.set("dummy" + yt, []), et[yt].forEach(function(At) {
                              b.set(At, "dummy" + yt), Z.get("dummy" + yt).push(At), S.has(At) && gt.add("dummy" + yt);
                            }), q.set("dummy" + yt, d[g.get(et[yt][0])]);
                          }, dt = 0; dt < et.length; dt++)
                            j(dt);
                        if (l.alignmentConstraint.horizontal)
                          for (var Mt = l.alignmentConstraint.horizontal, pt = function(yt) {
                            K.set("dummy" + yt, []), Mt[yt].forEach(function(At) {
                              U.set(At, "dummy" + yt), K.get("dummy" + yt).push(At), S.has(At) && nt.add("dummy" + yt);
                            }), at.set("dummy" + yt, L[g.get(Mt[yt][0])]);
                          }, xt = 0; xt < Mt.length; xt++)
                            pt(xt);
                      }
                      var lt = /* @__PURE__ */ new Map(), ot = /* @__PURE__ */ new Map(), Lt = function(yt) {
                        W.get(yt).forEach(function(At) {
                          var Zt = void 0, Bt = void 0;
                          At.direction == "horizontal" ? (Zt = b.get(yt) ? b.get(yt) : yt, b.get(At.id) ? Bt = { id: b.get(At.id), gap: At.gap, direction: At.direction } : Bt = At, lt.has(Zt) ? lt.get(Zt).push(Bt) : lt.set(Zt, [Bt]), lt.has(Bt.id) || lt.set(Bt.id, [])) : (Zt = U.get(yt) ? U.get(yt) : yt, U.get(At.id) ? Bt = { id: U.get(At.id), gap: At.gap, direction: At.direction } : Bt = At, ot.has(Zt) ? ot.get(Zt).push(Bt) : ot.set(Zt, [Bt]), ot.has(Bt.id) || ot.set(Bt.id, []));
                        });
                      }, ft = !0, st = !1, Xt = void 0;
                      try {
                        for (var Tt = W.keys()[Symbol.iterator](), wt; !(ft = (wt = Tt.next()).done); ft = !0) {
                          var $t = wt.value;
                          Lt($t);
                        }
                      } catch (Gt) {
                      ...
                      var bt = E(lt), zt = E(ot), St = n(bt), kt = n(zt), Kt = p(lt), fe = p(ot), Qt = [], jt = [];
                      St.forEach(function(Gt, yt) {
                        Qt[yt] = [], Gt.forEach(function(At) {
                          Kt.get(At).length == 0 && Qt[yt].push(At);
                        });
                      }), kt.forEach(function(Gt, yt) {
                        jt[yt] = [], Gt.forEach(function(At) {
                          fe.get(At).length == 0 && jt[yt].push(At);
                        });
                      });
                      var _t = A(lt, "horizontal", gt, q, Qt), Jt = A(ot, "vertical", nt, at, jt), ne = function(yt) {
                        Z.get(yt) ? Z.get(yt).forEach(function(At) {
                          d[g.get(At)] = _t.get(yt);
                        }) : d[g.get(yt)] = _t.get(yt);
                      }, te = !0, ee = !1, Ne = void 0;
                      try {
                        for (var ce = _t.keys()[Symbol.iterator](), Le; !(te = (Le = ce.next()).done); te = !0) {
                          var ge = Le.value;
                          ne(ge);
                        }
                      } catch (Gt) {
                      ...
                      var ke = function(yt) {
                        K.get(yt) ? K.get(yt).forEach(function(At) {
                          L[g.get(At)] = Jt.get(yt);
                        }) : L[g.get(yt)] = Jt.get(yt);
                      }, ue = !0, we = !1, Ce = void 0;
                      try {
                        for (var de = Jt.keys()[Symbol.iterator](), Me; !(ue = (Me = de.next()).done); ue = !0) {
                          var ge = Me.value;
                          ke(ge);
                        }
                      } catch (Gt) {
                  ...
                  for (var Yt = 0; Yt < R.length; Yt++) {
                    var Vt = R[Yt];
                    Vt.getChild() == null && Vt.setCenter(d[g.get(Vt.id)], L[g.get(Vt.id)]);
                  }
                }, a.exports = o;
              })
            ),
          ...
          function v(a) {
            ...
            return G[a](i, i.exports, v), i.exports;
          }
          var h = v(45);
          return h;
        })()
...
var yr = se.exports, Oe;
function mr() {
  return Oe || (Oe = 1, (function(w, F) {
    (function(G, N) {
      w.exports = N(pr());
    })(yr, function(M) {
      return (
        ...
        (() => {
          var G = {
              ...
              ((a, e, i) => {
                var f = /* @__PURE__ */ (function() {
                  function t(s, o) {
                    ...
                    try {
                      for (var d = s[Symbol.iterator](), L; !(l = (L = d.next()).done) && (c.push(L.value), !(o && c.length === o)); l = !0)
                        ;
                    } catch (R) {
                      T = !0, g = R;
                    } finally {
                ...
                })(), r = i(140).layoutBase.LinkedList, u = {};
                u.getTopMostNodes = function(t) {
                  ...
                  var l = new r(), T = /* @__PURE__ */ new Set(), g = [], d = void 0, L = void 0, R = void 0, C = !1, P = 1, V = [], Y = [], z = function() {
                    var _ = t.collection();
                    Y.push(_);
                    var n = o[0], E = t.collection();
                    E.merge(n).merge(n.descendants().intersection(s)), g.push(n), E.forEach(function(y) {
                      l.push(y), T.add(y), _.merge(y);
                    });
                    for (var p = function() {
                      n = l.shift();
                      var I = t.collection();
                      ...
                      for (var D = 0; D < I.length; D++) {
                        var S = I[D];
                        if (d = o.intersection(S.union(S.ancestors())), d != null && !T.has(d[0])) {
                          var W = d.union(d.descendants());
                          W.forEach(function(x) {
                            l.push(x), T.add(x), _.merge(x), o.has(x) && g.push(x);
                          });
                        }
                      }
                    }; l.length != 0; )
                      p();
                    if (_.forEach(function(y) {
                      s.intersection(y.connectedEdges()).forEach(function(I) {
                        _.has(I.source()) && _.has(I.target()) && _.merge(I);
                      });
                    }), g.length == o.length && (C = !0), !C || C && P > 1) {
                      L = g[0], R = L.connectedEdges().length, g.forEach(function(y) {
                        y.connectedEdges().length < R && (R = y.connectedEdges().length, L = y);
                      }), V.push(L.id());
                      var m = t.collection();
                      m.merge(g[0]), g.forEach(function(y) {
                        m.merge(y);
                      }), g = [], o = o.difference(m), P++;
                    }
                  };
                  do
                    z();
                  while (!C);
                  return c && V.length > 0 && c.set("dummy" + (c.size + 1), V), Y;
                  ...
                  if (!o.fixedNodeConstraint) {
                    ...
                    if (o.quality == "draft") {
                      var d = !0, L = !1, R = void 0;
                      try {
                        for (var C = s.nodeIndexes[Symbol.iterator](), P; !(d = (P = C.next()).done); d = !0) {
                          var V = P.value, Y = f(V, 2), z = Y[0], A = Y[1], _ = o.cy.getElementById(z);
                          if (_) {
                            var n = _.boundingBox(), E = s.xCoords[A] - n.w / 2, p = s.xCoords[A] + n.w / 2, m = s.yCoords[A] - n.h / 2, y = s.yCoords[A] + n.h / 2;
                            E < c && (c = E), p > l && (l = p), m < T && (T = m), y > g && (g = y);
                          }
                        }
                      } catch (x) {
                        L = !0, R = x;
                      ...
                      Object.keys(s).forEach(function(x) {
                        var Q = s[x], $ = Q.getRect().x, X = Q.getRect().x + Q.getRect().width, rt = Q.getRect().y, B = Q.getRect().y + Q.getRect().height;
                        $ < c && (c = $), X > l && (l = X), rt < T && (T = rt), B > g && (g = B);
                      });
                  ...
                  for (var l = Number.MAX_SAFE_INTEGER, T = Number.MIN_SAFE_INTEGER, g = Number.MAX_SAFE_INTEGER, d = Number.MIN_SAFE_INTEGER, L = void 0, R = void 0, C = void 0, P = void 0, V = t.descendants().not(":parent"), Y = V.length, z = 0; z < Y; z++) {
                    var A = V[z];
                    L = s[c.get(A.id())] - A.width() / 2, R = s[c.get(A.id())] + A.width() / 2, C = o[c.get(A.id())] - A.height() / 2, P = o[c.get(A.id())] + A.height() / 2, l > L && (l = L), T < R && (T = R), g > C && (g = C), d < P && (d = P);
                  }
                  var _ = {};
                  return _.topLeftX = l, _.topLeftY = g, _.width = T - l, _.height = d - g, _;
            ...
            816: (
              /***/
              ((a, e, i) => {
                var f = i(548), r = i(140).CoSELayout, u = i(140).CoSENode, t = i(140).layoutBase.PointD, s = i(140).layoutBase.DimensionD, o = i(140).layoutBase.LayoutConstants, c = i(140).layoutBase.FDLayoutConstants, l = i(140).CoSEConstants, T = function(d, L) {
                  var R = d.cy, C = d.eles, P = C.nodes(), V = C.edges(), Y = void 0, z = void 0, A = void 0, _ = {};
                  d.randomize && (Y = L.nodeIndexes, z = L.xCoords, A = L.yCoords);
                  var n = function(x) {
                    return typeof x == "function";
                  }, E = function(x, Q) {
                    return n(x) ? x(Q) : x;
                  }, p = f.calcParentsWithoutChildren(R, C), m = function W(x, Q, $, X) {
                    for (var rt = Q.length, B = 0; B < rt; B++) {
                      var O = Q[B], H = null;
                      O.intersection(p).length == 0 && (H = O.children());
                      var k = void 0, tt = O.layoutDimensions({
                        nodeDimensionsIncludeLabels: X.nodeDimensionsIncludeLabels
                      });
                      if (O.outerWidth() != null && O.outerHeight() != null)
                        if (X.randomize)
                          if (!O.isParent())
                            k = x.add(new u($.graphManager, new t(z[Y.get(O.id())] - tt.w / 2, A[Y.get(O.id())] - tt.h / 2), new s(parseFloat(tt.w), parseFloat(tt.h))));
                          else {
                            var ht = f.calcBoundingBox(O, z, A, Y);
                            O.intersection(p).length == 0 ? k = x.add(new u($.graphManager, new t(ht.topLeftX, ht.topLeftY), new s(ht.width, ht.height))) : k = x.add(new u($.graphManager, new t(ht.topLeftX, ht.topLeftY), new s(parseFloat(tt.w), parseFloat(tt.h))));
                          }
                        else
                          k = x.add(new u($.graphManager, new t(O.position("x") - tt.w / 2, O.position("y") - tt.h / 2), new s(parseFloat(tt.w), parseFloat(tt.h))));
                      else
                        k = x.add(new u(this.graphManager));
                      if (k.id = O.data("id"), k.nodeRepulsion = E(X.nodeRepulsion, O), k.paddingLeft = parseInt(O.css("padding")), k.paddingTop = parseInt(O.css("padding")), k.paddingRight = parseInt(O.css("padding")), k.paddingBottom = parseInt(O.css("padding")), X.nodeDimensionsIncludeLabels && (k.labelWidth = O.boundingBox({ includeLabels: !0, includeNodes: !1, includeOverlays: !1 }).w, k.labelHeight = O.boundingBox({ includeLabels: !0, includeNodes: !1, includeOverlays: !1 }).h, k.labelPosVertical = O.css("text-valign"), k.labelPosHorizontal = O.css("text-halign")), _[O.data("id")] = k, isNaN(k.rect.x) && (k.rect.x = 0), isNaN(k.rect.y) && (k.rect.y = 0), H != null && H.length > 0) {
                        var J = void 0;
                        J = $.getGraphManager().add($.newGraph(), k), W(J, H, $, X);
                      }
                    }
                  }, y = function(x, Q, $) {
                    for (var X = 0, rt = 0, B = 0; B < $.length; B++) {
                      var O = $[B], H = _[O.data("source")], k = _[O.data("target")];
                      if (H && k && H !== k && H.getEdgesBetween(k).length == 0) {
                        var tt = Q.add(x.newEdge(), H, k);
                        tt.id = O.id(), tt.idealLength = E(d.idealEdgeLength, O), tt.edgeElasticity = E(d.edgeElasticity, O), X += tt.idealLength, rt++;
                      }
                    }
                    d.idealEdgeLength != null && (rt > 0 ? l.DEFAULT_EDGE_LENGTH = c.DEFAULT_EDGE_LENGTH = X / rt : n(d.idealEdgeLength) ? l.DEFAULT_EDGE_LENGTH = c.DEFAULT_EDGE_LENGTH = 50 : l.DEFAULT_EDGE_LENGTH = c.DEFAULT_EDGE_LENGTH = d.idealEdgeLength, l.MIN_REPULSION_DIST = c.MIN_REPULSION_DIST = c.DEFAULT_EDGE_LENGTH / 10, l.DEFAULT_RADIAL_SEPARATION = c.DEFAULT_EDGE_LENGTH);
                  }, I = function(x, Q) {
                  ...
                  var D = new r(), S = D.newGraphManager();
                  return m(S.addRoot(), f.getTopMostNodes(P), D, d), y(D, S, V), I(D, d), D.runLayout(), _;
                };
              ...
              ((a, e, i) => {
                var f = /* @__PURE__ */ (function() {
                  ...
                  return function(L, R, C) {
                    return R && d(L.prototype, R), C && d(L, C), L;
                  };
                })();
                function r(d, L) {
                  if (!(d instanceof L))
                ...
                var u = i(658), t = i(548), s = i(657), o = s.spectralLayout, c = i(816), l = c.coseLayout, T = Object.freeze({
                  ...
                  function d(L) {
                    r(this, d), this.options = u({}, T, L);
                  }
                  return f(d, [{
                    key: "run",
                    value: function() {
                      var R = this, C = this.options, P = C.cy, V = C.eles, Y = [], z = [], A = void 0, _ = [];
                      ...
                      var E = void 0, p = !1;
                      if (P.layoutUtilities && C.packComponents && (E = P.layoutUtilities("get"), E || (E = P.layoutUtilities()), p = !0), V.nodes().length > 0)
                        if (p) {
                          var I = t.getTopMostNodes(C.eles.nodes());
                          if (A = t.connectComponents(P, C.eles, I), A.forEach(function(vt) {
                            var it = vt.boundingBox();
                            _.push({ x: it.x1 + it.w / 2, y: it.y1 + it.h / 2 });
                          }), C.randomize && A.forEach(function(vt) {
                            C.eles = vt, Y.push(o(C));
                          }), C.quality == "default" || C.quality == "proof") {
                            var D = P.collection();
                            if (C.tile) {
                              var S = /* @__PURE__ */ new Map(), W = [], x = [], Q = 0, $ = { nodeIndexes: S, xCoords: W, yCoords: x }, X = [];
                              if (A.forEach(function(vt, it) {
                                vt.edges().length == 0 && (vt.nodes().forEach(function(ut, Et) {
                                  D.merge(vt.nodes()[Et]), ut.isParent() || ($.nodeIndexes.set(vt.nodes()[Et].id(), Q++), $.xCoords.push(vt.nodes()[0].position().x), $.yCoords.push(vt.nodes()[0].position().y));
                                }), X.push(it));
                              }), D.length > 1) {
                                var rt = D.boundingBox();
                                _.push({ x: rt.x1 + rt.w / 2, y: rt.y1 + rt.h / 2 }), A.push(D), Y.push($);
                                for (var B = X.length - 1; B >= 0; B--)
                                  A.splice(X[B], 1), Y.splice(X[B], 1), _.splice(X[B], 1);
                              }
                            }
                            A.forEach(function(vt, it) {
                              C.eles = vt, z.push(l(C, Y[it])), t.relocateComponent(_[it], z[it], C);
                            });
                          } else
                            A.forEach(function(vt, it) {
                              t.relocateComponent(_[it], Y[it], C);
                            });
                          var O = /* @__PURE__ */ new Set();
                          if (A.length > 1) {
                            var H = [], k = V.filter(function(vt) {
                              return vt.css("display") == "none";
                            });
                            A.forEach(function(vt, it) {
                              var ut = void 0;
                              if (C.quality == "draft" && (ut = Y[it].nodeIndexes), vt.nodes().not(k).length > 0) {
                                var Et = {};
                                Et.edges = [], Et.nodes = [];
                                var Ct = void 0;
                                vt.nodes().not(k).forEach(function(Dt) {
                                  if (C.quality == "draft")
                                    if (!Dt.isParent())
                                      Ct = ut.get(Dt.id()), Et.nodes.push({ x: Y[it].xCoords[Ct] - Dt.boundingbox().w / 2, y: Y[it].yCoords[Ct] - Dt.boundingbox().h / 2, width: Dt.boundingbox().w, height: Dt.boundingbox().h });
                                    else {
                                      var mt = t.calcBoundingBox(Dt, Y[it].xCoords, Y[it].yCoords, ut);
                                      Et.nodes.push({ x: mt.topLeftX, y: mt.topLeftY, width: mt.width, height: mt.height });
                                    }
                                  else
                                    z[it][Dt.id()] && Et.nodes.push({ x: z[it][Dt.id()].getLeft(), y: z[it][Dt.id()].getTop(), width: z[it][Dt.id()].getWidth(), height: z[it][Dt.id()].getHeight() });
                                }), vt.edges().forEach(function(Dt) {
                                  var mt = Dt.source(), Ot = Dt.target();
                                  if (mt.css("display") != "none" && Ot.css("display") != "none")
                                    if (C.quality == "draft") {
                                      var Rt = ut.get(mt.id()), Ht = ut.get(Ot.id()), Ut = [], Pt = [];
                                      if (mt.isParent()) {
                                        var Ft = t.calcBoundingBox(mt, Y[it].xCoords, Y[it].yCoords, ut);
                                        Ut.push(Ft.topLeftX + Ft.width / 2), Ut.push(Ft.topLeftY + Ft.height / 2);
                                      } else
                                        Ut.push(Y[it].xCoords[Rt]), Ut.push(Y[it].yCoords[Rt]);
                                      if (Ot.isParent()) {
                                        var Yt = t.calcBoundingBox(Ot, Y[it].xCoords, Y[it].yCoords, ut);
                                        Pt.push(Yt.topLeftX + Yt.width / 2), Pt.push(Yt.topLeftY + Yt.height / 2);
                                      } else
                                        Pt.push(Y[it].xCoords[Ht]), Pt.push(Y[it].yCoords[Ht]);
                                      Et.edges.push({ startX: Ut[0], startY: Ut[1], endX: Pt[0], endY: Pt[1] });
                                    } else
                                      z[it][mt.id()] && z[it][Ot.id()] && Et.edges.push({ startX: z[it][mt.id()].getCenterX(), startY: z[it][mt.id()].getCenterY(), endX: z[it][Ot.id()].getCenterX(), endY: z[it][Ot.id()].getCenterY() });
                                }), Et.nodes.length > 0 && (H.push(Et), O.add(it));
                              }
                            });
                            var tt = E.packComponents(H, C.randomize).shifts;
                            if (C.quality == "draft")
                          ...
                          var m = C.eles.boundingBox();
                          if (_.push({ x: m.x1 + m.w / 2, y: m.y1 + m.h / 2 }), C.randomize) {
                            var y = o(C);
                            Y.push(y);
                          }
                          C.quality == "default" || C.quality == "proof" ? (z.push(l(C, Y[0])), t.relocateComponent(_[0], z[0], C)) : t.relocateComponent(_[0], Y[0], C);
                        }
                      var J = function(it, ut) {
                        if (C.quality == "default" || C.quality == "proof") {
                          typeof it == "number" && (it = ut);
                          var Et = void 0, Ct = void 0, Dt = it.data("id");
                          return z.forEach(function(Ot) {
                            Dt in Ot && (Et = { x: Ot[Dt].getRect().getCenterX(), y: Ot[Dt].getRect().getCenterY() }, Ct = Ot[Dt]);
                          }), C.nodeDimensionsIncludeLabels && (Ct.labelWidth && (Ct.labelPosHorizontal == "left" ? Et.x += Ct.labelWidth / 2 : Ct.labelPosHorizontal == "right" && (Et.x -= Ct.labelWidth / 2)), Ct.labelHeight && (Ct.labelPosVertical == "top" ? Et.y += Ct.labelHeight / 2 : Ct.labelPosVertical == "bottom" && (Et.y -= Ct.labelHeight / 2))), Et == null && (Et = { x: it.position("x"), y: it.position("y") }), {
                            x: Et.x,
                            y: Et.y
                          };
                        } else {
                          var mt = void 0;
                          return Y.forEach(function(Ot) {
                      ...
                      if (C.quality == "default" || C.quality == "proof" || C.randomize) {
                        var It = t.calcParentsWithoutChildren(P, V), Nt = V.filter(function(vt) {
                          return vt.css("display") == "none";
                        });
                        C.eles = V.not(Nt), V.nodes().not(":parent").not(Nt).layoutPositions(R, C, J), It.length > 0 && It.forEach(function(vt) {
                          vt.position(J(vt));
                        });
                      } else
            ...
            657: (
              /***/
              ((a, e, i) => {
                var f = i(548), r = i(140).layoutBase.Matrix, u = i(140).layoutBase.SVD, t = function(o) {
                  var c = o.cy, l = o.eles, T = l.nodes(), g = l.nodes(":parent"), d = /* @__PURE__ */ new Map(), L = /* @__PURE__ */ new Map(), R = /* @__PURE__ */ new Map(), C = [], P = [], V = [], Y = [], z = [], A = [], _ = [], n = [], E = void 0, p = 1e8, m = 1e-9, y = o.piTol, I = o.samplingType, D = o.nodeSeparation, S = void 0, W = function() {
                    for (var U = 0, Z = 0, K = !1; Z < S; ) {
                      U = Math.floor(Math.random() * E), K = !1;
                      for (var q = 0; q < Z; q++)
                        if (Y[q] == U) {
                          K = !0;
                          break;
                    ...
                    for (var q = [], at = 0, gt = 0, nt = 0, et = void 0, j = [], dt = 0, Mt = 1, pt = 0; pt < E; pt++)
                      j[pt] = p;
                    for (q[gt] = U, j[U] = 0; gt >= at; ) {
                      nt = q[at++];
                      for (var xt = C[nt], lt = 0; lt < xt.length; lt++)
                        et = L.get(xt[lt]), j[et] == p && (j[et] = j[nt] + 1, q[++gt] = et);
                      A[nt][Z] = j[nt] * D;
                    }
                    if (K) {
                      for (var ot = 0; ot < E; ot++)
                        A[ot][Z] < z[ot] && (z[ot] = A[ot][Z]);
                      for (var Lt = 0; Lt < E; Lt++)
                        z[Lt] > dt && (dt = z[Lt], Mt = Lt);
                    }
                    return Mt;
                  }, Q = function(U) {
                    var Z = void 0;
                    ...
                    for (var U = u.svd(_), Z = U.S, K = U.U, q = U.V, at = Z[0] * Z[0] * Z[0], gt = [], nt = 0; nt < S; nt++) {
                      gt[nt] = [];
                      for (var et = 0; et < S; et++)
                        gt[nt][et] = 0, nt == et && (gt[nt][et] = Z[nt] / (Z[nt] * Z[nt] + at / (Z[nt] * Z[nt])));
                    }
                    n = r.multMat(r.multMat(q, gt), r.transpose(K));
                  }, X = function() {
                    for (var U = void 0, Z = void 0, K = [], q = [], at = [], gt = [], nt = 0; nt < E; nt++)
                      K[nt] = Math.random(), q[nt] = Math.random();
                    K = r.normalize(K), q = r.normalize(q);
                    for (var et = m, j = m, dt = void 0; ; ) {
                      for (var Mt = 0; Mt < E; Mt++)
                        at[Mt] = K[Mt];
                      if (K = r.multGamma(r.multL(r.multGamma(at), A, n)), U = r.dotProduct(at, K), K = r.normalize(K), et = r.dotProduct(at, K), dt = Math.abs(et / j), dt <= 1 + y && dt >= 1)
                        break;
                      j = et;
                    }
                    for (var pt = 0; pt < E; pt++)
                      at[pt] = K[pt];
                    for (j = m; ; ) {
                      for (var xt = 0; xt < E; xt++)
                        gt[xt] = q[xt];
                      if (gt = r.minusOp(gt, r.multCons(at, r.dotProduct(at, gt))), q = r.multGamma(r.multL(r.multGamma(gt), A, n)), Z = r.dotProduct(gt, q), q = r.normalize(q), et = r.dotProduct(gt, q), dt = Math.abs(et / j), dt <= 1 + y && dt >= 1)
                        break;
                      j = et;
                    }
                    for (var lt = 0; lt < E; lt++)
                      gt[lt] = q[lt];
                    P = r.multCons(at, Math.sqrt(Math.abs(U))), V = r.multCons(gt, Math.sqrt(Math.abs(Z)));
                  };
                  f.connectComponents(c, l, f.getTopMostNodes(T), d), g.forEach(function(b) {
                    f.connectComponents(c, l, f.getTopMostNodes(b.descendants().intersection(l)), d);
                  });
                  for (var rt = 0, B = 0; B < T.length; B++)
                    T[B].isParent() || L.set(T[B].id(), rt++);
                  var O = !0, H = !1, k = void 0;
                  try {
                  ...
                  g.forEach(function(b) {
                    ...
                    var Z = 0, K = U.nodes(":childless")[0].connectedEdges().length;
                    U.nodes(":childless").forEach(function(q, at) {
                      q.connectedEdges().length < K && (K = q.connectedEdges().length, Z = at);
                    }), R.set(b.id(), U.nodes(":childless")[Z].id());
                  }), T.forEach(function(b) {
                    var U = void 0;
                    b.isParent() ? U = L.get(R.get(b.id())) : U = L.get(b.id()), b.neighborhood().nodes().forEach(function(Z) {
                      l.intersection(b.edgesWith(Z)).length > 0 && (Z.isParent() ? C[U].push(R.get(Z.id())) : C[U].push(Z.id()));
                    });
                  });
                  var Nt = function(U) {
                    var Z = L.get(U), K = void 0;
                    d.get(U).forEach(function(q) {
                      c.getElementById(q).isParent() ? K = R.get(q) : K = q, C[Z].push(K), C[L.get(K)].push(U);
                    });
                  }, vt = !0, it = !1, ut = void 0;
                  try {
                  ...
                  var mt = void 0;
                  if (E > 2) {
                    S = E < o.sampleSize ? E : o.sampleSize;
                    for (var Ot = 0; Ot < E; Ot++)
                      A[Ot] = [];
                    for (var Rt = 0; Rt < S; Rt++)
                      n[Rt] = [];
                    return o.quality == "draft" || o.step == "all" ? (Q(I), $(), X(), mt = { nodeIndexes: L, xCoords: P, yCoords: V }) : (L.forEach(function(b, U) {
                      P.push(c.getElementById(U).position("x")), V.push(c.getElementById(U).position("y"));
                    }), mt = { nodeIndexes: L, xCoords: P, yCoords: V }), mt;
                  } else {
                    var Ht = L.keys(), Ut = c.getElementById(Ht.next().value), Pt = Ut.position(), Ft = Ut.outerWidth();
                    if (P.push(Pt.x), V.push(Pt.y), E == 2) {
                      var Yt = c.getElementById(Ht.next().value), Vt = Yt.outerWidth();
                      P.push(Pt.x + Ft / 2 + Vt / 2 + o.idealEdgeLength), V.push(Pt.y);
                    }
                    return mt = { nodeIndexes: L, xCoords: P, yCoords: V }, mt;
                  }
                };
...
var xe = {
  ...
  L: /* @__PURE__ */ ct((w) => `${w},${w / 2} 0,${w} 0,0`, "L"),
  R: /* @__PURE__ */ ct((w) => `0,${w / 2} ${w},0 ${w},${w}`, "R"),
  T: /* @__PURE__ */ ct((w) => `0,0 ${w},0 ${w / 2},${w}`, "T"),
  B: /* @__PURE__ */ ct((w) => `${w / 2},0 ${w},${w} 0,${w}`, "B")
}, oe = {
  L: /* @__PURE__ */ ct((w, F) => w - F + 2, "L"),
  R: /* @__PURE__ */ ct((w, F) => w - 2, "R"),
  T: /* @__PURE__ */ ct((w, F) => w - F + 2, "T"),
  B: /* @__PURE__ */ ct((w, F) => w - 2, "B")
}, Nr = /* @__PURE__ */ ct(function(w) {
  return Wt(w) ? w === "L" ? "R" : "L" : w === "T" ? "B" : "T";
}, "getOppositeArchitectureDirection"), Re = /* @__PURE__ */ ct(function(w) {
  const F = w;
  return F === "L" || F === "R" || F === "T" || F === "B";
}, "isArchitectureDirection"), Wt = /* @__PURE__ */ ct(function(w) {
  const F = w;
  return F === "L" || F === "R";
}, "isArchitectureDirectionX"), qt = /* @__PURE__ */ ct(function(w) {
  const F = w;
  return F === "T" || F === "B";
}, "isArchitectureDirectionY"), Te = /* @__PURE__ */ ct(function(w, F) {
  const M = Wt(w) && qt(F), G = qt(w) && Wt(F);
  return M || G;
}, "isArchitectureDirectionXY"), Lr = /* @__PURE__ */ ct(function(w) {
  const F = w[0], M = w[1], G = Wt(F) && qt(M), N = qt(F) && Wt(M);
  return G || N;
}, "isArchitecturePairXY"), wr = /* @__PURE__ */ ct(function(w) {
  return w !== "LL" && w !== "RR" && w !== "TT" && w !== "BB";
}, "isValidArchitectureDirectionPair"), pe = /* @__PURE__ */ ct(function(w, F) {
  const M = `${w}${F}`;
  return wr(M) ? M : void 0;
}, "getArchitectureDirectionPair"), Cr = /* @__PURE__ */ ct(function([w, F], M) {
  const G = M[0], N = M[1];
  return Wt(G) ? qt(N) ? [w + (G === "L" ? -1 : 1), F + (N === "T" ? 1 : -1)] : [w + (G === "L" ? -1 : 1), F] : Wt(N) ? [w + (N === "L" ? 1 : -1), F + (G === "T" ? 1 : -1)] : [w, F + (G === "T" ? 1 : -1)];
}, "shiftPositionByArchitectureDirectionPair"), Mr = /* @__PURE__ */ ct(function(w) {
  return w === "LT" || w === "TL" ? [1, 1] : w === "BL" || w === "LB" ? [1, -1] : w === "BR" || w === "RB" ? [-1, -1] : [-1, 1];
}, "getArchitectureDirectionXYFactors"), Ar = /* @__PURE__ */ ct(function(w, F) {
  return Te(w, F) ? "bend" : Wt(w) ? "horizontal" : "vertical";
}, "getArchitectureDirectionAlignment"), Dr = /* @__PURE__ */ ct(function(w) {
  return w.type === "service";
}, "isArchitectureService"), Or = /* @__PURE__ */ ct(function(w) {
  return w.type === "junction";
}, "isArchitectureJunction"), be = /* @__PURE__ */ ct((w, F) => {
  const [M, G] = [w, F].sort();
  return `${JSON.stringify(M)}-${JSON.stringify(G)}`;
}, "architectureGroupAlignmentKey"), Pe = /* @__PURE__ */ ct((w) => w.data(), "edgeData"), ie = /* @__PURE__ */ ct((w) => w.data(), "nodeData"), xr = nr.architecture, Ge = class {
  constructor() {
    this.nodes = /* @__PURE__ */ new Map(), this.groups = /* @__PURE__ */ new Map(), this.edges = [], this.layoutHints = [], this.registeredIds = /* @__PURE__ */ new Map(), this.elements = /* @__PURE__ */ new Map(), this.diagramId = "", this.setAccTitle = Je, this.getAccTitle = Ke, this.setDiagramTitle = je, this.getDiagramTitle = _e, this.getAccDescription = tr, this.setAccDescription = er, this.clear();
  }
  static {
    ct(this, "ArchitectureDB");
  }
  setDiagramId(w) {
    this.diagramId = w;
  }
  ...
  clear() {
    this.nodes = /* @__PURE__ */ new Map(), this.groups = /* @__PURE__ */ new Map(), this.edges = [], this.layoutHints = [], this.registeredIds = /* @__PURE__ */ new Map(), this.dataStructures = void 0, this.elements = /* @__PURE__ */ new Map(), this.diagramId = "", rr();
  }
  addService({
    id: w,
    icon: F,
    ...
    if (this.registeredIds.has(w))
      throw new Error(
        `The service id [${w}] is already in use by another ${this.registeredIds.get(w)}`
      );
    if (M !== void 0) {
      if (w === M)
      ...
      if (this.registeredIds.get(M) === "node")
        throw new Error(`The service [${w}]'s parent is not a group`);
    }
    this.registeredIds.set(w, "node"), this.nodes.set(w, {
      id: w,
      type: "service",
      icon: F,
      iconText: N,
  ...
  getServices() {
    return [...this.nodes.values()].filter(Dr);
  }
  addJunction({ id: w, in: F }) {
    if (this.registeredIds.has(w))
      throw new Error(
        `The junction id [${w}] is already in use by another ${this.registeredIds.get(w)}`
      );
    if (F !== void 0) {
      if (w === F)
        throw new Error(`The junction [${w}] cannot be placed within itself`);
      if (!this.registeredIds.has(F))
        throw new Error(
          `The junction [${w}]'s parent does not exist. Please make sure the parent is created before this junction`
        );
      if (this.registeredIds.get(F) === "node")
        throw new Error(`The junction [${w}]'s parent is not a group`);
    }
    this.registeredIds.set(w, "node"), this.nodes.set(w, {
      id: w,
      type: "junction",
  ...
  getNode(w) {
    return this.nodes.get(w) ?? null;
  }
  addGroup({ id: w, icon: F, in: M, title: G }) {
    if (this.registeredIds.has(w))
      throw new Error(
        `The group id [${w}] is already in use by another ${this.registeredIds.get(w)}`
      );
    if (M !== void 0) {
      if (w === M)
    ...
    this.registeredIds.set(w, "group"), this.groups.set(w, {
      id: w,
      icon: F,
      title: G,
      in: M
  ...
  addEdge({
    ...
    if (!Re(M))
      throw new Error(
        `Invalid direction given for left hand side of edge ${w}--${F}. Expected (L,R,T,B) got ${String(M)}`
      );
    if (!Re(G))
      throw new Error(
        `Invalid direction given for right hand side of edge ${w}--${F}. Expected (L,R,T,B) got ${String(G)}`
      );
    if (!this.nodes.has(w) && !this.groups.has(w))
      throw new Error(
        `The left-hand id [${w}] does not yet exist. Please create the service/group before declaring an edge to it.`
      );
    if (!this.nodes.has(F) && !this.groups.has(F))
      throw new Error(
        `The right-hand id [${F}] does not yet exist. Please create the service/group before declaring an edge to it.`
      );
    const i = this.nodes.get(w).in, f = this.nodes.get(F).in;
    if (h && i && f && i == f)
      throw new Error(
    ...
    if (a && i && f && i == f)
      throw new Error(
        `The right-hand id [${F}] is modified to traverse the group boundary, but the edge does not pass through two groups.`
      );
    const r = {
      lhsId: w,
      lhsDir: M,
    ...
    this.edges.push(r);
    const u = this.nodes.get(w), t = this.nodes.get(F);
    u && t && (u.edges.push(this.edges[this.edges.length - 1]), t.edges.push(this.edges[this.edges.length - 1]));
  }
  getEdges() {
    return this.edges;
  }
  addLayoutHint(w) {
    if (w.members.length < 2)
      throw new Error(
        `An align directive requires at least two members; got ${w.members.length}`
      );
    const F = /* @__PURE__ */ new Set();
    w.members.forEach((M) => {
      if (this.registeredIds.get(M) !== "node")
        throw new Error(
          `align ${w.direction} references [${M}], which is not a service or junction`
        );
      if (F.has(M))
        throw new Error(`align ${w.direction} lists [${M}] more than once`);
      F.add(M);
    }), this.layoutHints.push(w);
  }
  getLayoutHints() {
  ...
  getDataStructures() {
    if (this.dataStructures === void 0) {
      const w = /* @__PURE__ */ new Map(), F = /* @__PURE__ */ new Map();
      for (const [h, a] of this.nodes.entries()) {
        const e = /* @__PURE__ */ new Map();
        for (const i of a.edges) {
          const f = this.getNode(i.lhsId)?.in, r = this.getNode(i.rhsId)?.in;
          if (f && r && f !== r) {
            const u = Ar(i.lhsDir, i.rhsDir);
            u !== "bend" && w.set(be(f, r), u);
          }
          if (i.lhsId === h) {
            const u = pe(i.lhsDir, i.rhsDir);
            u && e.set(u, i.rhsId);
          } else {
            const u = pe(i.rhsDir, i.lhsDir);
            u && e.set(u, i.lhsId);
          }
        }
        F.set(h, e);
      }
      const M = /* @__PURE__ */ new Set(), G = new Set(F.keys()), N = /* @__PURE__ */ ct((h) => {
        const a = /* @__PURE__ */ new Map([[h, [0, 0]]]), e = [h];
        for (; e.length > 0; ) {
          const i = e.shift();
          if (i) {
            M.add(i), G.delete(i);
            ...
            if (!f)
              throw new Error(
                `BFS error: adjacency list for id ${i} not found. Please report this as a bug.`
              );
            const r = a.get(i);
            if (!r)
              throw new Error(
                `BFS error: position for id ${i} not found in spatial map. Please report this as a bug.`
              );
            const [u, t] = r;
            f.forEach((s, o) => {
              M.has(s) || (a.set(s, Cr([u, t], o)), e.push(s));
            });
          }
        }
        return a;
  ...
  Ze(w, F), w.groups.map((M) => F.addGroup(M)), w.services.map((M) => F.addService({ ...M, type: "service" })), w.junctions.map((M) => F.addJunction({ ...M, type: "junction" })), w.edges.map((M) => F.addEdge(M)), w.alignments?.map(
    (M) => F.addLayoutHint({ direction: M.direction, members: [...M.members] })
  );
}, "populateDb"), Ue = {
  parser: {
  ...
  parse: /* @__PURE__ */ ct(async (w) => {
    const F = await cr("architecture", w);
    Se.debug(F);
    const M = Ue.parser?.yy;
    if (!(M instanceof Ge))
      throw new Error(
...
ct(ye, "withSeededRandom");
var re = /* @__PURE__ */ ct((w) => `<g><rect width="80" height="80" style="fill: #087ebf; stroke-width: 0px;"/>${w}</g>`, "wrapIcon"), ae = {
...
}, Fr = /* @__PURE__ */ ct(async function(w, F, M, G) {
  const N = M.getConfigField("padding"), v = M.getConfigField("iconSize"), h = v / 2, a = v / 6, e = a / 2;
  await Promise.all(
    F.edges().map(async (i) => {
      const {
        source: f,
      ...
      let { x: g, y: d } = i[0].sourceEndpoint();
      const { x: L, y: R } = i[0].midpoint();
      let { x: C, y: P } = i[0].targetEndpoint();
      const V = N + 4;
      if (t && (Wt(r) ? g += r === "L" ? -V : V : d += r === "T" ? -V : V + 18), l && (Wt(o) ? C += o === "L" ? -V : V : P += o === "T" ? -V : V + 18), !t && M.getNode(f)?.type === "junction" && (Wt(r) ? g += r === "L" ? h : -h : d += r === "T" ? h : -h), !l && M.getNode(s)?.type === "junction" && (Wt(o) ? C += o === "L" ? h : -h : P += o === "T" ? h : -h), i[0]._private.rscratch) {
        const Y = w.insert("g");
        if (Y.insert("path").attr("d", `M ${g},${d} L ${L},${R} L${C},${P} `).attr("class", "edge").attr("id", `${G}-${hr(f, s, { prefix: "L" })}`), u) {
          const z = Wt(r) ? oe[r](g, a) : g - e, A = qt(r) ? oe[r](d, a) : d - e;
          Y.insert("polygon").attr("points", Ie[r](a)).attr("transform", `translate(${z},${A})`).attr("class", "arrow");
        }
        if (c) {
          const z = Wt(o) ? oe[o](C, a) : C - e, A = qt(o) ? oe[o](P, a) : P - e;
          Y.insert("polygon").attr("points", Ie[o](a)).attr("transform", `translate(${z},${A})`).attr("class", "arrow");
        }
        if (T) {
          const z = Te(r, o) ? "XY" : Wt(r) ? "X" : "Y";
          let A = 0;
          z === "X" ? A = Math.abs(g - C) : z === "Y" ? A = Math.abs(d - P) / 1.5 : A = Math.abs(g - C) / 2;
          const _ = Y.append("g");
          if (await Ee(
            _,
            T,
            ...
            me()
          ), _.attr("dy", "1em").attr("alignment-baseline", "middle").attr("dominant-baseline", "middle").attr("text-anchor", "middle"), z === "X")
            _.attr("transform", "translate(" + L + ", " + R + ")");
          else if (z === "Y")
            _.attr("transform", "translate(" + L + ", " + R + ") rotate(-90)");
          else if (z === "XY") {
            const n = pe(r, o);
            if (n && Lr(n)) {
              const E = _.node().getBoundingClientRect(), [p, m] = Mr(n);
              _.attr("dominant-baseline", "auto").attr("transform", `rotate(${-1 * p * m * 45})`);
              const y = _.node().getBoundingClientRect();
              _.attr(
                "transform",
                `
                translate(${L}, ${R - E.height / 2})
...
}, "drawEdges"), br = /* @__PURE__ */ ct(async function(w, F, M, G) {
  const v = M.getConfigField("padding") * 0.75, h = M.getConfigField("fontSize"), e = M.getConfigField("iconSize") / 2;
  await Promise.all(
    F.nodes().map(async (i) => {
      const f = ie(i);
      if (f.type === "group") {
        const { h: r, w: u, x1: t, y1: s } = i.boundingBox(), o = w.append("rect");
        o.attr("id", `${G}-group-${f.id}`).attr("x", t + e).attr("y", s + e).attr("width", u).attr("height", r).attr("class", "node-bkg");
        const c = w.append("g");
        let l = t, T = s;
        if (f.icon) {
          const g = c.append("g");
          g.html(
            `<g>${await ve(f.icon, { height: v, width: v, fallbackPrefix: ae.prefix })}</g>`
          ), g.attr(
            "transform",
        ...
        M.setElementForId(f.id, o);
      }
    })
  );
}, "drawGroups"), Pr = /* @__PURE__ */ ct(async function(w, F, M, G) {
  const N = me();
  for (const v of M) {
    const h = F.append("g"), a = w.getConfigField("iconSize");
    if (v.title) {
      const r = h.append("g");
      await Ee(
        r,
    ...
    if (v.icon)
      e.html(
        `<g>${await ve(v.icon, { height: a, width: a, fallbackPrefix: ae.prefix })}</g>`
      );
    else if (v.iconText) {
      e.html(
        `<g>${await ve("blank", { height: a, width: a, fallbackPrefix: ae.prefix })}</g>`
      );
      const t = e.append("g").append("foreignObject").attr("width", a).attr("height", a).append("div").attr("class", "node-icon-text").attr("style", `height: ${a}px;`).append("div").html(or(v.iconText, N)), s = parseInt(
      ...
      e.append("path").attr("class", "node-bkg").attr("id", `${G}-node-${v.id}`).attr(
        "d",
        `M0,${a} V5 Q0,0 5,0 H${a - 5} Q${a},0 ${a},5 V${a} Z`
      );
    h.attr("id", `${G}-service-${v.id}`).attr("class", "architecture-service");
    const { width: i, height: f } = h.node().getBBox();
    v.width = i, v.height = f, w.setElementForId(v.id, h);
  }
  return 0;
}, "drawServices"), Gr = /* @__PURE__ */ ct(function(w, F, M, G) {
  M.forEach((N) => {
    const v = F.append("g"), h = w.getConfigField("iconSize");
    v.append("g").append("rect").attr("id", `${G}-node-${N.id}`).attr("fill-opacity", "0").attr("width", h).attr("height", h), v.attr("class", "architecture-junction");
    const { width: e, height: i } = v._groups[0][0].getBBox();
    v.width = e, v.height = i, w.setElementForId(N.id, v);
  });
}, "drawJunctions");
lr([
  {
...
function He(w, F) {
  F.nodes().map((M) => {
    ...
    if (G.type === "group")
      return;
    G.x = M.position().x, G.y = M.position().y, w.getElementById(G.id).attr("transform", "translate(" + (G.x || 0) + "," + (G.y || 0) + ")");
  });
}
ct(He, "positionNodes");
function We(w, F) {
...
function Ve(w, F) {
  w.forEach((M) => {
    const { lhsId: G, rhsId: N, lhsInto: v, lhsGroup: h, rhsInto: a, lhsDir: e, rhsDir: i, rhsGroup: f, title: r } = M, u = Te(M.lhsDir, M.rhsDir) ? "segments" : "straight", t = {
      id: `${G}-${N}`,
      label: r,
      source: G,
      sourceDir: e,
...
function ze(w, F, M, G = []) {
  const N = /* @__PURE__ */ ct((u, t) => {
    ...
    for (const [o, c] of u.entries()) {
      ...
      for (let d = 0; d < g.length - 1; d++)
        for (let L = d + 1; L < g.length; L++) {
          const [R, C] = g[d], [P, V] = g[L];
          if (M.get(be(R, P)) === t)
            s.set(l, [...s.get(l) ?? [], ...C, ...V]);
          else if (R === "default" || P === "default")
            s.set(l, [...s.get(l) ?? [], ...C, ...V]);
          else {
            const z = `${l}-${T++}`;
            s.set(z, C);
    ...
    return s;
  }, "flattenAlignments"), v = F.map((u) => {
    const t = /* @__PURE__ */ new Map(), s = /* @__PURE__ */ new Map();
    return u.forEach(([o, c], l) => {
      const T = w.getNode(l)?.in ?? "default", g = t.get(c) ?? /* @__PURE__ */ new Map();
      t.has(c) || t.set(c, g);
      const d = s.get(o) ?? /* @__PURE__ */ new Map();
      s.has(o) || s.set(o, d);
      for (const L of [g, d]) {
        const R = L.get(T) ?? [];
        L.has(T) || L.set(T, R), R.push(l);
      }
    }), {
      horiz: [...N(t, "horizontal").values()].filter(
        (o) => o.length > 1
      ),
      vert: [...N(s, "vertical").values()].filter(
        (o) => o.length > 1
      )
    };
  }), [h, a] = v.reduce(
  ...
  G.forEach((u) => u.members.forEach((t) => e.add(t)));
  const i = /* @__PURE__ */ ct((u) => u.filter((t) => !t.some((s) => e.has(s))), "dropOverlapping"), f = i(h), r = i(a);
  return G.forEach((u) => {
    u.members.length < 2 || (u.direction === "row" ? f.push([...u.members]) : r.push([...u.members]));
  }), {
    horizontal: f,
    vertical: r
  };
...
ct(ze, "getAlignments");
function $e(w, F, M = []) {
  const G = [], N = F.getConfigField("iconSize"), v = F.getConfigField("idealEdgeLengthMultiplier"), h = v * N, a = /* @__PURE__ */ new Set();
  M.forEach((f) => {
    for (let r = 0; r < f.members.length - 1; r++) {
      const u = f.members[r], t = f.members[r + 1];
      a.add(`${u}|${t}`), a.add(`${t}|${u}`), f.direction === "row" ? G.push({ left: u, right: t, gap: h }) : G.push({ top: u, bottom: t, gap: h });
    }
  });
  const e = /* @__PURE__ */ ct((f) => `${f[0]},${f[1]}`, "posToStr"), i = /* @__PURE__ */ ct((f) => f.split(",").map((r) => parseInt(r)), "strToPos");
  return w.forEach((f) => {
    const r = new Map(
      [...f.entries()].map(([o, c]) => [e(c), o])
    ), u = [e([0, 0])], t = {}, s = {
      L: [-1, 0],
      R: [1, 0],
      T: [0, 1],
    ...
    for (; u.length > 0; ) {
      ...
      if (o) {
        ...
        if (c) {
          const l = i(o);
          Object.entries(s).forEach(([T, g]) => {
            const d = e([l[0] + g[0], l[1] + g[1]]), L = r.get(d);
            if (L && !t[d]) {
              if (u.push(d), a.has(`${c}|${L}`))
                return;
              G.push({
                [xe[T]]: L,
                [xe[Nr(T)]]: c,
...
ct($e, "getRelativeConstraints");
function Be(w, F, M, G, N, { spatialMaps: v, groupAlignments: h }) {
  return new Promise((a) => {
    const e = sr("body").append("div").attr("id", "cy").attr("style", "display:none"), i = Fe({
    ...
    e.remove(), We(M, i), Ye(w, i, N), Xe(F, i, N), Ve(G, i);
    const f = N.getLayoutHints(), r = ze(N, v, h, f), u = $e(v, N, f), t = N.getConfigField("iconSize"), s = N.getConfigField("idealEdgeLengthMultiplier") * t, o = 0.5 * t, c = N.getConfigField("edgeElasticity"), l = N.getConfigField("seed"), T = i.layout({
      name: "fcose",
      quality: "proof",
      ...
      idealEdgeLength(g) {
        const [d, L] = g.connectedNodes(), { parent: R } = ie(d), { parent: C } = ie(L);
        return R === C ? s : o;
      },
      edgeElasticity(g) {
        const [d, L] = g.connectedNodes(), { parent: R } = ie(d), { parent: C } = ie(L);
    ...
    T.one("layoutstop", () => {
      function g(d, L, R, C) {
        let P, V;
        const { x: Y, y: z } = d, { x: A, y: _ } = L;
        V = (C - z + (Y - R) * (z - _) / (Y - A)) / Math.sqrt(1 + Math.pow((z - _) / (Y - A), 2)), P = Math.sqrt(Math.pow(C - z, 2) + Math.pow(R - Y, 2) - Math.pow(V, 2));
        const n = Math.sqrt(Math.pow(A - Y, 2) + Math.pow(_ - z, 2));
        P = P / n;
        let E = (A - Y) * (C - z) - (_ - z) * (R - Y);
        switch (!0) {
          case E >= 0:
            E = 1;
            break;
        ...
        return V = Math.abs(V) * E, P = P * p, {
          distances: V,
          weights: P
        };
      }
      ct(g, "getSegmentWeights"), i.startBatch();
      for (const d of Object.values(i.edges()))
        if (d.data?.()) {
          const { x: L, y: R } = d.source().position(), { x: C, y: P } = d.target().position();
          if (L !== C && R !== P) {
            const V = d.sourceEndpoint(), Y = d.targetEndpoint(), { sourceDir: z } = Pe(d), [A, _] = qt(z) ? [V.x, Y.y] : [Y.x, V.y], { weights: n, distances: E } = g(V, Y, A, _);
            d.style("segment-distances", E), d.style("segment-weights", n);
          }
        }
      i.endBatch(), ye(l, () => T.run());
    });
    try {
      ye(l, () => T.run());
    } catch (g) {
      throw g instanceof RangeError && g.message.includes("Invalid array length") ? new Error(
...
ct(Be, "layoutArchitecture");
var Ur = /* @__PURE__ */ ct(async (w, F, M, G) => {
  const N = G.db;
  N.setDiagramId(F);
  const v = N.getServices(), h = N.getJunctions(), a = N.getGroups(), e = N.getEdges(), i = N.getDataStructures(), f = qe(F), r = f.append("g");
  r.attr("class", "architecture-edges");
  const u = f.append("g");
  u.attr("class", "architecture-services");
  const t = f.append("g");
  t.attr("class", "architecture-groups"), await Pr(N, u, v, F), Gr(N, u, h, F);
  const s = await Be(v, h, a, e, N, i);
  await Fr(r, s, N, F), await br(t, s, N, F), He(N, s), Qe(void 0, f, N.getConfigField("padding"), N.getConfigField("useMaxWidth"));
}, "draw"), Yr = { draw: Ur }, $r = {
  parser: Ue,
  get db() {
    return new Ge();
