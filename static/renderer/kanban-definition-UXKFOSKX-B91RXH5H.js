import { _ as o, l as te, c as U, D as fe, ag as ye, ah as be, ai as me, ae as _e, B as K, i as F, H as ke, J as Ee, ab as Se, ac as ce, ad as le } from "./mermaid.core-CE4XPZv1.js";
import { g as Ne } from "./chunk-5VM5RSS4-GIn7YGKa.js";
var $ = (function() {
  var e = /* @__PURE__ */ o(function(O, i, n, r) {
    for (n = n || {}, r = O.length; r--; n[O[r]] = i) ;
    return n;
  }, "o"), h = [1, 4], p = [1, 13], s = [1, 12], d = [1, 15], _ = [1, 16], m = [1, 20], l = [1, 19], D = [6, 7, 8], I = [1, 26], g = [1, 24], w = [1, 25], k = [6, 7, 11], G = [1, 31], N = [6, 7, 11, 24], B = [1, 6, 13, 16, 17, 20, 23], f = [1, 35], A = [1, 36], L = [1, 6, 7, 11, 13, 16, 17, 20, 23], H = [1, 38], T = {
    ...
    performAction: /* @__PURE__ */ o(function(i, n, r, a, u, t, M) {
      var c = t.length - 1;
      switch (u) {
        case 6:
        case 7:
    ...
    table: [{ 3: 1, 4: 2, 5: 3, 6: [1, 5], 8: h }, { 1: [3] }, { 1: [2, 1] }, { 4: 6, 6: [1, 7], 7: [1, 8], 8: h }, { 6: p, 7: [1, 10], 9: 9, 12: 11, 13: s, 14: 14, 16: d, 17: _, 18: 17, 19: 18, 20: m, 23: l }, e(D, [2, 3]), { 1: [2, 2] }, e(D, [2, 4]), e(D, [2, 5]), { 1: [2, 6], 6: p, 12: 21, 13: s, 14: 14, 16: d, 17: _, 18: 17, 19: 18, 20: m, 23: l }, { 6: p, 9: 22, 12: 11, 13: s, 14: 14, 16: d, 17: _, 18: 17, 19: 18, 20: m, 23: l }, { 6: I, 7: g, 10: 23, 11: w }, e(k, [2, 24], { 18: 17, 19: 18, 14: 27, 16: [1, 28], 17: [1, 29], 20: m, 23: l }), e(k, [2, 19]), e(k, [2, 21], { 15: 30, 24: G }), e(k, [2, 22]), e(k, [2, 23]), e(N, [2, 25]), e(N, [2, 26]), e(N, [2, 28], { 20: [1, 32] }), { 21: [1, 33] }, { 6: I, 7: g, 10: 34, 11: w }, { 1: [2, 7], 6: p, 12: 21, 13: s, 14: 14, 16: d, 17: _, 18: 17, 19: 18, 20: m, 23: l }, e(B, [2, 14], { 7: f, 11: A }), e(L, [2, 8]), e(L, [2, 9]), e(L, [2, 10]), e(k, [2, 16], { 15: 37, 24: G }), e(k, [2, 17]), e(k, [2, 18]), e(k, [2, 20], { 24: H }), e(N, [2, 31]), { 21: [1, 39] }, { 22: [1, 40] }, e(B, [2, 13], { 7: f, 11: A }), e(L, [2, 11]), e(L, [2, 12]), e(k, [2, 15], { 24: H }), e(N, [2, 30]), { 22: [1, 41] }, e(N, [2, 27]), e(N, [2, 29])],
    ...
    parse: /* @__PURE__ */ o(function(i) {
      var n = this, r = [0], a = [], u = [null], t = [], M = this.table, c = "", W = 0, se = 0, ue = 2, re = 1, ge = t.slice.call(arguments, 1), b = Object.create(this.lexer), R = { yy: {} };
      for (var J in this.yy)
        Object.prototype.hasOwnProperty.call(this.yy, J) && (R.yy[J] = this.yy[J]);
      b.setInput(i, R.yy), R.yy.lexer = b, R.yy.parser = this, typeof b.yylloc > "u" && (b.yylloc = {});
      var q = b.yylloc;
      t.push(q);
      ...
      function pe(S) {
        r.length = r.length - 2 * S, u.length = u.length - S, t.length = t.length - S;
      }
      o(pe, "popStack");
      function ae() {
        var S;
        return S = a.pop() || b.lex() || re, typeof S != "number" && (S instanceof Array && (a = S, S = a.pop()), S = n.symbols_[S] || S), S;
      }
      o(ae, "lex");
      for (var E, P, x, Q, j = {}, z, C, oe, X; ; ) {
        if (P = r[r.length - 1], this.defaultActions[P] ? x = this.defaultActions[P] : ((E === null || typeof E > "u") && (E = ae()), x = M[P] && M[P][E]), typeof x > "u" || !x.length || !x[0]) {
          var Z = "";
          X = [];
          for (z in M[P])
            this.terminals_[z] && z > ue && X.push("'" + this.terminals_[z] + "'");
          b.showPosition ? Z = "Parse error on line " + (W + 1) + `:
` + b.showPosition() + `
Expecting ` + X.join(", ") + ", got '" + (this.terminals_[E] || E) + "'" : Z = "Parse error on line " + (W + 1) + ": Unexpected " + (E == re ? "end of input" : "'" + (this.terminals_[E] || E) + "'"), this.parseError(Z, {
            text: b.match,
        ...
        switch (x[0]) {
          case 1:
            r.push(E), u.push(b.yytext), t.push(b.yylloc), r.push(x[1]), E = null, se = b.yyleng, c = b.yytext, W = b.yylineno, q = b.yylloc;
            break;
          case 2:
            if (C = this.productions_[x[1]][1], j.$ = u[u.length - C], j._$ = {
              ...
              return Q;
            C && (r = r.slice(0, -1 * C * 2), u = u.slice(0, -1 * C), t = t.slice(0, -1 * C)), r.push(this.productions_[x[1]][0]), u.push(j.$), t.push(j._$), oe = M[r[r.length - 2]][r[r.length - 1]], r.push(oe);
            break;
          case 3:
            return !0;
        }
...
` + n + "^";
      ...
      test_match: /* @__PURE__ */ o(function(i, n) {
        ...
        }, this.options.ranges && (u.yylloc.range = this.yylloc.range.slice(0))), a = i[0].match(/(?:\r\n?|\n).*/g), a && (this.yylineno += a.length), this.yylloc = {
      ...
      next: /* @__PURE__ */ o(function() {
        ...
        for (var u = this._currentRules(), t = 0; t < u.length; t++)
          if (r = this._input.match(this.rules[u[t]]), r && (!n || r[0].length > n[0].length)) {
            if (n = r, a = t, this.options.backtrack_lexer) {
              if (i = this.test_match(r, u[t]), i !== !1)
                return i;
              if (this._backtrack) {
                n = !1;
                continue;
        ...
        return n ? (i = this.test_match(n, u[a]), i !== !1 ? i : !1) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
          text: "",
          token: null,
          line: this.yylineno
      ...
      performAction: /* @__PURE__ */ o(function(n, r, a, u) {
        switch (a) {
          case 0:
  ...
  return o(V, "Parser"), V.prototype = T, T.Parser = V, new V();
})();
$.parser = $;
var xe = $, v = [], ne = [], ee = 0, ie = {}, ve = /* @__PURE__ */ o(() => {
  ...
  for (let s = v.length - 1; s >= 0; s--)
    if (v[s].level === h && !p && (p = v[s]), v[s].level < h)
  ...
  for (const d of p) {
    ...
    h.push(_);
    const m = v.filter((l) => l.parentId === d.id);
    for (const l of m) {
      const D = {
        id: l.id,
        parentId: d.id,
  ...
  return { nodes: h, edges: e, other: {}, config: U() };
}, "getData"), Oe = /* @__PURE__ */ o((e, h, p, s, d) => {
  const _ = U();
  let m = _.mindmap?.padding ?? K.mindmap.padding;
  switch (s) {
    case y.ROUNDED_RECT:
    case y.RECT:
    case y.HEXAGON:
  ...
  const l = {
    ...
    level: e,
    label: F(p, _),
    width: _.mindmap?.maxNodeWidth ?? K.mindmap.maxNodeWidth,
    padding: m,
    isGroup: !1
  };
  if (d !== void 0) {
...
` + d + `
  ...
  switch (te.debug("In get type", e, h), e) {
    case "[":
      return y.RECT;
    case "(":
      return h === ")" ? y.ROUNDED_RECT : y.CLOUD;
    case "((":
      return y.CIRCLE;
    case ")":
      return y.CLOUD;
...
}, "getType"), Ce = /* @__PURE__ */ o((e, h) => {
  ie[e] = h;
}, "setElementForId"), we = /* @__PURE__ */ o((e) => {
  if (!e)
    return;
  const h = U(), p = v[v.length - 1];
  ...
  getLogger: Te,
  getElementById: Re
}, Be = Pe, Ve = /* @__PURE__ */ o(async (e, h, p, s) => {
  te.debug(`Rendering kanban diagram
` + e);
  const _ = s.db.getData(), m = U();
  m.htmlLabels = !1;
  const l = fe(h);
  for (const f of _.nodes)
    f.domId = `${h}-${f.id}`;
  const D = l.append("g");
  D.attr("class", "sections");
  const I = l.append("g");
  I.attr("class", "items");
  const g = _.nodes.filter(
  ...
  let N = 25;
  for (const f of g) {
    const A = m?.kanban?.sectionWidth || 200;
    w = w + 1, f.x = A * w + (w - 1) * k / 2, f.width = A, f.y = 0, f.height = A * 3, f.rx = 5, f.ry = 5, f.cssClasses = f.cssClasses + " section-" + w;
  ...
  for (const f of g) {
    const A = G[B];
    B = B + 1;
    const L = m?.kanban?.sectionWidth || 200, H = -L * 3 / 2 + N;
    let T = H;
    const Y = _.nodes.filter((i) => i.parentId === f.id);
    for (const i of Y) {
      if (i.isGroup)
        throw new Error("Groups within groups are not allowed in Kanban diagrams");
      i.x = f.x, i.width = L - 1.5 * k;
      const r = (await be(I, i, { config: m })).node().getBBox();
      i.y = T + r.height / 2, await me(i), T = i.y + r.height / 2 + k / 2;
    }
    const V = A.cluster.select("rect"), O = Math.max(T - H + 3 * k, 50) + (N - 25);
    V.attr("height", O);
  }
  _e(
    void 0,
    l,
    m.mindmap?.padding ?? K.kanban.padding,
    m.mindmap?.useMaxWidth ?? K.kanban.useMaxWidth
  );
}, "draw"), je = {
  draw: Ve
}, Fe = /* @__PURE__ */ o((e) => {
